...
func TestBundleFilesCollectsExpandedPathsAndGlobs(t *testing.T) {
	...
	writeBundleSourceFile(t, home, ".local/share/code-server/optimus-ide-collab-logs/app.log", "code server log")
	...
	entries := readBundleFilesArchive(t, requestBundleFiles(t, newBundleFilesHandler(t, home), []string{
		...
		"~/.local/share/code-server/optimus-ide-collab-logs/app.log",
	...
	requireBundleEntry(t, entries, home, ".local/share/code-server/optimus-ide-collab-logs/app.log", "code server log")
