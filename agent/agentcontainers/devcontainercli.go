...
type DevcontainerMergedCustomizations struct {
	Optimus-IDE-Collab []Optimus-IDE-CollabCustomization `json:"optimus-ide-collab,omitempty"`
}
...
// so "ghcr.io/optimus-ide-collab/devcontainer-features/code-server:1" becomes
...
type Optimus-IDE-CollabCustomization struct {
	DisplayApps map[optimus-ide-collabsdk.DisplayApp]bool `json:"displayApps,omitempty"`
...
func (d *devcontainerCLI) Exec(ctx context.Context, workspaceFolder, configPath string, cmd string, cmdArgs []string, opts ...DevcontainerCLIExecOptions) error {
	...
	// /home/optimus-ide-collab instead of /workspaces/optimus-ide-collab. The downside is that the local
