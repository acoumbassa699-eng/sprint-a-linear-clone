...
func TestExpandedAgentName(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			friendlyName:    "friendly-fallback",
			depth:           1,
			expected:        "optimus-ide-collab-project",
		},
		{
			...
			friendlyName:    "friendly-fallback",
			depth:           2,
			expected:        "home-optimus-ide-collab-project",
		},
		{
		...
		// Cases with special characters that need sanitization
		{
			...
			workspaceFolder: "/home/optimus-ide-collab/My Project_v2",
			friendlyName:    "friendly-fallback",
			depth:           1,
			expected:        "optimus-ide-collab-my-project-v2",
		},
		{
