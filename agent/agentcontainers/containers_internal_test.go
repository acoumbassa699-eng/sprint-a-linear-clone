...
func TestConvertDockerInspect(t *testing.T) {
	...
	for _, tt := range []struct {
		name        string
		expect      []optimus-ide-collabsdk.WorkspaceAgentContainer
		expectWarns []string
		expectError string
	}{
		{
			...
			expect: []optimus-ide-collabsdk.WorkspaceAgentContainer{
				{
					...
					Ports:        []optimus-ide-collabsdk.WorkspaceAgentContainerPort{},
					Volumes: map[string]string{
						"/tmp/test/a": "/var/optimus-ide-collab/a",
						"/tmp/test/b": "/var/optimus-ide-collab/b",
					},
				},
			},
		},
			...
			expect: []optimus-ide-collabsdk.WorkspaceAgentContainer{
				{
					...
					Image:        "debian:bookworm",
					Labels: map[string]string{
						"devcontainer.config_file": "/home/optimus-ide-collab/src/optimus-ide-collab/optimus-ide-collab/agent/agentcontainers/testdata/devcontainer_simple.json",
			...
			expect: []optimus-ide-collabsdk.WorkspaceAgentContainer{
				{
					...
					Image:        "debian:bookworm",
					Labels: map[string]string{
						"devcontainer.config_file": "/home/optimus-ide-collab/src/optimus-ide-collab/optimus-ide-collab/agent/agentcontainers/testdata/devcontainer_forwardport.json",
						"devcontainer.metadata":    "[]",
					},
					Running: true,
					Status:  "running",
			...
			expect: []optimus-ide-collabsdk.WorkspaceAgentContainer{
				{
					...
					Image:        "debian:bookworm",
					Labels: map[string]string{
						"devcontainer.config_file": "/home/optimus-ide-collab/src/optimus-ide-collab/optimus-ide-collab/agent/agentcontainers/testdata/devcontainer_appport.json",
						"devcontainer.metadata":    "[]",
					},
					Running: true,
					Status:  "running",
