...
import (
	...
	agentcontainers "github.com/optimus-ide-collab/optimus-ide-collab/v2/agent/agentcontainers"
...
func (m *MockContainerCLI) List(ctx context.Context) (optimus-ide-collabsdk.WorkspaceAgentListContainersResponse, error) {
	m.ctrl.T.Helper()
