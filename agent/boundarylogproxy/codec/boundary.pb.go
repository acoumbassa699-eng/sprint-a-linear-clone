...
// never forwarded to optimus-ide-collabd.
...
var file_agent_boundarylogproxy_codec_boundary_proto_goTypes = []interface{}{
	(*BoundaryMessage)(nil),                 // 0: optimus-ide-collab.boundarylogproxy.codec.v1.BoundaryMessage
	(*BoundaryStatus)(nil),                  // 1: optimus-ide-collab.boundarylogproxy.codec.v1.BoundaryStatus
	(*proto.ReportBoundaryLogsRequest)(nil), // 2: optimus-ide-collab.agent.v2.ReportBoundaryLogsRequest
}
var file_agent_boundarylogproxy_codec_boundary_proto_depIdxs = []int32{
	2, // 0: optimus-ide-collab.boundarylogproxy.codec.v1.BoundaryMessage.logs:type_name -> optimus-ide-collab.agent.v2.ReportBoundaryLogsRequest
	1, // 1: optimus-ide-collab.boundarylogproxy.codec.v1.BoundaryMessage.status:type_name -> optimus-ide-collab.boundarylogproxy.codec.v1.BoundaryStatus
