...
func (a *API) handleDesktopVNC(rw http.ResponseWriter, r *http.Request) {
	...
	// Accept WebSocket from optimus-ide-collabd.
	...
	wsCtx, wsNetConn := optimus-ide-collabsdk.WebsocketNetConn(ctx, conn, websocket.MessageBinary)
...
func (a *API) handleAction(rw http.ResponseWriter, r *http.Request) {
	...
	if err := json.NewDeoptimus-ide-collab(r.Body).Decode(&action); err != nil {
