...
func TestScanReturnsRepoChanges(t *testing.T) {
	...
	require.Equal(t, optimus-ide-collabsdk.WorkspaceAgentGitServerMessageTypeChanges, msg.Type)
...
func recvMsg(ctx context.Context, t *testing.T, ch <-chan optimus-ide-collabsdk.WorkspaceAgentGitServerMessage) optimus-ide-collabsdk.WorkspaceAgentGitServerMessage {
	t.Helper()
	select {
	case msg, ok := <-ch:
	...
	case <-ctx.Done():
		...
		return optimus-ide-collabsdk.WorkspaceAgentGitServerMessage{}
	}
}
...
func TestWebSocketIncrementalSubscribe(t *testing.T) {
	...
	require.Equal(t, optimus-ide-collabsdk.WorkspaceAgentGitServerMessageTypeChanges, msg1.Type)
	require.Len(t, msg1.Repositories, 1)
	...
	require.Equal(t, optimus-ide-collabsdk.WorkspaceAgentGitServerMessageTypeChanges, msg2.Type)
...
func TestWebSocketRefreshTriggersChanges(t *testing.T) {
	...
	err := stream.Send(optimus-ide-collabsdk.WorkspaceAgentGitClientMessage{
...
func TestWebSocketUnknownMessageType(t *testing.T) {
	...
	msg := recvMsg(ctx, t, ch)
	require.Equal(t, optimus-ide-collabsdk.WorkspaceAgentGitServerMessageTypeError, msg.Type)
...
func TestMultipleConcurrentConnections(t *testing.T) {
	...
	assert.Equal(t, optimus-ide-collabsdk.WorkspaceAgentGitServerMessageTypeChanges, msg1.Type)
	assert.Equal(t, optimus-ide-collabsdk.WorkspaceAgentGitServerMessageTypeChanges, msg2.Type)
...
func TestE2E_MultipleConcurrentChatWatchers(t *testing.T) {
	...
	require.Equal(t, optimus-ide-collabsdk.WorkspaceAgentGitServerMessageTypeChanges, msgA.Type)
	...
	require.Equal(t, optimus-ide-collabsdk.WorkspaceAgentGitServerMessageTypeChanges, msgB.Type)
...
func TestFallbackPollSkipsWhenRecentlyScanned(t *testing.T) {
	...
	require.Equal(t, optimus-ide-collabsdk.WorkspaceAgentGitServerMessageTypeChanges, msg3.Type)
}
