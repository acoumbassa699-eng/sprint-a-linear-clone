...
func TestCanonicalizePath_TildeExpansion(t *testing.T) {
	...
	got, err := agentcontext.CanonicalizePath("~/.optimus-ide-collab")
	require.NoError(t, err)
	require.Equal(t, filepath.Join(home, ".optimus-ide-collab"), got)
}
...
func TestCanonicalizePathIn_ExpandsAgainstGivenHome(t *testing.T) {
	...
	got, err := agentcontext.CanonicalizePathIn(home, "~/.optimus-ide-collab")
	require.NoError(t, err)
	require.Equal(t, filepath.Join(home, ".optimus-ide-collab"), got)
