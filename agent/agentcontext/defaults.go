...
func defaultBuiltinRoots() []string {
	return []string{
		// User-level Optimus-IDE-Collab config.
		"~/.optimus-ide-collab",
		"~/.optimus-ide-collab/skills",
...
// directory's Optimus-IDE-Collab and Claude config trees. The Manager
...
func defaultAllowedRoots() []string {
	return []string{"~", "~/.optimus-ide-collab", "~/.claude"}
}
