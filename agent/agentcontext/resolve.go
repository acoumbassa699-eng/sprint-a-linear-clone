...
// covers the cross-tool conventions Optimus-IDE-Collab supports; codex itself
...
// local user's filesystem. Optimus-IDE-Collab workspaces may execute
...
// scheme is internal to the agent and optimus-ide-collabd, but it is stable
