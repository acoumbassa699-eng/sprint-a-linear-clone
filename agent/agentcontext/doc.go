...
// files, skills, and MCP configuration) to optimus-ide-collabd.
//
// This is the agent half of the design described in
// "RFC: Workspace Context Sources for Optimus-IDE-Collab Agents". It owns:
//
...
//     to optimus-ide-collabd without coupling this package to any particular
//     drpc client version.
//
...
// MCP servers are pushed to optimus-ide-collabd alongside instruction files and
