...
const defaultSocketPath = `\\.\pipe\com.optimus-ide-collab.agentsocket`
...
func createSocket(path string) (net.Listener, error) {
	...
	// denied. This is important because we sort of expect customers to run the Optimus-IDE-Collab agent under a generic user
