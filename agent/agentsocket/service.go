...
import (
	...
	"github.com/optimus-ide-collab/optimus-ide-collab/v2/agent/agentsocket/proto"
	agentproto "github.com/optimus-ide-collab/optimus-ide-collab/v2/agent/proto"
	"github.com/optimus-ide-collab/optimus-ide-collab/v2/agent/unit"
)
...
var (
	...
	ErrAgentAPINotConnected       = xerrors.New("agent not connected to optimus-ide-collabd")
...
// to optimus-ide-collabd. This is called when the agent connects to optimus-ide-collabd.
...
// the agent disconnects from optimus-ide-collabd.
...
// UpdateAppStatus forwards an app status update to optimus-ide-collabd via the
...
// form. Payload bytes are intentionally omitted; they reach optimus-ide-collabd via the
