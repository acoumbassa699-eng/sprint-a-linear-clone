...
import (
	proto "github.com/optimus-ide-collab/optimus-ide-collab/v2/agent/proto"
...
// Payload bytes are never sent over the socket; they ship to optimus-ide-collabd via
// the drpc PushContextState path. Mirrors agentcontext.Resource minus
// the payload and the per-server MCP tool list, which ship to optimus-ide-collabd via
...
var file_agent_agentsocket_proto_agentsocket_proto_goTypes = []interface{}{
	(*PingRequest)(nil),                   // 0: optimus-ide-collab.agentsocket.v1.PingRequest
	(*PingResponse)(nil),                  // 1: optimus-ide-collab.agentsocket.v1.PingResponse
	(*SyncStartRequest)(nil),              // 2: optimus-ide-collab.agentsocket.v1.SyncStartRequest
	(*SyncStartResponse)(nil),             // 3: optimus-ide-collab.agentsocket.v1.SyncStartResponse
	(*SyncWantRequest)(nil),               // 4: optimus-ide-collab.agentsocket.v1.SyncWantRequest
	(*SyncWantResponse)(nil),              // 5: optimus-ide-collab.agentsocket.v1.SyncWantResponse
	(*SyncCompleteRequest)(nil),           // 6: optimus-ide-collab.agentsocket.v1.SyncCompleteRequest
	(*SyncCompleteResponse)(nil),          // 7: optimus-ide-collab.agentsocket.v1.SyncCompleteResponse
	(*SyncReadyRequest)(nil),              // 8: optimus-ide-collab.agentsocket.v1.SyncReadyRequest
	(*SyncReadyResponse)(nil),             // 9: optimus-ide-collab.agentsocket.v1.SyncReadyResponse
	(*SyncStatusRequest)(nil),             // 10: optimus-ide-collab.agentsocket.v1.SyncStatusRequest
	(*DependencyInfo)(nil),                // 11: optimus-ide-collab.agentsocket.v1.DependencyInfo
	(*SyncStatusResponse)(nil),            // 12: optimus-ide-collab.agentsocket.v1.SyncStatusResponse
	(*SyncListRequest)(nil),               // 13: optimus-ide-collab.agentsocket.v1.SyncListRequest
	(*UnitInfo)(nil),                      // 14: optimus-ide-collab.agentsocket.v1.UnitInfo
	(*SyncListResponse)(nil),              // 15: optimus-ide-collab.agentsocket.v1.SyncListResponse
	(*ContextSource)(nil),                 // 16: optimus-ide-collab.agentsocket.v1.ContextSource
	(*ContextSourcesRequest)(nil),         // 17: optimus-ide-collab.agentsocket.v1.ContextSourcesRequest
	(*ContextSourcesResponse)(nil),        // 18: optimus-ide-collab.agentsocket.v1.ContextSourcesResponse
	(*GetContextSourceRequest)(nil),       // 19: optimus-ide-collab.agentsocket.v1.GetContextSourceRequest
	(*GetContextSourceResponse)(nil),      // 20: optimus-ide-collab.agentsocket.v1.GetContextSourceResponse
	(*AddContextSourceRequest)(nil),       // 21: optimus-ide-collab.agentsocket.v1.AddContextSourceRequest
	(*AddContextSourceResponse)(nil),      // 22: optimus-ide-collab.agentsocket.v1.AddContextSourceResponse
	(*RemoveContextSourceRequest)(nil),    // 23: optimus-ide-collab.agentsocket.v1.RemoveContextSourceRequest
	(*RemoveContextSourceResponse)(nil),   // 24: optimus-ide-collab.agentsocket.v1.RemoveContextSourceResponse
	(*ContextResource)(nil),               // 25: optimus-ide-collab.agentsocket.v1.ContextResource
	(*ContextSnapshot)(nil),               // 26: optimus-ide-collab.agentsocket.v1.ContextSnapshot
	(*ContextSnapshotRequest)(nil),        // 27: optimus-ide-collab.agentsocket.v1.ContextSnapshotRequest
	(*ContextSnapshotResponse)(nil),       // 28: optimus-ide-collab.agentsocket.v1.ContextSnapshotResponse
	(*ResyncContextRequest)(nil),          // 29: optimus-ide-collab.agentsocket.v1.ResyncContextRequest
	(*ResyncContextResponse)(nil),         // 30: optimus-ide-collab.agentsocket.v1.ResyncContextResponse
	(*proto.UpdateAppStatusRequest)(nil),  // 31: optimus-ide-collab.agent.v2.UpdateAppStatusRequest
	(*proto.UpdateAppStatusResponse)(nil), // 32: optimus-ide-collab.agent.v2.UpdateAppStatusResponse
}
var file_agent_agentsocket_proto_agentsocket_proto_depIdxs = []int32{
	11, // 0: optimus-ide-collab.agentsocket.v1.SyncStatusResponse.dependencies:type_name -> optimus-ide-collab.agentsocket.v1.DependencyInfo
	14, // 1: optimus-ide-collab.agentsocket.v1.SyncListResponse.units:type_name -> optimus-ide-collab.agentsocket.v1.UnitInfo
	16, // 2: optimus-ide-collab.agentsocket.v1.ContextSourcesResponse.sources:type_name -> optimus-ide-collab.agentsocket.v1.ContextSource
	16, // 3: optimus-ide-collab.agentsocket.v1.GetContextSourceResponse.source:type_name -> optimus-ide-collab.agentsocket.v1.ContextSource
	16, // 4: optimus-ide-collab.agentsocket.v1.AddContextSourceResponse.source:type_name -> optimus-ide-collab.agentsocket.v1.ContextSource
	25, // 5: optimus-ide-collab.agentsocket.v1.ContextSnapshot.resources:type_name -> optimus-ide-collab.agentsocket.v1.ContextResource
	26, // 6: optimus-ide-collab.agentsocket.v1.ContextSnapshotResponse.snapshot:type_name -> optimus-ide-collab.agentsocket.v1.ContextSnapshot
	26, // 7: optimus-ide-collab.agentsocket.v1.ResyncContextResponse.snapshot:type_name -> optimus-ide-collab.agentsocket.v1.ContextSnapshot
	0,  // 8: optimus-ide-collab.agentsocket.v1.AgentSocket.Ping:input_type -> optimus-ide-collab.agentsocket.v1.PingRequest
	2,  // 9: optimus-ide-collab.agentsocket.v1.AgentSocket.SyncStart:input_type -> optimus-ide-collab.agentsocket.v1.SyncStartRequest
	4,  // 10: optimus-ide-collab.agentsocket.v1.AgentSocket.SyncWant:input_type -> optimus-ide-collab.agentsocket.v1.SyncWantRequest
	6,  // 11: optimus-ide-collab.agentsocket.v1.AgentSocket.SyncComplete:input_type -> optimus-ide-collab.agentsocket.v1.SyncCompleteRequest
	8,  // 12: optimus-ide-collab.agentsocket.v1.AgentSocket.SyncReady:input_type -> optimus-ide-collab.agentsocket.v1.SyncReadyRequest
	10, // 13: optimus-ide-collab.agentsocket.v1.AgentSocket.SyncStatus:input_type -> optimus-ide-collab.agentsocket.v1.SyncStatusRequest
	13, // 14: optimus-ide-collab.agentsocket.v1.AgentSocket.SyncList:input_type -> optimus-ide-collab.agentsocket.v1.SyncListRequest
	31, // 15: optimus-ide-collab.agentsocket.v1.AgentSocket.UpdateAppStatus:input_type -> optimus-ide-collab.agent.v2.UpdateAppStatusRequest
	17, // 16: optimus-ide-collab.agentsocket.v1.AgentSocket.ContextSources:input_type -> optimus-ide-collab.agentsocket.v1.ContextSourcesRequest
	19, // 17: optimus-ide-collab.agentsocket.v1.AgentSocket.GetContextSource:input_type -> optimus-ide-collab.agentsocket.v1.GetContextSourceRequest
	21, // 18: optimus-ide-collab.agentsocket.v1.AgentSocket.AddContextSource:input_type -> optimus-ide-collab.agentsocket.v1.AddContextSourceRequest
	23, // 19: optimus-ide-collab.agentsocket.v1.AgentSocket.RemoveContextSource:input_type -> optimus-ide-collab.agentsocket.v1.RemoveContextSourceRequest
	27, // 20: optimus-ide-collab.agentsocket.v1.AgentSocket.GetContextSnapshot:input_type -> optimus-ide-collab.agentsocket.v1.ContextSnapshotRequest
	29, // 21: optimus-ide-collab.agentsocket.v1.AgentSocket.ResyncContext:input_type -> optimus-ide-collab.agentsocket.v1.ResyncContextRequest
	1,  // 22: optimus-ide-collab.agentsocket.v1.AgentSocket.Ping:output_type -> optimus-ide-collab.agentsocket.v1.PingResponse
	3,  // 23: optimus-ide-collab.agentsocket.v1.AgentSocket.SyncStart:output_type -> optimus-ide-collab.agentsocket.v1.SyncStartResponse
	5,  // 24: optimus-ide-collab.agentsocket.v1.AgentSocket.SyncWant:output_type -> optimus-ide-collab.agentsocket.v1.SyncWantResponse
	7,  // 25: optimus-ide-collab.agentsocket.v1.AgentSocket.SyncComplete:output_type -> optimus-ide-collab.agentsocket.v1.SyncCompleteResponse
	9,  // 26: optimus-ide-collab.agentsocket.v1.AgentSocket.SyncReady:output_type -> optimus-ide-collab.agentsocket.v1.SyncReadyResponse
	12, // 27: optimus-ide-collab.agentsocket.v1.AgentSocket.SyncStatus:output_type -> optimus-ide-collab.agentsocket.v1.SyncStatusResponse
	15, // 28: optimus-ide-collab.agentsocket.v1.AgentSocket.SyncList:output_type -> optimus-ide-collab.agentsocket.v1.SyncListResponse
	32, // 29: optimus-ide-collab.agentsocket.v1.AgentSocket.UpdateAppStatus:output_type -> optimus-ide-collab.agent.v2.UpdateAppStatusResponse
	18, // 30: optimus-ide-collab.agentsocket.v1.AgentSocket.ContextSources:output_type -> optimus-ide-collab.agentsocket.v1.ContextSourcesResponse
	20, // 31: optimus-ide-collab.agentsocket.v1.AgentSocket.GetContextSource:output_type -> optimus-ide-collab.agentsocket.v1.GetContextSourceResponse
	22, // 32: optimus-ide-collab.agentsocket.v1.AgentSocket.AddContextSource:output_type -> optimus-ide-collab.agentsocket.v1.AddContextSourceResponse
	24, // 33: optimus-ide-collab.agentsocket.v1.AgentSocket.RemoveContextSource:output_type -> optimus-ide-collab.agentsocket.v1.RemoveContextSourceResponse
	28, // 34: optimus-ide-collab.agentsocket.v1.AgentSocket.GetContextSnapshot:output_type -> optimus-ide-collab.agentsocket.v1.ContextSnapshotResponse
	30, // 35: optimus-ide-collab.agentsocket.v1.AgentSocket.ResyncContext:output_type -> optimus-ide-collab.agentsocket.v1.ResyncContextResponse
