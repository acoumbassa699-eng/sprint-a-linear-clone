...
// see the Manifest doc comment in optimus-ide-collabsdk/agentsdk.
...
func (*Client) AsRequestOption() optimus-ide-collabsdk.RequestOption {
...
func (c *Client) GetLifecycleStates() []optimus-ide-collabsdk.WorkspaceAgentLifecycle {
...
func (c *Client) SetAnnouncementBannersFunc(f func() ([]optimus-ide-collabsdk.BannerConfig, error)) {
...
type FakeAgentAPI struct {
	...
	lifecycleStates     []optimus-ide-collabsdk.WorkspaceAgentLifecycle
	...
	getAnnouncementBannersFunc              func() ([]optimus-ide-collabsdk.BannerConfig, error)
...
func (f *FakeAgentAPI) SetAnnouncementBannersFunc(fn func() ([]optimus-ide-collabsdk.BannerConfig, error)) {
	f.Lock()
	defer f.Unlock()
...
func (f *FakeAgentAPI) GetLifecycleStates() []optimus-ide-collabsdk.WorkspaceAgentLifecycle {
	f.Lock()
	defer f.Unlock()
