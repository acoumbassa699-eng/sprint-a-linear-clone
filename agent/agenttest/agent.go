...
// The agent will use the provided optimus-ide-collab URL and session token.
...
// It is the responsibility of the caller to call optimus-ide-collabdtest.AwaitWorkspaceAgents
// to ensure agent is connected.
func New(t testing.TB, optimus-ide-collabURL *url.URL, agentToken string, opts ...func(*agent.Options)) agent.Agent {
	t.Helper()
	...
	if o.Client == nil {
		agentClient := agentsdk.New(optimus-ide-collabURL, agentsdk.WithFixedToken(agentToken))
