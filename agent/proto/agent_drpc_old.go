...
// is useful when you want to be maximally compatible with Optimus-IDE-Collabd Release Versions from 2.9+
...
// with Optimus-IDE-Collabd Release Versions from 2.12+
...
// the Tailnet API, which uses the same version number. Compatible with Optimus-IDE-Collab v2.13+
...
// PushResourcesMonitoringUsage and ReportConnection RPCs. Compatible with Optimus-IDE-Collab v2.19+
...
// agent manifest response. Compatible with Optimus-IDE-Collab v2.23+
type DRPCAgentClient25 interface {
	DRPCAgentClient24
}

// DRPCAgentClient26 is the Agent API at v2.6. It adds the CreateSubAgent,
// DeleteSubAgent and ListSubAgents RPCs. Compatible with Optimus-IDE-Collab v2.24+
...
// RPC for forwarding boundary audit logs to optimus-ide-collabd. Compatible with Optimus-IDE-Collab v2.30+
...
//   - UpdateAppStatus RPC.
//
// Compatible with Optimus-IDE-Collab v2.31+
...
// configs, MCP server tool lists) to optimus-ide-collabd.
