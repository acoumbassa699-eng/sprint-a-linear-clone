...
const (
	EnvInstructionsDirs = "OPTIMUS-IDE-COLLAB_AGENT_EXP_INSTRUCTIONS_DIRS"
	EnvInstructionsFile = "OPTIMUS-IDE-COLLAB_AGENT_EXP_INSTRUCTIONS_FILE"
	EnvSkillsDirs       = "OPTIMUS-IDE-COLLAB_AGENT_EXP_SKILLS_DIRS"
	EnvSkillMetaFile    = "OPTIMUS-IDE-COLLAB_AGENT_EXP_SKILL_META_FILE"
	EnvMCPConfigFiles   = "OPTIMUS-IDE-COLLAB_AGENT_EXP_MCP_CONFIG_FILES"
)
...
const (
	DefaultInstructionsDir  = "~/.optimus-ide-collab"
	DefaultInstructionsFile = "AGENTS.md"
	DefaultSkillsDir        = "~/.optimus-ide-collab/skills,.agents/skills"
...
// ReadEnvConfig reads the OPTIMUS-IDE-COLLAB_AGENT_EXP_* environment
...
// envVarKeys returns every OPTIMUS-IDE-COLLAB_AGENT_EXP_* env var key
...
// ClearEnvVars removes the OPTIMUS-IDE-COLLAB_AGENT_EXP_* environment
...
func ContextPartsFromDir(dir string) []optimus-ide-collabsdk.ChatMessagePart {
...
func readInstructionFiles(dirs []string, fileName string) []optimus-ide-collabsdk.ChatMessagePart {
	var parts []optimus-ide-collabsdk.ChatMessagePart
...
func readInstructionFileFromDir(dir, fileName string) (optimus-ide-collabsdk.ChatMessagePart, bool) {
	dirEntries, err := os.ReadDir(dir)
	if err != nil {
		return optimus-ide-collabsdk.ChatMessagePart{}, false
	}
...
// silently skipped.
func discoverSkills(skillsDirs []string, metaFile string) []optimus-ide-collabsdk.ChatMessagePart {
	...
	for _, skillsDir := range skillsDirs {
		...
		for _, entry := range entries {
			...
			parts = append(parts, optimus-ide-collabsdk.ChatMessagePart{
				Type:                     optimus-ide-collabsdk.ChatMessagePartTypeSkill,
				SkillName:                name,
