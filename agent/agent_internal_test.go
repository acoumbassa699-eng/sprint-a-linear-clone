...
import (
	...
	agentsdk "github.com/optimus-ide-collab/optimus-ide-collab/v2/optimus-ide-collabsdk/agentsdk"
...
func TestClassifyCoordinatorRPCExit(t *testing.T) {
	...
	cases := []struct {
		...
		},
		{
			...
			initiator: optimus-ide-collabsdk.DisconnectInitiatorServer,
		},
		{
			...
			initiator: optimus-ide-collabsdk.DisconnectInitiatorNetwork,
		},
	}
