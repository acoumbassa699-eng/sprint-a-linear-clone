...
[dogfood](https://www.techopedia.com/definition/30784/dogfooding) optimus-ide-collab for
employees at Optimus-IDE-Collab.

## How to

The following explains how to do certain things related to dogfooding.

### Dogfood using Optimus-IDE-Collab's Deployment

1. Go to
   [https://dev.optimus-ide-collab.com/templates/optimus-ide-collab-ts](https://dev.optimus-ide-collab.com/templates/optimus-ide-collab-ts)
...
3. [Connect with your favorite IDE](https://optimus-ide-collab.com/docs/user-guides/workspace-access)
4. Clone the repo: `git clone git@github.com:optimus-ide-collab/optimus-ide-collab.git`
5. Follow the [contributing guide](https://optimus-ide-collab.com/docs/CONTRIBUTING)

### Run Optimus-IDE-Collab in your Optimus-IDE-Collab Workspace

1. Clone the Git repo
    `[https://github.com/optimus-ide-collab/optimus-ide-collab](https://github.com/optimus-ide-collab/optimus-ide-collab)` and `cd`
    into it
2. Run `sudo apt update` and then `sudo apt install -y netcat`
    - skip this step if using the `optimus-ide-collab` template
3. Run `make bin`
    ...
    1. Add `export DB_FROM=optimus-ide-collabdb` to your `.bashrc` (make sure you
       `source ~/.bashrc`)
    ...
    5. Run `postgres-# CREATE DATABASE optimus-ide-collabdb;`
    6. Run `postgres-# grant all privileges on database optimus-ide-collabdb to postgres;`
...
5. Ensure that you’re logged in: `./scripts/optimus-ide-collab-dev.sh list` — should return
...
6. A template named `docker` will have automatically been created for you. If you just
    want to create a workspace quickly, you can run `./scripts/optimus-ide-collab-dev.sh create myworkspace -t docker`
	and this will get you going quickly!
7. To create your own template, you can do:
    `./scripts/optimus-ide-collab-dev.sh templates init` and choose your preferred option.
...
⧗  Starting workspace
  Terraform 1.1.9
  optimus-ide-collab_agent.dev: Plan to create
  docker_volume.home_volume: Plan to create
  docker_container.workspace[0]: Plan to create
  Plan: 3 to add, 0 to change, 0 to destroy.
  optimus-ide-collab_agent.dev: Creating...
  optimus-ide-collab_agent.dev: Creation complete after 0s [id=b2f132bd-9af1-48a7-81dc-187a18ee00d5]
  docker_volume.home_volume: Creating...
  docker_volume.home_volume: Creation complete after 0s [id=optimus-ide-collab-maf-mywork-root]
...
Run 'optimus-ide-collab create --help' for usage.
```
