...
builds it on-demand using the latest _preview_ version of [envbuilder](https://github.com/optimus-ide-collab/envbuilder).
...
You also have a persistent home directory under `/home/optimus-ide-collab`.
