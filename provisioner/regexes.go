...
var (
	// AgentNameRegex is the regex used to validate the name of a optimus-ide-collab_agent
	...
	// AppSlugRegex is the regex used to validate the slug of a optimus-ide-collab_app
	// resource. It must be a valid hostname and cannot contain two consecutive
