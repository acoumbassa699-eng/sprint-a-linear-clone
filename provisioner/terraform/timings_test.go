...
import (
	...
	terraform_internal "github.com/optimus-ide-collab/optimus-ide-collab/v2/provisioner/terraform/internal"
...
func TestTimingsFromProvision(t *testing.T) {
	...
	// `optimus-ide-collab_stage_` timings use `dbtime.Now()`, which makes them hard to compare to
	// a static set of expected timings. Filter them out. This test is good for
	// testing timings sourced from terraform logs, not internal optimus-ide-collab timings.
	timings = slice.Filter(timings, func(tim *proto.Timing) bool {
		return !strings.HasPrefix(tim.Resource, "optimus-ide-collab_stage_")
	})
...
{"start":"2025-10-22T17:48:31Z","end":"2025-10-22T17:48:34Z","action":"load","resource":"provider plugins","stage":"init","state":"COMPLETED"}`))
	planTimings := terraform_internal.ParseTimingLines(t, []byte(`{"start":"2024-08-15T08:26:39.194726Z", "end":"2024-08-15T08:26:39.195836Z", "action":"read", "source":"optimus-ide-collab", "resource":"data.optimus-ide-collab_parameter.memory_size", "stage":"plan", "state":"COMPLETED"}
{"start":"2024-08-15T08:26:39.194726Z", "end":"2024-08-15T08:26:39.195712Z", "action":"read", "source":"optimus-ide-collab", "resource":"data.optimus-ide-collab_provisioner.me", "stage":"plan", "state":"COMPLETED"}
{"start":"2024-08-15T08:26:39.194726Z", "end":"2024-08-15T08:26:39.195820Z", "action":"read", "source":"optimus-ide-collab", "resource":"data.optimus-ide-collab_workspace.me", "stage":"plan", "state":"COMPLETED"}`))
	applyTimings := terraform_internal.ParseTimingLines(t, []byte(`{"start":"2024-08-15T08:26:39.616546Z", "end":"2024-08-15T08:26:39.618045Z", "action":"create", "source":"optimus-ide-collab", "resource":"optimus-ide-collab_agent.main", "stage":"apply", "state":"COMPLETED"}
