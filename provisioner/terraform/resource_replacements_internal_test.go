...
func TestFindResourceReplacementsWithPaths(t *testing.T) {
	...
	cases := []struct {
		...
		{
			name: "optimus-ide-collab_* types are ignored",
			plan: &tfjson.Plan{
				ResourceChanges: []*tfjson.ResourceChange{
					{
						Address: "resource1",
						Type:    "optimus-ide-collab_resource",
						Change: &tfjson.Change{
							Actions: tfjson.Actions{tfjson.ActionDelete, tfjson.ActionCreate},
		...
		},
		{
			...
			plan: &tfjson.Plan{
				ResourceChanges: []*tfjson.ResourceChange{
					...
					{
						Address: "resource3",
						Type:    "optimus-ide-collab_example",
						Change: &tfjson.Change{
							Actions: tfjson.Actions{tfjson.ActionDelete, tfjson.ActionCreate},
							ReplacePaths: []interface{}{
...
func TestHasResourceReplacement(t *testing.T) {
	...
	cases := []struct {
		...
		{
			name: "optimus-ide-collab replacement is ignored",
			plan: &tfjson.Plan{
				ResourceChanges: []*tfjson.ResourceChange{
					{
						Address: "resource1",
