...
func TestOnlyDataResources(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			stateMod: &tfjson.StateModule{
				Resources: []*tfjson.StateResource{
					{Name: "cat", Type: "optimus-ide-collab_parameter", Mode: "data", Address: "cat-address"},
					{Name: "cow", Type: "foobaz", Mode: "data", Address: "cow-address"},
				},
				ChildModules: []*tfjson.StateModule{
					{
						Resources: []*tfjson.StateResource{
							{Name: "child-cat", Type: "optimus-ide-collab_parameter", Mode: "data", Address: "child-cat-address"},
		...
		},
		{
			...
			stateMod: &tfjson.StateModule{
				Resources: []*tfjson.StateResource{
					{Name: "cat", Type: "optimus-ide-collab_parameter", Mode: "foobar", Address: "cat-address"},
					{Name: "cow", Type: "foobaz", Mode: "foo", Address: "cow-address"},
				},
				ChildModules: []*tfjson.StateModule{
					{
						Resources: []*tfjson.StateResource{
							{Name: "child-cat", Type: "optimus-ide-collab_parameter", Mode: "foobar", Address: "child-cat-address"},
