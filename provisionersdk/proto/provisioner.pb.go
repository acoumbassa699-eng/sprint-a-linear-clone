...
type Metadata struct {
	...
	Optimus-IDE-CollabUrl                      string                      `protobuf:"bytes,1,opt,name=optimus-ide-collab_url,json=optimus-ide-collabUrl,proto3" json:"optimus-ide-collab_url,omitempty"`
...
func (x *Metadata) GetOptimus-IDE-CollabUrl() string {
	if x != nil {
