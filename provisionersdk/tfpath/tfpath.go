...
// directories. Optimus-IDE-Collab provisioner is supposed to remove them once after finishing the provisioning,
	...
	for _, fi := range entries {
		...
		if fi.IsDir() && isValidSessionDir(dirName) {
			...
			if err != nil {
				...
				// way to escalate this to an operator alert in Optimus-IDE-Collab. Until then, the best we
