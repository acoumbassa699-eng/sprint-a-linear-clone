...
const versionOutput = `Optimus-IDE-Collab v2.11.0+8979bfe Tue May  7 17:30:19 UTC 2024`
...
func serveScript(t *testing.T, in string) string {
	...
	script, exists := provisionersdk.AgentScriptEnv()[fmt.Sprintf("OPTIMUS-IDE-COLLAB_AGENT_SCRIPT_%s_%s", runtime.GOOS, runtime.GOARCH)]
	if !exists {
