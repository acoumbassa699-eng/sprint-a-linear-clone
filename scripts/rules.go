...
func dbauthzAuthorizationContext(m dsl.Matcher) {
	m.Import("context")
	m.Import("github.com/optimus-ide-collab/optimus-ide-collab/v2/optimus-ide-collabd/database/dbauthz")
...
func testingWithOwnerUser(m dsl.Matcher) {
	m.Import("testing")
	m.Import("github.com/optimus-ide-collab/optimus-ide-collab/v2/cli/clitest")
	m.Import("github.com/optimus-ide-collab/optimus-ide-collab/v2/enterprise/optimus-ide-collabd/optimus-ide-collabenttest")
	...
	m.Match(`
		$client, $_ := optimus-ide-collabdenttest.New($t, $*_)
		$*_
		clitest.$SetupConfig($t, $client, $_)
	`).Where(m["t"].Type.Implements("testing.TB") &&
		m["SetupConfig"].Text.Matches("^SetupConfig$") &&
...
// databaseImport enforces not importing any database types into /optimus-ide-collabsdk.
//
//nolint:unused,deadcode,varnamelen
func databaseImport(m dsl.Matcher) {
	m.Import("github.com/optimus-ide-collab/optimus-ide-collab/v2/optimus-ide-collabd/database")
	m.Match("database.$_").
		Report("Do not import any database types into optimus-ide-collabsdk").
		Where(
			m.File().PkgPath.Matches("github.com/optimus-ide-collab/optimus-ide-collab/v2/optimus-ide-collabsdk") &&
				!m.File().Name.Matches(`_test\.go$`),
		)
}
...
func publishInTransaction(m dsl.Matcher) {
	m.Import("github.com/optimus-ide-collab/optimus-ide-collab/v2/optimus-ide-collabd/database/pubsub")
...
func useStandardTimeoutsAndDelaysInTests(m dsl.Matcher) {
	...
	m.Import("github.com/optimus-ide-collab/optimus-ide-collab/v2/testutil")
...
func HttpAPIErrorMessage(m dsl.Matcher) {
	m.Import("github.com/optimus-ide-collab/optimus-ide-collab/v2/optimus-ide-collabd/httpapi")
...
func noPTYInAgent(m dsl.Matcher) {
	m.Import("github.com/optimus-ide-collab/optimus-ide-collab/v2/pty")
	m.Match(
		`pty.Command($*_)`,
