...
func main() {
	...
	outputDir := "./optimus-ide-collabd/apidoc"
	if d := os.Getenv("SWAG_OUTPUT_DIR"); d != "" {
		outputDir = d
	}

	err := gen.New().Build(&gen.Config{
		SearchDir:          "./optimus-ide-collabd,./optimus-ide-collabd/workspaceconnwatcher,./optimus-ide-collabsdk,./enterprise/optimus-ide-collabd,./enterprise/wsproxy/wsproxysdk",
		MainAPIFile:        "optimus-ide-collabd.go",
		OutputDir:          outputDir,
