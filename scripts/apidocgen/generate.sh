...
# from the optimus-ide-collabd API.
...
API_MD_TMP_FILE=$(mktemp /tmp/optimus-ide-collab-apidocgen.XXXXXX)
...
SWAG_OUTPUT_DIR="${SWAG_OUTPUT_DIR:-./optimus-ide-collabd/apidoc}"
