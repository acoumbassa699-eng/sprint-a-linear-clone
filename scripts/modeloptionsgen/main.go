...
func main() {
	...
	schema.General = extractFields(
		reflect.TypeOf(optimus-ide-collabsdk.ChatModelCallConfig{}),
		"",
	...
	providerTypes := []struct {
		...
		{"openai", reflect.TypeOf(optimus-ide-collabsdk.ChatModelOpenAIProviderOptions{})},
		{"anthropic", reflect.TypeOf(optimus-ide-collabsdk.ChatModelAnthropicProviderOptions{})},
		{"google", reflect.TypeOf(optimus-ide-collabsdk.ChatModelGoogleProviderOptions{})},
		{"openaicompat", reflect.TypeOf(optimus-ide-collabsdk.ChatModelOpenAICompatProviderOptions{})},
		{"openrouter", reflect.TypeOf(optimus-ide-collabsdk.ChatModelOpenRouterProviderOptions{})},
		{"vercel", reflect.TypeOf(optimus-ide-collabsdk.ChatModelVercelProviderOptions{})},
	}
