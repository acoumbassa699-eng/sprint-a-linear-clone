...
const (
	...
	changelogURLFmt  = "https://optimus-ide-collab.com/changelog/optimus-ide-collab-%d-%d"
	releaseTagURLFmt = "https://github.com/optimus-ide-collab/optimus-ide-collab/releases/tag/%s"
)
