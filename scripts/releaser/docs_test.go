...
func TestUpdateCalendarLatestReleaseVersionPrefix(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			channel: "mainline",
			want:    "[v2.35.1](https://github.com/optimus-ide-collab/optimus-ide-collab/releases/tag/v2.35.1)",
		},
		{
			name:    "minor release",
			newVer:  version{Major: 2, Minor: 35, Patch: 0},
			channel: "mainline",
			want:    "[v2.35.0](https://github.com/optimus-ide-collab/optimus-ide-collab/releases/tag/v2.35.0)",
		},
	}
...
func TestUpdateCalendarNotReleasedRowName(t *testing.T) {
	...
	const want = "[2.36](https://optimus-ide-collab.com/changelog/optimus-ide-collab-2-36)"
