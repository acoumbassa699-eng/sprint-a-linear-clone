...
> [!WARNING]
> Do not run this script unless specifically instructed to do so by Optimus-IDE-Collab support or engineering.
>
...
**2:** Run against your Optimus-IDE-Collab database:

```bash
psql -d optimus-ide-collab -f scripts/workspace-runtime-audit/workspace-runtime-audit.sql
```
