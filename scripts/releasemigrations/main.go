...
func main() {
	...
	flag.StringVar(&migrationDirectory, "dir", "optimus-ide-collabd/database/migrations", "Migration directory")
	flag.Parse()
...
func usage() {
	...
	_, _ = fmt.Println("Must be run from the optimus-ide-collab repo at the root.")
}
