...
import (
	...
	"github.com/optimus-ide-collab/guts"
	"github.com/optimus-ide-collab/guts/bindings"
	"github.com/optimus-ide-collab/guts/config"
)
...
func main() {
	...
	generateDirectories := map[string]string{
		"github.com/optimus-ide-collab/optimus-ide-collab/v2/optimus-ide-collabsdk":                  "",
		"github.com/optimus-ide-collab/optimus-ide-collab/v2/optimus-ide-collabd/healthcheck/health": "Health",
		"github.com/optimus-ide-collab/optimus-ide-collab/v2/optimus-ide-collabsdk/x/agenthooks":     "AgentHook",
	...
	// Serpent has some types referenced in the optimus-ide-collabsdk.
	// We want the referenced types generated.
	referencePackages := map[string]string{
		"github.com/optimus-ide-collab/preview/types": "Preview",
		"github.com/optimus-ide-collab/serpent":       "Serpent",
		"tailscale.com/derp":             "",
...
// TypeMappings is all the custom types for optimus-ide-collabsdk
func TypeMappings(gen *guts.GoParser) error {
	...
	gen.IncludeCustomDeclaration(map[string]guts.TypeOverride{
		"github.com/optimus-ide-collab/optimus-ide-collab/v2/optimus-ide-collabsdk.NullTime": config.OverrideNullable(config.OverrideLiteral(bindings.KeywordString)),
		...
		"github.com/optimus-ide-collab/preview/types.HCLString": func() bindings.ExpressionType {
			return bindings.Reference(bindings.Identifier{
				Name:    "NullHCLString",
				Package: nil,
				Prefix:  "",
	...
	err := gen.IncludeCustom(map[string]string{
		...
		"github.com/optimus-ide-collab/serpent.Regexp":         "string",
		"github.com/optimus-ide-collab/serpent.StringArray":    "string",
		"github.com/optimus-ide-collab/serpent.String":         "string",
		"github.com/optimus-ide-collab/serpent.YAMLConfigPath": "string",
		"github.com/optimus-ide-collab/serpent.Strings":        "[]string",
		"github.com/optimus-ide-collab/serpent.Int64":          "int64",
		"github.com/optimus-ide-collab/serpent.Bool":           "bool",
		"github.com/optimus-ide-collab/serpent.Duration":       "int64",
		"github.com/optimus-ide-collab/serpent.URL":            "string",
		"github.com/optimus-ide-collab/serpent.HostPort":       "string",
...
// ChatMessagePart fields in optimus-ide-collabsdk/chats.go. This function
...
type chatPartVariant struct {
	typeLiteral optimus-ide-collabsdk.ChatMessagePartType
...
func parseVariantTags() []chatPartVariant {
	t := reflect.TypeFor[optimus-ide-collabsdk.ChatMessagePart]()

	type fieldSets struct {
		required []string
		optional []string
	}
	byType := make(map[optimus-ide-collabsdk.ChatMessagePartType]*fieldSets)
...
func chatMessagePartTSName(t optimus-ide-collabsdk.ChatMessagePartType) string {
