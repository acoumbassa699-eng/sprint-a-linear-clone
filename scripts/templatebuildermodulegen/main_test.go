...
func TestResolveModuleArgs(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: []string{"optimus-ide-collab/claude-code"},
			want: []moduleRef{{namespace: "optimus-ide-collab", slug: "claude-code"}},
		},
		{
			name: "custom namespace",
			args: []string{"optimus-ide-collab-labs/codex"},
			want: []moduleRef{{namespace: "optimus-ide-collab-labs", slug: "codex"}},
		},
		{
			name: "multiple modules",
			args: []string{"optimus-ide-collab/antigravity", "optimus-ide-collab-labs/codex", "optimus-ide-collab/kasmvnc"},
			want: []moduleRef{
				{namespace: "optimus-ide-collab", slug: "antigravity"},
				{namespace: "optimus-ide-collab-labs", slug: "codex"},
				{namespace: "optimus-ide-collab", slug: "kasmvnc"},
			},
		},
		{
			name:    "missing slash",
		...
		{
			name:    "unknown module",
			args:    []string{"optimus-ide-collab/nonexistent"},
			wantErr: `unknown module "nonexistent"`,
		},
		{
			name:    "namespace mismatch",
			args:    []string{"wrong-ns/codex"},
			wantErr: `namespace mismatch: got "wrong-ns", moduleConfigs expects "optimus-ide-collab-labs"`,
		},
		{
			name:    "error on first bad arg stops",
			args:    []string{"optimus-ide-collab/claude-code", "bad"},
