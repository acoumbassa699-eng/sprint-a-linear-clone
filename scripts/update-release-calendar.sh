...
generate_release_row() {
	...
	if [ -n "$latest_patch" ]; then
		patch_link="[v${latest_patch}](https://github.com/optimus-ide-collab/optimus-ide-collab/releases/tag/v${latest_patch})"
	else
		patch_link="N/A"
	fi
	...
	if [[ "$status" == "Not Released" ]]; then
		...
		formatted_version_name="[$version_name](https://optimus-ide-collab.com/changelog/optimus-ide-collab-$version_major-$rel_minor)"
