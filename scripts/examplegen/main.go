...
func run(lint bool) error {
	...
	var examples []optimus-ide-collabsdk.TemplateExample
	var errs []error
...
func parseTemplateExample(projectFS, examplesFS fs.FS, name string) (te *optimus-ide-collabsdk.TemplateExample, err error) {
	var errs []error
	defer func() {
		if err != nil {
	...
	return &optimus-ide-collabsdk.TemplateExample{
		ID:          exampleID,
		Name:        displayName,
