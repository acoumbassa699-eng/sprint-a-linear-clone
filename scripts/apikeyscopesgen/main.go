...
func generate() ([]byte, error) {
	...
	if _, err := b.WriteString("package optimus-ide-collabsdk\n\n"); err != nil {
		return nil, err
	}
	...
	// We generate everything into optimus-ide-collabsdk/apikey_scopes_gen.go as the
	...
	if _, err := b.WriteString("\t// Deprecated: use optimus-ide-collabsdk.APIKeyScopeOptimus-IDE-CollabAll instead.\n"); err != nil {
		return nil, err
	}
	if _, err := b.WriteString("\tAPIKeyScopeAll APIKeyScope = \"all\"\n"); err != nil {
		return nil, err
	}
	if _, err := b.WriteString("\t// Deprecated: use optimus-ide-collabsdk.APIKeyScopeOptimus-IDE-CollabApplicationConnect instead.\n"); err != nil {
		return nil, err
	}
