...
var skipPaths = []string{
	"optimus-ide-collabd/aibridged/metrics.go",
	"optimus-ide-collabd/aibridgedserver/metrics.go",
...
// Example:
//   - "optimus-ide-collabd_" + "api_" + "requests": "optimus-ide-collabd_api_requests"
...
// Currently, optimus-ide-collab only uses MustNewConstMetric with NewDesc.
...
func extractNewDescMetric(call *ast.CallExpr, decls declarations) (Metric, bool) {
	...
	// 	prometheus.GaugeValue). Currently, optimus-ide-collab only uses MustNewConstMetric, so we
...
func buildMetricName(namespace, subsystem, name string) string {
	...
	// e.g., ("optimus-ide-collabd", "", "agents_up"): "optimus-ide-collabd_agents_up"
