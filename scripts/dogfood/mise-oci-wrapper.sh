...
# .github/workflows/dogfood.yaml and dogfood/optimus-ide-collab/ubuntu-*/Dockerfile.base.
...
WRAPPER_IMAGE="optimus-ide-collabdev/mise-oci-wrapper:$MISE_VERSION-$WRAPPER_REVISION"

# Mount the repo root rather than $PWD: `make -C dogfood/optimus-ide-collab` invokes
# the wrapper from dogfood/optimus-ide-collab/, but the project mise.toml/mise.lock
