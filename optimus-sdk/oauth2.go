...
// Optimus-IDE-Collab as an OAuth2 provider.
func (c *Client) OAuth2ProviderApps(ctx context.Context, filter OAuth2ProviderAppFilter) ([]OAuth2ProviderApp, error) {
	...
	return apps, json.NewDeoptimus-ide-collab(res.Body).Decode(&apps)
}
...
// PostOAuth2ProviderApp adds an application that can authenticate using Optimus-IDE-Collab
...
// PutOAuth2ProviderApp updates an application that can authenticate using Optimus-IDE-Collab
// as an OAuth2 provider.
