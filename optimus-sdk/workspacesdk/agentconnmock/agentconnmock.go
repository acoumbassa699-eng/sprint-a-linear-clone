...
import (
	...
	optimus-ide-collabsdk "github.com/optimus-ide-collab/optimus-ide-collab/v2/optimus-ide-collabsdk"
	healthsdk "github.com/optimus-ide-collab/optimus-ide-collab/v2/optimus-ide-collabsdk/healthsdk"
	workspacesdk "github.com/optimus-ide-collab/optimus-ide-collab/v2/optimus-ide-collabsdk/workspacesdk"
	wsjson "github.com/optimus-ide-collab/optimus-ide-collab/v2/optimus-ide-collabsdk/wsjson"
	tailnet "github.com/optimus-ide-collab/optimus-ide-collab/v2/tailnet"
)
...
func (m *MockAgentConn) ListContainers(ctx context.Context) (optimus-ide-collabsdk.WorkspaceAgentListContainersResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListContainers", ctx)
	ret0, _ := ret[0].(optimus-ide-collabsdk.WorkspaceAgentListContainersResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAgentConn) ListeningPorts(ctx context.Context) (optimus-ide-collabsdk.WorkspaceAgentListeningPortsResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListeningPorts", ctx)
	ret0, _ := ret[0].(optimus-ide-collabsdk.WorkspaceAgentListeningPortsResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAgentConn) RecreateDevcontainer(ctx context.Context, devcontainerID string) (optimus-ide-collabsdk.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RecreateDevcontainer", ctx, devcontainerID)
	ret0, _ := ret[0].(optimus-ide-collabsdk.Response)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAgentConn) WatchContainers(ctx context.Context, logger slog.Logger) (<-chan optimus-ide-collabsdk.WorkspaceAgentListContainersResponse, io.Closer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WatchContainers", ctx, logger)
	ret0, _ := ret[0].(<-chan optimus-ide-collabsdk.WorkspaceAgentListContainersResponse)
...
func (m *MockAgentConn) WatchGit(ctx context.Context, logger slog.Logger, chatID uuid.UUID) (*wsjson.Stream[optimus-ide-collabsdk.WorkspaceAgentGitServerMessage, optimus-ide-collabsdk.WorkspaceAgentGitClientMessage], error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WatchGit", ctx, logger, chatID)
	ret0, _ := ret[0].(*wsjson.Stream[optimus-ide-collabsdk.WorkspaceAgentGitServerMessage, optimus-ide-collabsdk.WorkspaceAgentGitClientMessage])
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
