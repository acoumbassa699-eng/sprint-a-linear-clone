...
// to the WorkspaceAgentConn, or it may be shared in the case of optimus-ide-collabd. If the
...
const (
	// Optimus-IDE-CollabChatIDHeader is the HTTP header containing the current
	// chat ID. Set by optimus-ide-collabd on agentconn requests originating
	// from chatd.
	Optimus-IDE-CollabChatIDHeader = "Optimus-IDE-Collab-Chat-Id"
	// Optimus-IDE-CollabAncestorChatIDsHeader is the HTTP header containing a
	// JSON array of ancestor chat UUIDs.
	Optimus-IDE-CollabAncestorChatIDsHeader = "Optimus-IDE-Collab-Ancestor-Chat-Ids"
)
...
type AgentConn interface {
	...
	ListContainers(ctx context.Context) (optimus-ide-collabsdk.WorkspaceAgentListContainersResponse, error)
	ListProcesses(ctx context.Context) (ListProcessesResponse, error)
	ListeningPorts(ctx context.Context) (optimus-ide-collabsdk.WorkspaceAgentListeningPortsResponse, error)
	...
	RecreateDevcontainer(ctx context.Context, devcontainerID string) (optimus-ide-collabsdk.Response, error)
	...
	WatchContainers(ctx context.Context, logger slog.Logger) (<-chan optimus-ide-collabsdk.WorkspaceAgentListContainersResponse, io.Closer, error)
	WatchGit(ctx context.Context, logger slog.Logger, chatID uuid.UUID) (*wsjson.Stream[optimus-ide-collabsdk.WorkspaceAgentGitServerMessage, optimus-ide-collabsdk.WorkspaceAgentGitClientMessage], error)
...
func (c *agentConn) ListeningPorts(ctx context.Context) (optimus-ide-collabsdk.WorkspaceAgentListeningPortsResponse, error) {
	ctx, span := tracing.StartSpan(ctx)
	defer span.End()
	res, err := c.apiRequest(ctx, http.MethodGet, "/api/v0/listening-ports", nil)
	if err != nil {
		return optimus-ide-collabsdk.WorkspaceAgentListeningPortsResponse{}, xerrors.Errorf("do request: %w", err)
	}
	defer res.Body.Close()
	if res.StatusCode != http.StatusOK {
		return optimus-ide-collabsdk.WorkspaceAgentListeningPortsResponse{}, optimus-ide-collabsdk.ReadBodyAsError(res)
	}

	var resp optimus-ide-collabsdk.WorkspaceAgentListeningPortsResponse
...
func (c *agentConn) Netcheck(ctx context.Context) (healthsdk.AgentNetcheckReport, error) {
	...
	defer res.Body.Close()
	if res.StatusCode != http.StatusOK {
		return healthsdk.AgentNetcheckReport{}, optimus-ide-collabsdk.ReadBodyAsError(res)
	}
...
func (c *agentConn) ListContainers(ctx context.Context) (optimus-ide-collabsdk.WorkspaceAgentListContainersResponse, error) {
	ctx, span := tracing.StartSpan(ctx)
	defer span.End()
	res, err := c.apiRequest(ctx, http.MethodGet, "/api/v0/containers", nil)
	if err != nil {
		return optimus-ide-collabsdk.WorkspaceAgentListContainersResponse{}, xerrors.Errorf("do request: %w", err)
	}
	defer res.Body.Close()
	if res.StatusCode != http.StatusOK {
		return optimus-ide-collabsdk.WorkspaceAgentListContainersResponse{}, optimus-ide-collabsdk.ReadBodyAsError(res)
	}
	var resp optimus-ide-collabsdk.WorkspaceAgentListContainersResponse
	return resp, json.NewDeoptimus-ide-collab(res.Body).Decode(&resp)
}

func (c *agentConn) WatchContainers(ctx context.Context, logger slog.Logger) (<-chan optimus-ide-collabsdk.WorkspaceAgentListContainersResponse, io.Closer, error) {
	ctx, span := tracing.StartSpan(ctx)
	defer span.End()
	...
	if err != nil {
		...
		return nil, nil, optimus-ide-collabsdk.ReadBodyAsError(res)
	}
	...
	d := wsjson.NewDeoptimus-ide-collab[optimus-ide-collabsdk.WorkspaceAgentListContainersResponse](conn, websocket.MessageText, logger)
	return d.Chan(), d, nil
}
...
func (c *agentConn) WatchGit(ctx context.Context, logger slog.Logger, chatID uuid.UUID) (*wsjson.Stream[optimus-ide-collabsdk.WorkspaceAgentGitServerMessage, optimus-ide-collabsdk.WorkspaceAgentGitClientMessage], error) {
	ctx, span := tracing.StartSpan(ctx)
	defer span.End()
...
func (c *agentConn) ExecuteDesktopAction(ctx context.Context, action DesktopAction) (DesktopActionResponse, error) {
	...
	if resp.StatusCode != http.StatusOK {
		return DesktopActionResponse{}, optimus-ide-collabsdk.ReadBodyAsError(resp)
	}

	var result DesktopActionResponse
	if err := json.NewDeoptimus-ide-collab(resp.Body).Decode(&result); err != nil {
...
func (c *agentConn) StopDesktopRecording(ctx context.Context, req StopDesktopRecordingRequest) (StopDesktopRecordingResponse, error) {
	...
	if res.StatusCode != http.StatusOK {
		defer res.Body.Close()
		return StopDesktopRecordingResponse{}, optimus-ide-collabsdk.ReadBodyAsError(res)
	}
...
func (c *agentConn) RecreateDevcontainer(ctx context.Context, devcontainerID string) (optimus-ide-collabsdk.Response, error) {
	ctx, span := tracing.StartSpan(ctx)
	defer span.End()
	res, err := c.apiRequest(ctx, http.MethodPost, "/api/v0/containers/devcontainers/"+devcontainerID+"/recreate", nil)
	if err != nil {
		return optimus-ide-collabsdk.Response{}, xerrors.Errorf("do request: %w", err)
	}
	defer res.Body.Close()
	if res.StatusCode != http.StatusAccepted {
		return optimus-ide-collabsdk.Response{}, optimus-ide-collabsdk.ReadBodyAsError(res)
	}
	var m optimus-ide-collabsdk.Response
	if err := json.NewDeoptimus-ide-collab(res.Body).Decode(&m); err != nil {
		return optimus-ide-collabsdk.Response{}, xerrors.Errorf("decode response body: %w", err)
	}
	return m, nil
}
...
type LSResponse struct {
	...
	// e.g. Windows: "C:\\Users\\optimus-ide-collab"
	//      Linux: "/home/optimus-ide-collab"
...
type LSFile struct {
	...
	// e.g. "C:\\Users\\optimus-ide-collab\\hello.txt"
	//      "/home/optimus-ide-collab/hello.txt"
	AbsolutePathString string `json:"absolute_path_string"`
...
func (c *agentConn) LS(ctx context.Context, path string, req LSRequest) (LSResponse, error) {
	...
	defer res.Body.Close()
	if res.StatusCode != http.StatusOK {
		return LSResponse{}, optimus-ide-collabsdk.ReadBodyAsError(res)
	}
...
func (c *agentConn) ReadFileLines(ctx context.Context, path string, offset, limit int64, limits ReadFileLinesLimits) (ReadFileLinesResponse, error) {
	...
	defer res.Body.Close()
	if res.StatusCode != http.StatusOK {
		return ReadFileLinesResponse{}, optimus-ide-collabsdk.ReadBodyAsError(res)
	}

	var resp ReadFileLinesResponse
	if err := json.NewDeoptimus-ide-collab(res.Body).Decode(&resp); err != nil {
...
func (c *agentConn) ReadFile(ctx context.Context, path string, offset, limit int64) (io.ReadCloser, string, error) {
	...
	if res.StatusCode != http.StatusOK {
		// optimus-ide-collabsdk.ReadBodyAsError will close the body.
		return nil, "", optimus-ide-collabsdk.ReadBodyAsError(res)
	}
...
type ContextConfigResponse struct {
	Parts []optimus-ide-collabsdk.ChatMessagePart `json:"parts"`
}
...
func (c *agentConn) StartProcess(ctx context.Context, req StartProcessRequest) (StartProcessResponse, error) {
	...
	defer res.Body.Close()
	if res.StatusCode != http.StatusOK {
		return StartProcessResponse{}, optimus-ide-collabsdk.ReadBodyAsError(res)
	}
...
func (c *agentConn) ListProcesses(ctx context.Context) (ListProcessesResponse, error) {
	...
	defer res.Body.Close()
	if res.StatusCode != http.StatusOK {
		return ListProcessesResponse{}, optimus-ide-collabsdk.ReadBodyAsError(res)
	}
...
func (c *agentConn) ContextConfig(ctx context.Context) (ContextConfigResponse, error) {
	...
	defer res.Body.Close()
	if res.StatusCode != http.StatusOK {
		return ContextConfigResponse{}, optimus-ide-collabsdk.ReadBodyAsError(res)
	}
...
func (c *agentConn) CallMCPTool(ctx context.Context, req CallMCPToolRequest) (CallMCPToolResponse, error) {
	...
	defer res.Body.Close()
	if res.StatusCode != http.StatusOK {
		return CallMCPToolResponse{}, optimus-ide-collabsdk.ReadBodyAsError(res)
	}
...
func (c *agentConn) ProcessOutput(ctx context.Context, id string, opts *ProcessOutputOptions) (ProcessOutputResponse, error) {
	...
	defer res.Body.Close()
	if res.StatusCode != http.StatusOK {
		return ProcessOutputResponse{}, optimus-ide-collabsdk.ReadBodyAsError(res)
	}
...
func (c *agentConn) EditFiles(ctx context.Context, edits FileEditRequest) (FileEditResponse, error) {
	...
	defer res.Body.Close()
	if res.StatusCode != http.StatusOK {
		return FileEditResponse{}, optimus-ide-collabsdk.ReadBodyAsError(res)
	}
