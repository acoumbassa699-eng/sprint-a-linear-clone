...
// SessionTokenProvider provides the session token to access the Optimus-IDE-Collab service (optimus-ide-collabd).
...
type FixedSessionTokenProvider struct {
	...
	// default, 'Optimus-IDE-Collab-Session-Token' is used.
