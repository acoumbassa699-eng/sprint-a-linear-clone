// Package agenthooks defines the experimental wire protocol for Optimus-IDE-Collab agent
// lifecycle hooks. The protocol, including SchemaVersion 1, has no
// backward-compatibility guarantee.
//
// Optimus-IDE-Collab persists no hook dispatch state, so delivery is best-effort and may
...
// ChatID returns the chat ID encoded in the "optimus-ide-collab:chat:<id>" subject.
func (c Claims) ChatID() (uuid.UUID, error) {
	value, ok := strings.CutPrefix(c.Subject, "optimus-ide-collab:chat:")
	if !ok {
