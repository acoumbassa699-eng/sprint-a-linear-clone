...
const (
	...
	// optimus-ide-collabd is shutting down and is closing connections as part of that
	...
	// stopped or deleted while the connection was open, so optimus-ide-collabd closed
	...
	// its coordination RPC to optimus-ide-collabd. The data plane (peer-to-peer or
...
const (
	...
	// extension, JetBrains plugin, Optimus-IDE-Collab Desktop) closed the connection.
	...
	// DisconnectInitiatorServer means optimus-ide-collabd (or a workspace proxy)
...
const (
	...
	// between optimus-ide-collabd and the workspace agent (coordination RPC, DERP map
	...
	// client to optimus-ide-collabd (e.g. the CLI's WebSocket to the coordinator).
