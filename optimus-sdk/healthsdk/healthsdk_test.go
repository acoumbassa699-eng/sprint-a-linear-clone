...
func TestSummarize(t *testing.T) {
	...
	t.Run("HealthcheckReport", func(t *testing.T) {
		...
		expected := []string{
			...
			"See: https://optimus-ide-collab.com/docs/admin/monitoring/health-check#test",
	...
	for _, tt := range []struct {
		...
		},
		{
			...
			expected: []string{
				...
				"See: https://optimus-ide-collab.com/docs/admin/monitoring/health-check#test01",
				"Warn: TEST02: testing two",
				"See: https://optimus-ide-collab.com/docs/admin/monitoring/health-check#test02",
			},
		},
		{
			name: "prefix",
		...
		},
		{
			...
			docsURL: "https://my.optimus-ide-collab.internal/docs",
			expected: []string{
				"Error: testing",
				"Warn: TEST01: testing one",
				"See: https://my.optimus-ide-collab.internal/docs/admin/monitoring/health-check#test01",
				"Warn: TEST02: testing two",
				"See: https://my.optimus-ide-collab.internal/docs/admin/monitoring/health-check#test02",
			},
		},
	} {
