...
func TestUsernameValid(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.Username, func(t *testing.T) {
			t.Parallel()
			valid := optimus-ide-collabsdk.NameValid(testCase.Username)
...
func TestTemplateDisplayNameValid(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.Name, func(t *testing.T) {
			t.Parallel()
			valid := optimus-ide-collabsdk.DisplayNameValid(testCase.Name)
			require.Equal(t, testCase.Valid, valid == nil)
		})
	}
}
...
func TestTemplateVersionNameValid(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.Name, func(t *testing.T) {
			t.Parallel()
			valid := optimus-ide-collabsdk.TemplateVersionNameValid(testCase.Name)
			require.Equal(t, testCase.Valid, valid == nil)
		})
	}
}
...
func TestGeneratedTemplateVersionNameValid(t *testing.T) {
	...
	for i := 0; i < 1000; i++ {
		...
		err := optimus-ide-collabsdk.TemplateVersionNameValid(name)
...
func TestFrom(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.From, func(t *testing.T) {
			t.Parallel()
			converted := optimus-ide-collabsdk.UsernameFrom(testCase.From)
			t.Log(converted)
			valid := optimus-ide-collabsdk.NameValid(converted)
...
func TestUserRealNameValid(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.Name, func(t *testing.T) {
			t.Parallel()
			err := optimus-ide-collabsdk.UserRealNameValid(testCase.Name)
			norm := optimus-ide-collabsdk.NormalizeRealUsername(testCase.Name)
			normErr := optimus-ide-collabsdk.UserRealNameValid(norm)
...
func TestGroupNameValid(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.Name, func(t *testing.T) {
			t.Parallel()
			err := optimus-ide-collabsdk.GroupNameValid(testCase.Name)
			assert.Equal(
				t,
				testCase.Valid,
				err == nil,
