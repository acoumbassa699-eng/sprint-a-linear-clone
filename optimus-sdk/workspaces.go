...
func (c *Client) getWorkspace(ctx context.Context, id uuid.UUID, opts ...RequestOption) (Workspace, error) {
	...
	return workspace, json.NewDeoptimus-ide-collab(res.Body).Decode(&workspace)
}
...
func (c *Client) WorkspaceBuilds(ctx context.Context, req WorkspaceBuildsRequest) ([]WorkspaceBuild, error) {
	...
	return workspaceBuild, json.NewDeoptimus-ide-collab(res.Body).Decode(&workspaceBuild)
}
...
func (c *Client) Workspaces(ctx context.Context, filter WorkspaceFilter) (WorkspacesResponse, error) {
	...
	return wres, json.NewDeoptimus-ide-collab(res.Body).Decode(&wres)
}
...
func (c *Client) ResolveAutostart(ctx context.Context, workspaceID string) (ResolveAutostartResponse, error) {
	...
	return response, json.NewDeoptimus-ide-collab(res.Body).Decode(&response)
}
...
func (c *Client) WorkspaceTimings(ctx context.Context, id uuid.UUID) (WorkspaceBuildTimings, error) {
	...
	return timings, json.NewDeoptimus-ide-collab(res.Body).Decode(&timings)
}
...
func (c *Client) WorkspaceExternalAgentCredentials(ctx context.Context, workspaceID uuid.UUID, agentName string) (ExternalAgentCredentials, error) {
	...
	return credentials, json.NewDeoptimus-ide-collab(res.Body).Decode(&credentials)
}
...
// The returned deoptimus-ide-collab should be closed by calling Close() when done to properly
// clean up the WebSocket connection.
func (c *Client) WatchAllWorkspaceBuilds(ctx context.Context) (*wsjson.Deoptimus-ide-collab[WorkspaceBuildUpdate], error) {
	ctx, span := tracing.StartSpan(ctx)
	defer span.End()
	...
	d := wsjson.NewDeoptimus-ide-collab[WorkspaceBuildUpdate](conn, websocket.MessageText, c.logger)
	return d, nil
}
...
func (c *Client) WorkspaceAvailableUsers(ctx context.Context, organizationID uuid.UUID, userID string) ([]MinimalUser, error) {
	...
	return users, json.NewDeoptimus-ide-collab(res.Body).Decode(&users)
}
