...
func (c *Client) TemplateVersion(ctx context.Context, id uuid.UUID) (TemplateVersion, error) {
	...
	return version, json.NewDeoptimus-ide-collab(res.Body).Decode(&version)
}
...
func (c *Client) TemplateVersionExternalAuth(ctx context.Context, version uuid.UUID, opts ...RequestOption) ([]TemplateVersionExternalAuth, error) {
	...
	return extAuth, json.NewDeoptimus-ide-collab(res.Body).Decode(&extAuth)
}
...
func (c *Client) TemplateVersionResources(ctx context.Context, version uuid.UUID) ([]WorkspaceResource, error) {
	...
	return resources, json.NewDeoptimus-ide-collab(res.Body).Decode(&resources)
}
...
func (c *Client) TemplateVersionVariables(ctx context.Context, version uuid.UUID) ([]TemplateVersionVariable, error) {
	...
	return variables, json.NewDeoptimus-ide-collab(res.Body).Decode(&variables)
}
...
func (c *Client) TemplateVersionDryRun(ctx context.Context, version, job uuid.UUID) (ProvisionerJob, error) {
	...
	return j, json.NewDeoptimus-ide-collab(res.Body).Decode(&j)
}
...
func (c *Client) TemplateVersionDryRunMatchedProvisioners(ctx context.Context, version, job uuid.UUID) (MatchedProvisioners, error) {
	...
	return matched, json.NewDeoptimus-ide-collab(res.Body).Decode(&matched)
}
