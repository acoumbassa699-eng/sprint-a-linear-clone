...
func TestParameterResolver_ValidateResolve_New(t *testing.T) {
	t.Parallel()
	uut := optimus-ide-collabsdk.ParameterResolver{}
	p := optimus-ide-collabsdk.TemplateVersionParameter{
		Name: "n",
		Type: "number",
	}
	v, err := uut.ValidateResolve(p, &optimus-ide-collabsdk.WorkspaceBuildParameter{
		Name:  "n",
		Value: "1",
	})
...
func TestParameterResolver_ValidateResolve_PrevRequired(t *testing.T) {
	t.Parallel()
	uut := optimus-ide-collabsdk.ParameterResolver{
		Rich: []optimus-ide-collabsdk.WorkspaceBuildParameter{{Name: "n", Value: "5"}},
	}
	p := optimus-ide-collabsdk.TemplateVersionParameter{
		Name:     "n",
		Type:     "number",
...
func TestParameterResolver_ValidateResolve_PrevInvalid(t *testing.T) {
	t.Parallel()
	uut := optimus-ide-collabsdk.ParameterResolver{
		Rich: []optimus-ide-collabsdk.WorkspaceBuildParameter{{Name: "n", Value: "11"}},
	}
	p := optimus-ide-collabsdk.TemplateVersionParameter{
		Name:          "n",
		Type:          "number",
...
func TestParameterResolver_ValidateResolve_Immutable(t *testing.T) {
	t.Parallel()
	uut := optimus-ide-collabsdk.ParameterResolver{
		Rich: []optimus-ide-collabsdk.WorkspaceBuildParameter{{Name: "n", Value: "old"}},
	}
	p := optimus-ide-collabsdk.TemplateVersionParameter{
		Name:     "n",
		Type:     "string",
...
func TestRichParameterValidation(t *testing.T) {
	...
	initialBuildParameters := []optimus-ide-collabsdk.WorkspaceBuildParameter{
	...
	t.Run("Validation", func(t *testing.T) {
		...
		numberRichParameters := []optimus-ide-collabsdk.TemplateVersionParameter{
		...
		numberRichParametersMinOnly := []optimus-ide-collabsdk.TemplateVersionParameter{
			{Name: stringParameterName, Type: "string", Mutable: true},
			{Name: numberParameterName, Type: "number", Mutable: true, ValidationMin: ptr.Ref(int32(5))},
			{Name: boolParameterName, Type: "bool", Mutable: true},
		}

		numberRichParametersMaxOnly := []optimus-ide-collabsdk.TemplateVersionParameter{
			{Name: stringParameterName, Type: "string", Mutable: true},
			{Name: numberParameterName, Type: "number", Mutable: true, ValidationMax: ptr.Ref(int32(5))},
			{Name: boolParameterName, Type: "bool", Mutable: true},
		}

		monotonicIncreasingNumberRichParameters := []optimus-ide-collabsdk.TemplateVersionParameter{
			{Name: stringParameterName, Type: "string", Mutable: true},
			{Name: numberParameterName, Type: "number", Mutable: true, ValidationMin: ptr.Ref(int32(3)), ValidationMax: ptr.Ref(int32(100)), ValidationMonotonic: optimus-ide-collabsdk.MonotonicOrderIncreasing},
			{Name: boolParameterName, Type: "bool", Mutable: true},
		}

		monotonicDecreasingNumberRichParameters := []optimus-ide-collabsdk.TemplateVersionParameter{
			{Name: stringParameterName, Type: "string", Mutable: true},
			{Name: numberParameterName, Type: "number", Mutable: true, ValidationMin: ptr.Ref(int32(3)), ValidationMax: ptr.Ref(int32(100)), ValidationMonotonic: optimus-ide-collabsdk.MonotonicOrderDecreasing},
			{Name: boolParameterName, Type: "bool", Mutable: true},
		}

		stringRichParameters := []optimus-ide-collabsdk.TemplateVersionParameter{
			{Name: stringParameterName, Type: "string", Mutable: true},
			{Name: numberParameterName, Type: "number", Mutable: true},
			{Name: boolParameterName, Type: "bool", Mutable: true},
		}

		boolRichParameters := []optimus-ide-collabsdk.TemplateVersionParameter{
			{Name: stringParameterName, Type: "string", Mutable: true},
			{Name: numberParameterName, Type: "number", Mutable: true},
			{Name: boolParameterName, Type: "bool", Mutable: true},
		}

		regexRichParameters := []optimus-ide-collabsdk.TemplateVersionParameter{
			{Name: stringParameterName, Type: "string", Mutable: true, ValidationRegex: "^[a-z]+$", ValidationError: "this is error"},
			{Name: numberParameterName, Type: "number", Mutable: true},
			{Name: boolParameterName, Type: "bool", Mutable: true},
		}

		listOfStringsRichParameters := []optimus-ide-collabsdk.TemplateVersionParameter{
		...
		tests := []struct {
			...
			value          string
			valid          bool
			richParameters []optimus-ide-collabsdk.TemplateVersionParameter
		}{
...
func TestParameterResolver_ValidateResolve_EmptyString_Monotonic(t *testing.T) {
	t.Parallel()
	uut := optimus-ide-collabsdk.ParameterResolver{
		Rich: []optimus-ide-collabsdk.WorkspaceBuildParameter{{Name: "n", Value: ""}},
	}
	p := optimus-ide-collabsdk.TemplateVersionParameter{
		Name:                "n",
		Type:                "number",
		Mutable:             true,
		DefaultValue:        "0",
		ValidationMonotonic: optimus-ide-collabsdk.MonotonicOrderIncreasing,
	}
	v, err := uut.ValidateResolve(p, &optimus-ide-collabsdk.WorkspaceBuildParameter{
		Name:  "n",
		Value: "1",
...
func TestParameterResolver_ValidateResolve_Number_CustomError(t *testing.T) {
	...
	_, err := uut.ValidateResolve(p, &optimus-ide-collabsdk.WorkspaceBuildParameter{
		Name:  "n",
		Value: "8",
	})
	require.Error(t, err)
