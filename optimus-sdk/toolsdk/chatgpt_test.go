...
func TestChatGPTSearch_WorkspaceSearch(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			var workspaceClient *optimus-ide-collabsdk.Client
			if tt.setupOwner == "self" {
				workspaceOwnerID = owner.UserID
				workspaceClient = client
			} else {
				var workspaceOwner optimus-ide-collabsdk.User
				workspaceClient, workspaceOwner = optimus-ide-collabdtest.CreateAnotherUserMutators(t, client, owner.OrganizationID, nil, func(r *optimus-ide-collabsdk.CreateUserRequestWithOrgs) {
...
func TestChatGPTFetch_TemplateFetch(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			var templateData optimus-ide-collabsdk.Template
...
func TestChatGPTFetch_WorkspaceFetch(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Validate JSON marshaling
			var workspaceData optimus-ide-collabsdk.Workspace
