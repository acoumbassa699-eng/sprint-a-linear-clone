...
func (t NullTime) MarshalJSON() ([]byte, error) {
	...
	if err != nil {
		return nil, xerrors.Errorf("optimus-ide-collabsdk.NullTime: json encode failed: %w", err)
	}
	return b, nil
}
...
func (t *NullTime) UnmarshalJSON(data []byte) error {
	...
	if err != nil {
		return xerrors.Errorf("optimus-ide-collabsdk.NullTime: json decode failed: %w", err)
	}
	t.Valid = true
	return nil
}
