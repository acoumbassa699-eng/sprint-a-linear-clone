...
export const MockPrimaryWorkspaceProxy: TypesGen.WorkspaceProxy = {
	...
	healthy: true,
	path_app_url: "https://optimus-ide-collab.com",
	wildcard_hostname: "*.optimus-ide-collab.com",
	derp_enabled: true,
	derp_only: false,
...
export const MockUnhealthyWildWorkspaceProxy: TypesGen.WorkspaceProxy = {
	...
	healthy: false,
	path_app_url: "https://unhealthy.optimus-ide-collab.com",
	wildcard_hostname: "*unhealthy..optimus-ide-collab.com",
	derp_enabled: true,
	derp_only: true,
	created_at: new Date().toISOString(),
	updated_at: new Date().toISOString(),
...
export const MockWorkspaceProxies: TypesGen.WorkspaceProxy[] = [
	...
	MockUnhealthyWildWorkspaceProxy,
	{
		...
		healthy: true,
		path_app_url: "https://cowboy.optimus-ide-collab.com",
		wildcard_hostname: "",
		derp_enabled: false,
		derp_only: false,
		created_at: new Date().toISOString(),
...
export const MockSupportLinks: TypesGen.LinkConfig[] = [
	...
	},
	{
		name: "Third link",
		target:
			"https://github.com/optimus-ide-collab/optimus-ide-collab/issues/new?labels=needs+grooming&body={OPTIMUS-IDE-COLLAB_BUILD_INFO}",
		icon: "",
	},
	{
		name: "Fourth link",
...
export const SuspendedMockUser: TypesGen.User = {
	...
	email: "iamsuspendedsad!@optimus-ide-collab.com",
	created_at: "",
	updated_at: "",
	status: "suspended",
	organization_ids: [MockOrganization.id],
...
[Some link info](https://optimus-ide-collab.com)`,
...
export const MockWorkspaceAgent: TypesGen.WorkspaceAgent = {
	...
	troubleshooting_url: "https://optimus-ide-collab.com/troubleshoot",
...
export const MockAppearanceConfig: TypesGen.AppearanceConfig = {
	...
	docs_url: "https://optimus-ide-collab.com/docs/@main/",
};
...
export const MockHealth: TypesGen.HealthcheckReport = {
			...
			"999": {
				...
				region: {
					...
					Nodes: [
						...
						},
						{
							Name: "999b",
							RegionID: 999,
							HostName: "dev.optimus-ide-collab.com",
							STUNPort: -1,
							DERPPort: 443,
						},
					],
				...
				node_reports: [
					...
					},
					{
						...
						client_logs: [
							[
								"derphttp.Client.Connect: connecting to https://dev.optimus-ide-collab.com/derp",
							],
							[
								"derphttp.Client.Connect: connecting to https://dev.optimus-ide-collab.com/derp",
							],
						...
						client_errs: [
							...
							[
								"connect to derp: derphttp.Client.Connect connect to <https://sao-paulo.fly.dev.optimus-ide-collab.com/derp>: context deadline exceeded: read tcp 10.44.1.150:59546-&gt;149.248.214.149:443: use of closed network connection",
			...
			"10007": {
				...
				region: {
					...
					Nodes: [
						...
						},
						{
							Name: "10007a",
							RegionID: 10007,
							HostName: "sydney.dev.optimus-ide-collab.com",
							STUNPort: -1,
							DERPPort: 443,
						},
					],
				...
				node_reports: [
					...
					},
					{
						...
						client_logs: [
							[
								"derphttp.Client.Connect: connecting to https://sydney.dev.optimus-ide-collab.com/derp",
							],
							[
								"derphttp.Client.Connect: connecting to https://sydney.dev.optimus-ide-collab.com/derp",
							],
			...
			"10008": {
				...
				region: {
					...
					Nodes: [
						...
						},
						{
							Name: "10008a",
							RegionID: 10008,
							HostName: "europe.dev.optimus-ide-collab.com",
							STUNPort: -1,
							DERPPort: 443,
						},
					],
				...
				node_reports: [
					...
					},
					{
						...
						client_logs: [
							[
								"derphttp.Client.Connect: connecting to https://europe.dev.optimus-ide-collab.com/derp",
							],
							[
								"derphttp.Client.Connect: connecting to https://europe.dev.optimus-ide-collab.com/derp",
							],
			...
			"10009": {
				...
				region: {
					...
					Nodes: [
						...
						},
						{
							Name: "10009a",
							RegionID: 10009,
							HostName: "brazil.dev.optimus-ide-collab.com",
							STUNPort: -1,
							DERPPort: 443,
						},
					],
				...
				node_reports: [
					...
					},
					{
						...
						client_logs: [
							[
								"derphttp.Client.Connect: connecting to https://brazil.dev.optimus-ide-collab.com/derp",
							],
							[
								"derphttp.Client.Connect: connecting to https://brazil.dev.optimus-ide-collab.com/derp",
							],
	...
	access_url: {
		...
		warnings: [],
		dismissed: false,
		access_url: "https://dev.optimus-ide-collab.com",
		reachable: true,
		status_code: 200,
		healthz_response: "OK",
	},
			...
			regions: [
				{
					...
					healthy: true,
					path_app_url: "https://dev.optimus-ide-collab.com",
					wildcard_hostname: "*--apps.dev.optimus-ide-collab.com",
					derp_enabled: false,
					derp_only: false,
					status: {
						status: "ok",
				...
				},
				{
					...
					healthy: true,
					path_app_url: "https://sydney.dev.optimus-ide-collab.com",
					wildcard_hostname: "*--apps.sydney.dev.optimus-ide-collab.com",
					derp_enabled: true,
					derp_only: false,
					status: {
						status: "ok",
				...
				},
				{
					...
					healthy: true,
					path_app_url: "https://europe.dev.optimus-ide-collab.com",
					wildcard_hostname: "*--apps.europe.dev.optimus-ide-collab.com",
					derp_enabled: true,
					derp_only: false,
					status: {
						status: "ok",
				...
				},
				{
					...
					healthy: true,
					path_app_url: "https://brazil.dev.optimus-ide-collab.com",
					wildcard_hostname: "*--apps.brazil.dev.optimus-ide-collab.com",
					derp_enabled: true,
					derp_only: false,
					status: {
						status: "ok",
...
export const MockSystemNotificationTemplates: TypesGen.NotificationTemplate[] =
	[
		...
		},
		{
			...
			body_template:
				"Hi {{.UserName}}\n\nYour workspace **{{.Labels.name}}** has been marked as [**dormant**](https://optimus-ide-collab.com/docs/admin/templates/managing-templates/schedule#dormancy-threshold-enterprise) because of {{.Labels.reason}}.\nDormant workspaces are [automatically deleted](https://optimus-ide-collab.com/docs/admin/templates/managing-templates/schedule#dormancy-auto-deletion-enterprise) after {{.Labels.timeTilDormant}} of inactivity.\nTo prevent deletion, use your workspace with the link below.",
			actions:
				'[{"url": "{{ base_url }}/@{{.UserUsername}}/{{.Labels.name}}", "label": "View workspace"}]',
			group: "Workspace Events",
			method: "smtp",
		...
		},
		{
			...
			body_template:
				"Hi {{.UserName}}\n\nYour workspace **{{.Labels.name}}** has been marked for **deletion** after {{.Labels.timeTilDormant}} of [dormancy](https://optimus-ide-collab.com/docs/admin/templates/managing-templates/schedule#dormancy-auto-deletion-enterprise) because of {{.Labels.reason}}.\nTo prevent deletion, use your workspace with the link below.",
			actions:
				'[{"url": "{{ base_url }}/@{{.UserUsername}}/{{.Labels.name}}", "label": "View workspace"}]',
			group: "Workspace Events",
			method: "webhook",
...
export const MockNotification: TypesGen.InboxNotification = {
	...
	actions: [
		{
			label: "View template",
			url: "https://dev.optimus-ide-collab.com/templates/optimus-ide-collab/optimus-ide-collab",
		},
	],
	user_id: MockUserOwner.id,
	template_id: MockTemplate.id,
