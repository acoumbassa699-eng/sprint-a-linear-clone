...
export const Default: Story = {
	args: {
		...
		detailsUrl: "https://registry.optimus-ide-collab.com/templates/docker",
		fields: [
			{
				type: "select",
				id: "docker-image",
...
export const NoConfiguration: Story = {
	args: {
		...
		detailsUrl: "https://registry.optimus-ide-collab.com/templates/kubernetes",
	},
};
...
export const WithoutIcon: Story = {
	args: {
		...
		detailsUrl: "https://registry.optimus-ide-collab.com",
	},
};
