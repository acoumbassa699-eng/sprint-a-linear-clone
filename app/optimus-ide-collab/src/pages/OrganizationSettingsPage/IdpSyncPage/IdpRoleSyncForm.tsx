...
export const IdpRoleSyncForm: FC<IdpRoleSyncFormProps> = ({
	...
	const [optimus-ide-collabRoles, setOptimus-IDE-CollabRoles] = useState<Option[]>([]);
	const id = useId();
				...
				<div className="flex flex-row gap-2 justify-between items-start">
					...
					<div className="grid items-center gap-1 flex-1">
						...
						<MultiSelectCombobox
							...
							value={optimus-ide-collabRoles}
							onChange={setOptimus-IDE-CollabRoles}
					...
					<div className="grid grid-rows-[28px_auto]">
						...
						<Button
							type="submit"
							className="min-w-fit"
							disabled={!idpRoleName || optimus-ide-collabRoles.length === 0}
							onClick={() => {
								const newSyncSettings = {
									...form.values,
									mapping: {
										...form.values.mapping,
										[idpRoleName]: optimus-ide-collabRoles.map((role) => role.value),
									},
								};
								void form.setFieldValue("mapping", newSyncSettings.mapping);
								form.handleSubmit();
								setIdpRoleName("");
								setOptimus-IDE-CollabRoles([]);
							}}
						>
							<Spinner loading={form.isSubmitting}>
								<PlusIcon />
...
interface RoleRowProps {
	...
	optimus-ide-collabRoles: readonly string[];
...
const RoleRow: FC<RoleRowProps> = ({
	...
	return (
		<TableRow data-testid={`role-${idpRole}`}>
			...
			<TableCell>
				<IdpPillList roles={optimus-ide-collabRoles} />
			</TableCell>
