...
export interface Optimus-IDE-CollabAgentsPageViewProps {
...
export const Optimus-IDE-CollabAgentsPageView: FC<Optimus-IDE-CollabAgentsPageViewProps> = ({
	adminOverridesData,
	adminOverridesError,
	...
	return (
		<div className="flex max-w-4xl flex-col gap-8">
			<SettingsHeader>
				<SettingsHeaderTitle>Optimus-IDE-Collab Agents</SettingsHeaderTitle>
				<SettingsHeaderDescription>
					Configure deployment-wide defaults for Optimus-IDE-Collab Agents and agent-specific
					capabilities.
				</SettingsHeaderDescription>
			</SettingsHeader>
			<div className="flex flex-col gap-6 rounded-lg border border-solid border-border px-6 py-7">
				...
				<SubagentModelOverrideSettings
					...
					description="Leave unset to use Optimus-IDE-Collab's title default, which prefers fast models from configured providers."
