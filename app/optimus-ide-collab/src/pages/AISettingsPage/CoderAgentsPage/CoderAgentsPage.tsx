...
import { Optimus-IDE-CollabAgentsPageView } from "./Optimus-IDE-CollabAgentsPageView";
...
const Optimus-IDE-CollabAgentsPage: FC = () => {
	...
	return (
		<RequirePermission isFeatureVisible={canEditDeploymentConfig}>
			<title>{pageTitle("Optimus-IDE-Collab Agents", "AI Settings")}</title>
...
export default Optimus-IDE-CollabAgentsPage;
