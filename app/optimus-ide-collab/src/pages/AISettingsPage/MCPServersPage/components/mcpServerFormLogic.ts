...
export interface MCPServerFormValues {
	...
	forwardOptimus-IDE-CollabHeaders: boolean;
...
export const buildInitialMCPServerFormValues = (
	...
	forwardOptimus-IDE-CollabHeaders: server?.forward_optimus-ide-collab_headers ?? false,
...
export const buildCreateMCPServerConfigRequest = (
	...
	const request: TypesGen.CreateMCPServerConfigRequest = {
		...
		forward_optimus-ide-collab_headers: values.forwardOptimus-IDE-CollabHeaders,
