...
import { AgentSettingLayout } from "#/pages/AISettingsPage/Optimus-IDE-CollabAgentsPage/components/AgentSettingLayout";
		...
		<AgentSettingLayout
			...
			description={
				<>
					...
					Requires the{" "}
					<Link
						href="https://registry.optimus-ide-collab.com/modules/optimus-ide-collab/portabledesktop"
						target="_blank"
						size="sm"
					>
