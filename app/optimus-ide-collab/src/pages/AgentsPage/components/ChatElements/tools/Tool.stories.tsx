...
export const ExecuteAuthRequired: Story = {
	args: {
		result: {
			...
			authenticate_url: "https://optimus-ide-collab.example.com/external-auth/github",
			output:
	...
	play: async ({ canvasElement }) => {
		...
		).toHaveAttribute("href", "https://optimus-ide-collab.example.com/external-auth/github");

		const openSpy = spyOn(window, "open").mockImplementation(() => null);
		await userEvent.click(button);
		expect(openSpy).toHaveBeenCalledWith(
			"https://optimus-ide-collab.example.com/external-auth/github",
			"_blank",
