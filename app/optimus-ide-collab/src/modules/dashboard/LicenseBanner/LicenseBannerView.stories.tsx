		...
		messages: [
			{
				...
				link: {
					href: "mailto:sales@optimus-ide-collab.com",
					label: "Contact sales@optimus-ide-collab.com.",
...
export const TelemetryRequiredError: Story = {
		...
		messages: [
			{
				...
				link: {
					href: "mailto:sales@optimus-ide-collab.com",
					label: "Contact sales@optimus-ide-collab.com if you need an exception.",
					showExternalIcon: false,
				},
			},
		],
	...
	play: async ({ canvasElement }) => {
		...
		).toHaveAttribute("href", "mailto:sales@optimus-ide-collab.com");
	},
};
