...
export const GlobalErrorBoundaryInner: FC<GlobalErrorBoundaryInnerProps> = ({
	...
	const optimus-ide-collabVersion = metadata["build-info"].value?.version;
...
function publicGithubIssueLink(
	optimus-ide-collabVersion: string | undefined,
	pathName: string,
	error: unknown,
): string {
	...
	const messageBody = `\
**Version**
${optimus-ide-collabVersion ?? "-- Set version --"}
