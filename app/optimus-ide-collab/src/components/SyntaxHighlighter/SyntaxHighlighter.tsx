...
import { useOptimus-IDE-CollabTheme } from "./optimus-ide-collabTheme";
...
export const SyntaxHighlighter: FC<SyntaxHighlighterProps> = ({
	...
	const optimus-ide-collabTheme = useOptimus-IDE-CollabTheme();
	...
	const commonProps = {
		language,
		theme: optimus-ide-collabTheme.name,
		height: 560,
		options: {
			minimap: {
				enabled: false,
	...
	if (optimus-ide-collabTheme.isLoading) {
		return null;
	}
