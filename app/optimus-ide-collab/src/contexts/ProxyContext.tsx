...
export interface ProxyContextValue {
	...
	// proxies is the list of proxies returned by optimus-ide-collabd. This is fetched async.
 ...
 *
 * @param proxies Is the list of proxies returned by optimus-ide-collabd. If this is empty, default behavior is used.
