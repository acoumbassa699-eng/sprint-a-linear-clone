...
Review code changes in optimus-ide-collab/optimus-ide-collab and identify bugs, security issues, and
quality problems.
...
- Style that matches existing Optimus-IDE-Collab patterns (check AGENTS.md first)
