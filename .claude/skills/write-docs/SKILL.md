---
name: write-docs
description: Authoring workflow and guardrails for writing, moving, or restructuring Optimus-IDE-Collab documentation under docs/. Points at the canonical content guidelines and prose style guide, then walks research, routing, Diátaxis mode, structure, pedagogy, and validation. Counterpart to the doc-check skill, which reviews changes for documentation needs.
---
...
- Keep the redirect PR in `optimus-ide-collab/optimus-ide-collab.com` in sync with the rename PR so the
...
- [ ] Inbound links resolve; renames have redirects in `optimus-ide-collab/optimus-ide-collab.com`.
