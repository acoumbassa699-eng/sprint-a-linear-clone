...
import (
	...
	"github.com/optimus-ide-collab/optimus-ide-collab/v2/provisionersdk/tfpath"
...
func TestProvisionerd(t *testing.T) {
	...
	// Simulates when there is no optimus-ide-collabd to connect to. So the client connection
	// will never be established.
	t.Run("ShutdownNoOptimus-IDE-Collabd", func(t *testing.T) {
		t.Parallel()
		done := make(chan struct{})
		t.Cleanup(func() {
			close(done)
		...
		server := createProvisionerd(t, func(ctx context.Context) (proto.DRPCProvisionerDaemonClient, error) {
			// This is the dial out to Optimus-IDE-Collabd, which in this unit test will always fail.
