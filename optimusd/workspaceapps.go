...
// @Produce json
// @Tags Applications
// @Success 200 {object} optimus-ide-collabsdk.AppHostResponse
// @Router /api/v2/applications/host [get]
// @Deprecated use api/v2/regions and see the primary proxy.
func (api *API) appHost(rw http.ResponseWriter, r *http.Request) {
	httpapi.Write(r.Context(), rw, http.StatusOK, optimus-ide-collabsdk.AppHostResponse{
...
func (api *API) workspaceApplicationAuth(rw http.ResponseWriter, r *http.Request) {
	...
	cookie, _, err := api.createAPIKey(ctx, apikey.CreateParams{
		...
		Scope:           database.ApiKeyScopeOptimus-IDE-CollabApplicationConnect,
	})
	if err != nil {
		httpapi.Write(ctx, rw, http.StatusInternalServerError, optimus-ide-collabsdk.Response{
