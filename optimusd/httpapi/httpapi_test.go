...
func TestWrite(t *testing.T) {
	...
	t.Run("NoErrors", func(t *testing.T) {
		...
		err := json.NewDeoptimus-ide-collab(rw.Body).Decode(&m)
		require.NoError(t, err)
		_, ok := m["errors"]
		require.False(t, ok)
	})
...
func TestRead(t *testing.T) {
	...
	t.Run("ValidateFailure", func(t *testing.T) {
		...
		var v optimus-ide-collabsdk.Response
		err := json.NewDeoptimus-ide-collab(rw.Body).Decode(&v)
		require.NoError(t, err)
...
func TestOneWayWebSocketEventSender(t *testing.T) {
	...
	t.Run("Returned callback can publish new event to WebSocket connection", func(t *testing.T) {
		...
		serverPayload := optimus-ide-collabsdk.ServerSentEvent{
	...
	t.Run("Renders the socket inert if the request context cancels", func(t *testing.T) {
		...
		cancel()
		require.True(t, <-successC)
		err = send(optimus-ide-collabsdk.ServerSentEvent{
			Type: optimus-ide-collabsdk.ServerSentEventTypeData,
