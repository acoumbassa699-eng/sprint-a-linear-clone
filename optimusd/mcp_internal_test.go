...
// used in production (optimus-ide-collabd.go:370). Without it the test would not
...
// fakeAccessControlStore mirrors optimus-ide-collabdtest.FakeAccessControlStore but is
// inlined here to avoid an import cycle (optimus-ide-collabdtest imports optimus-ide-collabd).
