...
func TestWorkspaceUpdates(t *testing.T) {
	...
	t.Run("Basic", func(t *testing.T) {
		...
		updateProvider := optimus-ide-collabd.NewUpdatesProvider(testutil.Logger(t), ps, db, &mockAuthorizer{})
		t.Cleanup(func() {
...
// GetAuthorizedWorkspacesAndAgentsByOwnerID implements optimus-ide-collabd.UpdatesQuerier.
...
// GetWorkspaceByAgentID implements optimus-ide-collabd.UpdatesQuerier.
...
var _ optimus-ide-collabd.UpdatesQuerier = (*mockWorkspaceStore)(nil)
