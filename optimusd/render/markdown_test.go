...
func TestHTML(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:     "Simple",
			input:    `**Optimus-IDE-Collab** is in *early access* mode. To ~~register~~ request access, fill out [this form](https://internal.example.com). ***Thank you!***`,
			expected: `<p><strong>Optimus-IDE-Collab</strong> is in <em>early access</em> mode. To <del>register</del> request access, fill out <a href="https://internal.example.com">this form</a>. <strong><em>Thank you!</em></strong></p>`,
		},
		{
			name:     "Tricky",
...
func TestInnerTextFromMarkdown(t *testing.T) {
	...
	tests := []struct {
		...
		{"LinkTextKeptUrlDropped", "Use [Optimus-IDE-Collab](https://optimus-ide-collab.com/docs) now.", "Use Optimus-IDE-Collab now."},
		{"ImageDropped", "# T\n\n![alt](a.svg)\n\nBody.", "T\nBody."},
