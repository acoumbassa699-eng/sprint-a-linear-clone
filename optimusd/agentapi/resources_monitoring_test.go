...
func TestVolumeResourceMonitorDebounce(t *testing.T) {
	...
	firstVolumePath := "/home/optimus-ide-collab"
	secondVolumePath := "/dev/optimus-ide-collab"
...
func TestVolumeResourceMonitor(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:             "WhenOK/NeverExceedsThreshold",
			volumePath:       "/home/optimus-ide-collab",
...
func TestVolumeResourceMonitorMultiple(t *testing.T) {
		...
		Datapoints: []*agentproto.PushResourcesMonitoringUsageRequest_Datapoint{
			{
				...
				Volumes: []*agentproto.PushResourcesMonitoringUsageRequest_Datapoint_VolumeUsage{
					{
						Volume: "/home/optimus-ide-collab",
						Used:   10,
						Total:  10,
					},
					{
						Volume: "/dev/optimus-ide-collab",
						Used:   10,
						Total:  10,
					},
				},
	...
	require.Equal(t, "/home/optimus-ide-collab", volumes[0]["path"])
	require.Equal(t, "/dev/optimus-ide-collab", volumes[1]["path"])
}
