...
// 500 resources; see agent/agentcontext/resolve.go), but optimus-ide-collabd
...
//
// The handler is a pure write path: nothing else in optimus-ide-collabd reads
...
// injected at optimus-ide-collabd construction so this package neither imports the chat
...
// optimus-ide-collabd or bloat the database.
...
// be evolved by adding fields to the proto without optimus-ide-collabd changes,
...
// guarantees the oneof variant is set so optimus-ide-collabd can still attribute
