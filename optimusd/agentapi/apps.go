...
func (a *AppsAPI) UpdateAppStatus(ctx context.Context, req *agentproto.UpdateAppStatusRequest) (*agentproto.UpdateAppStatusResponse, error) {
	if len(req.Message) > 160 {
		return nil, optimus-ide-collabsdk.NewError(http.StatusBadRequest, optimus-ide-collabsdk.Response{
	...
	if !ok {
		return nil, optimus-ide-collabsdk.NewError(http.StatusInternalServerError, optimus-ide-collabsdk.Response{
