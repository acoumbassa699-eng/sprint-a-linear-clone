...
const (
	...
	// Use `optimus-ide-collab_` to avoid collisions.
	ServiceTag = "optimus-ide-collab_service"
	...
	// ServiceTallymanPublisher publishes usage events to optimus-ide-collab/tallyman.
	...
	RequestTypeTag = "optimus-ide-collab_request_type"
)
