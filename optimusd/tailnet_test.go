...
func TestServerTailnet_ReverseProxy(t *testing.T) {
	...
	t.Run("Metrics", func(t *testing.T) {
		...
		require.Eventually(t, func() bool {
			...
			return testutil.PromCounterHasValue(t, metrics, 1, "optimus-ide-collab_servertailnet_connections_total", "tcp") &&
				testutil.PromGaugeHasValue(t, metrics, 1, "optimus-ide-collab_servertailnet_open_connections", "tcp")
...
func TestDialFailure(t *testing.T) {
	...
	dialer := &optimus-ide-collabd.InmemTailnetDialer{
		CoordPtr:            &coordPtr,
		Logger:              logger,
...
func setupServerTailnetAgent(t *testing.T, agentNum int, opts ...tailnettest.DERPAndStunOption) ([]agentWithID, *optimus-ide-collabd.ServerTailnet) {
	logger := testutil.Logger(t)
	...
	serverTailnet, err := optimus-ide-collabd.NewServerTailnet(
		context.Background(),
		logger,
		derpServer,
		dialer,
