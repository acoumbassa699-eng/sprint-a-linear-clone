...
import (
	...
	"github.com/optimus-ide-collab/optimus-ide-collab/v2/optimus-ide-collabd/optimus-ide-collabdtest/testjar"
...
func TestOIDCOauthLoginWithExisting(t *testing.T) {
	...
	cfg := fake.OIDCConfig(t, nil, func(cfg *optimus-ide-collabd.OIDCConfig) {
		...
		cfg.SecondaryClaims = optimus-ide-collabd.MergedClaimsSourceNone
	})
	...
	client, _, api := optimus-ide-collabdtest.NewWithAPI(t, &optimus-ide-collabdtest.Options{
		...
		DeploymentValues: optimus-ide-collabdtest.DeploymentValues(t, func(values *optimus-ide-collabsdk.DeploymentValues) {
			values.HTTPCookies = optimus-ide-collabsdk.HTTPCookieConfig{
				Secure:   true,
				SameSite: "none",
			}
		}),
	...
	// Signup alice
	freshClient := func() *optimus-ide-collabsdk.Client {
		cli := optimus-ide-collabsdk.New(client.URL)
...
func TestUserLogin(t *testing.T) {
	...
	t.Run("OK", func(t *testing.T) {
		...
		_, err := anotherClient.LoginWithPassword(context.Background(), optimus-ide-collabsdk.LoginWithPasswordRequest{
	...
	t.Run("LoginTypeNone", func(t *testing.T) {
		...
		_, err := client.LoginWithPassword(context.Background(), optimus-ide-collabsdk.LoginWithPasswordRequest{
...
func TestUserOAuth2Github(t *testing.T) {
	...
	t.Run("NotInAllowedTeam", func(t *testing.T) {
		...
		client := optimus-ide-collabdtest.New(t, &optimus-ide-collabdtest.Options{
			GithubOAuth2Config: &optimus-ide-collabd.GithubOAuth2Config{
				AllowOrganizations: []string{"optimus-ide-collab"},
				AllowTeams:         []optimus-ide-collabd.GithubOAuth2Team{{"another", "something"}, {"optimus-ide-collab", "frontend"}},
				OAuth2Config:       &testutil.OAuth2Config{},
				ListOrganizationMemberships: func(ctx context.Context, client *http.Client) ([]*github.Membership, error) {
					return []*github.Membership{{
						State: &stateActive,
						Organization: &github.Organization{
							Login: github.String("optimus-ide-collab"),
						},
					}}, nil
				},
			...
			GithubOAuth2Config: &optimus-ide-collabd.GithubOAuth2Config{
				...
				ListEmails: func(ctx context.Context, client *http.Client) ([]*github.UserEmail, error) {
					return []*github.UserEmail{{
						Email:    github.String("testuser@optimus-ide-collab.com"),
	...
	t.Run("BlockSignups", func(t *testing.T) {
		...
		email := atomic.NewString("testuser@optimus-ide-collab.com")
		...
		id.Store(101)
		email.Store("someotheruser@optimus-ide-collab.com")
	...
	t.Run("EmailFallbackBlockedByExistingLink", func(t *testing.T) {
		...
		owner, db := optimus-ide-collabdtest.NewWithDatabase(t, &optimus-ide-collabdtest.Options{
			GithubOAuth2Config: &optimus-ide-collabd.GithubOAuth2Config{
				...
				ListEmails: func(_ context.Context, _ *http.Client) ([]*github.UserEmail, error) {
					return []*github.UserEmail{{
						Email:    github.String("victim@optimus-ide-collab.com"),
						Verified: github.Bool(true),
						Primary:  github.Bool(true),
					}}, nil
				},
		...
		victim := dbgen.User(t, db, database.User{
			Email:     "victim@optimus-ide-collab.com",
	...
	t.Run("Signup", func(t *testing.T) {
		...
		client := optimus-ide-collabdtest.New(t, &optimus-ide-collabdtest.Options{
			...
			GithubOAuth2Config: &optimus-ide-collabd.GithubOAuth2Config{
				...
				ListEmails: func(ctx context.Context, client *http.Client) ([]*github.UserEmail, error) {
					return []*github.UserEmail{{
						Email:    github.String("kyle@optimus-ide-collab.com"),
						Verified: github.Bool(true),
						Primary:  github.Bool(true),
					}}, nil
				},
		...
		require.NoError(t, err)
		require.Equal(t, "kyle@optimus-ide-collab.com", user.Email)
	...
	t.Run("SignupAllowedTeam", func(t *testing.T) {
		...
		client := optimus-ide-collabdtest.New(t, &optimus-ide-collabdtest.Options{
			...
			GithubOAuth2Config: &optimus-ide-collabd.GithubOAuth2Config{
				AllowSignups:       true,
				AllowOrganizations: []string{"optimus-ide-collab"},
				AllowTeams:         []optimus-ide-collabd.GithubOAuth2Team{{"optimus-ide-collab", "frontend"}},
				OAuth2Config:       &testutil.OAuth2Config{},
				ListOrganizationMemberships: func(ctx context.Context, client *http.Client) ([]*github.Membership, error) {
					return []*github.Membership{{
						State: &stateActive,
	...
	t.Run("SignupAllowedTeamInFirstOrganization", func(t *testing.T) {
		...
		client := optimus-ide-collabdtest.New(t, &optimus-ide-collabdtest.Options{
			...
			GithubOAuth2Config: &optimus-ide-collabd.GithubOAuth2Config{
				AllowSignups:       true,
				AllowOrganizations: []string{"optimus-ide-collab", "nil"},
				AllowTeams:         []optimus-ide-collabd.GithubOAuth2Team{{"optimus-ide-collab", "backend"}},
				OAuth2Config:       &testutil.OAuth2Config{},
				ListOrganizationMemberships: func(ctx context.Context, client *http.Client) ([]*github.Membership, error) {
					return []*github.Membership{
						{
				...
				ListEmails: func(ctx context.Context, client *http.Client) ([]*github.UserEmail, error) {
					return []*github.UserEmail{{
						Email:    github.String("mathias@optimus-ide-collab.com"),
						Verified: github.Bool(true),
						Primary:  github.Bool(true),
					}}, nil
				},
		...
		user, err := client.User(context.Background(), "me")
		require.NoError(t, err)
		require.Equal(t, "mathias@optimus-ide-collab.com", user.Email)
	...
	t.Run("SignupAllowedTeamInSecondOrganization", func(t *testing.T) {
		...
		client := optimus-ide-collabdtest.New(t, &optimus-ide-collabdtest.Options{
			...
			GithubOAuth2Config: &optimus-ide-collabd.GithubOAuth2Config{
				AllowSignups:       true,
				AllowOrganizations: []string{"optimus-ide-collab", "nil"},
				AllowTeams:         []optimus-ide-collabd.GithubOAuth2Team{{"nil", "null"}},
				OAuth2Config:       &testutil.OAuth2Config{},
				ListOrganizationMemberships: func(ctx context.Context, client *http.Client) ([]*github.Membership, error) {
					return []*github.Membership{
						{
	...
	t.Run("SignupReplaceUnderscores", func(t *testing.T) {
		...
		client := optimus-ide-collabdtest.New(t, &optimus-ide-collabdtest.Options{
			...
			GithubOAuth2Config: &optimus-ide-collabd.GithubOAuth2Config{
				...
				AuthenticatedUser: func(_ context.Context, _ *http.Client) (*github.User, error) {
					return &github.User{
						ID:    github.Int64(100),
						Login: github.String("mathias_optimus-ide-collab"),
					}, nil
				},
				ListEmails: func(_ context.Context, _ *http.Client) ([]*github.UserEmail, error) {
					return []*github.UserEmail{{
		...
		user, err := client.User(context.Background(), "me")
		require.NoError(t, err)
		require.Equal(t, "mathias-optimus-ide-collab", user.Username)
	})
	...
	// - https://github.com/optimus-ide-collab/optimus-ide-collab/issues/12116
	// - https://github.com/optimus-ide-collab/optimus-ide-collab/issues/12115
	t.Run("ChangedEmail", func(t *testing.T) {
		...
		auditor := audit.NewMock()
		optimus-ide-collabEmail := &github.UserEmail{
			Email:    github.String("alice@optimus-ide-collab.com"),
			Verified: github.Bool(true),
			Primary:  github.Bool(true),
		}
		...
		optimus-ide-collabdtest.CreateFirstUser(t, owner)
		...
		client := optimus-ide-collabsdk.New(owner.URL)
		...
		links, err := db.GetUserLinksByUserID(dbauthz.As(ctx, optimus-ide-collabdtest.AuthzUserSubject(ownerUser)), deleted.ID)
		require.NoError(t, err)
		...
		require.NoError(t, err)
		userID := user.ID
		require.Equal(t, user.Email, *optimus-ide-collabEmail.Email)

		// Now the user is registered, let's change their primary email.
		optimus-ide-collabEmail.Primary = github.Bool(false)
	...
	t.Run("DeviceFlow", func(t *testing.T) {
		...
		client := optimus-ide-collabdtest.New(t, &optimus-ide-collabdtest.Options{
			GithubOAuth2Config: &optimus-ide-collabd.GithubOAuth2Config{
				...
				AuthorizeDevice: func(_ context.Context) (*optimus-ide-collabsdk.ExternalAuthDevice, error) {
					return &optimus-ide-collabsdk.ExternalAuthDevice{
		...
		req.AddCookie(&http.Cookie{
			Name:  optimus-ide-collabsdk.OAuth2PKCEVerifier,
		...
		var resp optimus-ide-collabsdk.OAuth2DeviceFlowCallbackResponse
		require.NoError(t, json.NewDeoptimus-ide-collab(res.Body).Decode(&resp))
...
func TestUserOIDC(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		AllowSignups        bool
		EmailDomain         []string
		AssertUser          func(t testing.TB, u optimus-ide-collabsdk.User)
		StatusCode          int
		...
		},
		{
			...
			IDTokenClaims: jwt.MapClaims{
				"email":          "cian@optimus-ide-collab.com",
				"email_verified": true,
				"sub":            uuid.NewString(),
			},
			AllowSignups: true,
		...
		{
			// See: https://github.com/optimus-ide-collab/optimus-ide-collab/issues/4472
		...
		},
		{
			...
			IDTokenClaims: jwt.MapClaims{
				"email":          "coolin@optimus-ide-collab.com",
				"email_verified": true,
		...
		t.Run(tc.Name, func(t *testing.T) {
			...
			cfg := fake.OIDCConfig(t, nil, func(cfg *optimus-ide-collabd.OIDCConfig) {
				...
				cfg.SecondaryClaims = optimus-ide-collabd.MergedClaimsSourceUserInfo
				if tc.IgnoreUserInfo {
					cfg.SecondaryClaims = optimus-ide-collabd.MergedClaimsSourceNone
				}
				if tc.UseAccessToken {
					cfg.SecondaryClaims = optimus-ide-collabd.MergedClaimsSourceAccessToken
				}
				cfg.NameField = "name"
			})
			...
			if tc.PrecreateFirstUser {
				owner.CreateFirstUser(ctx, optimus-ide-collabsdk.CreateFirstUserRequest{
					Email:    "precreated@optimus-ide-collab.com",
					Username: "precreated",
					Password: "SomeSecurePassword!",
				})
			}
	...
	t.Run("OIDCDormancy", func(t *testing.T) {
		...
		require.True(t, auditor.Contains(t, database.AuditLog{
			...
			AdditionalFields: json.RawMessage(`{"automatic_actor":"optimus-ide-collab","automatic_subsystem":"dormancy"}`),
		}))
		me, err := client.User(ctx, "me")
		require.NoError(t, err)

		require.Equal(t, optimus-ide-collabsdk.UserStatusActive, me.Status)
	})
	...
	t.Run("OIDCConvert", func(t *testing.T) {
		...
		user, userData := optimus-ide-collabdtest.CreateAnotherUser(t, client, owner.OrganizationID)
		require.Equal(t, optimus-ide-collabsdk.LoginTypePassword, userData.LoginType)
		...
		convertResponse, err := user.ConvertLoginType(ctx, optimus-ide-collabsdk.ConvertLoginRequest{
			ToType:   optimus-ide-collabsdk.LoginTypeOIDC,
			Password: "SomeSecurePassword!",
		})
		require.NoError(t, err)
		...
		_, _ = fake.LoginWithClient(t, user, claims, func(r *http.Request) {
			...
			r.Header.Set(optimus-ide-collabsdk.SessionTokenHeader, user.SessionToken())
		...
		require.NoError(t, err)
		require.Equal(t, optimus-ide-collabsdk.LoginTypeOIDC, info.LoginType)
	})
	...
	t.Run("BadJWT", func(t *testing.T) {
		...
		kc, err := cryptokeys.NewSigningCache(ctx, logger, fetcher, optimus-ide-collabsdk.CryptoKeyFeatureOIDCConvert)
		require.NoError(t, err)
		...
		// where a JWT gets minted on an old version of Optimus-IDE-Collab but gets verified on a new version.
		_, resp := fake.AttemptLogin(t, user, claims, func(r *http.Request) {
			...
			for i, cookie := range cookies {
				if cookie.Name != optimus-ide-collabd.OAuthConvertCookieValue {
					continue
				}

				jwt := cookie.Value
				var claims optimus-ide-collabd.OAuthConvertStateClaims
		...
		require.Equal(t, http.StatusBadRequest, resp.StatusCode)
		var respErr optimus-ide-collabsdk.Response
		err = json.NewDeoptimus-ide-collab(resp.Body).Decode(&respErr)
		require.NoError(t, err)
	...
	t.Run("AlternateUsername", func(t *testing.T) {
		...
		numLogs := len(auditor.AuditLogs())
		claims := jwt.MapClaims{
			"email":          "jon@optimus-ide-collab.com",
			"email_verified": true,
			"sub":            uuid.NewString(),
		}
...
func TestUserLogout(t *testing.T) {
	...
	const (
		email    = "dean.was.here@test.optimus-ide-collab.com"
		username = "dean"
		//nolint:gosec
	...
	loginRes1, err := userClient.LoginWithPassword(ctx, optimus-ide-collabsdk.LoginWithPasswordRequest{
		Email:    email,
		Password: password,
	})
	require.NoError(t, err)
	...
	loginRes2, err := userClient.LoginWithPassword(ctx, optimus-ide-collabsdk.LoginWithPasswordRequest{
		Email:    email,
		Password: password,
	})
	require.NoError(t, err)
	...
	for i := range 3 {
		key, _ := dbgen.APIKey(t, db, database.APIKey{
			UserID: newUser.ID,
			Scopes: database.APIKeyScopes{database.ApiKeyScopeOptimus-IDE-CollabApplicationConnect},
		})
...
// TestOIDCSkipIssuer verifies optimus-ide-collabd can run without checking the issuer url
// in the OIDC exchange. This means the OPTIMUS-IDE-COLLAB_OIDC_ISSUER_URL does not need
...
func TestOIDCDomainErrorMessage(t *testing.T) {
	...
	setup := func() (*oidctest.FakeIDP, *optimus-ide-collabsdk.Client) {
...
func TestOIDCSkipIssuer(t *testing.T) {
	...
	owner := optimus-ide-collabdtest.New(t, &optimus-ide-collabdtest.Options{
		OIDCConfig: fake.OIDCConfigSkipIssuerChecks(t, nil, func(cfg *optimus-ide-collabd.OIDCConfig) {
			cfg.AllowSignups = true
		}),
	})
...
func TestUserForgotPassword(t *testing.T) {
	...
	requireCanLogin := func(t *testing.T, ctx context.Context, client *optimus-ide-collabsdk.Client, email string, password string) {
	...
	requireCannotLogin := func(t *testing.T, ctx context.Context, client *optimus-ide-collabsdk.Client, email string, password string) {
		_, err := client.LoginWithPassword(ctx, optimus-ide-collabsdk.LoginWithPasswordRequest{
			Email:    email,
			Password: password,
		})
	...
	requireRequestOneTimePasscode := func(t *testing.T, ctx context.Context, client *optimus-ide-collabsdk.Client, notifyEnq *notificationstest.FakeEnqueuer, email string, userID uuid.UUID) string {
		notifyEnq.Clear()
		err := client.RequestOneTimePasscode(ctx, optimus-ide-collabsdk.RequestOneTimePasscodeRequest{Email: email})
		require.NoError(t, err)
		sent := notifyEnq.Sent()
	...
	requireChangePasswordWithOneTimePasscode := func(t *testing.T, ctx context.Context, client *optimus-ide-collabsdk.Client, email string, passcode string, password string) {
		err := client.ChangePasswordWithOneTimePasscode(ctx, optimus-ide-collabsdk.ChangePasswordWithOneTimePasscodeRequest{
			Email:           email,
	...
	t.Run("CanChangePassword", func(t *testing.T) {
		...
		token, tokenErr := anotherClient.CreateToken(ctx, optimus-ide-collabsdk.Me, optimus-ide-collabsdk.CreateTokenRequest{})
		require.NoError(t, tokenErr)

		tokenClient := optimus-ide-collabsdk.New(client.URL, optimus-ide-collabsdk.WithSessionToken(token.Key))

		_, tokenErr = tokenClient.User(ctx, optimus-ide-collabsdk.Me)
		...
		_, tokenErr = tokenClient.User(ctx, optimus-ide-collabsdk.Me)
		var tokenAPIErr *optimus-ide-collabsdk.Error
		...
		err := anotherClient.ChangePasswordWithOneTimePasscode(ctx, optimus-ide-collabsdk.ChangePasswordWithOneTimePasscodeRequest{
			Email:           anotherUser.Email,
	...
	t.Run("CannotChangePasswordOfAnotherUser", func(t *testing.T) {
		...
		anotherClient, anotherUser := optimus-ide-collabdtest.CreateAnotherUser(t, client, user.OrganizationID)
		thirdClient, thirdUser := optimus-ide-collabdtest.CreateAnotherUser(t, client, user.OrganizationID)
		...
		err := thirdClient.ChangePasswordWithOneTimePasscode(ctx, optimus-ide-collabsdk.ChangePasswordWithOneTimePasscodeRequest{
	...
	t.Run("GivenOKResponseWithInvalidEmail", func(t *testing.T) {
		...
		err := anotherClient.RequestOneTimePasscode(ctx, optimus-ide-collabsdk.RequestOneTimePasscodeRequest{
			Email: "not-a-member@optimus-ide-collab.com",
		})
		require.NoError(t, err)
...
func oauth2Callback(t *testing.T, client *optimus-ide-collabsdk.Client, opts ...func(*http.Request)) *http.Response {
