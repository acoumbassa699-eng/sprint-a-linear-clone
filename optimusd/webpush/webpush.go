...
type Dispatcher interface {
	...
	Dispatch(ctx context.Context, userID uuid.UUID, notification optimus-ide-collabsdk.WebpushMessage) error
	// Test sends a test web push notificatoin to a subscription to ensure it is valid.
	Test(ctx context.Context, req optimus-ide-collabsdk.WebpushSubscription) error
...
//
// See: https://github.com/optimus-ide-collab/internal/issues/528
...
func (n *Webpusher) Dispatch(ctx context.Context, userID uuid.UUID, msg optimus-ide-collabsdk.WebpushMessage) error {
...
func (n *Webpusher) Test(ctx context.Context, req optimus-ide-collabsdk.WebpushSubscription) error {
	msgJSON, err := json.Marshal(optimus-ide-collabsdk.WebpushMessage{
		Title: "It's working!",
...
func (n *NoopWebpusher) Dispatch(context.Context, uuid.UUID, optimus-ide-collabsdk.WebpushMessage) error {
	return xerrors.New(n.Msg)
}

func (n *NoopWebpusher) Test(context.Context, optimus-ide-collabsdk.WebpushSubscription) error {
	return xerrors.New(n.Msg)
}
