...
import (
	...
	strutil "github.com/optimus-ide-collab/optimus-ide-collab/v2/optimus-ide-collabd/util/strings"
...
Prompt: "Work on https://github.com/optimus-ide-collab/optimus-ide-collab/issues/1234" →
{
	"display_name": "Work on optimus-ide-collab/optimus-ide-collab #1234",
	"task_name": "optimus-ide-collab-1234"
}
...
func extractJSON(s string) string {
	...
	if err := json.NewDeoptimus-ide-collab(strings.NewReader(s)).Decode(&raw); err == nil {
		return string(raw)
	}
