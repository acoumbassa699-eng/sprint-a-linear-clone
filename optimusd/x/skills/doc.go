...
// Glossary:
//
//   - Personal skill: A user-owned skill that follows the user across Optimus-IDE-Collab
//     chats and workspaces, stored by Optimus-IDE-Collab rather than discovered from a
...
// Decision:
//
// Personal skills are stored by Optimus-IDE-Collab. For each chat turn, chatd fetches
...
// path, while storage remains owned by Optimus-IDE-Collab instead of individual workspace
