...
import "github.com/optimus-ide-collab/optimus-ide-collab/v2/optimus-ide-collabd/x/chatd/chattool"

const defaultSystemPromptPlanPathBlockPlaceholder = "{{OPTIMUS-IDE-COLLAB_CHAT_PLAN_FILE_PATH_BLOCK}}"
...
// configured.
const DefaultSystemPrompt = `You are the Optimus-IDE-Collab agent — an interactive chat tool that helps users with software-engineering tasks inside of the Optimus-IDE-Collab product.
