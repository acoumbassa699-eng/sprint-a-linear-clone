...
// dynamicTool wraps a optimus-ide-collabsdk.DynamicTool as a fantasy.AgentTool.
...
// dynamicToolsFromSDK converts optimus-ide-collabsdk.DynamicTool definitions
// into fantasy.AgentTool implementations for inclusion in the LLM
// tool list.
func dynamicToolsFromSDK(logger slog.Logger, tools []optimus-ide-collabsdk.DynamicTool) []fantasy.AgentTool {
	if len(tools) == 0 {
		return nil
	}
