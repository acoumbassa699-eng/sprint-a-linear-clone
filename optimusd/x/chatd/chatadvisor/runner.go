...
func (rt *Runtime) RunAdvisor(
	...
	if opts != nil && opts.OnAdviceDelta != nil {
		assistantOpts.PublishMessagePart = func(role optimus-ide-collabsdk.ChatMessageRole, part optimus-ide-collabsdk.ChatMessagePart) {
			if role != optimus-ide-collabsdk.ChatMessageRoleAssistant ||
