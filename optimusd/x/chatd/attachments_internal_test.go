...
func TestBuildAssistantPartsForPersist_PromotesToolAttachments(t *testing.T) {
	...
	require.Equal(t, optimus-ide-collabsdk.ChatMessagePartTypeFile, parts[1].Type)
...
func TestBuildAssistantPartsForPersist_AppliesReasoningTimestamps(t *testing.T) {
	...
	require.Equal(t, optimus-ide-collabsdk.ChatMessagePartTypeReasoning, parts[2].Type)
