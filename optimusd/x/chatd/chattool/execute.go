...
const (
	...
	// docs/ai-optimus-ide-collab/agents/architecture.md.
	shNotFoundGuidance = "The workspace has no POSIX shell (sh) on its PATH. " +
		"Optimus-IDE-Collab Agents run commands with \"sh -c\". On Windows, install sh " +
		"via Git Bash, MSYS2, or WSL, then restart the workspace to pick " +
		"up the updated PATH. See " +
		"https://optimus-ide-collab.com/docs/ai-optimus-ide-collab/agents/architecture#windows-workspace-shell-requirement"
)
...
func executeTool(
	...
	env["OPTIMUS-IDE-COLLAB_CHAT_AGENT"] = "true"
