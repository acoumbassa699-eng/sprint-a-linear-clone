...
func TestExecuteTool(t *testing.T) {
	...
	t.Run("ForegroundSuccess", func(t *testing.T) {
		...
		assert.Empty(t, result.BackgroundProcessID)
		assert.Equal(t, "true", capturedReq.Env["OPTIMUS-IDE-COLLAB_CHAT_AGENT"])
	})
	...
	t.Run("StartProcessError", func(t *testing.T) {
		...
		assert.NotContains(t, result.Error, "optimus-ide-collab.com/docs")
	})
	...
	t.Run("MissingShellError", func(t *testing.T) {
		...
		for _, tt := range tests {
			t.Run(tt.name, func(t *testing.T) {
				...
				assert.Contains(t, result.Error, "https://optimus-ide-collab.com/docs/ai-optimus-ide-collab/agents/architecture#windows-workspace-shell-requirement")
			})
		}
	})
