...
// responseErrorResult converts a optimus-ide-collabsdk.Response into a structured
...
func responseErrorResult(resp optimus-ide-collabsdk.Response) map[string]any {
