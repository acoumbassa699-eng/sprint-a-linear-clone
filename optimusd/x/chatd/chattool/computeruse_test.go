...
func TestDefaultComputerUseModel(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:     "unsupported",
			provider: optimus-ide-collabsdk.ChatComputerUseProvider("unsupported"),
			wantOK:   false,
		},
	}
...
func TestComputerUseProviderTool(t *testing.T) {
	...
	def, err := chattool.ComputerUseProviderTool(
		optimus-ide-collabsdk.ChatComputerUseProviderAnthropic,
	...
	openAITool, err := chattool.ComputerUseProviderTool(
		optimus-ide-collabsdk.ChatComputerUseProviderOpenAI,
		geometry.DeclaredWidth,
		geometry.DeclaredHeight,
	)
	require.NoError(t, err)
	...
	_, err = chattool.ComputerUseProviderTool(
		optimus-ide-collabsdk.ChatComputerUseProvider("unsupported"),
		geometry.DeclaredWidth,
		geometry.DeclaredHeight,
	)
	require.Error(t, err)
...
func TestComputerUseTool_Run_Screenshot(t *testing.T) {
	...
	tool := chattool.NewComputerUseTool(optimus-ide-collabsdk.ChatComputerUseProviderAnthropic, geometry.DeclaredWidth, geometry.DeclaredHeight, func(_ context.Context) (workspacesdk.AgentConn, error) {
		return mockConn, nil
