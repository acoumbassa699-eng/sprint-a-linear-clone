...
import (
	...
	optimus-ide-collabstrings "github.com/optimus-ide-collab/optimus-ide-collab/v2/optimus-ide-collabd/util/strings"
)

// readmeInputMaxBytes caps how many README bytes are parsed so a giant README
// can't OOM optimus-ide-collabd. It sits well above the output rune cap, so it never trims a
// real excerpt.
...
func readmeText(readme string, maxRunes int) string {
	...
	return optimus-ide-collabstrings.Truncate(text, maxRunes, optimus-ide-collabstrings.TruncateWithEllipsis)
}
