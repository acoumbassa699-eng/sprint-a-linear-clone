...
func SupportedComputerUseProviders() []string {
	providers := make([]string, len(optimus-ide-collabsdk.AllChatComputerUseProviders))
	for i, p := range optimus-ide-collabsdk.AllChatComputerUseProviders {
...
func DefaultComputerUseProvider(provider optimus-ide-collabsdk.ChatComputerUseProvider) optimus-ide-collabsdk.ChatComputerUseProvider {
	if provider == "" {
		return optimus-ide-collabsdk.ChatComputerUseProviderAnthropic
	}
	return provider
}

// DefaultComputerUseModel returns the default model for a computer use provider.
func DefaultComputerUseModel(provider optimus-ide-collabsdk.ChatComputerUseProvider) (modelProvider, modelName string, ok bool) {
	switch DefaultComputerUseProvider(provider) {
	case optimus-ide-collabsdk.ChatComputerUseProviderAnthropic:
		return fantasyanthropic.Name, ComputerUseAnthropicModelName, true
	case optimus-ide-collabsdk.ChatComputerUseProviderOpenAI:
...
func DefaultComputerUseDesktopGeometry(provider optimus-ide-collabsdk.ChatComputerUseProvider) workspacesdk.DesktopGeometry {
	switch DefaultComputerUseProvider(provider) {
	case optimus-ide-collabsdk.ChatComputerUseProviderOpenAI:
...
type computerUseTool struct {
	provider         optimus-ide-collabsdk.ChatComputerUseProvider
	declaredWidth    int
	declaredHeight   int
...
func ComputerUseProviderTool(provider optimus-ide-collabsdk.ChatComputerUseProvider, declaredWidth, declaredHeight int) (fantasy.Tool, error) {
	switch DefaultComputerUseProvider(provider) {
	case optimus-ide-collabsdk.ChatComputerUseProviderAnthropic:
