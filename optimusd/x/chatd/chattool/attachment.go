...
func storeScreenshotAttachment(
	...
	deoptimus-ide-collab := base64.NewDeoptimus-ide-collab(base64.StdEncoding, strings.NewReader(encodedPNG))
	data, err := io.ReadAll(io.LimitReader(deoptimus-ide-collab, maxAttachmentSize+1))
	if err != nil {
