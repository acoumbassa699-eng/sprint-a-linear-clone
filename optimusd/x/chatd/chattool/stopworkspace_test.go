...
func TestStopWorkspace(t *testing.T) {
	...
	t.Run("NoWorkspace", func(t *testing.T) {
		...
		tool := chattool.StopWorkspace(db, chat.ID, chattool.StopWorkspaceOptions{
			StopFn: func(_ context.Context, _ uuid.UUID, _ uuid.UUID, _ optimus-ide-collabsdk.CreateWorkspaceBuildRequest) (optimus-ide-collabsdk.WorkspaceBuild, error) {
	...
	t.Run("RunningWorkspaceStops", func(t *testing.T) {
		...
		tool := chattool.StopWorkspace(db, chat.ID, chattool.StopWorkspaceOptions{
			OwnerID: user.ID,
			StopFn: func(_ context.Context, _ uuid.UUID, wsID uuid.UUID, req optimus-ide-collabsdk.CreateWorkspaceBuildRequest) (optimus-ide-collabsdk.WorkspaceBuild, error) {
				stopCalled.Store(true)
				require.Equal(t, ws.ID, wsID)
				require.Equal(t, optimus-ide-collabsdk.WorkspaceTransitionStop, req.Transition)
	...
	t.Run("FailedLatestStopBuildStillStops", func(t *testing.T) {
		...
		tool := chattool.StopWorkspace(db, chat.ID, chattool.StopWorkspaceOptions{
			OwnerID: user.ID,
			StopFn: func(_ context.Context, _ uuid.UUID, _ uuid.UUID, req optimus-ide-collabsdk.CreateWorkspaceBuildRequest) (optimus-ide-collabsdk.WorkspaceBuild, error) {
				stopCalled.Store(true)
				require.Equal(t, optimus-ide-collabsdk.WorkspaceTransitionStop, req.Transition)
				buildResp := dbfake.WorkspaceBuild(t, db, ws).Seed(database.WorkspaceBuild{
					Transition:  database.WorkspaceTransitionStop,
