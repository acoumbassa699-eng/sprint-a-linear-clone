...
func TestRecordingTransport_CloseAfterDeoptimus-ide-collabConsumesContentLengthSucceeds(t *testing.T) {
	t.Parallel()
	...
	require.NoError(t, json.NewDeoptimus-ide-collab(resp.Body).Decode(&decoded))
...
func TestRecordingTransport_CloseAfterDeoptimus-ide-collabConsumesUnknownLengthJSONSucceeds(t *testing.T) {
	t.Parallel()
...
func TestRecordingTransport_CloseAfterDeoptimus-ide-collabConsumesUnknownLengthJSONWithTrailingDocumentMarksFailed(t *testing.T) {
	t.Parallel()
...
func TestRecordingTransport_CloseAfterDeoptimus-ide-collabConsumesUnknownLengthNDJSONMarksFailed(t *testing.T) {
	t.Parallel()
...
func TestRecordingTransport_CloseAfterDeoptimus-ide-collabDrainsUnknownLengthSucceeds(t *testing.T) {
	t.Parallel()
...
func TestRecordingTransport_MaxDrainBytesRespected(t *testing.T) {
	...
	// Build a body where json.Deoptimus-ide-collab consumes the first JSON document
	...
	// be bounded. The json.Deoptimus-ide-collab reads the JSON doc (~13 bytes),
