...
func TestContentFilterError(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			require.Equal(t, optimus-ide-collabsdk.ChatErrorKindContentFilter, classified.Kind)
			...
			require.Equal(t, optimus-ide-collabsdk.ChatErrorKindContentFilter, payload.Kind)
		})
	}
}
