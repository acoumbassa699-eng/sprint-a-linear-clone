...
func TestProcessStepStreamPreservesReasoningMetadataAcrossNilDelta(t *testing.T) {
	...
	result, err := processStepStream(context.Background(), stream, quartz.NewMock(t), func(optimus-ide-collabsdk.ChatMessageRole, optimus-ide-collabsdk.ChatMessagePart) {})
