...
func Test_extractManualTitleTurns(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			messages: []database.ChatMessage{
				mustChatMessage(t, database.ChatMessageRoleUser, database.ChatMessageVisibilityBoth,
					optimus-ide-collabsdk.ChatMessageFile(pasteFileID, "text/plain", "pasted-text-2026-01-02-03-04-05.txt"),
				),
			},
		...
		},
		{
			...
			messages: []database.ChatMessage{
				mustChatMessage(t, database.ChatMessageRoleUser, database.ChatMessageVisibilityBoth,
					optimus-ide-collabsdk.ChatMessagePart{Type: optimus-ide-collabsdk.ChatMessagePartTypeText, Text: "  review quickgen helpers  "},
				),
				mustChatMessage(t, database.ChatMessageRoleAssistant, database.ChatMessageVisibilityBoth,
					optimus-ide-collabsdk.ChatMessagePart{Type: optimus-ide-collabsdk.ChatMessagePartTypeText, Text: "  drafted a plan  "},
				),
				mustChatMessage(t, database.ChatMessageRoleSystem, database.ChatMessageVisibilityBoth,
					optimus-ide-collabsdk.ChatMessagePart{Type: optimus-ide-collabsdk.ChatMessagePartTypeText, Text: "system prompt"},
				),
				mustChatMessage(t, database.ChatMessageRoleTool, database.ChatMessageVisibilityBoth,
					optimus-ide-collabsdk.ChatMessagePart{Type: optimus-ide-collabsdk.ChatMessagePartTypeText, Text: "tool output"},
				),
				mustChatMessage(t, database.ChatMessageRoleUser, database.ChatMessageVisibilityModel,
					optimus-ide-collabsdk.ChatMessagePart{Type: optimus-ide-collabsdk.ChatMessagePartTypeText, Text: "hidden model note"},
				),
				mustChatMessage(t, database.ChatMessageRoleUser, database.ChatMessageVisibilityBoth,
					optimus-ide-collabsdk.ChatMessagePart{Type: optimus-ide-collabsdk.ChatMessagePartTypeText, Text: "   "},
				),
				mustChatMessage(t, database.ChatMessageRoleAssistant, database.ChatMessageVisibilityBoth,
					optimus-ide-collabsdk.ChatMessagePart{Type: optimus-ide-collabsdk.ChatMessagePartTypeReasoning, Text: "reasoning only"},
				),
				mustChatMessage(t, database.ChatMessageRoleUser, database.ChatMessageVisibilityBoth,
					optimus-ide-collabsdk.ChatMessagePart{Type: optimus-ide-collabsdk.ChatMessagePartTypeFile, MediaType: "text/plain"},
				),
			},
			want: []manualTitleTurn{
		...
		},
		{
			...
			messages: []database.ChatMessage{
				mustChatMessage(t, database.ChatMessageRoleUser, database.ChatMessageVisibilityBoth,
					optimus-ide-collabsdk.ChatMessagePart{Type: optimus-ide-collabsdk.ChatMessagePartTypeText, Text: "first chunk"},
					optimus-ide-collabsdk.ChatMessagePart{Type: optimus-ide-collabsdk.ChatMessagePartTypeReasoning, Text: "skip me"},
					optimus-ide-collabsdk.ChatMessagePart{Type: optimus-ide-collabsdk.ChatMessagePartTypeText, Text: " second chunk "},
				),
			},
...
func Test_titleInput(t *testing.T) {
	...
	textMessage := mustChatMessage(t, database.ChatMessageRoleUser, database.ChatMessageVisibilityBoth,
		optimus-ide-collabsdk.ChatMessageText("summarize build logs"),
	)
...
func Test_titlePasteText(t *testing.T) {
	...
	t.Run("skips fetch when user messages have text", func(t *testing.T) {
		...
		pasteText, err := titlePasteText(context.Background(), db, []database.ChatMessage{
			mustChatMessage(t, database.ChatMessageRoleUser, database.ChatMessageVisibilityBoth,
				optimus-ide-collabsdk.ChatMessageText("typed text"),
				optimus-ide-collabsdk.ChatMessageFile(pasteFileID, "text/plain", "pasted-text-2026-01-02-03-04-05.txt"),
			),
		})
	...
	t.Run("ignores non synthetic file only messages", func(t *testing.T) {
		...
		pasteText, err := titlePasteText(context.Background(), db, []database.ChatMessage{
			mustChatMessage(t, database.ChatMessageRoleUser, database.ChatMessageVisibilityBoth,
				optimus-ide-collabsdk.ChatMessageFile(uuid.New(), "image/png", "photo.png"),
			),
		})
		require.NoError(t, err)
		require.Nil(t, pasteText)
...
func TestMaybeGenerateChatTitleAppliesModelConfigReasoningEffort(t *testing.T) {
	...
	modelConfigRaw, err := json.Marshal(optimus-ide-collabsdk.ChatModelCallConfig{
...
func Test_generateManualTitle_UsesTimeout(t *testing.T) {
	...
	messages := []database.ChatMessage{
		mustChatMessage(
			...
			database.ChatMessageRoleUser,
			database.ChatMessageVisibilityBoth,
			optimus-ide-collabsdk.ChatMessageText("refresh chat title"),
		),
	}
...
func Test_generateManualTitle_TruncatesFirstUserInput(t *testing.T) {
	...
	messages := []database.ChatMessage{
		mustChatMessage(
			...
			database.ChatMessageRoleUser,
			database.ChatMessageVisibilityBoth,
			optimus-ide-collabsdk.ChatMessageText(longFirstUserText),
		),
	}
...
func newTemperatureRejectedError() *fantasy.ProviderError {
	return &fantasy.ProviderError{
		Title: "bad request",
		Message: `POST "http://optimus-ide-collab-aibridge/v1/messages": 400 Bad Request ` +
