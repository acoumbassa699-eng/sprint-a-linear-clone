...
func (p *Server) resolveAdvisorModelOverrideOrFallback(
	...
	logger slog.Logger,
) (fantasy.LanguageModel, optimus-ide-collabsdk.ChatModelCallConfig) {
...
func TestResolveAdvisorModelOverride(t *testing.T) {
	...
	t.Run("NilModelConfigReturnsFallback", func(t *testing.T) {
		...
		gotModel, gotCfg := p.resolveAdvisorModelOverrideOrFallback(
			ctx,
			database.Chat{},
			optimus-ide-collabsdk.AdvisorConfig{},
			fallbackModel,
			fallbackCallConfig,
			modelBuildOptions{},
			logger,
	...
	t.Run("ConfigLookupErrorReturnsFallback", func(t *testing.T) {
		...
		gotModel, gotCfg := p.resolveAdvisorModelOverrideOrFallback(
			ctx,
			database.Chat{},
			optimus-ide-collabsdk.AdvisorConfig{ModelConfigID: uuid.New()},
			fallbackModel,
			fallbackCallConfig,
			modelBuildOptions{},
			logger,
	...
	t.Run("InvalidOptionsJSONReturnsFallback", func(t *testing.T) {
		...
		gotModel, gotCfg := p.resolveAdvisorModelOverrideOrFallback(
			ctx,
			database.Chat{},
			optimus-ide-collabsdk.AdvisorConfig{ModelConfigID: configID},
			fallbackModel,
			fallbackCallConfig,
			modelBuildOptions{},
			logger,
	...
	t.Run("SuccessReturnsOverrideModelAndConfig", func(t *testing.T) {
		...
		configID := uuid.New()
		providerID := uuid.New()
		rawOptions, err := json.Marshal(optimus-ide-collabsdk.ChatModelCallConfig{
			...
			ReasoningEffort: &optimus-ide-collabsdk.ChatModelReasoningEffortConfig{
				...
				Max:     ptr.Ref(optimus-ide-collabsdk.ChatModelReasoningEffortXHigh),
			},
		})
		...
		require.Equal(t, optimus-ide-collabsdk.ChatModelReasoningEffortHigh, *gotCfg.ReasoningEffort.Default)
		require.Equal(t, optimus-ide-collabsdk.ChatModelReasoningEffortHigh, *gotCfg.ReasoningEffort.Max)
	})
...
func TestNewAdvisorRuntime(t *testing.T) {
	...
	t.Run("AppliesReasoningEffortToProviderOptions", func(t *testing.T) {
		...
		rt := p.newAdvisorRuntimeOrFallback(
			...
			optimus-ide-collabsdk.ChatModelCallConfig{
				ReasoningEffort: &optimus-ide-collabsdk.ChatModelReasoningEffortConfig{
					Default: ptr.Ref(optimus-ide-collabsdk.ChatModelReasoningEffortHigh),
					Max:     ptr.Ref(optimus-ide-collabsdk.ChatModelReasoningEffortXHigh),
				},
