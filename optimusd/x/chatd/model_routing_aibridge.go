...
const (
	aibridgeLocalBaseURL = "http://optimus-ide-collab-aibridge"
	...
	aibridgePlaceholderAPIKey   = "optimus-ide-collab-aibridge"
...
func (t *aiGatewayRoundTripper) RoundTrip(req *http.Request) (*http.Response, error) {
	...
	if len(t.providerAuth.Headers) > 0 {
		cloned.Header.Set(aibridge.HeaderOptimus-IDE-CollabToken, aibridgeDelegatedBYOKMarker)
	}
