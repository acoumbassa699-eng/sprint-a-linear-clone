	...
	tests := []struct {
	...
	}{
		{
			...
			want: chaterror.ClassifiedError{
				...
				Kind:       optimus-ide-collabsdk.ChatErrorKindOverloaded,
				Provider:   "",
				Retryable:  true,
				StatusCode: 529,
			},
		...
		},
		{
			...
			want: chaterror.ClassifiedError{
				...
				Kind:       optimus-ide-collabsdk.ChatErrorKindAuth,
				Provider:   "",
				Retryable:  false,
				StatusCode: 0,
			},
		},
		{
			...
			want: chaterror.ClassifiedError{
				...
				Kind:       optimus-ide-collabsdk.ChatErrorKindConfig,
				Provider:   "",
				Retryable:  false,
				StatusCode: 0,
			},
		...
		// the trailing newline written by http.Error).
		{
			...
			err: &fantasy.ProviderError{
				...
				Message:    fmt.Sprintf("%s: AI provider %q is disabled\n", optimus-ide-collabsdk.ChatErrorKindProviderDisabled, "openai"),
				StatusCode: http.StatusServiceUnavailable,
			},
			want: chaterror.ClassifiedError{
				Message:    "The OpenAI provider has been disabled. Contact your Optimus-IDE-Collab administrator.",
				Detail:     fmt.Sprintf("%s: AI provider %q is disabled", optimus-ide-collabsdk.ChatErrorKindProviderDisabled, "openai"),
				Kind:       optimus-ide-collabsdk.ChatErrorKindProviderDisabled,
				Provider:   "openai",
				Retryable:  false,
				StatusCode: 503,
			},
		},
		{
			...
			err: &fantasy.ProviderError{
				Title:      fantasy.ErrorTitleForStatusCode(http.StatusServiceUnavailable),
				Message:    fmt.Sprintf("%s: AI provider %q is disabled\n", optimus-ide-collabsdk.ChatErrorKindProviderDisabled, "mycustomprovider"),
				StatusCode: http.StatusServiceUnavailable,
			},
			want: chaterror.ClassifiedError{
				Message:    "The AI provider has been disabled. Contact your Optimus-IDE-Collab administrator.",
				Detail:     fmt.Sprintf("%s: AI provider %q is disabled", optimus-ide-collabsdk.ChatErrorKindProviderDisabled, "mycustomprovider"),
				Kind:       optimus-ide-collabsdk.ChatErrorKindProviderDisabled,
				Provider:   "",
				Retryable:  false,
				StatusCode: 503,
		...
		},
		{
			...
			err:  xerrors.New(fmt.Sprintf("%s: AI provider %q is disabled", optimus-ide-collabsdk.ChatErrorKindProviderDisabled, "anthropic")),
			want: chaterror.ClassifiedError{
				Message:    "The Anthropic provider has been disabled. Contact your Optimus-IDE-Collab administrator.",
				Detail:     fmt.Sprintf("%s: AI provider %q is disabled", optimus-ide-collabsdk.ChatErrorKindProviderDisabled, "anthropic"),
				Kind:       optimus-ide-collabsdk.ChatErrorKindProviderDisabled,
				Provider:   "anthropic",
				Retryable:  false,
				StatusCode: 0,
		...
		},
		{
			...
			err: &fantasy.ProviderError{
				Title:      fantasy.ErrorTitleForStatusCode(http.StatusServiceUnavailable),
				Message:    fmt.Sprintf("%s: AI provider %q is disabled\n", optimus-ide-collabsdk.ChatErrorKindProviderDisabled, "google"),
				StatusCode: http.StatusServiceUnavailable,
			},
			want: chaterror.ClassifiedError{
				Message:    "The Google provider has been disabled. Contact your Optimus-IDE-Collab administrator.",
				Detail:     fmt.Sprintf("%s: AI provider %q is disabled", optimus-ide-collabsdk.ChatErrorKindProviderDisabled, "google"),
				Kind:       optimus-ide-collabsdk.ChatErrorKindProviderDisabled,
				Provider:   "google",
				Retryable:  false,
				StatusCode: 503,
...
func TestClassify_OpenAIResponsesAPIDiagnostics(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name+"/BareString", func(t *testing.T) {
			...
			require.Equal(t, optimus-ide-collabsdk.ChatErrorKindGeneric, classified.Kind)
...
func TestClassify_PatternCoverage(t *testing.T) {
	...
	tests := []struct {
		name      string
		err       string
		wantKind  optimus-ide-collabsdk.ChatErrorKind
		wantRetry bool
	}{
		{name: "OverloadedLiteral", err: "overloaded", wantKind: optimus-ide-collabsdk.ChatErrorKindOverloaded, wantRetry: true},
		{name: "RateLimitLiteral", err: "rate limit", wantKind: optimus-ide-collabsdk.ChatErrorKindRateLimit, wantRetry: true},
		{name: "RateLimitUnderscoreLiteral", err: "rate_limit", wantKind: optimus-ide-collabsdk.ChatErrorKindRateLimit, wantRetry: true},
		{name: "RateLimitedLiteral", err: "rate limited", wantKind: optimus-ide-collabsdk.ChatErrorKindRateLimit, wantRetry: true},
		{name: "RateLimitedHyphenLiteral", err: "rate-limited", wantKind: optimus-ide-collabsdk.ChatErrorKindRateLimit, wantRetry: true},
		{name: "TooManyRequestsLiteral", err: "too many requests", wantKind: optimus-ide-collabsdk.ChatErrorKindRateLimit, wantRetry: true},
		{name: "TimeoutLiteral", err: "timeout", wantKind: optimus-ide-collabsdk.ChatErrorKindTimeout, wantRetry: true},
		{name: "TimedOutLiteral", err: "timed out", wantKind: optimus-ide-collabsdk.ChatErrorKindTimeout, wantRetry: true},
		{name: "ServiceUnavailableLiteral", err: "service unavailable", wantKind: optimus-ide-collabsdk.ChatErrorKindTimeout, wantRetry: true},
		{name: "UnavailableLiteral", err: "unavailable", wantKind: optimus-ide-collabsdk.ChatErrorKindTimeout, wantRetry: true},
		{name: "ConnectionResetLiteral", err: "connection reset", wantKind: optimus-ide-collabsdk.ChatErrorKindTimeout, wantRetry: true},
		{name: "ConnectionRefusedLiteral", err: "connection refused", wantKind: optimus-ide-collabsdk.ChatErrorKindTimeout, wantRetry: true},
		{name: "EOFLiteral", err: "eof", wantKind: optimus-ide-collabsdk.ChatErrorKindTimeout, wantRetry: true},
		{name: "BrokenPipeLiteral", err: "broken pipe", wantKind: optimus-ide-collabsdk.ChatErrorKindTimeout, wantRetry: true},
		{name: "BadGatewayLiteral", err: "bad gateway", wantKind: optimus-ide-collabsdk.ChatErrorKindTimeout, wantRetry: true},
		{name: "GatewayTimeoutLiteral", err: "gateway timeout", wantKind: optimus-ide-collabsdk.ChatErrorKindTimeout, wantRetry: true},
		{name: "ClientConnLiteral", err: "client conn", wantKind: optimus-ide-collabsdk.ChatErrorKindTimeout, wantRetry: true},
		{name: "GOAWAYLiteral", err: "goaway", wantKind: optimus-ide-collabsdk.ChatErrorKindTimeout, wantRetry: true},
		{name: "HTTP2StreamClosedLiteral", err: "http2: stream closed", wantKind: optimus-ide-collabsdk.ChatErrorKindTimeout, wantRetry: true},
		{name: "UseOfClosedNetworkConnectionLiteral", err: "use of closed network connection", wantKind: optimus-ide-collabsdk.ChatErrorKindTimeout, wantRetry: true},
		{name: "HTTP2InternalErrorReceivedFromPeerLiteral", err: "internal_error; received from peer", wantKind: optimus-ide-collabsdk.ChatErrorKindTimeout, wantRetry: true},
		{name: "HTTP2RefusedStreamReceivedFromPeerLiteral", err: "refused_stream; received from peer", wantKind: optimus-ide-collabsdk.ChatErrorKindTimeout, wantRetry: true},
		{name: "HTTP2CancelReceivedFromPeerLiteral", err: "cancel; received from peer", wantKind: optimus-ide-collabsdk.ChatErrorKindTimeout, wantRetry: true},
		{name: "HTTP2EnhanceYourCalmReceivedFromPeerLiteral", err: "enhance_your_calm; received from peer", wantKind: optimus-ide-collabsdk.ChatErrorKindTimeout, wantRetry: true},
		{name: "HTTP2NoErrorReceivedFromPeerLiteral", err: "no_error; received from peer", wantKind: optimus-ide-collabsdk.ChatErrorKindTimeout, wantRetry: true},
		{name: "AuthenticationLiteral", err: "authentication", wantKind: optimus-ide-collabsdk.ChatErrorKindAuth, wantRetry: false},
		{name: "UnauthorizedLiteral", err: "unauthorized", wantKind: optimus-ide-collabsdk.ChatErrorKindAuth, wantRetry: false},
		{name: "InvalidAPIKeyLiteral", err: "invalid api key", wantKind: optimus-ide-collabsdk.ChatErrorKindAuth, wantRetry: false},
		{name: "InvalidAPIKeyUnderscoreLiteral", err: "invalid_api_key", wantKind: optimus-ide-collabsdk.ChatErrorKindAuth, wantRetry: false},
		{name: "QuotaLiteral", err: "quota", wantKind: optimus-ide-collabsdk.ChatErrorKindUsageLimit, wantRetry: false},
		{name: "BillingLiteral", err: "billing", wantKind: optimus-ide-collabsdk.ChatErrorKindUsageLimit, wantRetry: false},
		{name: "InsufficientQuotaLiteral", err: "insufficient_quota", wantKind: optimus-ide-collabsdk.ChatErrorKindUsageLimit, wantRetry: false},
		{name: "AIBudgetExceededLiteral", err: "status 403: AI budget of US$10.00 exceeded", wantKind: optimus-ide-collabsdk.ChatErrorKindUsageLimit, wantRetry: false},
		{name: "AIBudgetCheckFailedLiteral", err: "status 500: internal server error checking user AI budget", wantKind: optimus-ide-collabsdk.ChatErrorKindGeneric, wantRetry: true},
		{name: "PaymentRequiredLiteral", err: "payment required", wantKind: optimus-ide-collabsdk.ChatErrorKindUsageLimit, wantRetry: false},
		{name: "ForbiddenLiteral", err: "forbidden", wantKind: optimus-ide-collabsdk.ChatErrorKindAuth, wantRetry: false},
		{name: "InvalidModelLiteral", err: "invalid model", wantKind: optimus-ide-collabsdk.ChatErrorKindConfig, wantRetry: false},
		{name: "ModelNotFoundLiteral", err: "model not found", wantKind: optimus-ide-collabsdk.ChatErrorKindConfig, wantRetry: false},
		{name: "ModelNotFoundUnderscoreLiteral", err: "model_not_found", wantKind: optimus-ide-collabsdk.ChatErrorKindConfig, wantRetry: false},
		{name: "UnsupportedModelLiteral", err: "unsupported model", wantKind: optimus-ide-collabsdk.ChatErrorKindConfig, wantRetry: false},
		{name: "ContextLengthExceededLiteral", err: "context length exceeded", wantKind: optimus-ide-collabsdk.ChatErrorKindConfig, wantRetry: false},
		{name: "ContextExceededLiteral", err: "context_exceeded", wantKind: optimus-ide-collabsdk.ChatErrorKindConfig, wantRetry: false},
		{name: "MaximumContextLengthLiteral", err: "maximum context length", wantKind: optimus-ide-collabsdk.ChatErrorKindConfig, wantRetry: false},
		{name: "MalformedConfigLiteral", err: "malformed config", wantKind: optimus-ide-collabsdk.ChatErrorKindConfig, wantRetry: false},
		{name: "MalformedConfigurationLiteral", err: "malformed configuration", wantKind: optimus-ide-collabsdk.ChatErrorKindConfig, wantRetry: false},
		{name: "ServerErrorLiteral", err: "server error", wantKind: optimus-ide-collabsdk.ChatErrorKindGeneric, wantRetry: true},
		{name: "InternalServerErrorLiteral", err: "internal server error", wantKind: optimus-ide-collabsdk.ChatErrorKindGeneric, wantRetry: true},
		{name: "ChatInterruptedLiteral", err: "chat interrupted", wantKind: optimus-ide-collabsdk.ChatErrorKindGeneric, wantRetry: false},
		{name: "RequestInterruptedLiteral", err: "request interrupted", wantKind: optimus-ide-collabsdk.ChatErrorKindGeneric, wantRetry: false},
		{name: "OperationInterruptedLiteral", err: "operation interrupted", wantKind: optimus-ide-collabsdk.ChatErrorKindGeneric, wantRetry: false},
		{name: "Status408", err: "status 408", wantKind: optimus-ide-collabsdk.ChatErrorKindTimeout, wantRetry: true},
		{name: "Status500", err: "status 500", wantKind: optimus-ide-collabsdk.ChatErrorKindGeneric, wantRetry: true},
		{name: "ProviderDisabledLiteral", err: "provider_disabled", wantKind: optimus-ide-collabsdk.ChatErrorKindProviderDisabled, wantRetry: false},
	}
...
func TestClassify_TransportFailuresUseBroaderRetryMessage(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			classified := chaterror.Classify(xerrors.New(tt.err))
			require.Equal(t, optimus-ide-collabsdk.ChatErrorKindTimeout, classified.Kind)
...
func TestClassify_HTTP2TransportErrors(t *testing.T) {
	...
	for _, tt := range transportOnly {
		t.Run("TransportOnly/"+tt.name, func(t *testing.T) {
			...
			classified := chaterror.Classify(xerrors.New(tt.err))
			require.Equal(t, optimus-ide-collabsdk.ChatErrorKindTimeout, classified.Kind, "Kind")
...
func TestClassify_UsageLimitBeatsAuth(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantKind:  optimus-ide-collabsdk.ChatErrorKindUsageLimit,
			wantRetry: false,
		},
		{
			name:      "PureAuthStillWorks",
			err:       "unauthorized",
			wantKind:  optimus-ide-collabsdk.ChatErrorKindAuth,
			wantRetry: false,
		},
		{
...
func TestClassify_UsageLimitMatchesStructuredDetail(t *testing.T) {
	...
	require.Equal(t, optimus-ide-collabsdk.ChatErrorKindUsageLimit, classified.Kind)
	require.False(t, classified.Retryable)
...
func TestClassify_UsageLimitPatternsDoNotBeat429(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			classified := chaterror.Classify(tt.err)
			require.Equal(t, optimus-ide-collabsdk.ChatErrorKindRateLimit, classified.Kind)
			require.True(t, classified.Retryable)
			require.Equal(t, 429, classified.StatusCode)
			require.Equal(t, tt.wantProvider, classified.Provider)
		})
...
func TestClassify_StatusCodeBeatsHTTP2Transport(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantKind:      optimus-ide-collabsdk.ChatErrorKindRateLimit,
			wantRetryable: true,
			wantStatus:    429,
		},
		{
...
func TestClassify_MissingKeyPreClassified(t *testing.T) {
	...
	require.Equal(t, optimus-ide-collabsdk.ChatErrorKindMissingKey, classified.Kind)
	require.False(t, classified.Retryable)
