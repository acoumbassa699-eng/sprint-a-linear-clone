...
func TestStreamPartsEndpointReplayLiveAndReselect(t *testing.T) {
	...
	require.NoError(t, buffer.AddPart(firstKey, optimus-ide-collabsdk.ChatMessageRoleAssistant, optimus-ide-collabsdk.ChatMessageText("replayed")))
	require.NoError(t, buffer.CreateEpisode(secondKey))
	require.NoError(t, buffer.AddPart(secondKey, optimus-ide-collabsdk.ChatMessageRoleAssistant, optimus-ide-collabsdk.ChatMessageText("second")))
	...
	require.NoError(t, buffer.AddPart(firstKey, optimus-ide-collabsdk.ChatMessageRoleAssistant, optimus-ide-collabsdk.ChatMessageText("live")))
	got = readStreamPartsTransportBatch(ctx, t, clientTransport)
	require.Len(t, got, 1)
	...
	require.NoError(t, buffer.AddPart(firstKey, optimus-ide-collabsdk.ChatMessageRoleAssistant, optimus-ide-collabsdk.ChatMessageText("ignored")))
	select {
	case <-ctx.Done():
		t.Fatal("timed out waiting to verify previous episode was canceled")
	default:
	}
	require.NoError(t, buffer.AddPart(secondKey, optimus-ide-collabsdk.ChatMessageRoleAssistant, optimus-ide-collabsdk.ChatMessageText("second-live")))
	got = readStreamPartsTransportBatch(ctx, t, clientTransport)
...
func TestStreamPartsEndpointWaitsForMissingEpisode(t *testing.T) {
	...
	require.NoError(t, buffer.AddPart(key, optimus-ide-collabsdk.ChatMessageRoleAssistant, optimus-ide-collabsdk.ChatMessageText("eventual")))
...
func TestStreamPartsEndpointReselectsWhileEpisodeMissing(t *testing.T) {
	...
	require.NoError(t, buffer.AddPart(selectedKey, optimus-ide-collabsdk.ChatMessageRoleAssistant, optimus-ide-collabsdk.ChatMessageText("selected")))
...
func TestStreamPartsEndpointWebSocket(t *testing.T) {
	...
	require.NoError(t, buffer.CreateEpisode(key))
	require.NoError(t, buffer.AddPart(key, optimus-ide-collabsdk.ChatMessageRoleAssistant, optimus-ide-collabsdk.ChatMessageText("websocket")))
...
func TestStreamPartsWebSocketSession(t *testing.T) {
	...
	require.NoError(t, buffer.CreateEpisode(key))
	require.NoError(t, buffer.AddPart(key, optimus-ide-collabsdk.ChatMessageRoleAssistant, optimus-ide-collabsdk.ChatMessageText("session")))
...
func TestLocalStreamPartsDialerReplayLiveAndClose(t *testing.T) {
	...
	require.NoError(t, buffer.CreateEpisode(key))
	require.NoError(t, buffer.AddPart(key, optimus-ide-collabsdk.ChatMessageRoleAssistant, optimus-ide-collabsdk.ChatMessageText("replayed")))
...
func readStreamPartsTransportBatch(ctx context.Context, t *testing.T, transport streamPartsClientTransport) []optimus-ide-collabsdk.ChatStreamEvent {
	t.Helper()
...
func readStreamPartsWebSocketBatch(ctx context.Context, t *testing.T, conn *websocket.Conn) []optimus-ide-collabsdk.ChatStreamEvent {
	t.Helper()
	var got []optimus-ide-collabsdk.ChatStreamEvent
	require.NoError(t, wsjson.Read(ctx, conn, &got))
	assertStreamPartsBatch(t, got)
	return got
}

func assertStreamPartsBatch(t *testing.T, got []optimus-ide-collabsdk.ChatStreamEvent) {
	t.Helper()
