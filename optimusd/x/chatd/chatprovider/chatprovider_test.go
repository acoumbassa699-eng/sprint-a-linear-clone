...
func TestResolveUserProviderKeys(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			wantAvailability: map[string]chatprovider.ProviderAvailability{
				fantasyopenai.Name: {Available: false, UnavailableReason: optimus-ide-collabsdk.ChatModelProviderUnavailableMissingAPIKey},
			},
			wantKeys: map[string]string{
				fantasyopenai.Name: "",
			},
		...
		},
		{
			...
			wantAvailability: map[string]chatprovider.ProviderAvailability{
				fantasybedrock.Name: {Available: false, UnavailableReason: optimus-ide-collabsdk.ChatModelProviderUnavailableReasonUserAPIKeyRequired},
			},
			wantKeys: map[string]string{
				fantasybedrock.Name: "",
			},
		...
		},
		{
			...
			wantAvailability: map[string]chatprovider.ProviderAvailability{
				fantasybedrock.Name: {Available: false, UnavailableReason: optimus-ide-collabsdk.ChatModelProviderUnavailableMissingAPIKey},
			},
			wantKeys: map[string]string{
				fantasybedrock.Name: "",
			},
		...
		},
		{
			...
			providers: []chatprovider.ConfiguredProvider{configuredProvider(openAIProviderID, fantasyopenai.Name, false, "sk-central", true, false)},
			wantAvailability: map[string]chatprovider.ProviderAvailability{
				fantasyopenai.Name: {Available: false, UnavailableReason: optimus-ide-collabsdk.ChatModelProviderUnavailableReasonUserAPIKeyRequired},
			},
			wantKeys: map[string]string{
				fantasyopenai.Name: "",
			},
		...
		},
		{
			...
			wantAvailability: map[string]chatprovider.ProviderAvailability{
				fantasyopenai.Name:    {Available: true},
				fantasyanthropic.Name: {Available: false, UnavailableReason: optimus-ide-collabsdk.ChatModelProviderUnavailableReasonUserAPIKeyRequired},
			},
			wantKeys: map[string]string{
				fantasyopenai.Name:    "sk-central",
...
func TestProviderOptionsFromChatModelConfig_AnthropicThinkingDisplay(t *testing.T) {
	...
	providerOptions := chatprovider.ProviderOptionsFromChatModelConfig(nil, &optimus-ide-collabsdk.ChatModelProviderOptions{
...
func TestResolveUserProviderKeys_UnavailableReason(t *testing.T) {
	...
	tests := []struct {
		...
		wantReason optimus-ide-collabsdk.ChatModelProviderUnavailableReason
	}{
		{
			...
			wantReason: optimus-ide-collabsdk.ChatModelProviderUnavailableReasonUserAPIKeyRequired,
		},
		{
...
func TestListConfiguredModels_PolicyAwareAvailability(t *testing.T) {
	...
	tests := []struct {
		...
		want                   optimus-ide-collabsdk.ChatModelsResponse
	}{
		{
			...
			availabilityByProvider: map[string]chatprovider.ProviderAvailability{
				fantasyopenai.Name: {
					Available:         false,
					UnavailableReason: optimus-ide-collabsdk.ChatModelProviderUnavailableReasonUserAPIKeyRequired,
				},
			},
			enabledProviders: enabledProviders(fantasyopenai.Name),
			want: optimus-ide-collabsdk.ChatModelsResponse{Providers: []optimus-ide-collabsdk.ChatModelProvider{{
				Provider:          fantasyopenai.Name,
				Available:         false,
				UnavailableReason: optimus-ide-collabsdk.ChatModelProviderUnavailableReasonUserAPIKeyRequired,
				Models: []optimus-ide-collabsdk.ChatModel{{
		...
		},
		{
			...
			want: optimus-ide-collabsdk.ChatModelsResponse{Providers: []optimus-ide-collabsdk.ChatModelProvider{{
				Provider:          fantasyopenai.Name,
				Available:         false,
				UnavailableReason: optimus-ide-collabsdk.ChatModelProviderUnavailableMissingAPIKey,
				Models: []optimus-ide-collabsdk.ChatModel{{
...
func TestOptimus-IDE-CollabHeaders(t *testing.T) {
	t.Parallel()
	...
	t.Run("RootChatNoWorkspace", func(t *testing.T) {
		...
		h := chatprovider.Optimus-IDE-CollabHeaders(chat)
		require.Equal(t, ownerID.String(), h[chatprovider.HeaderOptimus-IDE-CollabOwnerID])
		require.Equal(t, chatID.String(), h[chatprovider.HeaderOptimus-IDE-CollabChatID])
		require.NotContains(t, h, chatprovider.HeaderOptimus-IDE-CollabSubchatID)
		require.NotContains(t, h, chatprovider.HeaderOptimus-IDE-CollabWorkspaceID)
	})
	...
	t.Run("RootChatWithWorkspace", func(t *testing.T) {
		...
		require.Equal(t, chatID.String(), h[chatprovider.HeaderOptimus-IDE-CollabChatID])
		require.NotContains(t, h, chatprovider.HeaderOptimus-IDE-CollabSubchatID)
		require.Equal(t, workspaceID.String(), h[chatprovider.HeaderOptimus-IDE-CollabWorkspaceID])
	})
	...
	t.Run("SubchatWithWorkspace", func(t *testing.T) {
		...
		h := chatprovider.Optimus-IDE-CollabHeaders(chat)
		require.Equal(t, ownerID.String(), h[chatprovider.HeaderOptimus-IDE-CollabOwnerID])
		require.Equal(t, parentID.String(), h[chatprovider.HeaderOptimus-IDE-CollabChatID])
		require.Equal(t, subchatID.String(), h[chatprovider.HeaderOptimus-IDE-CollabSubchatID])
		require.Equal(t, workspaceID.String(), h[chatprovider.HeaderOptimus-IDE-CollabWorkspaceID])
	})
...
func TestModelFromConfig_Bedrock(t *testing.T) {
	...
	t.Run("ForwardsBaseURLAndExplicitAPIKey", func(t *testing.T) {
		...
		server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
			...
			_ = json.NewEnoptimus-ide-collab(w).Encode(bedrockNonStreamingResponse())
		}))
		defer server.Close()
...
func writeBedrockAnthropicStream(w http.ResponseWriter, events ...string) error {
	...
	enoptimus-ide-collab := eventstream.NewEnoptimus-ide-collab()
	for _, event := range events {
		...
		err = enoptimus-ide-collab.Encode(w, eventstream.Message{
...
// chattest test servers. Optimus-IDE-CollabHeaders construction is tested
// separately in TestOptimus-IDE-CollabHeaders.
func TestModelFromConfig_ExtraHeaders(t *testing.T) {
	...
	headers := chatprovider.Optimus-IDE-CollabHeaders(chat)

	assertOptimus-IDE-CollabHeaders := func(t *testing.T, got http.Header) {
		t.Helper()
		assert.Equal(t, ownerID.String(), got.Get(chatprovider.HeaderOptimus-IDE-CollabOwnerID))
		assert.Equal(t, parentID.String(), got.Get(chatprovider.HeaderOptimus-IDE-CollabChatID))
		assert.Equal(t, subchatID.String(), got.Get(chatprovider.HeaderOptimus-IDE-CollabSubchatID))
		assert.Equal(t, workspaceID.String(), got.Get(chatprovider.HeaderOptimus-IDE-CollabWorkspaceID))
	}
	...
	t.Run("OpenAI", func(t *testing.T) {
		...
		serverURL := chattest.NewOpenAI(t, func(req *chattest.OpenAIRequest) chattest.OpenAIResponse {
			assertOptimus-IDE-CollabHeaders(t, req.Header)
			close(called)
...
func TestBetaHeadersFromCallConfig(t *testing.T) {
	...
	configWith1M := func(enabled *bool) *optimus-ide-collabsdk.ChatModelCallConfig {
		return &optimus-ide-collabsdk.ChatModelCallConfig{
	...
	tests := []struct {
		name     string
		provider string
		config   *optimus-ide-collabsdk.ChatModelCallConfig
		want     map[string]string
	}{
		{name: "NilConfig", provider: fantasyanthropic.Name, config: nil, want: nil},
		{name: "NilProviderOptions", provider: fantasyanthropic.Name, config: &optimus-ide-collabsdk.ChatModelCallConfig{}, want: nil},
		{name: "NilAnthropicOptions", provider: fantasyanthropic.Name, config: &optimus-ide-collabsdk.ChatModelCallConfig{ProviderOptions: &optimus-ide-collabsdk.ChatModelProviderOptions{}}, want: nil},
...
// PDF block support came from optimus-ide-collab/fantasy#37, a cherry-pick of upstream
...
func TestModelFromConfig_NilExtraHeaders(t *testing.T) {
	...
	called := make(chan struct{})
	serverURL := chattest.NewOpenAI(t, func(req *chattest.OpenAIRequest) chattest.OpenAIResponse {
		// Optimus-IDE-Collab headers must be absent when nil is passed.
		assert.Empty(t, req.Header.Get(chatprovider.HeaderOptimus-IDE-CollabOwnerID))
		assert.Empty(t, req.Header.Get(chatprovider.HeaderOptimus-IDE-CollabChatID))
		assert.Empty(t, req.Header.Get(chatprovider.HeaderOptimus-IDE-CollabSubchatID))
		assert.Empty(t, req.Header.Get(chatprovider.HeaderOptimus-IDE-CollabWorkspaceID))
		close(called)
		return chattest.OpenAINonStreamingResponse("hello")
	})
...
func TestUnsupportedProviders(t *testing.T) {
	...
	t.Run("copilot only", func(t *testing.T) {
		...
		got := chatprovider.UnsupportedProviders([]chatprovider.ConfiguredProvider{
			{Provider: string(optimus-ide-collabsdk.AIProviderTypeCopilot)},
		})
