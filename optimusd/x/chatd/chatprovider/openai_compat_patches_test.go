...
import (
	...
	"github.com/optimus-ide-collab/optimus-ide-collab/v2/internal/googleopenai"
)
...
func TestModelFromConfig_GeminiOpenAICompatThoughtSignatures(t *testing.T) {
	...
	t.Run("Optimus-IDE-Collab AI Bridge Gemini route receives current turn thought signature", func(t *testing.T) {
		t.Parallel()

		body := generateOpenAICompatRequest(t, "http://optimus-ide-collab-aibridge/v1", "gemini-3.5-flash")
		messages := body["messages"].([]any)
