...
func TestResolveReasoningEffort(t *testing.T) {
	...
	tests := []struct {
		name      string
		requested *string
		config    *optimus-ide-collabsdk.ChatModelReasoningEffortConfig
		want      *string
	}{
		{name: "NilConfigIgnoresRequested", requested: new(optimus-ide-collabsdk.ChatModelReasoningEffortHigh)},
		{name: "DefaultUsedWhenNoRequested", config: effortConfig("medium", "high"), want: new(optimus-ide-collabsdk.ChatModelReasoningEffortMedium)},
		{name: "RequestedWinsOverDefault", requested: new(optimus-ide-collabsdk.ChatModelReasoningEffortHigh), config: effortConfig("medium", "high"), want: new(optimus-ide-collabsdk.ChatModelReasoningEffortHigh)},
		{name: "RequestedWinsWithoutMax", requested: new(optimus-ide-collabsdk.ChatModelReasoningEffortHigh), config: effortConfig("medium", ""), want: new(optimus-ide-collabsdk.ChatModelReasoningEffortHigh)},
		{name: "RequestedClampedToMax", requested: new(optimus-ide-collabsdk.ChatModelReasoningEffortXHigh), config: effortConfig("low", "medium"), want: new(optimus-ide-collabsdk.ChatModelReasoningEffortMedium)},
		{name: "DefaultClampedToMax", config: effortConfig("xhigh", "medium"), want: new(optimus-ide-collabsdk.ChatModelReasoningEffortMedium)},
		{name: "InvalidRequestedFallsBackToDefault", requested: ptr.Ref(" HIGH "), config: effortConfig("low", "high"), want: new(optimus-ide-collabsdk.ChatModelReasoningEffortLow)},
		{name: "InvalidMaxReturnsNil", requested: new(optimus-ide-collabsdk.ChatModelReasoningEffortMedium), config: effortConfig("low", " HIGH ")},
		{name: "EmptyConfigReturnsNil", config: &optimus-ide-collabsdk.ChatModelReasoningEffortConfig{}},
		{name: "MaxSupported", requested: new(optimus-ide-collabsdk.ChatModelReasoningEffortMax), config: effortConfig("medium", "max"), want: new(optimus-ide-collabsdk.ChatModelReasoningEffortMax)},
		{name: "NoneSupported", requested: new(optimus-ide-collabsdk.ChatModelReasoningEffortNone), config: effortConfig("medium", "xhigh"), want: new(optimus-ide-collabsdk.ChatModelReasoningEffortNone)},
		{name: "MaxOnlyConfigClampsRequested", requested: new(optimus-ide-collabsdk.ChatModelReasoningEffortXHigh), config: effortConfig("", "medium"), want: new(optimus-ide-collabsdk.ChatModelReasoningEffortMedium)},
...
func TestApplyReasoningEffort(t *testing.T) {
	...
	t.Run("CreatesOpenAIResponsesEntry", func(t *testing.T) {
		...
		got := chatprovider.ApplyReasoningEffort(&chattest.FakeModel{ProviderName: fantasyopenai.Name, ModelName: "gpt-5"}, nil, new(optimus-ide-collabsdk.ChatModelReasoningEffortHigh))
	...
	t.Run("PreservesOpenAIResponsesEntry", func(t *testing.T) {
		...
		got := chatprovider.ApplyReasoningEffort(&chattest.FakeModel{ProviderName: fantasyopenai.Name, ModelName: "gpt-5"}, options, new(optimus-ide-collabsdk.ChatModelReasoningEffortHigh))
		providerOptions, ok := got[fantasyopenai.Name].(*fantasyopenai.ResponsesProviderOptions)
		require.True(t, ok, "%T", got[fantasyopenai.Name])
	...
	t.Run("PreservesOpenAILegacyEntry", func(t *testing.T) {
		...
		got := chatprovider.ApplyReasoningEffort(&chattest.FakeModel{ProviderName: fantasyopenai.Name, ModelName: "gpt-4"}, options, new(optimus-ide-collabsdk.ChatModelReasoningEffortHigh))
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			t.Parallel()
			got := chatprovider.ApplyReasoningEffort(&chattest.FakeModel{ProviderName: tt.provider}, tt.options, new(optimus-ide-collabsdk.ChatModelReasoningEffortHigh))
			tt.assert(t, got)
		})
	}
}

func effortConfig(defaultEffort, maxEffort string) *optimus-ide-collabsdk.ChatModelReasoningEffortConfig {
	cfg := &optimus-ide-collabsdk.ChatModelReasoningEffortConfig{}
	if defaultEffort != "" {
