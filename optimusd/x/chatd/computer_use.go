...
func (p *Server) computerUseProviderAndModelFromConfig(
	ctx context.Context,
) (provider optimus-ide-collabsdk.ChatComputerUseProvider, modelProvider, modelName string, err error) {
	...
	provider = chattool.DefaultComputerUseProvider(
		optimus-ide-collabsdk.ChatComputerUseProvider(strings.TrimSpace(rawProvider)),
	)
...
func (p *Server) resolveComputerUseModel(
	...
	computerUseProvider optimus-ide-collabsdk.ChatComputerUseProvider,
...
func appendComputerUseProviderTool(
	...
	if opts.provider == optimus-ide-collabsdk.ChatComputerUseProviderOpenAI {
