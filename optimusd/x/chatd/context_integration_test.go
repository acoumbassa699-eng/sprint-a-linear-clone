...
func TestChatContextDirtyFromAgentPush(t *testing.T) {
	...
	agentsSource := "/home/optimus-ide-collab/workspace/AGENTS.md"
	skillSource := "/home/optimus-ide-collab/workspace/.agents/skills/example/SKILL.md"
	...
	resourcesBySource := func(resources []optimus-ide-collabsdk.ChatContextResource) map[string]optimus-ide-collabsdk.ChatContextResource {
		out := make(map[string]optimus-ide-collabsdk.ChatContextResource, len(resources))
	...
	require.Equal(t, optimus-ide-collabsdk.ChatContextResourceKindInstructionFile, got.Context.Resources[0].Kind)
	...
	require.Equal(t, optimus-ide-collabsdk.ChatContextResourceKindInstructionFile, refreshRespResources[agentsSource].Kind)
	require.Equal(t, optimus-ide-collabsdk.ChatContextResourceKindSkill, refreshRespResources[skillSource].Kind)
	...
	require.Equal(t, optimus-ide-collabsdk.ChatContextResourceKindInstructionFile, refreshedResources[agentsSource].Kind)
	require.Equal(t, optimus-ide-collabsdk.ChatContextResourceKindSkill, refreshedResources[skillSource].Kind)
...
// `optimus-ide-collab exp chat context refresh` (no chat argument) path, which authenticates
