...
func TestWorker_AutoArchiveDisabled(t *testing.T) {
	...
	require.NoError(t, f.db.UpsertChatAutoArchiveDays(ctx, optimus-ide-collabsdk.DefaultChatAutoArchiveDays))
...
func TestWorker_AutoArchivesInactiveRoot(t *testing.T) {
	...
	requireWatchEvent(t, pubsub, chat.ID, optimus-ide-collabsdk.ChatWatchEventKindDeleted)
...
func TestWorker_AutoArchivePublishesStateUpdatesForFamily(t *testing.T) {
	...
	requireWatchEvent(t, pubsub, root.ID, optimus-ide-collabsdk.ChatWatchEventKindDeleted)
	requireWatchEvent(t, pubsub, child.ID, optimus-ide-collabsdk.ChatWatchEventKindDeleted)
}
...
func TestWorker_AutoArchiveExpectedTransitionFailureDoesNotAbortTick(t *testing.T) {
	...
	requireWatchEvent(t, pubsub, valid.ID, optimus-ide-collabsdk.ChatWatchEventKindDeleted)
}
...
func requireWatchEvent(t *testing.T, pubsub *recordingPubsub, chatID uuid.UUID, kind optimus-ide-collabsdk.ChatWatchEventKind) {
	t.Helper()
