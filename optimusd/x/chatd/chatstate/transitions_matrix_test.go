...
func applyEditMessage(t *testing.T, f *testFixture, tx *chatstate.Tx, seeded seededChat, _ chatstate.ExecutionState, result *transitionCaseResult) error {
	t.Helper()
	content := mustMarshalParts(t, []optimus-ide-collabsdk.ChatMessagePart{optimus-ide-collabsdk.ChatMessageText("edited")})
	var err error
...
func mustMarshalParts(t *testing.T, parts []optimus-ide-collabsdk.ChatMessagePart) pqtype.NullRawMessage {
	t.Helper()
