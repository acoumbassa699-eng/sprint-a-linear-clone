...
// OpenAI scroll deltas are pixels, but Optimus-IDE-Collab desktop scroll amounts are
// wheel clicks.
const computerUseScrollPixelsPerWheelClick int64 = 100

// ComputerUseDesktopAction is a Optimus-IDE-Collab desktop operation requested by an
...
// Optimus-IDE-Collab desktop actions. A caller should execute the returned actions in order,
...
// DoubleClickAction maps an OpenAI computer-use double-click button to a Optimus-IDE-Collab
...
// ComputerUseClickAction maps an OpenAI computer-use click button to a Optimus-IDE-Collab
// desktop action name.
...
// NormalizeComputerUseKeys maps OpenAI keypress tokens to Optimus-IDE-Collab desktop key
// action tokens.
