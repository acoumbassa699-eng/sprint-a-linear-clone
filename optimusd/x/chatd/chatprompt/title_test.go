...
func TestTitleText(t *testing.T) {
	...
	syntheticPasteFile := func(id uuid.UUID) optimus-ide-collabsdk.ChatMessagePart {
		return optimus-ide-collabsdk.ChatMessageFile(id, "text/plain", "pasted-text-2026-01-02-03-04-05.txt")
	}
	...
	tests := []struct {
	...
	}{
		{
			...
			parts: []optimus-ide-collabsdk.ChatMessagePart{
				optimus-ide-collabsdk.ChatMessageText("  fix the flaky test  "),
				optimus-ide-collabsdk.ChatMessageReasoning("skip me"),
				optimus-ide-collabsdk.ChatMessageText(" in optimus-ide-collabd "),
			},
			want: "fix the flaky test in optimus-ide-collabd",
		},
		{
			name: "formats file reference with line range and content fence",
			parts: []optimus-ide-collabsdk.ChatMessagePart{
				optimus-ide-collabsdk.ChatMessageFileReference("main.go", 3, 7, "fmt.Println(\"hi\")\n"),
			},
		...
		},
		{
			...
			parts: []optimus-ide-collabsdk.ChatMessagePart{
				optimus-ide-collabsdk.ChatMessageFileReference("main.go", 3, 3, "   "),
			},
		...
		},
		{
			...
			parts: []optimus-ide-collabsdk.ChatMessagePart{
				optimus-ide-collabsdk.ChatMessageText("explain this"),
				optimus-ide-collabsdk.ChatMessageFileReference("app.ts", 1, 1, ""),
			},
		...
		},
		{
			...
			parts: []optimus-ide-collabsdk.ChatMessagePart{
				optimus-ide-collabsdk.ChatMessageText("typed context"),
				syntheticPasteFile(pasteFileID),
			},
...
func TestSyntheticPasteFileIDs(t *testing.T) {
	...
	noIDPart := optimus-ide-collabsdk.ChatMessagePart{
	...
	tests := []struct {
	...
	}{
		{
			...
			parts: []optimus-ide-collabsdk.ChatMessagePart{
				...
				optimus-ide-collabsdk.ChatMessageFile(pasteFileID, "text/plain", "pasted-text-2026-01-02-03-04-05.txt"),
				optimus-ide-collabsdk.ChatMessageFile(otherPasteFileID, "text/plain; charset=utf-8", "pasted-text-2026-12-31-23-59-59.txt"),
			},
		...
		},
		{
			...
			parts: []optimus-ide-collabsdk.ChatMessagePart{
				optimus-ide-collabsdk.ChatMessageFile(uuid.New(), "text/plain", "notes.txt"),
			},
			want: nil,
		},
		{
			...
			parts: []optimus-ide-collabsdk.ChatMessagePart{
				optimus-ide-collabsdk.ChatMessageFile(uuid.New(), "image/png", "pasted-text-2026-01-02-03-04-05.txt"),
			},
			want: nil,
		},
		{
			name:  "skips file parts without a file id",
			parts: []optimus-ide-collabsdk.ChatMessagePart{noIDPart},
			want:  nil,
		},
	}
