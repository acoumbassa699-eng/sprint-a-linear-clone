...
func TestRenderPlanPathPrompt(t *testing.T) {
	...
	t.Run("ReplacesPlaceholderWithResolvedHome", func(t *testing.T) {
		...
		require.Contains(t, text, "Your plan file path for this chat is: /Users/dev/.optimus-ide-collab/plans/PLAN-chat.md")
...
func TestFormatSystemInstructions(t *testing.T) {
	...
	t.Run("HomeAndPwdWithAgentContext", func(t *testing.T) {
		t.Parallel()
		got := formatSystemInstructions("linux", "/home/optimus-ide-collab/project", []optimus-ide-collabsdk.ChatMessagePart{
			{Type: optimus-ide-collabsdk.ChatMessagePartTypeContextFile, ContextFileContent: "home rules", ContextFilePath: "/home/optimus-ide-collab/.optimus-ide-collab/AGENTS.md"},
			{Type: optimus-ide-collabsdk.ChatMessagePartTypeContextFile, ContextFileContent: "project rules", ContextFilePath: "/home/optimus-ide-collab/project/AGENTS.md"},
		})
		require.Contains(t, got, "Operating System: linux")
		require.Contains(t, got, "Working Directory: /home/optimus-ide-collab/project")
		require.Contains(t, got, "Source: /home/optimus-ide-collab/.optimus-ide-collab/AGENTS.md")
		require.Contains(t, got, "home rules")
		require.Contains(t, got, "Source: /home/optimus-ide-collab/project/AGENTS.md")
	...
	t.Run("OnlyPwdFile", func(t *testing.T) {
		t.Parallel()
		got := formatSystemInstructions("", "/home/optimus-ide-collab/project", []optimus-ide-collabsdk.ChatMessagePart{
			{Type: optimus-ide-collabsdk.ChatMessagePartTypeContextFile, ContextFileContent: "project rules", ContextFilePath: "/home/optimus-ide-collab/project/AGENTS.md"},
		})
		require.Contains(t, got, "project rules")
		require.Contains(t, got, "Source: /home/optimus-ide-collab/project/AGENTS.md")
		require.NotContains(t, got, ".optimus-ide-collab/AGENTS.md")
	})
	...
	t.Run("OnlyHomeFile", func(t *testing.T) {
		t.Parallel()
		got := formatSystemInstructions("", "", []optimus-ide-collabsdk.ChatMessagePart{
			{Type: optimus-ide-collabsdk.ChatMessagePartTypeContextFile, ContextFileContent: "home rules", ContextFilePath: "~/.optimus-ide-collab/AGENTS.md"},
		})
		require.Contains(t, got, "Source: ~/.optimus-ide-collab/AGENTS.md")
		require.Contains(t, got, "home rules")
	...
	t.Run("TruncatedFile", func(t *testing.T) {
		t.Parallel()
		got := formatSystemInstructions("windows", "", []optimus-ide-collabsdk.ChatMessagePart{
			{Type: optimus-ide-collabsdk.ChatMessagePartTypeContextFile, ContextFileContent: "rules", ContextFilePath: "/path/AGENTS.md", ContextFileTruncated: true},
		})
	...
	t.Run("AgentContextBeforeFiles", func(t *testing.T) {
		t.Parallel()
		got := formatSystemInstructions("linux", "/home/project", []optimus-ide-collabsdk.ChatMessagePart{
			{Type: optimus-ide-collabsdk.ChatMessagePartTypeContextFile, ContextFileContent: "home", ContextFilePath: "/home/.optimus-ide-collab/AGENTS.md"},
			{Type: optimus-ide-collabsdk.ChatMessagePartTypeContextFile, ContextFileContent: "pwd", ContextFilePath: "/home/project/AGENTS.md"},
		})
		osIdx := strings.Index(got, "Operating System:")
		dirIdx := strings.Index(got, "Working Directory:")
		homeSourceIdx := strings.Index(got, "Source: /home/.optimus-ide-collab/AGENTS.md")
	...
	t.Run("EmptySectionsIgnored", func(t *testing.T) {
		t.Parallel()
		got := formatSystemInstructions("linux", "", []optimus-ide-collabsdk.ChatMessagePart{
			{Type: optimus-ide-collabsdk.ChatMessagePartTypeContextFile, ContextFileContent: "", ContextFilePath: "/empty"},
			{Type: optimus-ide-collabsdk.ChatMessagePartTypeContextFile, ContextFileContent: "real", ContextFilePath: "/real/AGENTS.md"},
		})
