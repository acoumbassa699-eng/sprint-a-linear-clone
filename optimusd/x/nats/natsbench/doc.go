// Command natsbench benchmarks Optimus-IDE-Collab's NATS-backed pubsub
// (github.com/optimus-ide-collab/optimus-ide-collab/v2/optimus-ide-collabd/x/nats) under high fan-out load.
//
...
// Correctness rules:
//
//   - Production defaults: the benchmark measures the pubsub as Optimus-IDE-Collab
