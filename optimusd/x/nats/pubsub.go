...
const (
	defaultClusterName   = "optimus-ide-collab"
...
func New(ctx context.Context, logger slog.Logger, opts Options) (pubSub *Pubsub, retErr error) {
	...
	publishPool, err := newConnPool(ns, opts, handlers, opts.PublishConns, "optimus-ide-collab-pubsub-pub")
	if err != nil {
		return nil, err
	}
	defer func() {
	...
	subscribePool, err := newConnPool(ns, opts, handlers, opts.SubscribeConns, "optimus-ide-collab-pubsub-sub")
	if err != nil {
		return nil, err
	}
	defer func() {
