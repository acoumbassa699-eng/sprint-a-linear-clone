...
// @Produce json
// @Tags Notifications
// @Success 200 {object} optimus-ide-collabsdk.NotificationsSettings
...
// @Produce json
// @Tags Notifications
// @Param request body optimus-ide-collabsdk.NotificationsSettings true "Notifications settings request"
// @Success 200 {object} optimus-ide-collabsdk.NotificationsSettings
// @Success 304
...
// @Produce json
// @Tags Notifications
// @Success 200 {array} optimus-ide-collabsdk.NotificationTemplate
// @Failure 500 {object} optimus-ide-collabsdk.Response "Failed to retrieve 'system' notifications template"
...
// @Tags Notifications
// @Success 200 {array} optimus-ide-collabsdk.NotificationTemplate
// @Failure 500 {object} optimus-ide-collabsdk.Response "Failed to retrieve 'custom' notifications template"
...
// @Produce json
// @Tags Notifications
// @Success 200 {array} optimus-ide-collabsdk.NotificationMethodsResponse
...
func (api *API) notificationDispatchMethods(rw http.ResponseWriter, r *http.Request) {
	...
	httpapi.Write(r.Context(), rw, http.StatusOK, optimus-ide-collabsdk.NotificationMethodsResponse{
...
// @Success 200 {array} optimus-ide-collabsdk.NotificationPreference
...
// @Produce json
// @Tags Notifications
// @Param request body optimus-ide-collabsdk.UpdateUserNotificationPreferences true "Preferences"
// @Param user path string true "User ID, name, or me"
// @Success 200 {array} optimus-ide-collabsdk.NotificationPreference
...
func (api *API) putUserNotificationPreferences(rw http.ResponseWriter, r *http.Request) {
	...
	// Parse request.
	var prefs optimus-ide-collabsdk.UpdateUserNotificationPreferences
...
// @Accept json
// @Produce json
// @Param request body optimus-ide-collabsdk.CustomNotificationRequest true "Provide a non-empty title or message"
// @Success 204 "No Content"
// @Failure 400 {object} optimus-ide-collabsdk.Response "Invalid request body"
// @Failure 403 {object} optimus-ide-collabsdk.Response "System users cannot send custom notifications"
// @Failure 500 {object} optimus-ide-collabsdk.Response "Failed to send custom notification"
...
func (api *API) postCustomNotification(rw http.ResponseWriter, r *http.Request) {
	...
	// Parse request
	var req optimus-ide-collabsdk.CustomNotificationRequest
...
func convertNotificationTemplates(in []database.NotificationTemplate) (out []optimus-ide-collabsdk.NotificationTemplate) {
	for _, tmpl := range in {
		out = append(out, optimus-ide-collabsdk.NotificationTemplate{
			ID:               tmpl.ID,
			Name:             tmpl.Name,
...
func convertNotificationPreferences(in []database.NotificationPreference) (out []optimus-ide-collabsdk.NotificationPreference) {
	for _, pref := range in {
		out = append(out, optimus-ide-collabsdk.NotificationPreference{
