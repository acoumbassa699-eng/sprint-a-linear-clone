...
import (
	...
	"cdr.dev/slog/v3"
	archivefs "github.com/optimus-ide-collab/optimus-ide-collab/v2/archive/fs"
	...
	"github.com/optimus-ide-collab/optimus-ide-collab/v2/provisioner/terraform/tfparse"
...
// @Success 200 {object} optimus-ide-collabsdk.TemplateVersion
...
func (api *API) templateVersion(rw http.ResponseWriter, r *http.Request) {
	...
	var matchedProvisioners *optimus-ide-collabsdk.MatchedProvisioners
	...
	var warnings []optimus-ide-collabsdk.TemplateVersionWarning
	if len(schemas) > 0 {
		warnings = append(warnings, optimus-ide-collabsdk.TemplateVersionWarningUnsupportedWorkspaces)
	}
...
// @Tags Templates
// @Param templateversion path string true "Template version ID" format(uuid)
// @Param request body optimus-ide-collabsdk.PatchTemplateVersionRequest true "Patch template version request"
// @Success 200 {object} optimus-ide-collabsdk.TemplateVersion
...
func (api *API) patchTemplateVersion(rw http.ResponseWriter, r *http.Request) {
	...
	var params optimus-ide-collabsdk.PatchTemplateVersionRequest
...
// @Tags Templates
// @Param templateversion path string true "Template version ID" format(uuid)
// @Success 200 {array} optimus-ide-collabsdk.TemplateVersionParameter
...
// @Success 200 {array} optimus-ide-collabsdk.TemplateVersionExternalAuth
...
func (api *API) templateVersionExternalAuth(rw http.ResponseWriter, r *http.Request) {
	...
	externalAuthCtx := ctx
	if q := r.URL.Query().Get("user_id"); q != "" && q != optimus-ide-collabsdk.Me {
		id, err := uuid.Parse(q)
		if err != nil {
			httpapi.Write(ctx, rw, http.StatusBadRequest, optimus-ide-collabsdk.Response{
...
// response.
func (api *API) templateVersionExternalAuthForUser(ctx context.Context, templateVersion database.TemplateVersion, userID uuid.UUID) ([]optimus-ide-collabsdk.TemplateVersionExternalAuth, error) {
	var rawProviders []database.ExternalAuthProvider
	err := json.Unmarshal(templateVersion.ExternalAuthProviders, &rawProviders)
	if err != nil {
		return nil, httperror.NewResponseError(http.StatusInternalServerError, optimus-ide-collabsdk.Response{
			Message: "Internal error reading auth config from database",
			Detail:  err.Error(),
		})
	}

	providers := make([]optimus-ide-collabsdk.TemplateVersionExternalAuth, 0)
	for _, rawProvider := range rawProviders {
		...
		if config == nil {
			return nil, httperror.NewResponseError(http.StatusNotFound, optimus-ide-collabsdk.Response{
		...
		provider := optimus-ide-collabsdk.TemplateVersionExternalAuth{
			ID:              config.ID,
			Type:            config.Type,
...
// @Tags Templates
// @Param templateversion path string true "Template version ID" format(uuid)
// @Success 200 {array} optimus-ide-collabsdk.TemplateVersionVariable
...
// @Tags Templates
// @Param templateversion path string true "Template version ID" format(uuid)
// @Param request body optimus-ide-collabsdk.CreateTemplateVersionDryRunRequest true "Dry-run request"
// @Success 201 {object} optimus-ide-collabsdk.ProvisionerJob
...
func (api *API) postTemplateVersionDryRun(rw http.ResponseWriter, r *http.Request) {
	...
	var req optimus-ide-collabsdk.CreateTemplateVersionDryRunRequest
...
// @Success 200 {object} optimus-ide-collabsdk.ProvisionerJob
...
// @Param templateversion path string true "Template version ID" format(uuid)
// @Param jobID path string true "Job ID" format(uuid)
// @Success 200 {object} optimus-ide-collabsdk.MatchedProvisioners
...
// @Param templateversion path string true "Template version ID" format(uuid)
// @Param jobID path string true "Job ID" format(uuid)
// @Success 200 {array} optimus-ide-collabsdk.WorkspaceResource
...
// @Success 200 {array} optimus-ide-collabsdk.TemplateVersion
...
func (api *API) templateVersionsByTemplate(rw http.ResponseWriter, r *http.Request) {
	...
	var err error
	apiVersions := []optimus-ide-collabsdk.TemplateVersion{}
...
// @Tags Templates
// @Param template path string true "Template ID" format(uuid)
// @Param request body optimus-ide-collabsdk.ArchiveTemplateVersionsRequest true "Archive request"
// @Success 200 {object} optimus-ide-collabsdk.Response
...
func (api *API) postArchiveTemplateVersions(rw http.ResponseWriter, r *http.Request) {
	...
	var req optimus-ide-collabsdk.ArchiveTemplateVersionsRequest
	if !httpapi.Read(ctx, rw, r, &req) {
		return
	}
	...
	httpapi.Write(ctx, rw, http.StatusOK, optimus-ide-collabsdk.ArchiveTemplateVersionsResponse{
		TemplateID:  template.ID,
...
// @Produce json
// @Tags Templates
// @Param request body optimus-ide-collabsdk.UpdateActiveTemplateVersion true "Modified template version"
// @Param template path string true "Template ID" format(uuid)
// @Success 200 {object} optimus-ide-collabsdk.Response
...
func (api *API) patchActiveTemplateVersion(rw http.ResponseWriter, r *http.Request) {
	...
	var req optimus-ide-collabsdk.UpdateActiveTemplateVersion
	if !httpapi.Read(ctx, rw, r, &req) {
		return
	}
...
// @Tags Templates
// @Param organization path string true "Organization ID" format(uuid)
// @Param request body optimus-ide-collabsdk.CreateTemplateVersionRequest true "Create template version request"
// @Success 201 {object} optimus-ide-collabsdk.TemplateVersion
...
func (api *API) postTemplateVersionsByOrganization(rw http.ResponseWriter, r *http.Request) {
	...
	// Ensure the "owner" tag is properly applied in addition to request tags and optimus-ide-collab_workspace_tags.
	// User-specified tags in the request will take precedence over tags parsed from `optimus-ide-collab_workspace_tags`
...
func (api *API) dynamicTemplateVersionTags(ctx context.Context, rw http.ResponseWriter, orgID uuid.UUID, owner uuid.UUID, file database.File, templateVariables []optimus-ide-collabsdk.VariableValue) (map[string]string, bool) {
...
// provisioned, each resource can have an agent that dials back to optimus-ide-collabd. The
...
func convertTemplateVersion(version database.TemplateVersion, job optimus-ide-collabsdk.ProvisionerJob, matchedProvisioners *optimus-ide-collabsdk.MatchedProvisioners, warnings []optimus-ide-collabsdk.TemplateVersionWarning) optimus-ide-collabsdk.TemplateVersion {
	return optimus-ide-collabsdk.TemplateVersion{
		...
		CreatedBy: optimus-ide-collabsdk.MinimalUser{
...
func convertTemplateVersionVariables(dbVariables []database.TemplateVersionVariable) []optimus-ide-collabsdk.TemplateVersionVariable {
	variables := make([]optimus-ide-collabsdk.TemplateVersionVariable, 0)
...
func convertTemplateVersionVariable(variable database.TemplateVersionVariable) optimus-ide-collabsdk.TemplateVersionVariable {
	templateVariable := optimus-ide-collabsdk.TemplateVersionVariable{
		Name:         variable.Name,
