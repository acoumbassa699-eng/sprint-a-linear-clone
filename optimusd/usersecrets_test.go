...
func TestPostUserSecret(t *testing.T) {
	...
	t.Run("Optimus-IDE-CollabPrefixEnvName", func(t *testing.T) {
		t.Parallel()
		ctx := testutil.Context(t, testutil.WaitMedium)

		_, err := client.CreateUserSecret(ctx, optimus-ide-collabsdk.Me, optimus-ide-collabsdk.CreateUserSecretRequest{
			Name:    "optimus-ide-collab-prefix-secret",
			Value:   "value",
			EnvName: "OPTIMUS-IDE-COLLAB_AGENT_TOKEN",
		})
		requireSecretValidationContainsError(t, err, http.StatusBadRequest, "env_name", "OPTIMUS-IDE-COLLAB_")
	})
	...
	t.Run("OversizedValue", func(t *testing.T) {
		...
		_, err := client.CreateUserSecret(ctx, optimus-ide-collabsdk.Me, optimus-ide-collabsdk.CreateUserSecretRequest{
			...
			Value: strings.Repeat("a", optimus-ide-collabsdk.MaxUserSecretValueBytes+1),
		})
...
func TestPostUserSecretForbiddenForAnotherUser(t *testing.T) {
	...
	memberClient, _ := optimus-ide-collabdtest.CreateAnotherUser(t, client, owner.OrganizationID, rbac.RoleAuditor())
	ctx := testutil.Context(t, testutil.WaitMedium)

	_, err := memberClient.CreateUserSecret(ctx, owner.UserID.String(), optimus-ide-collabsdk.CreateUserSecretRequest{
		Name:    "forbidden",
		Value:   "value",
		EnvName: "FORBIDDEN",
	})
...
func TestGetUserSecrets(t *testing.T) {
	...
	ctx := testutil.Context(t, testutil.WaitMedium)
	secrets, err := client.UserSecrets(ctx, optimus-ide-collabsdk.Me)
	require.NoError(t, err)
...
func TestGetUserSecret(t *testing.T) {
	...
	t.Run("Found", func(t *testing.T) {
		...
		created, err := client.CreateUserSecret(ctx, optimus-ide-collabsdk.Me, optimus-ide-collabsdk.CreateUserSecretRequest{
		...
		got, err := client.UserSecretByName(ctx, optimus-ide-collabsdk.Me, "get-found-secret")
		require.NoError(t, err)
	...
	t.Run("NotFound", func(t *testing.T) {
		...
		_, err := client.UserSecretByName(ctx, optimus-ide-collabsdk.Me, "nonexistent")
		require.Error(t, err)
		var sdkErr *optimus-ide-collabsdk.Error
		require.ErrorAs(t, err, &sdkErr)
...
func TestPatchUserSecret(t *testing.T) {
	...
	t.Run("UpdateDescription", func(t *testing.T) {
		...
		newDesc := "updated"
		updated, err := client.UpdateUserSecret(ctx, optimus-ide-collabsdk.Me, "patch-desc-secret", optimus-ide-collabsdk.UpdateUserSecretRequest{
			Description: &newDesc,
		})
		require.NoError(t, err)
	...
	t.Run("NoFields", func(t *testing.T) {
		...
		_, err = client.UpdateUserSecret(ctx, optimus-ide-collabsdk.Me, "patch-nofields-secret", optimus-ide-collabsdk.UpdateUserSecretRequest{})
		require.Error(t, err)
		var sdkErr *optimus-ide-collabsdk.Error
		require.ErrorAs(t, err, &sdkErr)
	...
	t.Run("NotFound", func(t *testing.T) {
		...
		newVal := "new-value"
		_, err := client.UpdateUserSecret(ctx, optimus-ide-collabsdk.Me, "nonexistent", optimus-ide-collabsdk.UpdateUserSecretRequest{
			Value: &newVal,
		})
		require.Error(t, err)
		var sdkErr *optimus-ide-collabsdk.Error
	...
	t.Run("ConflictEnvName", func(t *testing.T) {
		...
		_, err = client.UpdateUserSecret(ctx, optimus-ide-collabsdk.Me, "conflict-env-2", optimus-ide-collabsdk.UpdateUserSecretRequest{
			EnvName: &taken,
		})
		requireSecretValidationEqualsError(t, err, http.StatusConflict, "env_name", "environment variable already in use")
	})
	...
	t.Run("ConflictFilePath", func(t *testing.T) {
		...
		_, err = client.UpdateUserSecret(ctx, optimus-ide-collabsdk.Me, "conflict-fp-2", optimus-ide-collabsdk.UpdateUserSecretRequest{
			FilePath: &taken,
		})
		requireSecretValidationEqualsError(t, err, http.StatusConflict, "file_path", "file path already in use")
	})
	...
	t.Run("InvalidEnvName", func(t *testing.T) {
		...
		badEnvName := "1INVALID"
		_, err = client.UpdateUserSecret(ctx, optimus-ide-collabsdk.Me, "patch-invalid-env", optimus-ide-collabsdk.UpdateUserSecretRequest{
			EnvName: &badEnvName,
		})
		requireSecretValidationContainsError(t, err, http.StatusBadRequest, "env_name", "must start")
	})
	...
	t.Run("InvalidFilePath", func(t *testing.T) {
		...
		_, err = client.UpdateUserSecret(ctx, optimus-ide-collabsdk.Me, "patch-invalid-file-path", optimus-ide-collabsdk.UpdateUserSecretRequest{
	...
	t.Run("InvalidValue", func(t *testing.T) {
		...
		_, err = client.UpdateUserSecret(ctx, optimus-ide-collabsdk.Me, "patch-invalid-val", optimus-ide-collabsdk.UpdateUserSecretRequest{
			Value: &badVal,
		})
		requireSecretValidationContainsError(t, err, http.StatusBadRequest, "value", "null bytes")
	})
	...
	t.Run("ToggleEnabled", func(t *testing.T) {
		...
		disable := false
		updated, err := client.UpdateUserSecret(ctx, optimus-ide-collabsdk.Me, "toggle-enabled", optimus-ide-collabsdk.UpdateUserSecretRequest{
			Enabled: &disable,
		})
		require.NoError(t, err)
	...
	t.Run("ClearingBothTargetsRejected", func(t *testing.T) {
		...
		// injection target.
		empty := ""
		_, err = client.UpdateUserSecret(ctx, optimus-ide-collabsdk.Me, "clear-both", optimus-ide-collabsdk.UpdateUserSecretRequest{
			EnvName: &empty,
		})
		requireSecretValidationContainsError(t, err, http.StatusBadRequest, "env_name", "at least one of env_name or file_path")
	})
	...
	t.Run("ClearingTargetsWhileDisablingAllowed", func(t *testing.T) {
		...
		empty := ""
		disabled := false
		updated, err := client.UpdateUserSecret(ctx, optimus-ide-collabsdk.Me, "clear-and-disable", optimus-ide-collabsdk.UpdateUserSecretRequest{
			EnvName: &empty,
			Enabled: &disabled,
		})
		require.NoError(t, err)
		...
		enable := true
		_, err = client.UpdateUserSecret(ctx, optimus-ide-collabsdk.Me, "clear-and-disable", optimus-ide-collabsdk.UpdateUserSecretRequest{
			Enabled: &enable,
		})
		requireSecretValidationContainsError(t, err, http.StatusBadRequest, "env_name", "at least one of env_name or file_path")
	...
	t.Run("AtomicEnvFileSwap", func(t *testing.T) {
		...
		updated, err := client.UpdateUserSecret(ctx, optimus-ide-collabsdk.Me, "atomic-swap", optimus-ide-collabsdk.UpdateUserSecretRequest{
			EnvName:  &empty,
			FilePath: &newPath,
		})
		require.NoError(t, err)
...
func requireSecretValidation(t *testing.T, err error, status int, field string) optimus-ide-collabsdk.ValidationError {
	t.Helper()
	...
	return optimus-ide-collabsdk.ValidationError{}
}
...
func TestUserSecretLimits(t *testing.T) {
	...
	t.Run("CountLimit", func(t *testing.T) {
		...
		var firstSecret optimus-ide-collabsdk.UserSecret
		for i := 0; i < optimus-ide-collabsdk.MaxUserSecretsPerUserCount; i++ {
			s, err := client.CreateUserSecret(ctx, optimus-ide-collabsdk.Me, optimus-ide-collabsdk.CreateUserSecretRequest{
		...
		_, err = client.UpdateUserSecret(ctx, optimus-ide-collabsdk.Me, firstSecret.Name, optimus-ide-collabsdk.UpdateUserSecretRequest{
			Description: &newDescription,
		})
		require.NoError(t, err)

		// Other-user isolation: the second user's budget is independent.
		_, err = otherClient.CreateUserSecret(ctx, optimus-ide-collabsdk.Me, optimus-ide-collabsdk.CreateUserSecretRequest{
	...
	t.Run("TotalBytesLimit", func(t *testing.T) {
		...
		// bytes).
		big := strings.Repeat("a", optimus-ide-collabsdk.MaxUserSecretValueBytes)
		numBig := optimus-ide-collabsdk.MaxUserSecretsTotalValueBytes / optimus-ide-collabsdk.MaxUserSecretValueBytes
		remainder := optimus-ide-collabsdk.MaxUserSecretsTotalValueBytes % optimus-ide-collabsdk.MaxUserSecretValueBytes
		var firstSecret optimus-ide-collabsdk.UserSecret
		for i := 0; i < numBig; i++ {
			s, err := client.CreateUserSecret(ctx, optimus-ide-collabsdk.Me, optimus-ide-collabsdk.CreateUserSecretRequest{
	...
	t.Run("EnvBytesLimit", func(t *testing.T) {
		...
		envBig, err := client.CreateUserSecret(ctx, optimus-ide-collabsdk.Me, optimus-ide-collabsdk.CreateUserSecretRequest{
			Name:    "env-big",
			Value:   strings.Repeat("a", optimus-ide-collabsdk.MaxUserSecretValueBytes-16),
			EnvName: "ENV_BIG",
		})
		require.NoError(t, err)
		...
		fileOK, err := client.CreateUserSecret(ctx, optimus-ide-collabsdk.Me, optimus-ide-collabsdk.CreateUserSecretRequest{
			Name:     "file-ok",
			Value:    strings.Repeat("a", 1024),
		...
		newDescription := "renamed"
		_, err = client.UpdateUserSecret(ctx, optimus-ide-collabsdk.Me, envBig.Name, optimus-ide-collabsdk.UpdateUserSecretRequest{
			Description: &newDescription,
		})
		require.NoError(t, err)
		...
		envName := "ENV_LATE"
		_, err = client.UpdateUserSecret(ctx, optimus-ide-collabsdk.Me, fileOK.Name, optimus-ide-collabsdk.UpdateUserSecretRequest{
			EnvName: &envName,
		})
		requireSecretAPIError(t, err, http.StatusBadRequest, "env_name")
...
// are plain optimus-ide-collabsdk.Response without ValidationError entries.
...
func TestDeleteUserSecret(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		...
		err = client.DeleteUserSecret(ctx, optimus-ide-collabsdk.Me, "delete-me-secret")
		require.NoError(t, err)

		// Verify it's gone.
		_, err = client.UserSecretByName(ctx, optimus-ide-collabsdk.Me, "delete-me-secret")
		require.Error(t, err)
		var sdkErr *optimus-ide-collabsdk.Error
		require.ErrorAs(t, err, &sdkErr)
		assert.Equal(t, http.StatusNotFound, sdkErr.StatusCode())
	...
	t.Run("NotFound", func(t *testing.T) {
		...
		err := client.DeleteUserSecret(ctx, optimus-ide-collabsdk.Me, "nonexistent")
		require.Error(t, err)
		var sdkErr *optimus-ide-collabsdk.Error
		require.ErrorAs(t, err, &sdkErr)
		assert.Equal(t, http.StatusNotFound, sdkErr.StatusCode())
