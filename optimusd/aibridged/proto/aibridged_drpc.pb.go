...
type drpcEncoding_File_optimus-ide-collabd_aibridged_proto_aibridged_proto struct{}

func (drpcEncoding_File_optimus-ide-collabd_aibridged_proto_aibridged_proto) Marshal(msg drpc.Message) ([]byte, error) {
	return proto.Marshal(msg.(proto.Message))
}

func (drpcEncoding_File_optimus-ide-collabd_aibridged_proto_aibridged_proto) MarshalAppend(buf []byte, msg drpc.Message) ([]byte, error) {
	return proto.MarshalOptions{}.MarshalAppend(buf, msg.(proto.Message))
}

func (drpcEncoding_File_optimus-ide-collabd_aibridged_proto_aibridged_proto) Unmarshal(buf []byte, msg drpc.Message) error {
	return proto.Unmarshal(buf, msg.(proto.Message))
}

func (drpcEncoding_File_optimus-ide-collabd_aibridged_proto_aibridged_proto) JSONMarshal(msg drpc.Message) ([]byte, error) {
	return protojson.Marshal(msg.(proto.Message))
}

func (drpcEncoding_File_optimus-ide-collabd_aibridged_proto_aibridged_proto) JSONUnmarshal(buf []byte, msg drpc.Message) error {
...
func (c *drpcRecorderClient) RecordInterception(ctx context.Context, in *RecordInterceptionRequest) (*RecordInterceptionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.Recorder/RecordInterception", drpcEncoding_File_optimus-ide-collabd_aibridged_proto_aibridged_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *drpcRecorderClient) RecordInterceptionEnded(ctx context.Context, in *RecordInterceptionEndedRequest) (*RecordInterceptionEndedResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.Recorder/RecordInterceptionEnded", drpcEncoding_File_optimus-ide-collabd_aibridged_proto_aibridged_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *drpcRecorderClient) RecordTokenUsage(ctx context.Context, in *RecordTokenUsageRequest) (*RecordTokenUsageResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.Recorder/RecordTokenUsage", drpcEncoding_File_optimus-ide-collabd_aibridged_proto_aibridged_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *drpcRecorderClient) RecordPromptUsage(ctx context.Context, in *RecordPromptUsageRequest) (*RecordPromptUsageResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.Recorder/RecordPromptUsage", drpcEncoding_File_optimus-ide-collabd_aibridged_proto_aibridged_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *drpcRecorderClient) RecordToolUsage(ctx context.Context, in *RecordToolUsageRequest) (*RecordToolUsageResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.Recorder/RecordToolUsage", drpcEncoding_File_optimus-ide-collabd_aibridged_proto_aibridged_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *drpcRecorderClient) RecordModelThought(ctx context.Context, in *RecordModelThoughtRequest) (*RecordModelThoughtResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.Recorder/RecordModelThought", drpcEncoding_File_optimus-ide-collabd_aibridged_proto_aibridged_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (DRPCRecorderDescription) Method(n int) (string, drpc.Encoding, drpc.Receiver, interface{}, bool) {
	switch n {
	case 0:
		return "/proto.Recorder/RecordInterception", drpcEncoding_File_optimus-ide-collabd_aibridged_proto_aibridged_proto{},
	...
	case 1:
		return "/proto.Recorder/RecordInterceptionEnded", drpcEncoding_File_optimus-ide-collabd_aibridged_proto_aibridged_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return srv.(DRPCRecorderServer).
	...
	case 2:
		return "/proto.Recorder/RecordTokenUsage", drpcEncoding_File_optimus-ide-collabd_aibridged_proto_aibridged_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return srv.(DRPCRecorderServer).
					RecordTokenUsage(
						ctx,
	...
	case 3:
		return "/proto.Recorder/RecordPromptUsage", drpcEncoding_File_optimus-ide-collabd_aibridged_proto_aibridged_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return srv.(DRPCRecorderServer).
					RecordPromptUsage(
						ctx,
	...
	case 4:
		return "/proto.Recorder/RecordToolUsage", drpcEncoding_File_optimus-ide-collabd_aibridged_proto_aibridged_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return srv.(DRPCRecorderServer).
					RecordToolUsage(
						ctx,
	...
	case 5:
		return "/proto.Recorder/RecordModelThought", drpcEncoding_File_optimus-ide-collabd_aibridged_proto_aibridged_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return srv.(DRPCRecorderServer).
					RecordModelThought(
						ctx,
...
func (x *drpcRecorder_RecordInterceptionStream) SendAndClose(m *RecordInterceptionResponse) error {
	if err := x.MsgSend(m, drpcEncoding_File_optimus-ide-collabd_aibridged_proto_aibridged_proto{}); err != nil {
		return err
	}
	return x.CloseSend()
}
...
func (c *drpcMCPConfiguratorClient) GetMCPServerConfigs(ctx context.Context, in *GetMCPServerConfigsRequest) (*GetMCPServerConfigsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.MCPConfigurator/GetMCPServerConfigs", drpcEncoding_File_optimus-ide-collabd_aibridged_proto_aibridged_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *drpcMCPConfiguratorClient) GetMCPServerAccessTokensBatch(ctx context.Context, in *GetMCPServerAccessTokensBatchRequest) (*GetMCPServerAccessTokensBatchResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.MCPConfigurator/GetMCPServerAccessTokensBatch", drpcEncoding_File_optimus-ide-collabd_aibridged_proto_aibridged_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (DRPCMCPConfiguratorDescription) Method(n int) (string, drpc.Encoding, drpc.Receiver, interface{}, bool) {
	switch n {
	case 0:
		return "/proto.MCPConfigurator/GetMCPServerConfigs", drpcEncoding_File_optimus-ide-collabd_aibridged_proto_aibridged_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
	...
	case 1:
		return "/proto.MCPConfigurator/GetMCPServerAccessTokensBatch", drpcEncoding_File_optimus-ide-collabd_aibridged_proto_aibridged_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return srv.(DRPCMCPConfiguratorServer).
...
func (c *drpcAuthorizerClient) IsAuthorized(ctx context.Context, in *IsAuthorizedRequest) (*IsAuthorizedResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.Authorizer/IsAuthorized", drpcEncoding_File_optimus-ide-collabd_aibridged_proto_aibridged_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *drpcAuthorizerClient) IsBudgetExceeded(ctx context.Context, in *IsBudgetExceededRequest) (*IsBudgetExceededResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.Authorizer/IsBudgetExceeded", drpcEncoding_File_optimus-ide-collabd_aibridged_proto_aibridged_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (DRPCAuthorizerDescription) Method(n int) (string, drpc.Encoding, drpc.Receiver, interface{}, bool) {
	switch n {
	case 0:
		return "/proto.Authorizer/IsAuthorized", drpcEncoding_File_optimus-ide-collabd_aibridged_proto_aibridged_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
	...
	case 1:
		return "/proto.Authorizer/IsBudgetExceeded", drpcEncoding_File_optimus-ide-collabd_aibridged_proto_aibridged_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return srv.(DRPCAuthorizerServer).
					IsBudgetExceeded(
						ctx,
...
func (c *drpcProviderConfiguratorClient) GetAIProviders(ctx context.Context, in *GetAIProvidersRequest) (*GetAIProvidersResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.ProviderConfigurator/GetAIProviders", drpcEncoding_File_optimus-ide-collabd_aibridged_proto_aibridged_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *drpcProviderConfiguratorClient) WatchAIProviders(ctx context.Context, in *WatchAIProvidersRequest) (DRPCProviderConfigurator_WatchAIProvidersClient, error) {
	stream, err := c.cc.NewStream(ctx, "/proto.ProviderConfigurator/WatchAIProviders", drpcEncoding_File_optimus-ide-collabd_aibridged_proto_aibridged_proto{})
	if err != nil {
		return nil, err
	}
	x := &drpcProviderConfigurator_WatchAIProvidersClient{stream}
	if err := x.MsgSend(in, drpcEncoding_File_optimus-ide-collabd_aibridged_proto_aibridged_proto{}); err != nil {
		return nil, err
	}
...
func (x *drpcProviderConfigurator_WatchAIProvidersClient) Recv() (*WatchAIProvidersResponse, error) {
	...
	if err := x.MsgRecv(m, drpcEncoding_File_optimus-ide-collabd_aibridged_proto_aibridged_proto{}); err != nil {
		return nil, err
	}
	return m, nil
}
...
func (x *drpcProviderConfigurator_WatchAIProvidersClient) RecvMsg(m *WatchAIProvidersResponse) error {
	return x.MsgRecv(m, drpcEncoding_File_optimus-ide-collabd_aibridged_proto_aibridged_proto{})
}
...
func (DRPCProviderConfiguratorDescription) Method(n int) (string, drpc.Encoding, drpc.Receiver, interface{}, bool) {
	switch n {
	case 0:
		return "/proto.ProviderConfigurator/GetAIProviders", drpcEncoding_File_optimus-ide-collabd_aibridged_proto_aibridged_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
	...
	case 1:
		return "/proto.ProviderConfigurator/WatchAIProviders", drpcEncoding_File_optimus-ide-collabd_aibridged_proto_aibridged_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
...
func (x *drpcProviderConfigurator_WatchAIProvidersStream) Send(m *WatchAIProvidersResponse) error {
	return x.MsgSend(m, drpcEncoding_File_optimus-ide-collabd_aibridged_proto_aibridged_proto{})
}
