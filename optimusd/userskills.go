...
// @Param request body optimus-ide-collabsdk.CreateUserSkillRequest true "Create user skill request"
// @Success 201 {object} optimus-ide-collabsdk.UserSkill
...
func (api *API) postUserSkill(rw http.ResponseWriter, r *http.Request) {
	...
	var req optimus-ide-collabsdk.CreateUserSkillRequest
...
// @Tags Users
// @Param user path string true "User ID, username, or me"
// @Success 200 {array} optimus-ide-collabsdk.UserSkillMetadata
...
// @Success 200 {object} optimus-ide-collabsdk.UserSkill
...
// @Param user path string true "User ID, username, or me"
// @Param skillName path string true "Skill name"
// @Param request body optimus-ide-collabsdk.UpdateUserSkillRequest true "Update user skill request"
// @Success 200 {object} optimus-ide-collabsdk.UserSkill
...
func (api *API) patchUserSkill(rw http.ResponseWriter, r *http.Request) {
	...
	var req optimus-ide-collabsdk.UpdateUserSkillRequest
	if !httpapi.Read(ctx, rw, r, &req) {
		return
	}
