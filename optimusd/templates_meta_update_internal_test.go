...
func TestResolveTemplateMetaUpdate(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "Name",
			req:  optimus-ide-collabsdk.UpdateTemplateMeta{Name: ptr.Ref("renamed")},
		...
		},
		{
			...
			req:  optimus-ide-collabsdk.UpdateTemplateMeta{Name: ptr.Ref("")},
		...
		{
			name: "DisplayName",
			req:  optimus-ide-collabsdk.UpdateTemplateMeta{DisplayName: ptr.Ref("Renamed")},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		{
			name: "Description",
			req:  optimus-ide-collabsdk.UpdateTemplateMeta{Description: ptr.Ref("New description")},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		{
			name: "Icon",
			req:  optimus-ide-collabsdk.UpdateTemplateMeta{Icon: ptr.Ref("/new.svg")},
			expected: expected{override: func(r *templateMetaUpdate) {
				r.icon = "/new.svg"
			}},
		},
		{
			...
			req:  optimus-ide-collabsdk.UpdateTemplateMeta{DefaultTTLMillis: ptr.Ref(int64(7200_000))},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		},
		{
			...
			req:  optimus-ide-collabsdk.UpdateTemplateMeta{DefaultTTLMillis: ptr.Ref(int64(0))},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		},
		{
			...
			req:  optimus-ide-collabsdk.UpdateTemplateMeta{ActivityBumpMillis: ptr.Ref(int64(900_000))},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		},
		{
			...
			req:  optimus-ide-collabsdk.UpdateTemplateMeta{TimeTilAutostopNotifyMillis: ptr.Ref(int64(300_000))},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		},
		{
			...
			req:  optimus-ide-collabsdk.UpdateTemplateMeta{TimeTilAutostopNotifyMillis: ptr.Ref(int64(0))},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		},
		{
			...
			req:  optimus-ide-collabsdk.UpdateTemplateMeta{AllowUserAutostart: ptr.Ref(true)},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		},
		{
			...
			req:  optimus-ide-collabsdk.UpdateTemplateMeta{AllowUserAutostop: ptr.Ref(true)},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		},
		{
			...
			req:  optimus-ide-collabsdk.UpdateTemplateMeta{AllowUserAutostop: ptr.Ref(false)},
			expected: expected{
		...
		},
		{
			...
			req:  optimus-ide-collabsdk.UpdateTemplateMeta{AllowUserCancelWorkspaceJobs: ptr.Ref(true)},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		},
		{
			...
			req:  optimus-ide-collabsdk.UpdateTemplateMeta{FailureTTLMillis: ptr.Ref(int64(3_600_000))},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		},
		{
			...
			req:  optimus-ide-collabsdk.UpdateTemplateMeta{TimeTilDormantMillis: ptr.Ref(int64(7_200_000))},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		},
		{
			...
			req:  optimus-ide-collabsdk.UpdateTemplateMeta{TimeTilDormantAutoDeleteMillis: ptr.Ref(int64(14_400_000))},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		},
		{
			...
			req:  optimus-ide-collabsdk.UpdateTemplateMeta{RequireActiveVersion: ptr.Ref(false)},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		},
		{
			...
			req:  optimus-ide-collabsdk.UpdateTemplateMeta{DeprecationMessage: ptr.Ref("now deprecated")},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		},
		{
			...
			req:  optimus-ide-collabsdk.UpdateTemplateMeta{DeprecationMessage: ptr.Ref("")},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		},
		{
			...
			req:  optimus-ide-collabsdk.UpdateTemplateMeta{UseClassicParameterFlow: ptr.Ref(false)},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		},
		{
			...
			req:  optimus-ide-collabsdk.UpdateTemplateMeta{DisableModuleCache: ptr.Ref(false)},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		// CORS behavior.
		{
			...
			req: optimus-ide-collabsdk.UpdateTemplateMeta{
				CORSBehavior: ptr.Ref(optimus-ide-collabsdk.CORSBehavior(database.CorsBehaviorSimple)),
			},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		},
		{
			...
			req: optimus-ide-collabsdk.UpdateTemplateMeta{
				CORSBehavior: ptr.Ref(optimus-ide-collabsdk.CORSBehavior("")),
			},
		...
		},
		{
			...
			req: optimus-ide-collabsdk.UpdateTemplateMeta{
				CORSBehavior: ptr.Ref(optimus-ide-collabsdk.CORSBehavior("not-a-real-value")),
			},
			expected: expected{
		...
		// the corresponding *Intent field being false; only true triggers it.
		{
			...
			req:  optimus-ide-collabsdk.UpdateTemplateMeta{DisableEveryoneGroupAccess: ptr.Ref(false)},
			expected: expected{override: func(*templateMetaUpdate) {
		...
		},
		{
			...
			req:  optimus-ide-collabsdk.UpdateTemplateMeta{DisableEveryoneGroupAccess: ptr.Ref(true)},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		},
		{
			...
			req:      optimus-ide-collabsdk.UpdateTemplateMeta{UpdateWorkspaceLastUsedAt: ptr.Ref(false)},
			expected: expected{override: func(*templateMetaUpdate) {}},
		},
		{
			name: "UpdateWorkspaceLastUsedAtTrue",
			req:  optimus-ide-collabsdk.UpdateTemplateMeta{UpdateWorkspaceLastUsedAt: ptr.Ref(true)},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		},
		{
			...
			req:      optimus-ide-collabsdk.UpdateTemplateMeta{UpdateWorkspaceDormantAt: ptr.Ref(false)},
			expected: expected{override: func(*templateMetaUpdate) {}},
		},
		{
			name: "UpdateWorkspaceDormantAtTrue",
			req:  optimus-ide-collabsdk.UpdateTemplateMeta{UpdateWorkspaceDormantAt: ptr.Ref(true)},
			expected: expected{override: func(r *templateMetaUpdate) {
...
func TestResolveTemplateMetaUpdate_NameClearedFallsBackToTemplateName(t *testing.T) {
	...
	got, _ := resolveTemplateMetaUpdate(tpl, schedOpts, optimus-ide-collabsdk.UpdateTemplateMeta{
		Name: ptr.Ref(""),
	})
...
func TestResolveTemplateMetaUpdate_NilRequestUsesScheduleOptsForRequirements(t *testing.T) {
	...
	got, validErrs := resolveTemplateMetaUpdate(tpl, schedOpts, optimus-ide-collabsdk.UpdateTemplateMeta{})
	if len(validErrs) != 0 {
