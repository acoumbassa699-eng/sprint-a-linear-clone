...
import (
	...
	"github.com/optimus-ide-collab/optimus-ide-collab/v2/optimus-ide-collabd/httpmw/patternmatcher"
)
...
func EndHTTPSpan(r *http.Request, status int, span trace.Span) {
	...
	span.SetAttributes(httpconv.ServerRequest("optimus-ide-collabd", r)...)
