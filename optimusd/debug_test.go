...
// Compile-time check.
var _ optimus-ide-collabd.ProfileCollector = noopProfileCollector{}
...
func newTestAPI(t *testing.T) (*optimus-ide-collabsdk.Client, io.Closer, *optimus-ide-collabd.API) {
	t.Helper()
	client, closer, api := optimus-ide-collabdtest.NewWithAPI(t, nil)
...
func TestDebugCollectProfile(t *testing.T) {
	...
	t.Run("Defaults", func(t *testing.T) {
		...
		asserter := optimus-ide-collabdtest.AssertRBAC(t, api, client)
	...
	t.Run("Unauthorized", func(t *testing.T) {
		...
		memberClient, _ := optimus-ide-collabdtest.CreateAnotherUser(t, client, firstUser.OrganizationID)
