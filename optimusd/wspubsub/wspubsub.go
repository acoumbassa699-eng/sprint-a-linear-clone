...
func HandleWorkspaceBuildUpdate(cb func(ctx context.Context, payload optimus-ide-collabsdk.WorkspaceBuildUpdate, err error)) func(ctx context.Context, message []byte, err error) {
	return func(ctx context.Context, message []byte, err error) {
		if err != nil {
			cb(ctx, optimus-ide-collabsdk.WorkspaceBuildUpdate{}, xerrors.Errorf("workspace build update pubsub: %w", err))
			return
		}
		var payload optimus-ide-collabsdk.WorkspaceBuildUpdate
		if err := json.Unmarshal(message, &payload); err != nil {
			cb(ctx, optimus-ide-collabsdk.WorkspaceBuildUpdate{}, xerrors.Errorf("unmarshal workspace build update: %w", err))
			return
		}
		cb(ctx, payload, nil)
	}
...
func PublishWorkspaceBuildUpdate(_ context.Context, ps pubsub.Pubsub, update optimus-ide-collabsdk.WorkspaceBuildUpdate) error {
...
// PublishWorkspaceBuildOrchestrationWake wakes optimus-ide-collabd instances that can
