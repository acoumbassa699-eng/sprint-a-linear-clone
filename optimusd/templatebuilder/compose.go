...
type ComposeRequest struct {
	...
	// config (OPTIMUS-IDE-COLLAB_TEMPLATE_BUILDER_REGISTRY_URL).
	RegistryURL string
...
// source files. It extracts the optimus-ide-collab_agent resource name from the
...
// the Optimus-IDE-Collab file store.
