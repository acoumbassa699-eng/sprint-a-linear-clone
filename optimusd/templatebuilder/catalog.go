...
// This is the on-disk schema; optimus-ide-collabsdk.TemplateBuilderModule is the API type.
...
var validVariableTypes = map[string]optimus-ide-collabsdk.TemplateBuilderVariableType{
	"string": optimus-ide-collabsdk.TemplateBuilderVariableTypeString,
	"number": optimus-ide-collabsdk.TemplateBuilderVariableTypeNumber,
	"bool":   optimus-ide-collabsdk.TemplateBuilderVariableTypeBool,
}
...
func (m ModuleManifest) ToSDK() optimus-ide-collabsdk.TemplateBuilderModule {
	variables := make([]optimus-ide-collabsdk.TemplateBuilderModuleVariable, 0, len(m.Variables))
	for _, v := range m.Variables {
		...
		variables = append(variables, optimus-ide-collabsdk.TemplateBuilderModuleVariable{
			Name:        v.Name,
	...
	return optimus-ide-collabsdk.TemplateBuilderModule{
		ID:            m.ID,
