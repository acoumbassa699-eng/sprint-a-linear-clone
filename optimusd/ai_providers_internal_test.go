...
func TestEnsureBedrockExternalID(t *testing.T) {
	...
	t.Run("NoRoleLeavesEmpty", func(t *testing.T) {
		t.Parallel()
		s := optimus-ide-collabsdk.AIProviderSettings{Bedrock: &optimus-ide-collabsdk.AIProviderBedrockSettings{Region: "us-east-1"}}
		ensureBedrockExternalID(&s)
	...
	t.Run("GeneratesWhenRoleSet", func(t *testing.T) {
		t.Parallel()
		s := optimus-ide-collabsdk.AIProviderSettings{Bedrock: &optimus-ide-collabsdk.AIProviderBedrockSettings{
...
func TestMergeAIProviderSettingsExternalID(t *testing.T) {
	...
	roleARN := "arn:aws:iam::123456789012:role/BedrockRole"
	existing := optimus-ide-collabsdk.AIProviderSettings{Bedrock: &optimus-ide-collabsdk.AIProviderBedrockSettings{
		RoleARN:    roleARN,
		ExternalID: "stored-value",
	}}
	patch := optimus-ide-collabsdk.AIProviderSettings{Bedrock: &optimus-ide-collabsdk.AIProviderBedrockSettings{
		RoleARN:    roleARN,
