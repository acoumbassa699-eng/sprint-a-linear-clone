...
type Limit struct {
	...
	Source           optimus-ide-collabsdk.AIBudgetLimitSource
}
...
func ResolveUserAIBudget(ctx context.Context, db Store, userID uuid.UUID, policy optimus-ide-collabsdk.AIBudgetPolicy) (EffectiveGroup, bool, error) {
	...
	if err == nil {
		return EffectiveGroup{
			...
			Limit: &Limit{
				...
				Source:           optimus-ide-collabsdk.AIBudgetLimitSourceUserOverride,
			},
		}, true, nil
	}
	...
	switch policy {
	case optimus-ide-collabsdk.AIBudgetPolicyHighest:
		...
		return EffectiveGroup{
			...
			Limit: &Limit{
				...
				Source:           optimus-ide-collabsdk.AIBudgetLimitSourceGroup,
			},
		}, true, nil
	default:
...
// user.
func ResolveUserEffectiveGroup(ctx context.Context, db Store, userID uuid.UUID, policy optimus-ide-collabsdk.AIBudgetPolicy) (EffectiveGroup, bool, error) {
