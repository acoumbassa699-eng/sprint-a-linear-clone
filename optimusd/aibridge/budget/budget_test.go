	...
	tests := []struct {
	...
	}{
		{
			...
			setup: func(t *testing.T, ctx context.Context, db database.Store) (uuid.UUID, budget.EffectiveGroup, bool) {
				...
				require.NoError(t, err)
				return user.ID, budget.EffectiveGroup{GroupID: og.ID, Limit: &budget.Limit{SpendLimitMicros: 1_000_000, Source: optimus-ide-collabsdk.AIBudgetLimitSourceUserOverride}}, true
			},
		},
		{
			...
			setup: func(t *testing.T, ctx context.Context, db database.Store) (uuid.UUID, budget.EffectiveGroup, bool) {
				...
				return user.ID, budget.EffectiveGroup{GroupID: gid, Limit: &budget.Limit{SpendLimitMicros: 8_000_000, Source: optimus-ide-collabsdk.AIBudgetLimitSourceGroup}}, true
			},
		},
		{
			...
			setup: func(t *testing.T, ctx context.Context, db database.Store) (uuid.UUID, budget.EffectiveGroup, bool) {
				...
				return user.ID, budget.EffectiveGroup{GroupID: high, Limit: &budget.Limit{SpendLimitMicros: 50_000_000, Source: optimus-ide-collabsdk.AIBudgetLimitSourceGroup}}, true
			},
		},
		{
			...
			setup: func(t *testing.T, ctx context.Context, db database.Store) (uuid.UUID, budget.EffectiveGroup, bool) {
				...
				return user.ID, budget.EffectiveGroup{GroupID: winner, Limit: &budget.Limit{SpendLimitMicros: 10_000_000, Source: optimus-ide-collabsdk.AIBudgetLimitSourceGroup}}, true
			},
		},
		{
		...
		},
		{
			...
			setup: func(t *testing.T, ctx context.Context, db database.Store) (uuid.UUID, budget.EffectiveGroup, bool) {
				...
				return user.ID, budget.EffectiveGroup{GroupID: everyoneID, Limit: &budget.Limit{SpendLimitMicros: 7_000_000, Source: optimus-ide-collabsdk.AIBudgetLimitSourceGroup}}, true
			},
		},
		{
			...
			setup: func(t *testing.T, ctx context.Context, db database.Store) (uuid.UUID, budget.EffectiveGroup, bool) {
				...
				require.NoError(t, err)
				return user.ID, budget.EffectiveGroup{GroupID: everyoneID, Limit: &budget.Limit{SpendLimitMicros: 2_000_000, Source: optimus-ide-collabsdk.AIBudgetLimitSourceUserOverride}}, true
			},
		},
		{
			name:   "UnsupportedPolicy",
			policy: optimus-ide-collabsdk.AIBudgetPolicy("unsupported"),
			setup: func(t *testing.T, ctx context.Context, db database.Store) (uuid.UUID, budget.EffectiveGroup, bool) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setup: func(t *testing.T, ctx context.Context, db database.Store) (uuid.UUID, budget.EffectiveGroup, bool) {
				...
				require.NoError(t, err)
				return user.ID, budget.EffectiveGroup{GroupID: group.ID, Limit: &budget.Limit{SpendLimitMicros: 7_000_000, Source: optimus-ide-collabsdk.AIBudgetLimitSourceGroup}}, true
			},
		},
		{
