...
// SourceAgents is chatd traffic originating from a Optimus-IDE-Collab agent.
...
//
// Implementations live in optimus-ide-collabd/aibridged. optimus-ide-collabd registers an in-process
// factory on optimus-ide-collabd.API.AIBridgeTransportFactory at startup so callers route
