...
// HeaderOptimus-IDE-CollabToken is a header set by clients opting into BYOK
// (Bring Your Own Key) mode. It carries the Optimus-IDE-Collab token so
...
const HeaderOptimus-IDE-CollabToken = "X-Optimus-IDE-Collab-AI-Governance-Token" //nolint:gosec // This is a header name, not a credential.

// HeaderOptimus-IDE-CollabRequestID is a header set by aibridgeproxyd on each
// request forwarded to aibridged for cross-service log correlation.
const HeaderOptimus-IDE-CollabRequestID = "X-Optimus-IDE-Collab-AI-Governance-Request-Id"
...
const HeaderAgentFirewallSessionID = "X-Optimus-IDE-Collab-Agent-Firewall-Session-Id"
...
const HeaderAgentFirewallSequenceNumber = "X-Optimus-IDE-Collab-Agent-Firewall-Sequence-Number"
...
// by the presence of the X-Optimus-IDE-Collab-AI-Governance-Token header.
func IsBYOK(header http.Header) bool {
	return strings.TrimSpace(header.Get(HeaderOptimus-IDE-CollabToken)) != ""
}
...
func ExtractAuthToken(header http.Header) string {
	if token := strings.TrimSpace(header.Get(HeaderOptimus-IDE-CollabToken)); token != "" {
		return token
	}
