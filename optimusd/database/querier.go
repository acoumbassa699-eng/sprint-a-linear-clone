...
type sqlcQuerier interface {
	...
	// of OPTIMUS-IDE-COLLAB_NOTIFICATIONS_LEASE_PERIOD. Once a message is delivered, its status is updated and the lease expires (set to NULL).
	...
	// See: https://github.com/optimus-ide-collab/internal/issues/1438
	...
	// and have not connected to optimus-ide-collabd since a week.
	...
	// These were most likely created via 'optimus-ide-collab login' as the prebuilds user.
	...
	// terminal statuses defined by ChatDebugStatus in optimus-ide-collabsdk/chats.go.
	//
	...
	// result into optimus-ide-collabsdk.AdvisorConfig. Returns '{}' when unset so zero
	...
	// definition used by optimus-ide-collabd/database/queries/workspaces.sql).
	...
	//
	//   * deleted = false: Optimus-IDE-Collab soft-deletes by flipping users.deleted
	...
	// for the experimental chat advisor. Callers marshal optimus-ide-collabsdk.AdvisorConfig
