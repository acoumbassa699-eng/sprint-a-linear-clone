...
func TestGetDeploymentWorkspaceAgentUsageStats(t *testing.T) {
	...
	t.Run("Aggregates", func(t *testing.T) {
		...
		db = dbauthz.New(db, authz, slogtest.Make(t, &slogtest.Options{}), optimus-ide-collabdtest.AccessControlStorePointer())
		ctx := context.Background()
		agentID := uuid.New()
...
func TestGetAuthorizedWorkspacesAndAgentsByOwnerID(t *testing.T) {
	...
	t.Run("dbauthz", func(t *testing.T) {
		...
		authzdb := dbauthz.New(db, authorizer, slogtest.Make(t, &slogtest.Options{}), optimus-ide-collabdtest.AccessControlStorePointer())
...
func TestProxyByHostname(t *testing.T) {
	...
	proxies := []struct {
		...
		{
			name:             "one",
			accessURL:        "https://one.optimus-ide-collab.com",
			wildcardHostname: "*.wildcard.one.optimus-ide-collab.com",
		},
		{
			name:             "two",
			accessURL:        "https://two.optimus-ide-collab.com",
			wildcardHostname: "*--suffix.two.optimus-ide-collab.com",
		},
		{
			name:             "three",
			accessURL:        "https://three.optimus-ide-collab.com:8443",
			wildcardHostname: "*.wildcard.three.optimus-ide-collab.com",
		},
		{
			name:             "four",
			accessURL:        "https://four.optimus-ide-collab.com/",
			wildcardHostname: "*.wildcard.four.optimus-ide-collab.com",
		},
	}
	...
	cases := []struct {
		...
		{
			name:              "MatchAccessURL",
			testHostname:      "one.optimus-ide-collab.com",
			allowAccessURL:    true,
			allowWildcardHost: true,
			matchProxyName:    "one",
		},
		{
			...
			testHostname:      "three.optimus-ide-collab.com",
			allowAccessURL:    true,
		...
		},
		{
			...
			testHostname:      "four.optimus-ide-collab.com",
			allowAccessURL:    true,
			allowWildcardHost: false,
			matchProxyName:    "four",
		},
		{
			...
			testHostname:      "one.optimus-ide-collab",
			allowAccessURL:    true,
			allowWildcardHost: false,
			matchProxyName:    "",
		},
		{
			...
			testHostname:      "one.optimus-ide-collab.co",
			allowAccessURL:    true,
			allowWildcardHost: false,
			matchProxyName:    "",
		},
		{
			name:              "MatchWildcard",
			testHostname:      "something.wildcard.one.optimus-ide-collab.com",
			allowAccessURL:    true,
			allowWildcardHost: true,
			matchProxyName:    "one",
		},
		{
			...
			testHostname:      "something.wildcard.one.optimus-ide-collab",
		...
		{
			name:              "MatchSuffix",
			testHostname:      "something--suffix.two.optimus-ide-collab.com",
			allowAccessURL:    true,
			allowWildcardHost: true,
			matchProxyName:    "two",
		},
		{
			...
			testHostname:      "something--suffix.two.optimus-ide-collab",
			allowAccessURL:    false,
			allowWildcardHost: true,
			matchProxyName:    "",
		},
		{
			...
			testHostname:      ".*ne.optimus-ide-collab.com",
			allowAccessURL:    true,
			allowWildcardHost: true,
			matchProxyName:    "",
		},
		{
			...
			testHostname:      "https://one.optimus-ide-collab.com",
			allowAccessURL:    true,
			allowWildcardHost: true,
			matchProxyName:    "",
		},
		{
			...
			testHostname:      "one.optimus-ide-collab.com:8080/hello",
			allowAccessURL:    true,
			allowWildcardHost: true,
			matchProxyName:    "",
		},
		...
		},
		{
			...
			testHostname:      "hi.wildcard.one.optimus-ide-collab.com",
			allowAccessURL:    true,
			allowWildcardHost: false,
			matchProxyName:    "",
		},
...
func TestGetUsers_IncludeSystem(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Given: a system user
			// postgres: introduced by migration optimus-ide-collabd/database/migrations/00030*_system_user.up.sql
			db, _ := dbtestutil.NewDB(t)
...
func TestUpdateSystemUser(t *testing.T) {
	...
	// Given: a system user introduced by migration optimus-ide-collabd/database/migrations/00030*_system_user.up.sql
	db, _ := dbtestutil.NewDB(t)
	users, err := db.GetUsers(ctx, database.GetUsersParams{
		IncludeSystem: true,
	})
...
func TestInsertUserServiceAccountConstraints(t *testing.T) {
	...
	t.Run("ServiceAccountWithNonEmptyEmail", func(t *testing.T) {
		...
		_, err := db.InsertUser(ctx, database.InsertUserParams{
			Email:            "sa@optimus-ide-collab.com",
			LoginType:        database.LoginTypeNone,
			ID:               uuid.New(),
...
func TestGetAuthorizedConnectionLogsOffset(t *testing.T) {
	...
	db, _ := dbtestutil.NewDB(t)
	authz := rbac.NewAuthorizer(prometheus.NewRegistry())
	authDb := dbauthz.New(db, authz, slogtest.Make(t, &slogtest.Options{}), optimus-ide-collabdtest.AccessControlStorePointer())
...
func TestConnectionLogsOffsetFilters(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			name: "StatusOngoing",
			params: database.GetConnectionLogsOffsetParams{
				Status: string(optimus-ide-collabsdk.ConnectionLogStatusOngoing),
			},
			expectedLogIDs: []uuid.UUID{log4.ID},
		},
		{
			...
			params: database.GetConnectionLogsOffsetParams{
				Status: string(optimus-ide-collabsdk.ConnectionLogStatusCompleted),
			},
...
func TestUserSecretsAuthorization(t *testing.T) {
	...
	db, _ := dbtestutil.NewDB(t)
	authorizer := rbac.NewStrictCachingAuthorizer(prometheus.NewRegistry())
	authDB := dbauthz.New(db, authorizer, slogtest.Make(t, &slogtest.Options{}), optimus-ide-collabdtest.AccessControlStorePointer())
...
func TestChatLabels(t *testing.T) {
	...
	t.Run("CreateWithLabels", func(t *testing.T) {
		...
		labels := database.StringMap{"github.repo": "optimus-ide-collab/optimus-ide-collab", "env": "prod"}
		...
		require.NoError(t, err)
		require.Equal(t, database.StringMap{"github.repo": "optimus-ide-collab/optimus-ide-collab", "env": "prod"}, chat.Labels)
...
func TestGetChatsFilter(t *testing.T) {
	...
	linkPR(draftPR.ID, "https://github.com/optimus-ide-collab/optimus-ide-collab/pull/1001", "open", true)
	makeUnread(draftPR.ID) // also unread

	openPR := createRoot("open pr chat")
	linkPR(openPR.ID, "https://github.com/optimus-ide-collab/optimus-ide-collab/pull/1002", "open", false)

	mergedPR := createRoot("merged pr chat")
	linkPR(mergedPR.ID, "https://github.com/optimus-ide-collab/optimus-ide-collab/pull/1003", "merged", false)

	closedPR := createRoot("closed pr chat")
	linkPR(closedPR.ID, "https://github.com/optimus-ide-collab/optimus-ide-collab/pull/1004", "closed", false)
	...
	linkPR(childWithDraftPR.ID, "https://github.com/optimus-ide-collab/optimus-ide-collab/pull/1005", "open", true)
	...
	// with the "optimus-ide-collab/optimus-ide-collab" URLs in the earlier PR fixtures.
	...
	tests := []struct {
		...
		{"Repo/MatchesViaURL", database.GetChatsParams{RepoQuery: "optimus-ide-collab/optimus-ide-collab"}, []uuid.UUID{draftPR.ID, openPR.ID, mergedPR.ID, closedPR.ID}},
