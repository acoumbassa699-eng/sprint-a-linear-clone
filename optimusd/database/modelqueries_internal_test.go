...
// defined by ChatDebugTerminalStatuses in optimus-ide-collabsdk.  If a new terminal
...
func TestFinalizeStaleChatDebugRows_TerminalStatusAlignment(t *testing.T) {
	...
	goTerminal := optimus-ide-collabsdk.ChatDebugTerminalStatuses()
	...
	for _, match := range matches {
		...
		require.Equal(t, goStatuses, sqlStatuses,
			"terminal statuses in FinalizeStaleChatDebugRows SQL must match "+
				"optimus-ide-collabsdk.ChatDebugTerminalStatuses(); update both when adding "+
