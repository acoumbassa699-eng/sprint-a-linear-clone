...
const (
	ApiKeyScopeOptimus-IDE-CollabAll                            APIKeyScope = "optimus-ide-collab:all"
	ApiKeyScopeOptimus-IDE-CollabApplicationConnect             APIKeyScope = "optimus-ide-collab:application_connect"
	...
	ApiKeyScopeOptimus-IDE-CollabWorkspacescreate               APIKeyScope = "optimus-ide-collab:workspaces.create"
	ApiKeyScopeOptimus-IDE-CollabWorkspacesoperate              APIKeyScope = "optimus-ide-collab:workspaces.operate"
	ApiKeyScopeOptimus-IDE-CollabWorkspacesdelete               APIKeyScope = "optimus-ide-collab:workspaces.delete"
	ApiKeyScopeOptimus-IDE-CollabWorkspacesaccess               APIKeyScope = "optimus-ide-collab:workspaces.access"
	ApiKeyScopeOptimus-IDE-CollabTemplatesbuild                 APIKeyScope = "optimus-ide-collab:templates.build"
	ApiKeyScopeOptimus-IDE-CollabTemplatesauthor                APIKeyScope = "optimus-ide-collab:templates.author"
	ApiKeyScopeOptimus-IDE-CollabApikeysmanageSelf              APIKeyScope = "optimus-ide-collab:apikeys.manage_self"
...
func (e APIKeyScope) Valid() bool {
	...
	case ApiKeyScopeOptimus-IDE-CollabAll,
		ApiKeyScopeOptimus-IDE-CollabApplicationConnect,
		...
		ApiKeyScopeOptimus-IDE-CollabWorkspacescreate,
		ApiKeyScopeOptimus-IDE-CollabWorkspacesoperate,
		ApiKeyScopeOptimus-IDE-CollabWorkspacesdelete,
		ApiKeyScopeOptimus-IDE-CollabWorkspacesaccess,
		ApiKeyScopeOptimus-IDE-CollabTemplatesbuild,
		ApiKeyScopeOptimus-IDE-CollabTemplatesauthor,
		ApiKeyScopeOptimus-IDE-CollabApikeysmanageSelf,
...
func AllAPIKeyScopeValues() []APIKeyScope {
	return []APIKeyScope{
		ApiKeyScopeOptimus-IDE-CollabAll,
		ApiKeyScopeOptimus-IDE-CollabApplicationConnect,
		ApiKeyScopeAibridgeInterceptionCreate,
		ApiKeyScopeAibridgeInterceptionRead,
		ApiKeyScopeAibridgeInterceptionUpdate,
...
// Hashed bearer secrets used by AI Gateway standalone replicas to authenticate into optimus-ide-collabd.
...
// Runtime configuration for AI providers. Authoritative source for the provider set served by aibridged. Replaces deployment-time OPTIMUS-IDE-COLLAB_AIBRIDGE_* environment variables.
...
type BoundarySession struct {
	...
	// Time when the first log for this session was received by optimus-ide-collabd.
	StartedAt time.Time `db:"started_at" json:"started_at"`
...
type CustomRole struct {
	...
	ID uuid.UUID `db:"id" json:"id"`
	// System roles are managed by Optimus-IDE-Collab and cannot be modified or deleted by users.
...
type MCPServerConfig struct {
	...
	ForwardOptimus-IDE-CollabHeaders     bool           `db:"forward_optimus-ide-collab_headers" json:"forward_optimus-ide-collab_headers"`
...
// A table used to configure apps that can use Optimus-IDE-Collab as an OAuth2 provider, the reverse of what we are calling external authentication.
...
type UsageEvent struct {
	...
	CreatedAt time.Time       `db:"created_at" json:"created_at"`
	// Set to a timestamp while the event is being published by a Optimus-IDE-Collab replica to the usage collector service. Used to avoid duplicate publishes by multiple replicas. Timestamps older than 1 hour are considered expired.
...
type User struct {
	...
	// Name of the Optimus-IDE-Collab user
	Name string `db:"name" json:"name"`
	// The GitHub.com numerical user ID. It is used to check if the user has starred the Optimus-IDE-Collab repository. It is also used for filtering users in the users list CLI command, and may become more widely used in the future.
...
type WorkspaceAgent struct {
	...
	// The resolved path of a user-specified directory. e.g. ~/optimus-ide-collab -> /home/optimus-ide-collab/optimus-ide-collab
...
type WorkspaceAgentContextSnapshot struct {
	...
	// Time at which optimus-ide-collabd received the push.
