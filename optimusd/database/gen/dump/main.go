...
var preamble = []byte("-- Code generated by 'make optimus-ide-collabd/database/generate'. DO NOT EDIT.")
...
func openEmbeddedPostgres() (string, func(), error) {
	...
	cacheDir := filepath.Join(cacheRoot, "optimus-ide-collab", "dbdump-postgres")

	runtimeDir, err := os.MkdirTemp("", "optimus-ide-collab-dbdump-postgres-")
	if err != nil {
