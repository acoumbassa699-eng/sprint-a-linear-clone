...
func TestAPIKeyScopesExpand(t *testing.T) {
	...
	t.Run("builtins", func(t *testing.T) {
		...
		cases := []struct {
			...
			{
				name:   "all",
				scopes: APIKeyScopes{ApiKeyScopeOptimus-IDE-CollabAll},
				want: func(t *testing.T, s rbac.Scope) {
			...
			},
			{
				...
				scopes: APIKeyScopes{ApiKeyScopeOptimus-IDE-CollabApplicationConnect},
				want: func(t *testing.T, s rbac.Scope) {
	...
	t.Run("merge", func(t *testing.T) {
		t.Parallel()
		scopes := APIKeyScopes{ApiKeyScopeOptimus-IDE-CollabApplicationConnect, ApiKeyScopeOptimus-IDE-CollabAll, ApiKeyScopeWorkspaceRead}
