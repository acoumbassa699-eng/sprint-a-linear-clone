...
func NewDB(t testing.TB, opts ...Option) (database.Store, pubsub.Pubsub) {
	...
	connectionURL := os.Getenv("OPTIMUS-IDE-COLLAB_PG_CONNECTION_URL")
...
//     ./scripts/optimus-ide-collab-dev.sh server --postgres-url='postgres://postgres:postgres@127.0.0.1:5432/<dbname>?sslmode=disable'
...
func normalizeDump(schema []byte) []byte {
	...
	// https://github.com/optimus-ide-collab/internal/issues/965.
