...
func New(ctx context.Context, logger slog.Logger, db database.Store, vals *optimus-ide-collabsdk.DeploymentValues, reg prometheus.Registerer, opts ...Option) io.Closer {
...
func (i *instance) purgeTick(ctx context.Context, db database.Store, start time.Time) error {
	...
	chatDebugRetentionDays, chatDebugRetentionErr := db.GetChatDebugRetentionDays(ctx, optimus-ide-collabsdk.DefaultChatDebugRetentionDays)
