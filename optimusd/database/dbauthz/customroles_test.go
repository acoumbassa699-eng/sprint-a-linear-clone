...
func TestInsertCustomRoles(t *testing.T) {
	...
	testCases := []struct {
		...
		site           []optimus-ide-collabsdk.Permission
		org            []optimus-ide-collabsdk.Permission
		user           []optimus-ide-collabsdk.Permission
		member         []optimus-ide-collabsdk.Permission
		...
		},
		{
			...
			site: optimus-ide-collabsdk.CreatePermissions(map[optimus-ide-collabsdk.RBACResource][]optimus-ide-collabsdk.RBACAction{
				optimus-ide-collabsdk.ResourceWorkspace: {optimus-ide-collabsdk.ActionRead},
			}),
			org: optimus-ide-collabsdk.CreatePermissions(map[optimus-ide-collabsdk.RBACResource][]optimus-ide-collabsdk.RBACAction{
				optimus-ide-collabsdk.ResourceWorkspace: {optimus-ide-collabsdk.ActionRead},
			}),
		...
		},
		{
			...
			org: optimus-ide-collabsdk.CreatePermissions(map[optimus-ide-collabsdk.RBACResource][]optimus-ide-collabsdk.RBACAction{
				...
				optimus-ide-collabsdk.ResourceWorkspace: {optimus-ide-collabsdk.ActionViewInsights},
			}),
		...
		},
		{
			...
			subject:        merge(canCreateCustomRole, rbac.RoleOwner()),
			org: optimus-ide-collabsdk.CreatePermissions(map[optimus-ide-collabsdk.RBACResource][]optimus-ide-collabsdk.RBACAction{
				"foobar": {optimus-ide-collabsdk.ActionViewInsights},
			}),
		...
		},
		{
			...
			organizationID: orgID,
			subject:        merge(canCreateCustomRole, rbac.ScopedRoleOrgAdmin(orgID)),
			user: optimus-ide-collabsdk.CreatePermissions(map[optimus-ide-collabsdk.RBACResource][]optimus-ide-collabsdk.RBACAction{
				optimus-ide-collabsdk.ResourceWorkspace: {optimus-ide-collabsdk.ActionRead},
			}),
			errorContains: "organization roles specify site or user permissions",
		},
		{
			...
			organizationID: orgID,
			subject:        merge(canCreateCustomRole),
			member: optimus-ide-collabsdk.CreatePermissions(map[optimus-ide-collabsdk.RBACResource][]optimus-ide-collabsdk.RBACAction{
				optimus-ide-collabsdk.ResourceWorkspace: {optimus-ide-collabsdk.ActionRead},
			}),
		...
		},
		{
			...
			site: optimus-ide-collabsdk.CreatePermissions(map[optimus-ide-collabsdk.RBACResource][]optimus-ide-collabsdk.RBACAction{
				optimus-ide-collabsdk.ResourceDeploymentConfig: {optimus-ide-collabsdk.ActionUpdate}, // not ok!
			}),
			errorContains: "organization roles specify site or user permissions",
		},
		// ok!
...
func convertSDKPerm(perm optimus-ide-collabsdk.Permission) database.CustomRolePermission {
