...
import (
	...
	"github.com/optimus-ide-collab/optimus-ide-collab/v2/optimus-ide-collabd/rbac/regosql"
...
func (s *MethodTestSuite) SetupSuite() {
	...
	az := dbauthz.New(mockStore, nil, slog.Make(), optimus-ide-collabdtest.AccessControlStorePointer())
...
func (s *MethodTestSuite) SubtestWithDB(db database.Store, testCaseF func(db database.Store, check *expects)) func() {
	return func() {
		...
		fakeAuthorizer := &optimus-ide-collabdtest.FakeAuthorizer{}
					...
					if !cmp.Equal(a, b, cmpOptions...) {
						diffOpts := append(
							...
							cmpopts.SortSlices(func(a, b any) bool {
								...
								_ = gob.NewEnoptimus-ide-collab(&ab).Encode(a)
								_ = gob.NewEnoptimus-ide-collab(&bb).Encode(b)
...
func (s *MethodTestSuite) NotAuthorizedErrorTest(ctx context.Context, az *optimus-ide-collabdtest.FakeAuthorizer, testCase expects, callMethod func(ctx context.Context) ([]reflect.Value, error)) {
