...
func TestPGPubsub_Metrics(t *testing.T) {
	...
	gatherCount++
	require.NoError(t, err)
	require.True(t, testutil.PromGaugeHasValue(t, metrics, 0, "optimus-ide-collab_pubsub_current_events"))
	require.True(t, testutil.PromGaugeHasValue(t, metrics, 0, "optimus-ide-collab_pubsub_current_subscribers"))
	...
	require.Eventually(t, func() bool {
		...
		gatherCount++
		assert.NoError(t, err)
		return testutil.PromGaugeHasValue(t, metrics, 1, "optimus-ide-collab_pubsub_current_events") &&
			testutil.PromGaugeHasValue(t, metrics, 1, "optimus-ide-collab_pubsub_current_subscribers") &&
			testutil.PromGaugeHasValue(t, metrics, 1, "optimus-ide-collab_pubsub_connected") &&
			testutil.PromCounterHasValue(t, metrics, gatherCount, "optimus-ide-collab_pubsub_publishes_total", "true") &&
			testutil.PromCounterHasValue(t, metrics, gatherCount, "optimus-ide-collab_pubsub_subscribes_total", "true") &&
			testutil.PromCounterHasValue(t, metrics, gatherCount, "optimus-ide-collab_pubsub_messages_total", "normal") &&
			testutil.PromCounterHasValue(t, metrics, float64(len(data))+latencyBytes, "optimus-ide-collab_pubsub_received_bytes_total") &&
			testutil.PromCounterHasValue(t, metrics, float64(len(data))+latencyBytes, "optimus-ide-collab_pubsub_published_bytes_total") &&
			testutil.PromGaugeAssertion(t, metrics, func(in float64) bool { return in > 0 }, "optimus-ide-collab_pubsub_send_latency_seconds") &&
			testutil.PromGaugeAssertion(t, metrics, func(in float64) bool { return in > 0 }, "optimus-ide-collab_pubsub_receive_latency_seconds") &&
			testutil.PromCounterHasValue(t, metrics, gatherCount, "optimus-ide-collab_pubsub_latency_measures_total") &&
			!testutil.PromCounterGathered(t, metrics, "optimus-ide-collab_pubsub_latency_measure_errs_total")
	...
	require.Eventually(t, func() bool {
		...
		assert.NoError(t, err)
		return testutil.PromGaugeHasValue(t, metrics, 1, "optimus-ide-collab_pubsub_current_events") &&
			testutil.PromGaugeHasValue(t, metrics, 2, "optimus-ide-collab_pubsub_current_subscribers") &&
			testutil.PromGaugeHasValue(t, metrics, 1, "optimus-ide-collab_pubsub_connected") &&
			testutil.PromCounterHasValue(t, metrics, 1+gatherCount, "optimus-ide-collab_pubsub_publishes_total", "true") &&
			testutil.PromCounterHasValue(t, metrics, 1+gatherCount, "optimus-ide-collab_pubsub_subscribes_total", "true") &&
			testutil.PromCounterHasValue(t, metrics, gatherCount, "optimus-ide-collab_pubsub_messages_total", "normal") &&
			testutil.PromCounterHasValue(t, metrics, 1, "optimus-ide-collab_pubsub_messages_total", "colossal") &&
			testutil.PromCounterHasValue(t, metrics, float64(colossalSize+len(data))+latencyBytes, "optimus-ide-collab_pubsub_received_bytes_total") &&
			testutil.PromCounterHasValue(t, metrics, float64(colossalSize+len(data))+latencyBytes, "optimus-ide-collab_pubsub_published_bytes_total") &&
			testutil.PromGaugeAssertion(t, metrics, func(in float64) bool { return in > 0 }, "optimus-ide-collab_pubsub_send_latency_seconds") &&
			testutil.PromGaugeAssertion(t, metrics, func(in float64) bool { return in > 0 }, "optimus-ide-collab_pubsub_receive_latency_seconds") &&
			testutil.PromCounterHasValue(t, metrics, gatherCount, "optimus-ide-collab_pubsub_latency_measures_total") &&
			!testutil.PromCounterGathered(t, metrics, "optimus-ide-collab_pubsub_latency_measure_errs_total")
