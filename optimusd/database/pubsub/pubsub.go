...
func (p *PGPubsub) subscribeQueue(event string, newQ *MsgQueue) (cancel func(), err error) {
	...
	if unlistenInProgress != nil {
		...
		// events.  c.f. https://github.com/optimus-ide-collab/optimus-ide-collab/issues/15312
	...
	// c.f. https://github.com/optimus-ide-collab/optimus-ide-collab/issues/11950
...
var (
	currentSubscribersDesc = prometheus.NewDesc(
		"optimus-ide-collab_pubsub_current_subscribers",
		"The current number of active pubsub subscribers",
		nil, nil,
	)
	currentEventsDesc = prometheus.NewDesc(
		"optimus-ide-collab_pubsub_current_events",
