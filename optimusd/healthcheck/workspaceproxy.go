...
type WorkspaceProxiesFetchUpdater interface {
	Fetch(context.Context) (optimus-ide-collabsdk.RegionsResponse[optimus-ide-collabsdk.WorkspaceProxy], error)
...
func (*AGPLWorkspaceProxiesFetchUpdater) Fetch(context.Context) (optimus-ide-collabsdk.RegionsResponse[optimus-ide-collabsdk.WorkspaceProxy], error) {
	return optimus-ide-collabsdk.RegionsResponse[optimus-ide-collabsdk.WorkspaceProxy]{}, nil
}
...
func (r *WorkspaceProxyReport) Run(ctx context.Context, opts *WorkspaceProxyReportOptions) {
	...
	if r.WorkspaceProxies.Regions == nil {
		r.WorkspaceProxies.Regions = make([]optimus-ide-collabsdk.WorkspaceProxy, 0)
	}
