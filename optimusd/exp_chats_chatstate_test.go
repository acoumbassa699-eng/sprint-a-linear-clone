...
func withChatWorkerDisabled(o *optimus-ide-collabdtest.Options) {
...
func driveChatToWaiting(ctx context.Context, t *testing.T, api *optimus-ide-collabd.API, chatID uuid.UUID) {
	t.Helper()
...
func driveChatToRequiresAction(
	...
	assistantContent, err := chatprompt.MarshalParts([]optimus-ide-collabsdk.ChatMessagePart{
		optimus-ide-collabsdk.ChatMessageText("dispatching dynamic tool"),
		{
...
func TestPostChatsStartsRunning(t *testing.T) {
	...
	require.NoError(t, err)
	require.Equal(t, optimus-ide-collabsdk.ChatStatusRunning, chat.Status,
	...
	require.NoError(t, err)
	require.Equal(t, optimus-ide-collabsdk.ChatStatusRunning, gotChat.Status)
...
func TestArchiveChatStateTransitions(t *testing.T) {
	...
	t.Run("IdleSucceeds", func(t *testing.T) {
		...
		chat, err := client.CreateChat(ctx, optimus-ide-collabsdk.CreateChatRequest{
			OrganizationID: firstUser.OrganizationID,
			Content:        []optimus-ide-collabsdk.ChatInputPart{{Type: optimus-ide-collabsdk.ChatInputPartTypeText, Text: "archive me"}},
		})
		require.NoError(t, err)
	...
	t.Run("ActiveChatReturnsConflict", func(t *testing.T) {
		...
		chat, err := client.CreateChat(ctx, optimus-ide-collabsdk.CreateChatRequest{
			OrganizationID: firstUser.OrganizationID,
			Content:        []optimus-ide-collabsdk.ChatInputPart{{Type: optimus-ide-collabsdk.ChatInputPartTypeText, Text: "no archive"}},
		})
		require.NoError(t, err)
...
func TestPostChatMessagesBusyInterrupt(t *testing.T) {
	...
	chat, err := client.CreateChat(ctx, optimus-ide-collabsdk.CreateChatRequest{
		OrganizationID: firstUser.OrganizationID,
		Content:        []optimus-ide-collabsdk.ChatInputPart{{Type: optimus-ide-collabsdk.ChatInputPartTypeText, Text: "hello"}},
	})
	require.NoError(t, err)
	require.Equal(t, optimus-ide-collabsdk.ChatStatusRunning, chat.Status)
	...
	resp, err := client.CreateChatMessage(ctx, chat.ID, optimus-ide-collabsdk.CreateChatMessageRequest{
		Content:      []optimus-ide-collabsdk.ChatInputPart{{Type: optimus-ide-collabsdk.ChatInputPartTypeText, Text: "stop"}},
	...
	got, err := client.GetChat(ctx, chat.ID)
	require.NoError(t, err)
	require.Equal(t, optimus-ide-collabsdk.ChatStatusInterrupting, got.Status,
...
func TestDeleteChatQueuedMessageMissingReturns404(t *testing.T) {
	...
	_, err = client.CreateChatMessage(ctx, chat.ID, optimus-ide-collabsdk.CreateChatMessageRequest{
		Content:      []optimus-ide-collabsdk.ChatInputPart{{Type: optimus-ide-collabsdk.ChatInputPartTypeText, Text: "queued"}},
...
func TestInterruptChatIdleReturnsConflict(t *testing.T) {
	...
	chat, err := client.CreateChat(ctx, optimus-ide-collabsdk.CreateChatRequest{
		OrganizationID: firstUser.OrganizationID,
		Content:        []optimus-ide-collabsdk.ChatInputPart{{Type: optimus-ide-collabsdk.ChatInputPartTypeText, Text: "interrupt me"}},
	})
	require.NoError(t, err)
...
func TestSubmitToolResultsRequiresActionSucceeds(t *testing.T) {
	...
	dynamicTools := []optimus-ide-collabsdk.DynamicTool{{
		Name:        "echo",
	...
	for _, msg := range got.Messages {
		...
		for _, part := range msg.Content {
			if part.Type == optimus-ide-collabsdk.ChatMessagePartTypeToolResult && part.ToolCallID == toolCallID {
...
func TestPatchChatArchiveChildRejected(t *testing.T) {
	...
	root, err := client.CreateChat(ctx, optimus-ide-collabsdk.CreateChatRequest{
		OrganizationID: firstUser.OrganizationID,
		Content:        []optimus-ide-collabsdk.ChatInputPart{{Type: optimus-ide-collabsdk.ChatInputPartTypeText, Text: "root"}},
	})
	require.NoError(t, err)
	...
	err = client.UpdateChat(ctx, childA.ID, optimus-ide-collabsdk.UpdateChatRequest{Archived: ptr.Ref(true)})
...
func TestPatchChatUnarchiveChildRejected(t *testing.T) {
	...
	err = client.UpdateChat(ctx, root.ID, optimus-ide-collabsdk.UpdateChatRequest{Archived: ptr.Ref(true)})
	require.NoError(t, err)
	for _, id := range []uuid.UUID{root.ID, childA.ID, childB.ID} {
		got, gerr := loadChatRow(ctx, db, id)
		require.NoError(t, gerr)
	...
	err = client.UpdateChat(ctx, childA.ID, optimus-ide-collabsdk.UpdateChatRequest{Archived: ptr.Ref(false)})
	requireSDKError(t, err, http.StatusBadRequest)
...
func TestPostChatMessagesInvalidStateReturnsSharedResponse(t *testing.T) {
	...
	_, err = client.CreateChatMessage(ctx, chat.ID, optimus-ide-collabsdk.CreateChatMessageRequest{
		Content: []optimus-ide-collabsdk.ChatInputPart{{Type: optimus-ide-collabsdk.ChatInputPartTypeText, Text: "send"}},
	})
...
func TestReconcileInvalidChatStateSucceeds(t *testing.T) {
	...
	require.Equal(t, optimus-ide-collabsdk.ChatStatusError, reconciled.Status)
...
func driveChatToInvalidWaitingWithQueue(
	...
	rawContent, err := chatprompt.MarshalParts([]optimus-ide-collabsdk.ChatMessagePart{
