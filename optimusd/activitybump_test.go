...
func TestWorkspaceActivityBump(t *testing.T) {
	...
	setupActivityTest := func(t *testing.T, deadline ...time.Duration) (client *optimus-ide-collabsdk.Client, workspace optimus-ide-collabsdk.Workspace, assertBumped func(want bool)) {
		t.Helper()
		const ttl = time.Hour
