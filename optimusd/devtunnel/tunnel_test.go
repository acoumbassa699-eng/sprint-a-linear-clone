...
import (
	...
	"github.com/optimus-ide-collab/wgtunnel/tunneld"
...
func TestTunnel(t *testing.T) {
	...
	if runtime.GOOS == "windows" {
		t.Skip("these tests are flaky on windows and cause the tests to fail with '(unknown)' and no output, see https://github.com/optimus-ide-collab/internal/issues/579")
	}
...
func newTunnelServer(t *testing.T) *tunnelServer {
	...
	baseURLParsed.Host = net.JoinHostPort("tunnel.optimus-ide-collab.com", baseURLParsed.Port())
