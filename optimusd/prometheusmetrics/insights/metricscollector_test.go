...
func TestCollectInsights(t *testing.T) {
	...
	ownerClient := optimus-ide-collabdtest.New(t, options)
	...
	ok := assert.Eventuallyf(t, func() bool {
		...
		for _, metric := range metrics {
			...
			case "optimus-ide-collabd_insights_applications_usage_seconds", "optimus-ide-collabd_insights_templates_active_users", "optimus-ide-collabd_insights_parameters":
