...
// @Success 200 {object} optimus-ide-collabsdk.Workspace
...
func (api *API) workspace(rw http.ResponseWriter, r *http.Request) {
	...
	if workspace.Deleted && !showDeleted {
		httpapi.Write(ctx, rw, http.StatusGone, optimus-ide-collabsdk.Response{
	...
	appStatus := optimus-ide-collabsdk.WorkspaceAppStatus{}
...
// @Success 200 {object} optimus-ide-collabsdk.WorkspacesResponse
...
func (api *API) workspaces(rw http.ResponseWriter, r *http.Request) {
	...
	if len(workspaceRows) == 1 {
		httpapi.Write(ctx, rw, http.StatusOK, optimus-ide-collabsdk.WorkspacesResponse{
...
// @Param request body optimus-ide-collabsdk.CreateWorkspaceRequest true "Create workspace request"
// @Success 200 {object} optimus-ide-collabsdk.Workspace
...
func (api *API) postWorkspacesByOrganization(rw http.ResponseWriter, r *http.Request) {
	...
	var req optimus-ide-collabsdk.CreateWorkspaceRequest
...
func createWorkspace(
	...
	if err != nil {
		if httpapi.Is404Error(err) {
			return optimus-ide-collabsdk.Workspace{}, httperror.ErrResourceNotFound
		}
		return optimus-ide-collabsdk.Workspace{}, httperror.NewResponseError(http.StatusInternalServerError, optimus-ide-collabsdk.Response{
	...
	if err != nil {
		return optimus-ide-collabsdk.Workspace{}, httperror.NewResponseError(http.StatusBadRequest, optimus-ide-collabsdk.Response{
			Message:     "Invalid Autostart Schedule.",
			Validations: []optimus-ide-collabsdk.ValidationError{{Field: "schedule", Detail: err.Error()}},
		})
	}
	...
	if err != nil {
		return optimus-ide-collabsdk.Workspace{}, httperror.NewResponseError(http.StatusBadRequest, optimus-ide-collabsdk.Response{
			...
			Validations: []optimus-ide-collabsdk.ValidationError{{Field: "ttl_ms", Detail: err.Error()}},
		})
	}
	...
	if req.AutomaticUpdates != "" {
		...
		if err != nil {
			return optimus-ide-collabsdk.Workspace{}, httperror.NewResponseError(http.StatusBadRequest, optimus-ide-collabsdk.Response{
				...
				Validations: []optimus-ide-collabsdk.ValidationError{{Field: "automatic_updates", Detail: err.Error()}},
			})
		}
	}
	...
	if err == nil {
		...
		return optimus-ide-collabsdk.Workspace{}, httperror.NewResponseError(http.StatusConflict, optimus-ide-collabsdk.Response{
...
func (api *API) requireWorkspaceOwnerExternalAuth(ctx context.Context, templateVersion database.TemplateVersion, ownerID uuid.UUID) error {
	...
	return httperror.NewResponseError(http.StatusForbidden, optimus-ide-collabsdk.Response{
...
func (api *API) preflightWorkspaceCreate(ctx context.Context, ownerID uuid.UUID, req optimus-ide-collabsdk.CreateWorkspaceRequest) (database.Template, error) {
	template, err := requestTemplate(ctx, req, api.Database)
	if err != nil {
	...
	if !api.HTTPAuth.AuthorizeContext(ctx, policy.ActionCreate,
		...
		return database.Template{}, httperror.NewResponseError(http.StatusForbidden, optimus-ide-collabsdk.Response{
	...
	if templateAccessControl.IsDeprecated() {
		return database.Template{}, httperror.NewResponseError(http.StatusBadRequest, optimus-ide-collabsdk.Response{
...
func requestTemplate(ctx context.Context, req optimus-ide-collabsdk.CreateWorkspaceRequest, db database.Store) (database.Template, error) {
	...
	if templateID == uuid.Nil {
		...
		if err != nil {
			return database.Template{}, httperror.NewResponseError(http.StatusInternalServerError, optimus-ide-collabsdk.Response{
				Message: "Internal error fetching template version.",
				Detail:  err.Error(),
			})
		}
	...
	if template.Deleted {
		return database.Template{}, httperror.NewResponseError(http.StatusNotFound, optimus-ide-collabsdk.Response{
...
func (api *API) notifyWorkspaceCreated(
	...
	parameters []optimus-ide-collabsdk.WorkspaceBuildParameter,
) {
...
// @Tags Workspaces
// @Param workspace path string true "Workspace ID" format(uuid)
// @Param request body optimus-ide-collabsdk.UpdateWorkspaceRequest true "Metadata update request"
// @Success 204
...
func (api *API) patchWorkspace(rw http.ResponseWriter, r *http.Request) {
	...
	var req optimus-ide-collabsdk.UpdateWorkspaceRequest
	if !httpapi.Read(ctx, rw, r, &req) {
		return
	}
	...
	if err != nil {
		...
		if errors.Is(err, sql.ErrNoRows) {
			httpapi.Write(ctx, rw, http.StatusMethodNotAllowed, optimus-ide-collabsdk.Response{
...
// @Tags Workspaces
// @Param workspace path string true "Workspace ID" format(uuid)
// @Param request body optimus-ide-collabsdk.UpdateWorkspaceAutostartRequest true "Schedule update request"
// @Success 204
...
func (api *API) putWorkspaceAutostart(rw http.ResponseWriter, r *http.Request) {
	...
	var req optimus-ide-collabsdk.UpdateWorkspaceAutostartRequest
	if !httpapi.Read(ctx, rw, r, &req) {
		return
	}
	...
	if !templateSchedule.UserAutostartEnabled {
		httpapi.Write(ctx, rw, http.StatusBadRequest, optimus-ide-collabsdk.Response{
			...
			Validations: []optimus-ide-collabsdk.ValidationError{{Field: "schedule", Detail: "Autostart is not allowed for workspaces using this template."}},
		})
		return
	}
...
// @Tags Workspaces
// @Param workspace path string true "Workspace ID" format(uuid)
// @Param request body optimus-ide-collabsdk.UpdateWorkspaceTTLRequest true "Workspace TTL update request"
// @Success 204
...
func (api *API) putWorkspaceTTL(rw http.ResponseWriter, r *http.Request) {
	...
	var req optimus-ide-collabsdk.UpdateWorkspaceTTLRequest
	if !httpapi.Read(ctx, rw, r, &req) {
		return
	}
	...
	err := api.Database.InTx(func(s database.Store) error {
		...
		if !templateSchedule.UserAutostopEnabled {
			return optimus-ide-collabsdk.ValidationError{Field: "ttl_ms", Detail: "Custom autostop TTL is not allowed for workspaces using this template."}
		}
		...
		if validityErr != nil {
			return optimus-ide-collabsdk.ValidationError{Field: "ttl_ms", Detail: validityErr.Error()}
		}
	...
	if err != nil {
		resp := optimus-ide-collabsdk.Response{
			Message: "Error updating workspace time until shutdown.",
		}
		var validErr optimus-ide-collabsdk.ValidationError
		if errors.As(err, &validErr) {
			resp.Validations = []optimus-ide-collabsdk.ValidationError{validErr}
...
// @Tags Workspaces
// @Param workspace path string true "Workspace ID" format(uuid)
// @Param request body optimus-ide-collabsdk.UpdateWorkspaceDormancy true "Make a workspace dormant or active"
// @Success 200 {object} optimus-ide-collabsdk.Workspace
...
func (api *API) putWorkspaceDormant(rw http.ResponseWriter, r *http.Request) {
	...
	var req optimus-ide-collabsdk.UpdateWorkspaceDormancy
	if !httpapi.Read(ctx, rw, r, &req) {
		return
	}
...
// @Tags Workspaces
// @Param workspace path string true "Workspace ID" format(uuid)
// @Param request body optimus-ide-collabsdk.PutExtendWorkspaceRequest true "Extend deadline update request"
...
func (api *API) putExtendWorkspace(rw http.ResponseWriter, r *http.Request) {
	...
	var req optimus-ide-collabsdk.PutExtendWorkspaceRequest
	if !httpapi.Read(ctx, rw, r, &req) {
		return
	}
...
// @Accept json
// @Param workspace path string true "Workspace ID" format(uuid)
// @Param request body optimus-ide-collabsdk.PostWorkspaceUsageRequest false "Post workspace usage request"
// @Success 204
...
func (api *API) postWorkspaceUsage(rw http.ResponseWriter, r *http.Request) {
	...
	if !api.Experiments.Enabled(optimus-ide-collabsdk.ExperimentWorkspaceUsage) {
	...
	ctx := r.Context()
	var req optimus-ide-collabsdk.PostWorkspaceUsageRequest
	if !httpapi.Read(ctx, rw, r, &req) {
		return
	}
	...
	if !slices.Contains(optimus-ide-collabsdk.AllowedAppNames, req.AppName) {
		httpapi.Write(ctx, rw, http.StatusBadRequest, optimus-ide-collabsdk.Response{
			Message: "Invalid request",
			Validations: []optimus-ide-collabsdk.ValidationError{{
				Field:  "app_name",
				Detail: fmt.Sprintf("must be one of %v", optimus-ide-collabsdk.AllowedAppNames),
			}},
		})
		return
	}
	...
	switch req.AppName {
	case optimus-ide-collabsdk.UsageAppNameVscode:
		stat.SessionCountVscode = 1
	case optimus-ide-collabsdk.UsageAppNameJetbrains:
		stat.SessionCountJetbrains = 1
	case optimus-ide-collabsdk.UsageAppNameReconnectingPty:
		stat.SessionCountReconnectingPty = 1
	case optimus-ide-collabsdk.UsageAppNameSSH:
		stat.SessionCountSsh = 1
	default:
		// This means the app_name is in the optimus-ide-collabsdk.AllowedAppNames but not being
...
// @Tags Workspaces
// @Param workspace path string true "Workspace ID" format(uuid)
// @Param request body optimus-ide-collabsdk.UpdateWorkspaceAutomaticUpdatesRequest true "Automatic updates request"
// @Success 204
...
func (api *API) putWorkspaceAutoupdates(rw http.ResponseWriter, r *http.Request) {
	...
	var req optimus-ide-collabsdk.UpdateWorkspaceAutomaticUpdatesRequest
	if !httpapi.Read(ctx, rw, r, &req) {
		return
	}
	...
	if !database.AutomaticUpdates(req.AutomaticUpdates).Valid() {
		httpapi.Write(ctx, rw, http.StatusBadRequest, optimus-ide-collabsdk.Response{
			Message:     "Invalid request",
			Validations: []optimus-ide-collabsdk.ValidationError{{Field: "automatic_updates", Detail: "must be always or never"}},
		})
		return
	}
...
// @Tags Workspaces
// @Param workspace path string true "Workspace ID" format(uuid)
// @Success 200 {object} optimus-ide-collabsdk.ResolveAutostartResponse
...
func (api *API) resolveAutostart(rw http.ResponseWriter, r *http.Request) {
	...
	if !useActiveVersion {
		httpapi.Write(ctx, rw, http.StatusOK, optimus-ide-collabsdk.ResolveAutostartResponse{})
		return
	}
	...
	resolver := optimus-ide-collabsdk.ParameterResolver{
		Rich: db2sdk.WorkspaceBuildParameters(dbBuildParams),
	}

	var response optimus-ide-collabsdk.ResolveAutostartResponse
...
// @Tags Workspaces
// @Param workspace path string true "Workspace ID" format(uuid)
// @Success 200 {object} optimus-ide-collabsdk.ServerSentEvent
...
func (api *API) watchWorkspace(
	...
	sendUpdate := func(_ context.Context, _ []byte) {
		...
		if err != nil {
			_ = sendEvent(optimus-ide-collabsdk.ServerSentEvent{
				Type: optimus-ide-collabsdk.ServerSentEventTypeError,
				Data: optimus-ide-collabsdk.Response{
					Message: "Internal error fetching workspace.",
					Detail:  err.Error(),
				},
			})
		...
		_ = sendEvent(optimus-ide-collabsdk.ServerSentEvent{
			Type: optimus-ide-collabsdk.ServerSentEventTypeData,
			Data: w,
		})
	}
	...
	_ = sendEvent(optimus-ide-collabsdk.ServerSentEvent{
		Type: optimus-ide-collabsdk.ServerSentEventTypePing,
	})
...
func (api *API) watchAllWorkspaceBuilds(rw http.ResponseWriter, r *http.Request) {
	...
	updates := make(chan optimus-ide-collabsdk.WorkspaceBuildUpdate, 256)

	cancelSubscribe, err := api.Pubsub.SubscribeWithErr(wspubsub.AllWorkspaceEventChannel,
		wspubsub.HandleWorkspaceBuildUpdate(
			func(_ context.Context, update optimus-ide-collabsdk.WorkspaceBuildUpdate, err error) {
				if err != nil {
	...
	enc := wsjson.NewEnoptimus-ide-collab[optimus-ide-collabsdk.WorkspaceBuildUpdate](conn, websocket.MessageText)
	for {
		select {
		case <-ctx.Done():
			return
...
// @Tags Workspaces
// @Param workspace path string true "Workspace ID" format(uuid)
// @Success 200 {object} optimus-ide-collabsdk.WorkspaceBuildTimings
...
// @Tags Workspaces
// @Param workspace path string true "Workspace ID" format(uuid)
// @Success 200 {object} optimus-ide-collabsdk.WorkspaceACL
...
func (api *API) workspaceACL(rw http.ResponseWriter, r *http.Request) {
	...
	// Convert the db types to the optimus-ide-collabsdk.WorkspaceUser type
	users := make([]optimus-ide-collabsdk.WorkspaceUser, 0, len(dbUsers))
	for _, it := range dbUsers {
		users = append(users, optimus-ide-collabsdk.WorkspaceUser{
	...
	groups := make([]optimus-ide-collabsdk.WorkspaceGroup, 0, len(dbGroups))
	for _, it := range dbGroups {
		groups = append(groups, optimus-ide-collabsdk.WorkspaceGroup{
	...
	httpapi.Write(ctx, rw, http.StatusOK, optimus-ide-collabsdk.WorkspaceACL{
		Users:  users,
		Groups: groups,
	})
}
...
// @Tags Workspaces
// @Param workspace path string true "Workspace ID" format(uuid)
// @Param request body optimus-ide-collabsdk.UpdateWorkspaceACL true "Update workspace ACL request"
// @Success 204
...
func (api *API) patchWorkspaceACL(rw http.ResponseWriter, r *http.Request) {
	...
	var req optimus-ide-collabsdk.UpdateWorkspaceACL
	if !httpapi.Read(ctx, rw, r, &req) {
		return
	}
	...
	err := api.Database.InTx(func(tx database.Store) error {
		...
		for id, role := range req.UserRoles {
			if role == optimus-ide-collabsdk.WorkspaceRoleDeleted {
...
type workspaceData struct {
	...
	builds       []optimus-ide-collabsdk.WorkspaceBuild
	appStatuses  []optimus-ide-collabsdk.WorkspaceAppStatus
	allowRenames bool
}
...
func convertWorkspaces(
	...
	buildByWorkspaceID := map[uuid.UUID]optimus-ide-collabsdk.WorkspaceBuild{}
	...
	appStatusesByWorkspaceID := map[uuid.UUID]optimus-ide-collabsdk.WorkspaceAppStatus{}
	for _, appStatus := range data.appStatuses {
		appStatusesByWorkspaceID[appStatus.WorkspaceID] = appStatus
	}

	apiWorkspaces := make([]optimus-ide-collabsdk.Workspace, 0, len(workspaces))
	for _, workspace := range workspaces {
...
func convertWorkspace(
	...
	requesterID uuid.UUID,
	workspace database.Workspace,
	workspaceBuild optimus-ide-collabsdk.WorkspaceBuild,
	template database.Template,
	allowRenames bool,
	latestAppStatus optimus-ide-collabsdk.WorkspaceAppStatus,
) (optimus-ide-collabsdk.Workspace, error) {
	if requesterID == uuid.Nil {
		return optimus-ide-collabsdk.Workspace{}, xerrors.Errorf("developer error: requesterID cannot be uuid.Nil!")
	}
	...
	return optimus-ide-collabsdk.Workspace{
		ID:                                   workspace.ID,
		...
		DormantAt:                            dormantAt,
		Health: optimus-ide-collabsdk.WorkspaceHealth{
			Healthy:       len(failingAgents) == 0,
			FailingAgents: failingAgents,
		},
		AutomaticUpdates: optimus-ide-collabsdk.AutomaticUpdates(workspace.AutomaticUpdates),
...
func sharedWorkspaceActors(
	...
	out := make([]optimus-ide-collabsdk.SharedWorkspaceActor, 0, len(workspace.UserACL)+len(workspace.GroupACL))
	...
	for id, aclEntry := range workspace.UserACL {
		...
		out = append(out, optimus-ide-collabsdk.SharedWorkspaceActor{
			ID:        userID,
			ActorType: optimus-ide-collabsdk.SharedWorkspaceActorTypeUser,
			Roles:     []optimus-ide-collabsdk.WorkspaceRole{convertToWorkspaceRole(aclEntry.Permissions)},
	...
	for id, aclEntry := range workspace.GroupACL {
		...
		out = append(out, optimus-ide-collabsdk.SharedWorkspaceActor{
			ID:        groupID,
			ActorType: optimus-ide-collabsdk.SharedWorkspaceActorTypeGroup,
			Roles:     []optimus-ide-collabsdk.WorkspaceRole{convertToWorkspaceRole(aclEntry.Permissions)},
...
func validWorkspaceAutomaticUpdates(updates optimus-ide-collabsdk.AutomaticUpdates) (database.AutomaticUpdates, error) {
	if updates == "" {
...
type WorkspaceACLUpdateValidator optimus-ide-collabsdk.UpdateWorkspaceACL
...
// WorkspaceACLUpdateValidator implements acl.UpdateValidator[optimus-ide-collabsdk.WorkspaceRole]
var _ acl.UpdateValidator[optimus-ide-collabsdk.WorkspaceRole] = WorkspaceACLUpdateValidator{}

func (w WorkspaceACLUpdateValidator) Users() (map[string]optimus-ide-collabsdk.WorkspaceRole, string) {
	return w.UserRoles, workspaceACLUpdateUsersFieldName
}

func (w WorkspaceACLUpdateValidator) Groups() (map[string]optimus-ide-collabsdk.WorkspaceRole, string) {
	return w.GroupRoles, workspaceACLUpdateGroupsFieldName
}

func (WorkspaceACLUpdateValidator) ValidateRole(role optimus-ide-collabsdk.WorkspaceRole) error {
	actions := db2sdk.WorkspaceRoleActions(role)
	if len(actions) == 0 && role != optimus-ide-collabsdk.WorkspaceRoleDeleted {
...
func convertToWorkspaceRole(actions []policy.Action) optimus-ide-collabsdk.WorkspaceRole {
	switch {
	case slice.SameElements(actions, db2sdk.WorkspaceRoleActions(optimus-ide-collabsdk.WorkspaceRoleAdmin)):
		return optimus-ide-collabsdk.WorkspaceRoleAdmin
	case slice.SameElements(actions, db2sdk.WorkspaceRoleActions(optimus-ide-collabsdk.WorkspaceRoleUse)):
		return optimus-ide-collabsdk.WorkspaceRoleUse
	}

	return optimus-ide-collabsdk.WorkspaceRoleDeleted
}
...
// @Success 200 {array} optimus-ide-collabsdk.MinimalUser
...
func (api *API) workspaceAvailableUsers(rw http.ResponseWriter, r *http.Request) {
	...
	minimalUsers := make([]optimus-ide-collabsdk.MinimalUser, 0, len(users))
	for _, user := range users {
		minimalUsers = append(minimalUsers, optimus-ide-collabsdk.MinimalUser{
			ID:        user.ID,
