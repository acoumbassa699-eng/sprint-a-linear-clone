...
// @Produce json
// @Tags General
// @Success 200 {object} optimus-ide-collabsdk.UpdateCheckResponse
// @Router /api/v2/updatecheck [get]
func (api *API) updateCheck(rw http.ResponseWriter, r *http.Request) {
	ctx := r.Context()

	currentVersion := optimus-ide-collabsdk.UpdateCheckResponse{
		Current: true,
	...
	httpapi.Write(ctx, rw, http.StatusOK, optimus-ide-collabsdk.UpdateCheckResponse{
