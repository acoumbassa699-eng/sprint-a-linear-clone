...
func requireBuildTimeStatsEmpty(t *testing.T, stats optimus-ide-collabsdk.TemplateBuildTimeStats) {
	require.Empty(t, stats[optimus-ide-collabsdk.WorkspaceTransitionStart])
	require.Empty(t, stats[optimus-ide-collabsdk.WorkspaceTransitionStop])
	require.Empty(t, stats[optimus-ide-collabsdk.WorkspaceTransitionDelete])
}
...
func TestCache_BuildTime(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.want.loads {
				wantTransition := optimus-ide-collabsdk.WorkspaceTransition(tt.args.transition)
				gotStats := cache.TemplateBuildTimeStats(template.ID)
