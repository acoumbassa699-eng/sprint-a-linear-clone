...
// @Success 200 {array} optimus-ide-collabsdk.OAuth2ProviderApp
...
// @Success 200 {object} optimus-ide-collabsdk.OAuth2ProviderApp
...
// @Produce json
// @Tags Enterprise
// @Param request body optimus-ide-collabsdk.PostOAuth2ProviderAppRequest true "The OAuth2 application to create."
// @Success 200 {object} optimus-ide-collabsdk.OAuth2ProviderApp
...
// @Tags Enterprise
// @Param app path string true "App ID"
// @Param request body optimus-ide-collabsdk.PutOAuth2ProviderAppRequest true "Update an OAuth2 application."
// @Success 200 {object} optimus-ide-collabsdk.OAuth2ProviderApp
...
// @Tags Enterprise
// @Param app path string true "App ID"
// @Success 200 {array} optimus-ide-collabsdk.OAuth2ProviderAppSecret
...
// @Tags Enterprise
// @Param app path string true "App ID"
// @Success 200 {array} optimus-ide-collabsdk.OAuth2ProviderAppSecretFull
...
// @Param response_type query optimus-ide-collabsdk.OAuth2ProviderResponseType true "Response type"
...
// @Param grant_type formData optimus-ide-collabsdk.OAuth2ProviderGrantType true "Grant type"
...
// @Produce json
// @Tags Enterprise
// @Success 200 {object} optimus-ide-collabsdk.OAuth2AuthorizationServerMetadata
...
// @Produce json
// @Tags Enterprise
// @Success 200 {object} optimus-ide-collabsdk.OAuth2ProtectedResourceMetadata
...
// @Produce json
// @Tags Enterprise
// @Param request body optimus-ide-collabsdk.OAuth2ClientRegistrationRequest true "Client registration request"
// @Success 201 {object} optimus-ide-collabsdk.OAuth2ClientRegistrationResponse
...
// @Produce json
// @Tags Enterprise
// @Success 200 {object} optimus-ide-collabsdk.OAuth2ProviderSettings
...
func (api *API) oauth2ProviderSettings(rw http.ResponseWriter, r *http.Request) {
	...
	httpapi.Write(ctx, rw, http.StatusOK, optimus-ide-collabsdk.OAuth2ProviderSettings{
...
// @Produce json
// @Tags Enterprise
// @Param request body optimus-ide-collabsdk.OAuth2ProviderSettings true "OAuth2 provider settings request"
// @Success 200 {object} optimus-ide-collabsdk.OAuth2ProviderSettings
// @Router /api/v2/oauth2-provider/settings [put]
func (api *API) putOAuth2ProviderSettings(rw http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	var req optimus-ide-collabsdk.OAuth2ProviderSettings
...
// @Success 200 {object} optimus-ide-collabsdk.OAuth2ClientConfiguration
...
// @Tags Enterprise
// @Param client_id path string true "Client ID"
// @Param request body optimus-ide-collabsdk.OAuth2ClientRegistrationRequest true "Client update request"
// @Success 200 {object} optimus-ide-collabsdk.OAuth2ClientConfiguration
