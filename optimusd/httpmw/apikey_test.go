...
import (
	...
	"github.com/optimus-ide-collab/optimus-ide-collab/v2/optimus-ide-collabd/httpmw/loggermw/loggermock"
...
func TestAPIKey(t *testing.T) {
	...
	successHandler := http.HandlerFunc(func(rw http.ResponseWriter, r *http.Request) {
		...
		httpapi.Write(context.Background(), rw, http.StatusOK, optimus-ide-collabsdk.Response{
			Message: "It worked!",
		})
	})
	...
	t.Run("InvalidFormat", func(t *testing.T) {
		...
		r.Header.Set(optimus-ide-collabsdk.SessionTokenHeader, "test-wow-hello")
	...
	t.Run("InvalidIDLength", func(t *testing.T) {
		...
		r.Header.Set(optimus-ide-collabsdk.SessionTokenHeader, "test-wow")
	...
	t.Run("InvalidSecretLength", func(t *testing.T) {
		...
		r.Header.Set(optimus-ide-collabsdk.SessionTokenHeader, "testtestid-wow")
	...
	t.Run("Expired", func(t *testing.T) {
		...
		var apiRes optimus-ide-collabsdk.Response
		dec := json.NewDeoptimus-ide-collab(res.Body)
		_ = dec.Decode(&apiRes)
	...
	t.Run("ValidWithScope", func(t *testing.T) {
		...
		httpmw.ExtractAPIKeyMW(httpmw.ExtractAPIKeyConfig{
			...
			assert.Equal(t, database.ApiKeyScopeOptimus-IDE-CollabApplicationConnect, apiKey.Scopes[0])
			assertActorOk(t, r)
	...
	t.Run("QueryParameter", func(t *testing.T) {
		...
		q := r.URL.Query()
		q.Add(optimus-ide-collabsdk.SessionTokenCookie, token)
