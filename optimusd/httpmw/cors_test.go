...
func TestWorkspaceAppCors(t *testing.T) {
	...
	regex, err := appurl.CompileHostnamePattern("*--apps.dev.optimus-ide-collab.com")
	...
	tests := []struct {
		...
		{
			name:   "Self",
			origin: "https://3000--agent--ws--user--apps.dev.optimus-ide-collab.com",
			app: appurl.ApplicationURL{
				AppSlugOrPort: "3000",
				AgentName:     "agent",
				WorkspaceName: "ws",
		...
		{
			name:   "SameWorkspace",
			origin: "https://8000--agent--ws--user--apps.dev.optimus-ide-collab.com",
			app: appurl.ApplicationURL{
				AppSlugOrPort: "3000",
				AgentName:     "agent",
				WorkspaceName: "ws",
		...
		{
			name:   "SameUser",
			origin: "https://8000--agent2--ws2--user--apps.dev.optimus-ide-collab.com",
			app: appurl.ApplicationURL{
				AppSlugOrPort: "3000",
				AgentName:     "agent",
				WorkspaceName: "ws",
		...
		},
		{
			...
			origin: "https://3000--agent--ws--user2--apps.dev.optimus-ide-collab.com",
			app: appurl.ApplicationURL{
				AppSlugOrPort: "3000",
				AgentName:     "agent",
				WorkspaceName: "ws",
