...
func TestPrometheus(t *testing.T) {
	...
	t.Run("Concurrent", func(t *testing.T) {
		...
		concurrentWebsockets, ok := metricLabels["optimus-ide-collabd_api_concurrent_websockets"]
		require.True(t, ok, "optimus-ide-collabd_api_concurrent_websockets metric not found")
	...
	t.Run("UserRoute", func(t *testing.T) {
		...
		reqProcessed, ok := metricLabels["optimus-ide-collabd_api_requests_processed_total"]
		require.True(t, ok, "optimus-ide-collabd_api_requests_processed_total metric not found")
		require.Equal(t, "/api/v2/users/{user}", reqProcessed["path"])
		require.Equal(t, "GET", reqProcessed["method"])

		concurrentRequests, ok := metricLabels["optimus-ide-collabd_api_concurrent_requests"]
		require.True(t, ok, "optimus-ide-collabd_api_concurrent_requests metric not found")
