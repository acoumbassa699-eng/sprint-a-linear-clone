...
func NewLoginHelper(client *optimus-ide-collabsdk.Client, fake *FakeIDP) *LoginHelper {
	if client == nil {
...
// convenience method.
func (h *LoginHelper) Login(t *testing.T, idTokenClaims jwt.MapClaims) (*optimus-ide-collabsdk.Client, *http.Response) {
	t.Helper()
	unauthenticatedClient := optimus-ide-collabsdk.New(h.client.URL)

	return h.fake.Login(t, unauthenticatedClient, idTokenClaims)
}

// AttemptLogin does not assert a successful login.
func (h *LoginHelper) AttemptLogin(t *testing.T, idTokenClaims jwt.MapClaims) (*optimus-ide-collabsdk.Client, *http.Response) {
	t.Helper()
	unauthenticatedClient := optimus-ide-collabsdk.New(h.client.URL)
...
func (*LoginHelper) ExpireOauthToken(t *testing.T, db database.Store, user *optimus-ide-collabsdk.Client) database.UserLink {
	t.Helper()
...
func (h *LoginHelper) ForceRefresh(t *testing.T, db database.Store, user *optimus-ide-collabsdk.Client, idToken jwt.MapClaims) {
	t.Helper()
