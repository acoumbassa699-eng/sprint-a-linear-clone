...
func TestFakeIDPBasicFlow(t *testing.T) {
	...
	// This is the Optimus-IDE-Collab callback using an actual network request.
	fake.SetOptimus-IDE-CollabdCallbackHandler(func(w http.ResponseWriter, r *http.Request) {
		// Emulate OIDC flow
