...
func AssertRBAC(t *testing.T, api *optimus-ide-collabd.API, client *optimus-ide-collabsdk.Client) RBACAsserter {
...
// convertObjects converts the optimus-ide-collabsdk types to rbac.Object. Unfortunately
...
func caller(skip int) string {
	...
	i := strings.Index(file, "optimus-ide-collab")
	if i >= 0 {
		file = file[i:]
	}
