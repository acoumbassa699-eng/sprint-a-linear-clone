...
const (
	...
	MCPServerName = "Optimus-IDE-Collab"
	// MCPServerInstructions is the instructions text for the MCP server.
	MCPServerInstructions = "Optimus-IDE-Collab MCP Server providing workspace and template management tools"
...
func (s *Server) RegisterTools(client *optimus-ide-collabsdk.Client, opts ...func(*toolsdk.Deps)) error {
	if client == nil {
...
// refuse to add Optimus-IDE-Collab as a connector.
func (s *Server) RegisterChatGPTTools(client *optimus-ide-collabsdk.Client, opts ...func(*toolsdk.Deps)) error {
	if client == nil {
		return xerrors.New("client cannot be nil: MCP HTTP server requires authenticated client")
	}
