...
//
//  1. The workspace agent periodically POSTs stats to optimus-ide-collabd.  On receiving
//     this POST, if there is an active SSH or web terminal session, bump both
//     the workspace's last_used_at and the deadline.
//  2. The optimus-ide-collabd app proxy and wsproxy will periodically report app status
//     (optimus-ide-collabd calls directly, wsproxy POSTs).  This only bumps the workspace's
...
//
// https://github.com/optimus-ide-collab/internal/issues/196
