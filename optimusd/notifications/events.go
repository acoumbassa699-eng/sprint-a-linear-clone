...
// TODO: autogenerate these: https://github.com/optimus-ide-collab/team-coconut/issues/36
// TODO(defelmnq): add fallback icon to optimus-ide-collabd/inboxnofication.go when adding a new template
