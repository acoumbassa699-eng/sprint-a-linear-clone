	...
	return &Metrics{
		...
		QueuedSeconds: promauto.With(reg).NewHistogramVec(prometheus.HistogramOpts{
			...
			Help: "The time elapsed between a notification being enqueued in the store and retrieved for dispatching " +
				"(measures the latency of the notifications system). This should generally be within OPTIMUS-IDE-COLLAB_NOTIFICATIONS_FETCH_INTERVAL " +
				"seconds; higher values for a sustained period indicates delayed processing and OPTIMUS-IDE-COLLAB_NOTIFICATIONS_LEASE_COUNT " +
