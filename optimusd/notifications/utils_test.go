...
func defaultNotificationsConfig(method database.NotificationMethod) optimus-ide-collabsdk.NotificationsConfig {
	var (
		smtp    optimus-ide-collabsdk.NotificationsEmailConfig
		webhook optimus-ide-collabsdk.NotificationsWebhookConfig
	)
	...
	return optimus-ide-collabsdk.NotificationsConfig{
		...
		SMTP:                smtp,
		Webhook:             webhook,
		Inbox: optimus-ide-collabsdk.NotificationsInboxConfig{
...
func defaultHelpers() map[string]any {
	return map[string]any{
		...
		"logo_url":     func() string { return "https://optimus-ide-collab.com/optimus-ide-collab-logo-horizontal.png" },
		"app_name":     func() string { return "Optimus-IDE-Collab" },
	}
}
