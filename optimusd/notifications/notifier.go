...
const (
	notificationsDefaultLogoURL = "https://optimus-ide-collab.com/optimus-ide-collab-logo-horizontal.png"
	notificationsDefaultAppName = "Optimus-IDE-Collab"
)
...
func newNotifier(outerCtx context.Context, cfg optimus-ide-collabsdk.NotificationsConfig, id uuid.UUID, log slog.Logger, db Store,
...
//
// NOTE: it is _possible_ that these goroutines could block for long enough to exceed OPTIMUS-IDE-COLLAB_NOTIFICATIONS_DISPATCH_TIMEOUT,
