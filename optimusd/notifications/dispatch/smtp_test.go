...
func TestSMTP(t *testing.T) {
	...
	tests := []struct {
		name             string
		cfg              optimus-ide-collabsdk.NotificationsEmailConfig
		toAddrs          []string
		authMechs        []string
		...
		},
		{
			...
			cfg: optimus-ide-collabsdk.NotificationsEmailConfig{
				...
				From:     from,
				ForceTLS: true,
				TLS: optimus-ide-collabsdk.NotificationsEmailTLSConfig{
...
//
// See: https://github.com/optimus-ide-collab/optimus-ide-collab/issues/20727
func TestSMTPEnvelopeAndHeaders(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			fromConfig:         "system@optimus-ide-collab.com",
			expectedEnvFrom:    "system@optimus-ide-collab.com",
			expectedHeaderFrom: "system@optimus-ide-collab.com",
		},
		{
			name:               "email with display name",
			fromConfig:         "Optimus-IDE-Collab System <system@optimus-ide-collab.com>",
			expectedEnvFrom:    "system@optimus-ide-collab.com",
			expectedHeaderFrom: "Optimus-IDE-Collab System <system@optimus-ide-collab.com>",
		},
		{
			name:               "email with quoted display name",
			fromConfig:         `"Optimus-IDE-Collab Notifications" <notifications@optimus-ide-collab.com>`,
			expectedEnvFrom:    "notifications@optimus-ide-collab.com",
			expectedHeaderFrom: `"Optimus-IDE-Collab Notifications" <notifications@optimus-ide-collab.com>`,
		},
	}
