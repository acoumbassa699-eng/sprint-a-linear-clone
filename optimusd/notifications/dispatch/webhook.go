...
type WebhookHandler struct {
	cfg optimus-ide-collabsdk.NotificationsWebhookConfig
	log slog.Logger
...
func NewWebhookHandler(cfg optimus-ide-collabsdk.NotificationsWebhookConfig, log slog.Logger) *WebhookHandler {
