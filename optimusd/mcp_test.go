...
func mcpDeploymentValues(t testing.TB) *optimus-ide-collabsdk.DeploymentValues {
	t.Helper()

	return optimus-ide-collabdtest.DeploymentValues(t)
}

// newMCPClient creates a test server and returns the admin client.
func newMCPClient(t testing.TB) *optimus-ide-collabsdk.Client {
	t.Helper()

	providerKeys := optimus-ide-collabdtest.FakeOpenAICompatProviderAPIKeys(t)
	return optimus-ide-collabdtest.New(t, &optimus-ide-collabdtest.Options{
...
func createMCPServerConfig(t testing.TB, client *optimus-ide-collabsdk.Client, slug string, enabled bool) optimus-ide-collabsdk.MCPServerConfig {
	t.Helper()

	ctx := testutil.Context(t, testutil.WaitLong)
	config, err := client.CreateMCPServerConfig(ctx, optimus-ide-collabsdk.CreateMCPServerConfigRequest{
...
func TestMCPServerConfigsCRUD(t *testing.T) {
	...
	created, err := client.CreateMCPServerConfig(ctx, optimus-ide-collabsdk.CreateMCPServerConfigRequest{
	...
	require.False(t, created.ForwardOptimus-IDE-CollabHeaders)
	...
	require.False(t, configs[0].ForwardOptimus-IDE-CollabHeaders)

	fetched, err := client.MCPServerConfigByID(ctx, created.ID)
	require.NoError(t, err)
	require.Equal(t, created.ID, fetched.ID)
	require.False(t, fetched.AllowInPlanMode)
	require.False(t, fetched.ForwardOptimus-IDE-CollabHeaders)

	// Update display name, availability, allow_in_plan_mode, and
	// forward_optimus-ide-collab_headers.
	newName := "Renamed Server"
	newAvail := "force_on"
	allowInPlanMode := true
	forwardOptimus-IDE-CollabHeaders := true
	updated, err := client.UpdateMCPServerConfig(ctx, created.ID, optimus-ide-collabsdk.UpdateMCPServerConfigRequest{
		DisplayName:         &newName,
		Availability:        &newAvail,
		AllowInPlanMode:     &allowInPlanMode,
		ForwardOptimus-IDE-CollabHeaders: &forwardOptimus-IDE-CollabHeaders,
	})
	require.NoError(t, err)
	...
	require.True(t, updated.ForwardOptimus-IDE-CollabHeaders)
	...
	require.True(t, configs[0].ForwardOptimus-IDE-CollabHeaders)

	fetched, err = client.MCPServerConfigByID(ctx, created.ID)
	require.NoError(t, err)
	require.True(t, fetched.AllowInPlanMode)
	require.True(t, fetched.ForwardOptimus-IDE-CollabHeaders)
...
// secrets. See: https://github.com/optimus-ide-collab/optimus-ide-collab/pull/23227#discussion_r2959461109
func TestMCPServerConfigsSecretsNeverLeaked(t *testing.T) {
	...
	created, err := adminClient.CreateMCPServerConfig(ctx, optimus-ide-collabsdk.CreateMCPServerConfigRequest{
...
func TestMCPServerConfigsAuthConnected(t *testing.T) {
	...
	_, err = adminClient.CreateMCPServerConfig(ctx, optimus-ide-collabsdk.CreateMCPServerConfigRequest{
...
func TestMCPServerConfigsUserOIDCClearsFields(t *testing.T) {
	...
	_, err = client.UpdateMCPServerConfig(ctx, created.ID, optimus-ide-collabsdk.UpdateMCPServerConfigRequest{
	...
	_, err = client.CreateMCPServerConfig(ctx, optimus-ide-collabsdk.CreateMCPServerConfigRequest{
...
func TestMCPServerConfigsOAuth2Disconnect(t *testing.T) {
	...
	newDisconnectFixture := func(t *testing.T, slug, revocationURL string) (memberClient *optimus-ide-collabsdk.Client, memberID uuid.UUID, db database.Store, configID uuid.UUID) {
		t.Helper()
		...
		firstUser := optimus-ide-collabdtest.CreateFirstUser(t, adminClient)
		memberClient, member := optimus-ide-collabdtest.CreateAnotherUser(t, adminClient, firstUser.OrganizationID)
	...
	t.Run("DoesNotRevealHiddenConfigs", func(t *testing.T) {
		...
		ctx := testutil.Context(t, testutil.WaitLong)
		providerKeys := optimus-ide-collabdtest.FakeOpenAICompatProviderAPIKeys(t)
		adminClient, _ := optimus-ide-collabdtest.NewWithDatabase(t, &optimus-ide-collabdtest.Options{
			DeploymentValues:    mcpDeploymentValues(t),
			ChatProviderAPIKeys: &providerKeys,
		})
		firstUser := optimus-ide-collabdtest.CreateFirstUser(t, adminClient)
	...
	t.Run("RefreshCannotRestoreDisconnectedToken", func(t *testing.T) {
		...
		type configResult struct {
			configs []optimus-ide-collabsdk.MCPServerConfig
			err     error
		}
	...
	t.Run("OnlyDisconnectsCallingUser", func(t *testing.T) {
		...
		firstUser := optimus-ide-collabdtest.CreateFirstUser(t, adminClient)
		memberClient, member := optimus-ide-collabdtest.CreateAnotherUser(t, adminClient, firstUser.OrganizationID)
		otherClient, other := optimus-ide-collabdtest.CreateAnotherUser(t, adminClient, firstUser.OrganizationID)
		...
		requireAuthConnected := func(client *optimus-ide-collabsdk.Client, want bool) {
			t.Helper()
			configs, err := client.MCPServerConfigs(ctx)
			require.NoError(t, err)
			require.Len(t, configs, 1)
...
func TestMCPServerConfigsOAuth2AutoDiscovery(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		...
		overridden, err := client.CreateMCPServerConfig(ctx, optimus-ide-collabsdk.CreateMCPServerConfigRequest{
	...
	t.Run("RedirectURIContainsRealConfigID", func(t *testing.T) {
		...
		authServer := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
			...
			case "/register":
				...
				if err := json.NewDeoptimus-ide-collab(r.Body).Decode(&body); err != nil {
...
func createChatModelConfigForMCP(t testing.TB, client *optimus-ide-collabsdk.ExperimentalClient) optimus-ide-collabsdk.ChatModelConfig {
	t.Helper()
