...
// https://github.com/optimus-ide-collab/optimus-ide-collab/issues/1194
//
...
// Production callers reload once at startup; tests reload per optimus-ide-collabd.
...
//
// TODO: @emyrk This would be great if it was instanced to a optimus-ide-collabd rather
	...
	roles := builtInRoleMap{
		...
		agentsAccess: func(organizationID uuid.UUID) Role {
			return Role{
				...
				DisplayName: "Optimus-IDE-Collab Agents User",
				Site:        []Permission{},
				User:        []Permission{},
				ByOrgID: map[string]OrgPermissions{
					organizationID.String(): {
