...
func TestExternalScopeNames(t *testing.T) {
	...
	for _, name := range names {
		...
		// Composite optimus-ide-collab:* scopes expand to one or more site permissions.
		if strings.HasPrefix(name, "optimus-ide-collab:") {
...
func TestIsExternalScope(t *testing.T) {
	...
	require.True(t, IsExternalScope("optimus-ide-collab:workspaces.create"))
