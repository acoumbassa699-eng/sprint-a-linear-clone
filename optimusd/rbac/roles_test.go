...
// These were "pared down" in https://github.com/optimus-ide-collab/optimus-ide-collab/pull/21359 to avoid
...
func TestRolePermissions(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			// replicas to optimus-ide-collabd. Keys are deployment-wide.
			Name:     "AIGatewayKey",
			Actions:  []policy.Action{policy.ActionCreate, policy.ActionRead, policy.ActionDelete},
