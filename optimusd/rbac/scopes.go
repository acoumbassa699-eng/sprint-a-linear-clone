...
const (
	ScopeAll                ScopeName = "optimus-ide-collab:all"
	ScopeApplicationConnect ScopeName = "optimus-ide-collab:application_connect"
...
// Composite optimus-ide-collab:* scopes expand to multiple low-level resource:action permissions
...
// CompositeSitePermissions returns the site-level Permission list for a optimus-ide-collab:* scope.
...
// CompositeScopeNames lists all high-level optimus-ide-collab:* names in sorted order.
