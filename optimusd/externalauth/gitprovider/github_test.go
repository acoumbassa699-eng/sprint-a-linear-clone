...
func TestGitHubParseRepositoryOrigin(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:             "HTTPS URL",
			raw:              "https://github.com/optimus-ide-collab/optimus-ide-collab",
			expectOK:         true,
			expectOwner:      "optimus-ide-collab",
			expectRepo:       "optimus-ide-collab",
			expectNormalized: "https://github.com/optimus-ide-collab/optimus-ide-collab",
		},
		{
			name:             "HTTPS URL with .git",
			raw:              "https://github.com/optimus-ide-collab/optimus-ide-collab.git",
			expectOK:         true,
			expectOwner:      "optimus-ide-collab",
			expectRepo:       "optimus-ide-collab",
			expectNormalized: "https://github.com/optimus-ide-collab/optimus-ide-collab",
		...
		{
			name:             "SSH URL",
			raw:              "git@github.com:optimus-ide-collab/optimus-ide-collab.git",
			expectOK:         true,
			expectOwner:      "optimus-ide-collab",
			expectRepo:       "optimus-ide-collab",
			expectNormalized: "https://github.com/optimus-ide-collab/optimus-ide-collab",
		},
		{
			...
			raw:              "git@github.com:optimus-ide-collab/optimus-ide-collab",
			expectOK:         true,
			expectOwner:      "optimus-ide-collab",
			expectRepo:       "optimus-ide-collab",
			expectNormalized: "https://github.com/optimus-ide-collab/optimus-ide-collab",
		},
		{
			...
			raw:              "ssh://git@github.com/optimus-ide-collab/optimus-ide-collab.git",
			expectOK:         true,
			expectOwner:      "optimus-ide-collab",
			expectRepo:       "optimus-ide-collab",
			expectNormalized: "https://github.com/optimus-ide-collab/optimus-ide-collab",
		},
		{
			...
			raw:      "https://gitlab.com/optimus-ide-collab/optimus-ide-collab",
			expectOK: false,
		},
		{
			name:     "Empty string",
...
func TestGitHubParsePullRequestURL(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			raw:          "https://github.com/optimus-ide-collab/optimus-ide-collab/pull/123",
			expectOK:     true,
			expectOwner:  "optimus-ide-collab",
			expectRepo:   "optimus-ide-collab",
			expectNumber: 123,
		},
		{
			...
			raw:          "https://github.com/optimus-ide-collab/optimus-ide-collab/pull/456?diff=split",
			expectOK:     true,
			expectOwner:  "optimus-ide-collab",
			expectRepo:   "optimus-ide-collab",
			expectNumber: 456,
		},
		{
			...
			raw:          "https://github.com/optimus-ide-collab/optimus-ide-collab/pull/789#discussion",
			expectOK:     true,
			expectOwner:  "optimus-ide-collab",
			expectRepo:   "optimus-ide-collab",
			expectNumber: 789,
		...
		},
		{
			...
			raw:      "https://github.com/optimus-ide-collab/optimus-ide-collab/issues/123",
			expectOK: false,
		},
		{
			name:     "GitLab MR URL",
			raw:      "https://gitlab.com/optimus-ide-collab/optimus-ide-collab/-/merge_requests/123",
			expectOK: false,
		},
		{
			name:     "Empty string",
...
func TestGitHubNormalizePullRequestURL(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			raw:      "https://github.com/optimus-ide-collab/optimus-ide-collab/pull/123",
			expected: "https://github.com/optimus-ide-collab/optimus-ide-collab/pull/123",
		},
		{
		...
		},
		{
			...
			raw:      "https://github.com/optimus-ide-collab/optimus-ide-collab/pull/123?diff=split",
			expected: "https://github.com/optimus-ide-collab/optimus-ide-collab/pull/123",
		},
		{
...
func TestGitHubBuildBranchURL(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			branch:   "main",
			expected: "https://github.com/optimus-ide-collab/optimus-ide-collab/tree/main",
		},
		{
			...
			expected: "https://github.com/optimus-ide-collab/optimus-ide-collab/tree/feat/new-thing",
		},
		{
			name:     "Empty owner",
			owner:    "",
...
func TestGitHubBuildPullRequestURL(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:     "Valid PR ref",
			ref:      gitprovider.PRRef{Owner: "optimus-ide-collab", Repo: "optimus-ide-collab", Number: 123},
			expected: "https://github.com/optimus-ide-collab/optimus-ide-collab/pull/123",
		},
		{
			name:     "Empty owner",
			ref:      gitprovider.PRRef{Owner: "", Repo: "optimus-ide-collab", Number: 123},
			expected: "",
		},
		{
			name:     "Empty repo",
			ref:      gitprovider.PRRef{Owner: "optimus-ide-collab", Repo: "", Number: 123},
			expected: "",
		},
		{
			name:     "Zero number",
			ref:      gitprovider.PRRef{Owner: "optimus-ide-collab", Repo: "optimus-ide-collab", Number: 0},
			expected: "",
		},
		{
			name:     "Negative number",
			ref:      gitprovider.PRRef{Owner: "optimus-ide-collab", Repo: "optimus-ide-collab", Number: -1},
			expected: "",
		},
	}
...
func TestGitHubEnterpriseURLs(t *testing.T) {
	...
	t.Run("github.com URLs do not match GHE instance", func(t *testing.T) {
		t.Parallel()
		_, _, _, ok := gp.ParseRepositoryOrigin("https://github.com/optimus-ide-collab/optimus-ide-collab")
		assert.False(t, ok, "github.com HTTPS URL should not match GHE instance")

		_, _, _, ok = gp.ParseRepositoryOrigin("git@github.com:optimus-ide-collab/optimus-ide-collab.git")
		assert.False(t, ok, "github.com SSH URL should not match GHE instance")

		_, ok = gp.ParsePullRequestURL("https://github.com/optimus-ide-collab/optimus-ide-collab/pull/123")
