...
func (b Builder) DeploymentValues(dv *optimus-ide-collabsdk.DeploymentValues) Builder {
	// nolint: revive
	b.deploymentValues = dv
	return b
}

func (b Builder) Experiments(exp optimus-ide-collabsdk.Experiments) Builder {
	// nolint: revive
	cpy := make(optimus-ide-collabsdk.Experiments, len(exp))
	copy(cpy, exp)
	b.experiments = cpy
	return b
}
...
func (b Builder) RichParameterValues(p []optimus-ide-collabsdk.WorkspaceBuildParameter) Builder {
	// nolint: revive
...
func (e BuildError) Response() (int, optimus-ide-collabsdk.Response) {
	...
	return e.Status, optimus-ide-collabsdk.Response{
		Message: e.Message,
		Detail:  e.Error(),
	}
}
...
func (b *Builder) findNewBuildParameterValue(name string, presets []database.TemplateVersionPresetParameter) *optimus-ide-collabsdk.WorkspaceBuildParameter {
...
func (b *Builder) checkTemplateJobStatus() error {
	...
	templateVersionJobStatus := optimus-ide-collabsdk.ProvisionerJobStatus(templateVersionJob.JobStatus)
...
func (b *Builder) checkRunningBuild() error {
	...
	if optimus-ide-collabsdk.ProvisionerJobStatus(job.JobStatus).Active() {
