...
func TestTemplateBuilderBases(t *testing.T) {
	...
	t.Run("OK", func(t *testing.T) {
		...
		basesByID := make(map[string]optimus-ide-collabsdk.TemplateBuilderBase, len(resp.Bases))
...
func TestTemplateBuilderSession(t *testing.T) {
	...
	t.Run("WizardEntry", func(t *testing.T) {
		...
		err := client.TemplateBuilderSession(ctx, optimus-ide-collabsdk.TemplateBuilderSessionRequest{
			SessionID: uuid.New(),
			EventType: optimus-ide-collabsdk.TemplateBuilderSessionEventWizardEntry,
		})
		require.NoError(t, err)
	})
	...
	t.Run("ComposeCompletion", func(t *testing.T) {
		...
		err := client.TemplateBuilderSession(ctx, optimus-ide-collabsdk.TemplateBuilderSessionRequest{
			SessionID:       uuid.New(),
			EventType:       optimus-ide-collabsdk.TemplateBuilderSessionEventComposeCompletion,
	...
	t.Run("MemberCannotSubmit", func(t *testing.T) {
		...
		err := memberClient.TemplateBuilderSession(ctx, optimus-ide-collabsdk.TemplateBuilderSessionRequest{
			EventType: optimus-ide-collabsdk.TemplateBuilderSessionEventWizardEntry,
		})
		require.Error(t, err)
