...
const (
	TallymanOptimus-IDE-CollabLicenseKeyHeader   = "Optimus-IDE-Collab-License-Key"
	TallymanOptimus-IDE-CollabDeploymentIDHeader = "Optimus-IDE-Collab-Deployment-ID"
)
