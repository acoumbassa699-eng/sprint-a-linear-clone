...
func TestOAuth2ClientMetadataValidation(t *testing.T) {
	...
	t.Run("GrantTypeValidation", func(t *testing.T) {
		...
		tests := []struct {
			...
			},
			{
				...
				grantTypes:  []optimus-ide-collabsdk.OAuth2ProviderGrantType{"authorization_code"},
				expectError: false,
			},
			{
				name:        "InvalidRefreshTokenAlone",
				grantTypes:  []optimus-ide-collabsdk.OAuth2ProviderGrantType{"refresh_token"},
				expectError: true, // refresh_token requires authorization_code to be present
			},
			{
				name:        "ValidMultiple",
				grantTypes:  []optimus-ide-collabsdk.OAuth2ProviderGrantType{"authorization_code", "refresh_token"},
				expectError: false,
			},
			{
				name:        "InvalidUnsupported",
				grantTypes:  []optimus-ide-collabsdk.OAuth2ProviderGrantType{"client_credentials"},
				expectError: true,
			},
			{
				name:        "InvalidPassword",
				grantTypes:  []optimus-ide-collabsdk.OAuth2ProviderGrantType{"password"},
				expectError: true,
			},
			{
				name:        "InvalidImplicit",
				grantTypes:  []optimus-ide-collabsdk.OAuth2ProviderGrantType{"implicit"},
				expectError: true,
			},
			{
				name:        "MixedValidInvalid",
				grantTypes:  []optimus-ide-collabsdk.OAuth2ProviderGrantType{"authorization_code", "client_credentials"},
				expectError: true,
			},
		}
	...
	t.Run("ResponseTypeValidation", func(t *testing.T) {
		...
		tests := []struct {
			...
			{
				name:          "ValidCode",
				responseTypes: []optimus-ide-collabsdk.OAuth2ProviderResponseType{"code"},
				expectError:   false,
			},
			{
				name:          "InvalidToken",
				responseTypes: []optimus-ide-collabsdk.OAuth2ProviderResponseType{"token"},
				expectError:   true,
			},
			{
				name:          "InvalidImplicit",
				responseTypes: []optimus-ide-collabsdk.OAuth2ProviderResponseType{"id_token"},
				expectError:   true,
			},
			{
				name:          "InvalidMultiple",
				responseTypes: []optimus-ide-collabsdk.OAuth2ProviderResponseType{"code", "token"},
				expectError:   true,
			},
		}
