...
func CreateTestOAuth2App(t *testing.T, client *optimus-ide-collabsdk.Client) (*optimus-ide-collabsdk.OAuth2ProviderApp, string) {
	t.Helper()
...
func EnableDCR(t *testing.T, client *optimus-ide-collabsdk.Client) {
	t.Helper()
...
func doAuthorizeRequest(t *testing.T, client *optimus-ide-collabsdk.Client, baseURL string, params AuthorizeParams) *http.Response {
	t.Helper()
	...
	// Add session token
	req.Header.Set("Optimus-IDE-Collab-Session-Token", client.SessionToken())
...
func AuthorizeOAuth2App(t *testing.T, client *optimus-ide-collabsdk.Client, baseURL string, params AuthorizeParams) string {
	t.Helper()
...
func ExchangeCodeForToken(t *testing.T, baseURL string, params TokenExchangeParams) *oauth2.Token {
	...
	err = json.NewDeoptimus-ide-collab(resp.Body).Decode(&tokenResp)
...
func RequireOAuth2Error(t *testing.T, resp *http.Response, expectedError string) {
	...
	err := json.NewDeoptimus-ide-collab(resp.Body).Decode(&errorResp)
...
func CleanupOAuth2App(t *testing.T, client *optimus-ide-collabsdk.Client, appID uuid.UUID) {
	t.Helper()
...
func AuthorizeOAuth2AppExpectingError(t *testing.T, client *optimus-ide-collabsdk.Client, baseURL string, params AuthorizeParams, expectedStatusCode int) {
	t.Helper()
