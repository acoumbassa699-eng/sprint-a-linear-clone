...
func AuditLogs(ctx context.Context, db database.Store, query string) (database.GetAuditLogsOffsetParams,
	database.CountAuditLogsParams, []optimus-ide-collabsdk.ValidationError,
) {
...
func ConnectionLogs(ctx context.Context, db database.Store, query string, apiKey database.APIKey) (database.GetConnectionLogsOffsetParams, database.CountConnectionLogsParams, []optimus-ide-collabsdk.ValidationError) {
	// Always lowercase for all searches.
	query = strings.ToLower(query)
	values, errors := searchTerms(query, func(term string, values url.Values) error {
	...
	filter := database.GetConnectionLogsOffsetParams{
		...
		Status:              string(httpapi.ParseCustom(parser, values, "", "status", httpapi.ParseEnum[optimus-ide-collabsdk.ConnectionLogStatus])),
	}
...
func Users(query string) (database.GetUsersParams, []optimus-ide-collabsdk.ValidationError) {
	// Always lowercase for all searches.
	query = strings.ToLower(query)
	values, errors := searchTerms(query, func(term string, values url.Values) error {
		values.Add("search", term)
...
func Members(query string, organizationID uuid.UUID) (database.OrganizationMembersParams, []optimus-ide-collabsdk.ValidationError) {
...
func Workspaces(ctx context.Context, db database.Store, query string, page optimus-ide-collabsdk.Pagination, agentInactiveDisconnectTimeout time.Duration, actorID uuid.UUID) (database.GetWorkspacesParams, []optimus-ide-collabsdk.ValidationError) {
...
func Templates(ctx context.Context, db database.Store, actorID uuid.UUID, query string) (database.GetTemplatesWithFilterParams, []optimus-ide-collabsdk.ValidationError) {
	// Always lowercase for all searches.
	query = strings.ToLower(query)
	values, errors := searchTerms(query, func(term string, values url.Values) error {
	...
	if filter.AuthorUsername == optimus-ide-collabsdk.Me {
...
func AIBridgeSessions(ctx context.Context, db database.Store, query string, page optimus-ide-collabsdk.Pagination, actorID uuid.UUID, afterSessionID string) (database.ListAIBridgeSessionsParams, []optimus-ide-collabsdk.ValidationError) {
	...
	if !filter.StartedBefore.IsZero() && !filter.StartedAfter.IsZero() && !filter.StartedBefore.After(filter.StartedAfter) {
		parser.Errors = append(parser.Errors, optimus-ide-collabsdk.ValidationError{
...
func AIBridgeModels(query string, page optimus-ide-collabsdk.Pagination) (database.ListAIBridgeModelsParams, []optimus-ide-collabsdk.ValidationError) {
	// nolint:exhaustruct // Empty values just means "don't filter by that field".
...
func AIBridgeClients(query string, page optimus-ide-collabsdk.Pagination) (database.ListAIBridgeClientsParams, []optimus-ide-collabsdk.ValidationError) {
	// nolint:exhaustruct // Empty values just means "don't filter by that field".
...
func Tasks(ctx context.Context, db database.Store, query string, actorID uuid.UUID) (database.ListTasksParams, []optimus-ide-collabsdk.ValidationError) {
...
func Chats(query string) (database.GetChatsParams, []optimus-ide-collabsdk.ValidationError) {
...
func searchTerms(query string, defaultKey func(term string, values url.Values) error) (url.Values, []optimus-ide-collabsdk.ValidationError) {
	...
	for _, element := range elements {
		if strings.HasPrefix(element, ":") || strings.HasSuffix(element, ":") {
			return nil, []optimus-ide-collabsdk.ValidationError{
				{
					Field:  "q",
...
func parseUser(ctx context.Context, db database.Store, parser *httpapi.QueryParamParser, vals url.Values, queryParam string, actorID uuid.UUID) uuid.UUID {
	return httpapi.ParseCustom(parser, vals, uuid.Nil, queryParam, func(v string) (uuid.UUID, error) {
		...
		if v == optimus-ide-collabsdk.Me && actorID != uuid.Nil {
			return actorID, nil
		}
...
func parseGroup(ctx context.Context, db database.Store, parser *httpapi.QueryParamParser, vals url.Values, queryParam string) uuid.UUID {
	return httpapi.ParseCustom(parser, vals, uuid.Nil, queryParam, func(v string) (uuid.UUID, error) {
		...
		case 2:
			orgName := parts[0]
			if err := optimus-ide-collabsdk.NameValid(orgName); err != nil {
		...
		if err := optimus-ide-collabsdk.GroupNameValid(groupName); err != nil {
