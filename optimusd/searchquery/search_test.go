...
func TestSearchWorkspace(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			Query: `param:"image=ghcr.io/optimus-ide-collab/optimus-ide-collab-preview:main"`,
			Expected: database.GetWorkspacesParams{
				ParamNames:  []string{"image"},
				ParamValues: []string{"ghcr.io/optimus-ide-collab/optimus-ide-collab-preview:main"},
			},
		},
		{
	...
	for _, c := range testCases {
		t.Run(c.Name, func(t *testing.T) {
			...
			values, errs := searchquery.Workspaces(context.Background(), db, c.Query, optimus-ide-collabsdk.Pagination{}, 0, c.ActorID)
	...
	t.Run("AgentInactiveDisconnectTimeout", func(t *testing.T) {
		...
		db, _ := dbtestutil.NewDB(t)
		values, errs := searchquery.Workspaces(context.Background(), db, query, optimus-ide-collabsdk.Pagination{}, timeout, uuid.Nil)
	...
	testCases := []struct {
		...
		},
		{
			...
			Expected: database.GetUsersParams{
				Search:    "user-name",
				Status:    []database.UserStatus{database.UserStatusActive},
				RbacRole:  []string{optimus-ide-collabsdk.RoleOwner},
				LoginType: []database.LoginType{},
			},
		},
		{
			...
			Expected: database.GetUsersParams{
				...
				RbacRole:  []string{optimus-ide-collabsdk.RoleMember},
				LoginType: []database.LoginType{},
			},
		},
		{
...
func TestSearchChats(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			Name:  "DiffURL",
			Query: `diff_url:"https://github.com/optimus-ide-collab/optimus-ide-collab/pull/123"`,
			Expected: database.GetChatsParams{
				Archived:  sql.NullBool{Bool: false, Valid: true},
				OwnedOnly: true,
				DiffURL: sql.NullString{
					String: "https://github.com/optimus-ide-collab/optimus-ide-collab/pull/123",
					Valid:  true,
				},
			},
		},
		...
		},
		{
			...
			Expected: database.GetChatsParams{
				...
				OwnedOnly: true,
				DiffURL: sql.NullString{
					String: "https://github.com/optimus-ide-collab/optimus-ide-collab/pull/1",
					Valid:  true,
				},
			},
		},
		...
		},
		{
			...
			Query: `title:deploy diff_url:"https://github.com/optimus-ide-collab/optimus-ide-collab/pull/456"`,
			Expected: database.GetChatsParams{
				Archived:   sql.NullBool{Bool: false, Valid: true},
				OwnedOnly:  true,
				TitleQuery: "deploy",
				DiffURL:    sql.NullString{String: "https://github.com/optimus-ide-collab/optimus-ide-collab/pull/456", Valid: true},
			},
		},
		{
			Name:  "PrNumber",
		...
		{
			Name:  "RepoQuery",
			Query: "repo:optimus-ide-collab/optimus-ide-collab",
			Expected: database.GetChatsParams{
				Archived:  sql.NullBool{Bool: false, Valid: true},
				OwnedOnly: true,
				RepoQuery: "optimus-ide-collab/optimus-ide-collab",
			},
		},
		{
			Name:  "PrTitleQuery",
		...
		},
		{
			...
			Query: "pr:99 repo:optimus-ide-collab/optimus-ide-collab pr_title:deploy",
			Expected: database.GetChatsParams{
				Archived:     sql.NullBool{Bool: false, Valid: true},
				OwnedOnly:    true,
				PrNumber:     99,
		...
		},
		{
			...
			Query: `repo:optimus-ide-collab/optimus-ide-collab archived:true search:"foo bar"`,
			Expected: database.GetChatsParams{
				Archived:  sql.NullBool{Bool: true, Valid: true},
				OwnedOnly: true,
				RepoQuery: "optimus-ide-collab/optimus-ide-collab",
		...
		},
		{
			...
			Query: `search:foo archived:true repo:optimus-ide-collab/optimus-ide-collab diff_url:"https://github.com/optimus-ide-collab/optimus-ide-collab/pull/1" has_unread:true pr_status:open source:created_by_me`,
			Expected: database.GetChatsParams{
				Archived:            sql.NullBool{Bool: true, Valid: true},
				OwnedOnly:           true,
				RepoQuery:           "optimus-ide-collab/optimus-ide-collab",
				DiffURL:             sql.NullString{String: "https://github.com/optimus-ide-collab/optimus-ide-collab/pull/1", Valid: true},
				HasUnread:           sql.NullBool{Bool: true, Valid: true},
				PullRequestStatuses: []string{"open"},
				Search:              "foo",
			},
