...
func keyIDs(keys []optimus-ide-collabsdk.AIProviderKey) []uuid.UUID {
...
func TestAIProvidersCRUD(t *testing.T) {
	...
	t.Run("CreatePreservesPresetProviderTypes", func(t *testing.T) {
		...
		tests := []struct {
			...
			{providerType: optimus-ide-collabsdk.AIProviderTypeAzure, baseURL: "https://example.openai.azure.com/openai/v1"},
			{providerType: optimus-ide-collabsdk.AIProviderTypeGoogle, baseURL: "https://generativelanguage.googleapis.com/v1beta/openai/"},
			{providerType: optimus-ide-collabsdk.AIProviderTypeOpenAICompat, baseURL: "https://compat.example.com/v1"},
			{providerType: optimus-ide-collabsdk.AIProviderTypeOpenrouter, baseURL: "https://openrouter.ai/api/v1"},
			{providerType: optimus-ide-collabsdk.AIProviderTypeVercel, baseURL: "https://ai-gateway.vercel.sh/v1"},
		}
	...
	t.Run("CreateGetUpdateDelete", func(t *testing.T) {
		...
		req := optimus-ide-collabsdk.CreateAIProviderRequest{
			...
			Settings: optimus-ide-collabsdk.AIProviderSettings{
				Bedrock: &optimus-ide-collabsdk.AIProviderBedrockSettings{
					Region: "us-east-1",
				},
			},
		}
		...
		disabled := false
		updated, err := client.UpdateAIProvider(ctx, created.Name, optimus-ide-collabsdk.UpdateAIProviderRequest{
	...
	t.Run("RequiredBaseURL", func(t *testing.T) {
		...
		//nolint:gocritic // Owner role is the audience for this endpoint.
		_, err := client.CreateAIProvider(ctx, optimus-ide-collabsdk.CreateAIProviderRequest{
			Type:    optimus-ide-collabsdk.AIProviderTypeOpenAI,
		...
		require.Contains(t, sdkErr.Validations, optimus-ide-collabsdk.ValidationError{Field: "base_url", Detail: "base_url is required"})
		...
		baseURL = ""
		_, err = client.UpdateAIProvider(ctx, created.Name, optimus-ide-collabsdk.UpdateAIProviderRequest{
			BaseURL: &baseURL,
		})
		sdkErr = requireSDKError(t, err, http.StatusBadRequest)
		require.Equal(t, "Invalid AI provider request.", sdkErr.Message)
	...
	t.Run("UpdateSettingsEmptyObjectRejected", func(t *testing.T) {
		...
		var body optimus-ide-collabsdk.Response
		require.NoError(t, json.NewDeoptimus-ide-collab(res.Body).Decode(&body))
	...
	t.Run("ListExcludesDeletedProviderKeys", func(t *testing.T) {
		...
		// own keys.
		//nolint:gocritic // Owner role is the audience for this endpoint.
		deleted, err := client.CreateAIProvider(ctx, optimus-ide-collabsdk.CreateAIProviderRequest{
			Type:    optimus-ide-collabsdk.AIProviderTypeOpenAI,
			Name:    "list-deleted",
			Enabled: true,
			BaseURL: "https://api.openai.com/v1",
		...
		live, err := client.CreateAIProvider(ctx, optimus-ide-collabsdk.CreateAIProviderRequest{
			Type:    optimus-ide-collabsdk.AIProviderTypeOpenAI,
			Name:    "list-live",
			Enabled: true,
			BaseURL: "https://api.openai.com/v1",
	...
	t.Run("Unauthenticated", func(t *testing.T) {
		...
		anon := optimus-ide-collabsdk.New(ownerClient.URL)
	...
	t.Run("BedrockSettingsRequireAnthropic", func(t *testing.T) {
		...
		require.NoError(t, err)
		_, err = client.UpdateAIProvider(ctx, provider.Name, optimus-ide-collabsdk.UpdateAIProviderRequest{
			Settings: &optimus-ide-collabsdk.AIProviderSettings{
...
func TestAIProvidersKeyManagement(t *testing.T) {
	...
	t.Run("UpdateReplacesKeys", func(t *testing.T) {
		...
		replacement := []optimus-ide-collabsdk.AIProviderKeyMutation{
		...
		updated, err := client.UpdateAIProvider(ctx, provider.Name, optimus-ide-collabsdk.UpdateAIProviderRequest{
			APIKeys: &replacement,
		})
		require.NoError(t, err)
	...
	t.Run("UpdateKeepsExistingByID", func(t *testing.T) {
		...
		// implicitly removed.
		patch := []optimus-ide-collabsdk.AIProviderKeyMutation{
			{ID: &keepID},
	...
	t.Run("UpdateClearsKeys", func(t *testing.T) {
		...
		empty := []optimus-ide-collabsdk.AIProviderKeyMutation{}
		updated, err := client.UpdateAIProvider(ctx, provider.Name, optimus-ide-collabsdk.UpdateAIProviderRequest{
			APIKeys: &empty,
		})
		require.NoError(t, err)
	...
	t.Run("UpdateKeepOnlyIsNoOp", func(t *testing.T) {
		...
		mutations := []optimus-ide-collabsdk.AIProviderKeyMutation{
	...
	t.Run("BedrockRejectsUpdateWithKeys", func(t *testing.T) {
		...
		rejected := []optimus-ide-collabsdk.AIProviderKeyMutation{
	...
	t.Run("CopilotCreateWithoutKeys", func(t *testing.T) {
		...
		//nolint:gocritic // Owner role is the audience for this endpoint.
		provider, err := client.CreateAIProvider(ctx, optimus-ide-collabsdk.CreateAIProviderRequest{
			Type:    optimus-ide-collabsdk.AIProviderTypeCopilot,
			Name:    "keys-copilot",
			Enabled: true,
			BaseURL: "https://api.business.githubcopilot.com",
		})
		require.NoError(t, err)
		require.Equal(t, optimus-ide-collabsdk.AIProviderTypeCopilot, provider.Type)
	...
	t.Run("WhitespaceKeyRejected", func(t *testing.T) {
		...
		muts := []optimus-ide-collabsdk.AIProviderKeyMutation{{APIKey: &padded}}
		_, err = client.UpdateAIProvider(ctx, provider.Name, optimus-ide-collabsdk.UpdateAIProviderRequest{
			APIKeys: &muts,
		})
		require.Error(t, err)
	...
	t.Run("NonOwnerForbidden", func(t *testing.T) {
		t.Parallel()
		ownerClient := optimus-ide-collabdtest.New(t, nil)
		firstUser := optimus-ide-collabdtest.CreateFirstUser(t, ownerClient)
		ctx := testutil.Context(t, testutil.WaitLong)
		...
		_, err = memberClient.UpdateAIProvider(ctx, provider.Name, optimus-ide-collabsdk.UpdateAIProviderRequest{
			APIKeys: &patch,
		})
		require.Error(t, err)
		var sdkErr *optimus-ide-collabsdk.Error
	...
	t.Run("MutationBothFieldsRejected", func(t *testing.T) {
		...
		muts := []optimus-ide-collabsdk.AIProviderKeyMutation{
	...
	t.Run("PATCHKeysSurfacesOpsInAudit", func(t *testing.T) {
		...
		updatedProvider, err := client.UpdateAIProvider(ctx, provider.Name, optimus-ide-collabsdk.UpdateAIProviderRequest{
			APIKeys: &mutations,
		})
		require.NoError(t, err)
		...
		var added optimus-ide-collabsdk.AIProviderKey
	...
	t.Run("MutationUnknownIDRejected", func(t *testing.T) {
		...
		bogus := uuid.New()
		muts := []optimus-ide-collabsdk.AIProviderKeyMutation{{ID: &bogus}}
		_, err = client.UpdateAIProvider(ctx, provider.Name, optimus-ide-collabsdk.UpdateAIProviderRequest{
			APIKeys: &muts,
		})
		require.Error(t, err)
...
func TestAIProvidersBedrockExternalID(t *testing.T) {
	...
	createBedrock := func(t *testing.T, client *optimus-ide-collabsdk.Client, name string, b optimus-ide-collabsdk.AIProviderBedrockSettings) (optimus-ide-collabsdk.AIProvider, error) {
		t.Helper()
		ctx := testutil.Context(t, testutil.WaitLong)
		//nolint:gocritic // Owner role is the audience for this endpoint.
		return client.CreateAIProvider(ctx, optimus-ide-collabsdk.CreateAIProviderRequest{
			Type:     optimus-ide-collabsdk.AIProviderTypeBedrock,
			Name:     name,
			Enabled:  true,
			BaseURL:  "https://bedrock-runtime.us-east-1.amazonaws.com",
			Settings: optimus-ide-collabsdk.AIProviderSettings{Bedrock: &b},
		})
	}
	...
	t.Run("GeneratedWhenRoleSet", func(t *testing.T) {
		...
		created, err := createBedrock(t, client, "bedrock-role", optimus-ide-collabsdk.AIProviderBedrockSettings{
			Region:  "us-east-1",
			RoleARN: roleARN,
		})
		require.NoError(t, err)
	...
	t.Run("AbsentWithoutRole", func(t *testing.T) {
		...
		created, err := createBedrock(t, client, "bedrock-no-role", optimus-ide-collabsdk.AIProviderBedrockSettings{Region: "us-east-1"})
		require.NoError(t, err)
		require.NotNil(t, created.Settings.Bedrock)
	...
	t.Run("RejectsClientValueOnCreate", func(t *testing.T) {
		...
		_, err := createBedrock(t, client, "bedrock-client-id", optimus-ide-collabsdk.AIProviderBedrockSettings{
			Region:     "us-east-1",
			RoleARN:    roleARN,
			ExternalID: "client-supplied-value",
		})
		sdkErr := requireSDKError(t, err, http.StatusBadRequest)
		require.Contains(t, sdkErr.Validations, optimus-ide-collabsdk.ValidationError{
	...
	t.Run("StableWhenPatchOmitsValue", func(t *testing.T) {
		...
		created, err := createBedrock(t, client, "bedrock-stable", optimus-ide-collabsdk.AIProviderBedrockSettings{
			Region:  "us-east-1",
			RoleARN: roleARN,
		})
		require.NoError(t, err)
		...
		updated, err := client.UpdateAIProvider(ctx, created.Name, optimus-ide-collabsdk.UpdateAIProviderRequest{
			Settings: &optimus-ide-collabsdk.AIProviderSettings{
				Bedrock: &optimus-ide-collabsdk.AIProviderBedrockSettings{Region: "us-west-2", RoleARN: roleARN},
			},
		})
		require.NoError(t, err)
		require.Equal(t, "us-west-2", updated.Settings.Bedrock.Region)
	...
	t.Run("StableAcrossRoleRemovalAndReassignment", func(t *testing.T) {
		...
		created, err := createBedrock(t, client, "bedrock-toggle", optimus-ide-collabsdk.AIProviderBedrockSettings{
			Region:  "us-east-1",
			RoleARN: roleARN,
		})
		require.NoError(t, err)
		...
		cleared, err := client.UpdateAIProvider(ctx, created.Name, optimus-ide-collabsdk.UpdateAIProviderRequest{
			Settings: &optimus-ide-collabsdk.AIProviderSettings{
				Bedrock: &optimus-ide-collabsdk.AIProviderBedrockSettings{Region: "us-east-1"},
			},
		})
		...
		readded, err := client.UpdateAIProvider(ctx, created.Name, optimus-ide-collabsdk.UpdateAIProviderRequest{
			Settings: &optimus-ide-collabsdk.AIProviderSettings{
				Bedrock: &optimus-ide-collabsdk.AIProviderBedrockSettings{Region: "us-east-1", RoleARN: roleB},
			},
		})
		require.NoError(t, err)
	...
	t.Run("AllowsEchoedValueOnPatch", func(t *testing.T) {
		...
		created, err := createBedrock(t, client, "bedrock-echo", optimus-ide-collabsdk.AIProviderBedrockSettings{
			Region:  "us-east-1",
			RoleARN: roleARN,
		})
		require.NoError(t, err)
		...
		updated, err := client.UpdateAIProvider(ctx, created.Name, optimus-ide-collabsdk.UpdateAIProviderRequest{
			Settings: &optimus-ide-collabsdk.AIProviderSettings{
				Bedrock: &optimus-ide-collabsdk.AIProviderBedrockSettings{Region: "us-west-2", RoleARN: roleARN, ExternalID: original},
			},
		})
		require.NoError(t, err)
		require.Equal(t, "us-west-2", updated.Settings.Bedrock.Region)
	...
	t.Run("RejectsChangedValueOnPatch", func(t *testing.T) {
		...
		created, err := createBedrock(t, client, "bedrock-change", optimus-ide-collabsdk.AIProviderBedrockSettings{
			Region:  "us-east-1",
			RoleARN: roleARN,
		})
		require.NoError(t, err)
		...
		_, err = client.UpdateAIProvider(ctx, created.Name, optimus-ide-collabsdk.UpdateAIProviderRequest{
			Settings: &optimus-ide-collabsdk.AIProviderSettings{
				Bedrock: &optimus-ide-collabsdk.AIProviderBedrockSettings{Region: "us-east-1", RoleARN: roleARN, ExternalID: "client-tries-to-change-it"},
			},
		})
		sdkErr := requireSDKError(t, err, http.StatusBadRequest)
	...
	t.Run("GeneratedWhenRoleAddedByPatch", func(t *testing.T) {
		...
		created, err := createBedrock(t, client, "bedrock-add-role", optimus-ide-collabsdk.AIProviderBedrockSettings{Region: "us-east-1"})
		require.NoError(t, err)
		require.Empty(t, created.Settings.Bedrock.ExternalID)

		updated, err := client.UpdateAIProvider(ctx, created.Name, optimus-ide-collabsdk.UpdateAIProviderRequest{
			Settings: &optimus-ide-collabsdk.AIProviderSettings{
				Bedrock: &optimus-ide-collabsdk.AIProviderBedrockSettings{Region: "us-east-1", RoleARN: roleARN},
			},
		})
		require.NoError(t, err)
	...
	t.Run("RejectsClientValueWhenRoleAddedByPatch", func(t *testing.T) {
		...
		created, err := createBedrock(t, client, "bedrock-add-role-id", optimus-ide-collabsdk.AIProviderBedrockSettings{Region: "us-east-1"})
		require.NoError(t, err)
		require.Empty(t, created.Settings.Bedrock.ExternalID)
		...
		_, err = client.UpdateAIProvider(ctx, created.Name, optimus-ide-collabsdk.UpdateAIProviderRequest{
			Settings: &optimus-ide-collabsdk.AIProviderSettings{
				Bedrock: &optimus-ide-collabsdk.AIProviderBedrockSettings{Region: "us-east-1", RoleARN: roleARN, ExternalID: "client-supplied-value"},
			},
		})
		sdkErr := requireSDKError(t, err, http.StatusBadRequest)
		require.Equal(t, externalIDReadOnlyMsg, sdkErr.Message)
