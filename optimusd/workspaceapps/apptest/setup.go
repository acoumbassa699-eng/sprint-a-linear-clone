...
const (
	...
	proxyTestSubdomainRaw = "*.test.optimus-ide-collab.com"
	proxyTestSubdomain    = "test.optimus-ide-collab.com"
)
...
type Deployment struct {
	...
	FirstUser      optimus-ide-collabsdk.CreateFirstUserResponse
...
type App struct {
	...
	CORSBehavior optimus-ide-collabsdk.CORSBehavior
}
...
// AppClient returns a *optimus-ide-collabsdk.Client that will route all requests to the
...
func (d *Details) AppClient(t *testing.T) *optimus-ide-collabsdk.Client {
	client := optimus-ide-collabsdk.New(d.PathAppBaseURL, optimus-ide-collabsdk.WithSessionToken(d.SDKClient.SessionToken()))
...
func setupProxyTestWithFactory(t *testing.T, factory DeploymentFactory, opts *DeploymentOptions) *Details {
	...
	// requests regardless of hostname to the optimus-ide-collabd test server.
	...
	me, err := deployment.SDKClient.User(ctx, optimus-ide-collabsdk.Me)
	...
	details.Apps.PublicCORSPassthru = App{
		...
		CORSBehavior:  optimus-ide-collabsdk.CORSBehaviorPassthru,
		Query:         proxyTestAppQuery,
	}
...
//nolint:revive
func createWorkspaceWithApps(t *testing.T, client *optimus-ide-collabsdk.Client, orgID uuid.UUID, me optimus-ide-collabsdk.User, port uint16, serveHTTPS bool, workspaceMutators ...func(*optimus-ide-collabsdk.CreateWorkspaceRequest)) (optimus-ide-collabsdk.Workspace, optimus-ide-collabsdk.WorkspaceAgent) {
	...
	workspaceMutators = append([]func(*optimus-ide-collabsdk.CreateWorkspaceRequest){
		func(req *optimus-ide-collabsdk.CreateWorkspaceRequest) {
	...
	workspace := optimus-ide-collabdtest.CreateWorkspace(t, client, template.ID, workspaceMutators...)
	...
	agents := make([]optimus-ide-collabsdk.WorkspaceAgent, 0, 1)
...
func doWithRetries(t require.TestingT, client *optimus-ide-collabsdk.Client, req *http.Request) (*http.Response, error) {
...
func requestWithRetries(ctx context.Context, t testing.TB, client *optimus-ide-collabsdk.Client, method, urlOrPath string, body interface{}, opts ...optimus-ide-collabsdk.RequestOption) (*http.Response, error) {
	t.Helper()
	var resp *http.Response
	var err error
	require.Eventually(t, func() bool {
...
func forceURLTransport(t *testing.T, client *optimus-ide-collabsdk.Client) {
