...
import (
	...
	"github.com/optimus-ide-collab/optimus-ide-collab/v2/scaletest/placebo"
)

func Test_Runner(t *testing.T) {
	t.Skip("This test is flakey, see https://github.com/optimus-ide-collab/optimus-ide-collab/actions/runs/3463709674/jobs/5784335013#step:9:215")
	t.Parallel()
