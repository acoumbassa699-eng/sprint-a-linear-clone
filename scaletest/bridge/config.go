...
type Config struct {
	...
	// "bridge": Create users in Optimus-IDE-Collab and use their session tokens to make requests through AI Gateway.
...
func (c Config) NewStrategy(client *optimus-ide-collabsdk.Client) requestModeStrategy {
	if c.Mode == RequestModeDirect {
