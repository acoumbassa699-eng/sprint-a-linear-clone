...
func (r *Runner) Run(ctx context.Context, id string, logs io.Writer) error {
	...
	// runner's client. Using optimus-ide-collabsdk.New directly would inherit
	...
	// land on the same optimus-ide-collabd replica, concentrating load.
...
func (r *Runner) dialTailnet(ctx context.Context, client *optimus-ide-collabsdk.Client, user optimus-ide-collabsdk.User, logger slog.Logger) (*tailnet.ControlProtocolClients, error) {
...
func (r *Runner) watchWorkspaceUpdates(ctx context.Context, clients *tailnet.ControlProtocolClients, user optimus-ide-collabsdk.User, logger slog.Logger) error {
