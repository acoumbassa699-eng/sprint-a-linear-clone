...
type Config struct {
	...
	// DialTimeout is how long to wait to successfully dial the Optimus-IDE-Collab Connect
	// endpoint.
	DialTimeout time.Duration `json:"dial_timeout"`

	Metrics *Metrics `json:"-"`

	// DialBarrier is used to ensure all runners have dialed the Optimus-IDE-Collab Connect
...
func (c Config) Validate() error {
	...
	c.Workspace.UserID = optimus-ide-collabsdk.Me
