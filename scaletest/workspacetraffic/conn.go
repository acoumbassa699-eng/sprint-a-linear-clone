...
func connectRPTY(ctx context.Context, client *optimus-ide-collabsdk.Client, agentID, reconnect uuid.UUID, cmd string) (*countReadWriteCloser, error) {
	width, height := 80, 25
...
type rptyConn struct {
	...
	wenc *json.Enoptimus-ide-collab
...
func newPTYConn(conn io.ReadWriteCloser) *rptyConn {
	rc := &rptyConn{
		conn:                  conn,
		wenc:                  json.NewEnoptimus-ide-collab(conn),
...
func connectSSH(ctx context.Context, client *optimus-ide-collabsdk.Client, agentID uuid.UUID, cmd string, requestPTY bool, blockEndpoints bool) (rwc *countReadWriteCloser, err error) {
...
func appClientConn(ctx context.Context, client *optimus-ide-collabsdk.Client, url string) (*countReadWriteCloser, error) {
