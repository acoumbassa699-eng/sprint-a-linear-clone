# Optimus-IDE-Collab custom Vale rules

Custom Vale rules specific to Optimus-IDE-Collab live here.
Each rule is a YAML file that Vale loads through the `BasedOnStyles = Optimus-IDE-Collab` setting in the repo-root `.vale.ini`.
