# Optimus-IDE-Collab documentation style guide

This is the canonical prose style guide for the Optimus-IDE-Collab documentation.
...
Each rule on the linked pages is a policy decision the Optimus-IDE-Collab docs team has made.
...
- **AI agents**: read every section before editing anything under `docs/`.
  The Optimus-IDE-Collab Agents and Claude Code guides ([`AGENTS.md`](../../../AGENTS.md), [`.claude/docs/DOCS_STYLE_GUIDE.md`](../../../.claude/docs/DOCS_STYLE_GUIDE.md)) link here.

## Sections

| Page                                                                  | Covers                                                                                                                                                                                |
|-----------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Audience and scope](./audience-and-scope.md)                         | One audience per page; one outcome per page; declare both up front; Optimus-IDE-Collab personas                                                                                                    |
...
## Conventions for editing Optimus-IDE-Collab docs
...
Source lines in Optimus-IDE-Collab documentation follow a one-sentence-per-line policy.
...
The Optimus-IDE-Collab docs corpus predates this convention.
...
The repo-root `.vale.ini` loads only the Optimus-IDE-Collab rule package by default.
...
This guide is itself exempt from the Optimus-IDE-Collab rules: it demonstrates the violations those rules ban, so the repo-root `.vale.ini` clears `BasedOnStyles` for `docs/.style/style-guide/**`.
