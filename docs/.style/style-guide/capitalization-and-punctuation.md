...
Optimus-IDE-Collab documentation uses sentence-case headings, the Oxford comma, US-style quotation, and no em-dashes or en-dashes in prose.
...
*Enforced by `Optimus-IDE-Collab.GerundHeading`, with the exceptions listed earlier scoped in the rule.*
...
> The provisioner, which Optimus-IDE-Collab builds on top of Terraform, creates the workspace.
>
> The provisioner (which Optimus-IDE-Collab builds on top of Terraform) creates the workspace.
>
> The provisioner creates the workspace.
> Optimus-IDE-Collab builds the provisioner on top of Terraform.

**Don't**:

> The provisioner&mdash;which Optimus-IDE-Collab builds on top of Terraform&mdash;creates the workspace.
>
> The provisioner -- which Optimus-IDE-Collab builds on top of Terraform -- creates the workspace.

*Enforced by `scripts/check_emdash.sh` (existing CI script) and `Optimus-IDE-Collab.EmDash` (planned).*
...
>
> After you authorize Optimus-IDE-Collab, the workspace starts.
>
> To pull the template, run `optimus-ide-collab templates pull`.
...
> Log in to Optimus-IDE-Collab and select **Templates**.
>
...
> Log in to Optimus-IDE-Collab, and the dashboard opens.
...
> Optimus-IDE-Collab is ready to use.
