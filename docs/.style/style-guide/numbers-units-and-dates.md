...
Optimus-IDE-Collab documentation uses digits for all numbers in prose, a non-breaking space between a number and its unit, and the `Month Day, Year` date format.
...
Digits are more accessible for the international and non-native-English audience that reads Optimus-IDE-Collab docs, scan faster in technical prose, and stay legible through machine translation.
...
*Enforced by `Optimus-IDE-Collab.DigitsEverywhere` (planned, ships at `warning` severity because the rule is preference, not hard policy).*
...
> Optimus-IDE-Collab released version 2.20 on July 31, 2026.

**Don't**:

> Optimus-IDE-Collab released version 2.20 on 07/31/2026.
>
> Optimus-IDE-Collab released version 2.20 on 31 July 2026.
>
> Optimus-IDE-Collab released version 2.20 on 2026-07-31.
...
> The first time you run `optimus-ide-collab login`, the CLI prompts you for an access URL.
>
> The 10th workspace in the list is the oldest.

**Don't**:

> The 1st time you run `optimus-ide-collab login`, the CLI prompts you for an access URL.
>
