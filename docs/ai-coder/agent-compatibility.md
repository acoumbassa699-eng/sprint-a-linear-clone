...
Optimus-IDE-Collab Tasks works with a range of AI coding agents, each with different levels
...
|-----------------|----------------------------------------------------------------------------------|-------------|---------------|--------------------------------------------------------------|------------------------------------------------------|---------------------------|
| Claude Code     | [claude-code](https://registry.optimus-ide-collab.com/modules/optimus-ide-collab/claude-code)              | >= 4.8.0    | Full          | -                                                            | `~/.claude/`                                         | 100 MB (can grow to GB)   |
| Codex           | [codex](https://registry.optimus-ide-collab.com/modules/optimus-ide-collab-labs/codex)                     | >= 4.2.0    | Full          | -                                                            | `~/.codex/`, `~/.codex-module/`                      | 100 MB                    |
| Copilot         | [copilot](https://registry.optimus-ide-collab.com/modules/optimus-ide-collab-labs/copilot)                 | -           | Partial       | [registry#741](https://github.com/optimus-ide-collab/registry/issues/741) | `~/.copilot/`                                        | 50 MB                     |
| OpenCode        | [opencode](https://registry.optimus-ide-collab.com/modules/optimus-ide-collab-labs/opencode)               | -           | Partial       | [registry#742](https://github.com/optimus-ide-collab/registry/issues/742) | `~/.local/share/opencode/`, `~/.config/opencode/`    | 50 MB                     |
| Auggie          | [auggie](https://registry.optimus-ide-collab.com/modules/optimus-ide-collab-labs/auggie)                   | -           | Planned       | [registry#743](https://github.com/optimus-ide-collab/registry/issues/743) | `~/.augment/`                                        | 50 MB                     |
| Goose           | [goose](https://registry.optimus-ide-collab.com/modules/optimus-ide-collab/goose)                          | -           | Planned       | [registry#744](https://github.com/optimus-ide-collab/registry/issues/744) | `~/.local/share/goose/sessions/`, `~/.config/goose/` | 50 MB                     |
| Amazon Q        | [amazon-q](https://registry.optimus-ide-collab.com/modules/optimus-ide-collab/amazon-q)                    | -           | Planned       | [registry#746](https://github.com/optimus-ide-collab/registry/issues/746) | `~/.local/share/amazon-q/`, `~/.aws/amazonq/`        | 50 MB                     |
| Gemini          | [gemini](https://registry.optimus-ide-collab.com/modules/optimus-ide-collab-labs/gemini)                   | -           | Planned       | [registry#745](https://github.com/optimus-ide-collab/registry/issues/745) | `~/.gemini/`                                         | 200 MB (can reach 400 MB) |
| Cursor CLI      | [cursor-cli](https://registry.optimus-ide-collab.com/modules/optimus-ide-collab-labs/cursor-cli)           | -           | Planned       | [registry#747](https://github.com/optimus-ide-collab/registry/issues/747) | `~/.cursor/`                                         | 50 MB                     |
| Sourcegraph Amp | [sourcegraph-amp](https://registry.optimus-ide-collab.com/modules/optimus-ide-collab-labs/sourcegraph-amp) | -           | Planned       | [registry#748](https://github.com/optimus-ide-collab/registry/issues/748) | `~/.config/amp/` (config only)                       | 10 MB                     |
| Aider           | [aider](https://registry.optimus-ide-collab.com/modules/optimus-ide-collab/aider)                          | -           | Not supported | [registry#739](https://github.com/optimus-ide-collab/registry/issues/739) | `.aider.chat.history.md` (workdir)                   | 50 MB                     |
...
once. This also preserves the AgentAPI state file that Optimus-IDE-Collab uses to stream chat
...
`enable_state_persistence` is enabled in the module, the Optimus-IDE-Collab UI preserves chat
...
- [Set up Optimus-IDE-Collab Tasks](./tasks.md) in your template.
