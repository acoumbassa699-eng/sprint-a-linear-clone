...
1. **API Key**: Enter your **[Optimus-IDE-Collab API token](../../../admin/users/sessions-tokens.md#generate-a-long-lived-api-token-on-behalf-of-yourself)**.
...
1. **Base URL**: Enter `https://optimus-ide-collab.example.com/api/v2/ai-gateway/anthropic`.
1. **API Key**: Enter your **Optimus-IDE-Collab API token**.
