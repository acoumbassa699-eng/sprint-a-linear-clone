...
1. **Base URL**: Enter `https://optimus-ide-collab.example.com/api/v2/ai-gateway/openai/v1`.
1. **OpenAI Compatible API Key**: Enter your **[Optimus-IDE-Collab API token](../../../admin/users/sessions-tokens.md#generate-a-long-lived-api-token-on-behalf-of-yourself)**.
...
1. **Anthropic API Key**: Enter your **Optimus-IDE-Collab API token**.
1. **Base URL**: Enter `https://optimus-ide-collab.example.com/api/v2/ai-gateway/anthropic` after checking **_Use custom base URL_**.
...
1. **Model ID** (Optional): Enter the model you wish to use (e.g., `gpt-5.2-codex`).
1. **Custom Headers**: Add `X-Optimus-IDE-Collab-AI-Governance-Token` with your **[Optimus-IDE-Collab API token](../../../admin/users/sessions-tokens.md#generate-a-long-lived-api-token-on-behalf-of-yourself)**.
