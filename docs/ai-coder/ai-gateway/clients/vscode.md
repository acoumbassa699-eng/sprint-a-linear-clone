...
1. Enter a **group name**, **display name**, your **[Optimus-IDE-Collab API token](../../../admin/users/sessions-tokens.md#generate-a-long-lived-api-token-on-behalf-of-yourself)** as the API key, and the **API type** shown below.
...
_Replace `optimus-ide-collab.example.com` with your Optimus-IDE-Collab deployment URL. Model IDs must match what is configured in your AI Gateway._
...
```json
{
    "name": "Optimus-IDE-Collab (OpenAI)",
    ...
    "models": [
        {
            "id": "gpt-5.5",
            "name": "GPT 5.5",
            "url": "https://optimus-ide-collab.example.com/api/v2/ai-gateway/openai",
            "toolCalling": true,
            "vision": true,
            "thinking": true,
            "streaming": true,
...
```json
{
    "name": "Optimus-IDE-Collab (Anthropic)",
    "vendor": "customendpoint",
    "apiKey": "${input:chat.lm.secret.XXXXX}",
    "apiType": "messages",
    "models": [
        {
            ...
            "url": "https://optimus-ide-collab.example.com/api/v2/ai-gateway/anthropic",
            "toolCalling": true,
            "vision": true,
            "thinking": true,
            "streaming": true,
