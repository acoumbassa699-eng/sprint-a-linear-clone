...
* **Authentication**: Your **[Optimus-IDE-Collab API token](../../../admin/users/sessions-tokens.md#generate-a-long-lived-api-token-on-behalf-of-yourself)**.
...
1. **URL**: `https://optimus-ide-collab.example.com/api/v2/ai-gateway/openai/v1`
1. **API Key**: Paste your **[Optimus-IDE-Collab API token](../../../admin/users/sessions-tokens.md#generate-a-long-lived-api-token-on-behalf-of-yourself)**.
