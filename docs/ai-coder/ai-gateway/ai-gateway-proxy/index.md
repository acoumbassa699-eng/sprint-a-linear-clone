...
Clients authenticate by passing their Optimus-IDE-Collab token in the proxy credentials.
...
* [Set up AI Gateway Proxy](./setup.md) on your Optimus-IDE-Collab deployment
