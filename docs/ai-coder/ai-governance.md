...
Optimus-IDE-Collab Workspaces already lets teams run AI tools like
[Cursor](https://registry.optimus-ide-collab.com/modules/optimus-ide-collab/cursor) and
[Claude Code](https://registry.optimus-ide-collab.com/modules/optimus-ide-collab/claude-code) inside their
...
> [!NOTE]
> As of Optimus-IDE-Collab v2.32, the AI Governance Add-On is required to use AI Gateway and Agent Firewall.
> Deployments without the add-on cannot access these features.

## Who should use the AI Governance Add-On

The AI Governance Add-On is for teams that want to extend the Optimus-IDE-Collab platform to
...
- Rolling out AI-powered IDEs like Cursor and AI coding agents like Claude Code
  across teams
- Looking to centrally observe, audit, and govern AI activity in Optimus-IDE-Collab
  Workspaces
...
or vendor-managed policies, you can continue using them. Optimus-IDE-Collab Workspaces can
...
authentication so users authenticate through Optimus-IDE-Collab, eliminating the need to
...
Starting with Optimus-IDE-Collab v2.30 (February 2026), AI Gateway and Agent Firewall are
...
[Optimus-IDE-Collab account team](https://optimus-ide-collab.com/contact/sales).

## How Optimus-IDE-Collab Tasks usage is measured
...
The usage metric used to measure Optimus-IDE-Collab Tasks consumption is called **Agent
Workspace Builds** (prev. "managed agents").

An Agent Workspace Build is counted each time a workspace is started
specifically for a coding agent to independently work on a Optimus-IDE-Collab Task. Most of
the work in this workspace is performed by the agent, not a human developer.
Each Optimus-IDE-Collab Task starts its own workspace, and the usage meter counts one Agent
Workspace Build.

Traditional Optimus-IDE-Collab Workspaces started manually by developers or scheduled to
...
|---------------------------------------------------------------------------------------------------|--------------------------------|
| Developer creates a Optimus-IDE-Collab Task to write end-to-end tests                                          | Yes                            |
| Automated pipeline creates a task via Optimus-IDE-Collab Tasks CLI (with Claude Code) to review a pull request | Yes                            |
| Developer resumes an old Optimus-IDE-Collab Task order to continue prototyping                                 | Yes                            |
...
| Developer creates a workspace for use with Optimus-IDE-Collab AI Gateway and Agent Firewall                    | No                             |

In the future, additional capabilities for managing agents (beyond Optimus-IDE-Collab Tasks)
may also consume agent workspace builds.

### Agent Workspace Build Limits

Without proper controls and sandboxing, it is not recommended to open up Optimus-IDE-Collab
...
proportionately with user count. Usage counts are measured and sent to Optimus-IDE-Collab via
[usage data reporting](./usage-data-reporting.md). Optimus-IDE-Collab Tasks and other AI
features continue to function normally even if the limit is breached. Admins
will receive a warning to [contact their account team](https://optimus-ide-collab.com/contact)
to remediate.

### Tracking Agent Workspace Builds

Admins can monitor Agent Workspace Build usage from the Optimus-IDE-Collab dashboard.
