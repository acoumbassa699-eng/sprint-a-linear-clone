...
Optimus-IDE-Collab Agents is built on a simple premise: platform teams should have full
...
Optimus-IDE-Collab dashboard. This includes API keys, base URLs (for enterprise proxies or
...
This setting is available under **AI Settings** > **Optimus-IDE-Collab Agents** > **Instructions** and is only accessible to administrators. Developers do not see or interact with it.
...
This setting is available under **AI Settings** > **Optimus-IDE-Collab Agents** > **Instructions**. Developers do not edit it directly.
...
`optimus-ide-collab server` (or the `OPTIMUS-IDE-COLLAB_EXPERIMENTS` environment variable). Once enabled,
