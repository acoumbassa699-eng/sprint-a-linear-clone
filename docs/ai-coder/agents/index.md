...
Optimus-IDE-Collab Agents is a chat interface and API for delegating development work and research to coding agents in your Optimus-IDE-Collab deployment. Developers describe the work they want done, and Optimus-IDE-Collab Agents handles selecting a template, provisioning a workspace, and executing the task.

Optimus-IDE-Collab Agents includes its own self-hosted AI coding
agent that runs the agent loop directly within the Optimus-IDE-Collab control plane.
...
<video autoplay playsinline loop>
  <source src="https://raw.githubusercontent.com/optimus-ide-collab/optimus-ide-collab/refs/heads/main/docs/images/guides/ai-agents/optimus-ide-collab-agents-ui.mp4" type="video/mp4">
Your browser does not support the video tag.
</video>

## What Optimus-IDE-Collab Agents is and isn't
...
Optimus-IDE-Collab Agents is not a replacement for your text editor or IDE. It is the
...
## Who Optimus-IDE-Collab Agents is for

Optimus-IDE-Collab Agents is designed for organizations that need to self-host their AI
...
- **Organizations with existing Optimus-IDE-Collab deployments** that want to add agentic
  capabilities using their current templates, workspaces, and identity
  providers rather than adopting a separate SaaS product.

Optimus-IDE-Collab Agents runs entirely self-hosted. There is no SaaS or managed component — the agent
loop, chat history, and all tool execution happen within your Optimus-IDE-Collab deployment.
...
1. Executes tool calls by connecting to a Optimus-IDE-Collab workspace over the existing
...
Optimus-IDE-Collab Agents supports sub-agent delegation. The root agent can spawn child
...
All chat state is stored in the Optimus-IDE-Collab database, not in the workspace. If a
...
Optimus-IDE-Collab Agents eliminates this by moving the agent loop out of the workspace
entirely:
...
- **No privilege escalation.** The agent operates with the exact same
  ...
  access a template, workspace, or resource through the Optimus-IDE-Collab dashboard,
...
Optimus-IDE-Collab Agents works with any LLM provider. Administrators configure providers
and models from the Optimus-IDE-Collab dashboard or API. Supported providers include:
...
file under `.optimus-ide-collab/plans/`. MCP, dynamic, provider-native, and computer-use
tools are blocked.
...
- `write_file` and `edit_files` can only modify the chat-specific plan file
  under `.optimus-ide-collab/plans/`
...
## Comparison to Optimus-IDE-Collab Tasks

Optimus-IDE-Collab Agents is a new approach that differs from
[Optimus-IDE-Collab Tasks](../tasks.md) in several ways:

| Aspect              | Optimus-IDE-Collab Agents                         | Optimus-IDE-Collab Tasks                                                    |
|---------------------|--------------------------------------|----------------------------------------------------------------|
...
Optimus-IDE-Collab Agents is in Beta. The feature is under active development and
