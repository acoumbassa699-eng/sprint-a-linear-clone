...
Optimus-IDE-Collab Agents completes work by calling tools: structured functions the agent
...
3. Optimus-IDE-Collab executes the tool in the control plane using your identity and
