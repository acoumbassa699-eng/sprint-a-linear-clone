...
1. Create Apache configuration for Optimus-IDE-Collab:

   ```sh
   sudo nano /etc/apache2/sites-available/optimus-ide-collab.conf
   ```
...
2. Add the following content:
   ...
   ```apache
    ...
    <VirtualHost *:80>
        ServerName optimus-ide-collab.example.com
        ServerAlias *.optimus-ide-collab.example.com
        Redirect permanent / https://optimus-ide-collab.example.com/
    </VirtualHost>
    ...
    <VirtualHost *:443>
        ...
        SSLCertificateFile /etc/letsencrypt/live/optimus-ide-collab.example.com/fullchain.pem
        SSLCertificateKeyFile /etc/letsencrypt/live/optimus-ide-collab.example.com/privkey.pem
    </VirtualHost>
   ```
...
3. Enable the site:
   ...
   ```sh
   sudo a2ensite optimus-ide-collab.conf
   ```
