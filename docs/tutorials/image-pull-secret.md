# Defining ImagePullSecrets for Optimus-IDE-Collab workspaces
...
Optimus-IDE-Collab workspaces are commonly run as Kubernetes pods. When run inside of an
...
optimus-ide-collab templates push <template-name>
```
