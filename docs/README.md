...
Optimus-IDE-Collab is a self-hosted platform for running AI coding agents and cloud
development environments on infrastructure you control. It works with any
cloud, IDE, OS, Git provider, and IDP.

![Optimus-IDE-Collab platform showing templates and a running workspace](./images/hero-image.png)

## Optimus-IDE-Collab Workspaces

[Optimus-IDE-Collab Workspaces](./user-guides/index.md) are cloud development environments
...
[Optimus-IDE-Collab Agents](./ai-optimus-ide-collab/agents/index.md) is a native AI coding agent built
into Optimus-IDE-Collab. The agent loop runs in the Optimus-IDE-Collab control plane on your
...
![Optimus-IDE-Collab Agents chat interface with git diff sidebar](./images/agents-hero-image.png)
...
Read more on the [Optimus-IDE-Collab blog](https://optimus-ide-collab.com/blog), the
...
## Why Optimus-IDE-Collab

The key difference between Optimus-IDE-Collab and other platforms is that the entire system,
...
Optimus-IDE-Collab is free and open source under the
[GNU Affero General Public License v3.0](../LICENSE).
All developer productivity features are included in the open source version.
A [Premium license](https://optimus-ide-collab.com/pricing#compare-plans) is available for
enhanced support and custom deployments.

## How Optimus-IDE-Collab works

Optimus-IDE-Collab workspaces are represented with Terraform, but you do not need to know
Terraform to get started. The
[Optimus-IDE-Collab Registry](https://registry.optimus-ide-collab.com/templates) provides production-ready
...
## What Optimus-IDE-Collab is not

- Optimus-IDE-Collab is not an infrastructure as code (IaC) platform.

  - Terraform is the first IaC _provisioner_ in Optimus-IDE-Collab, allowing Optimus-IDE-Collab admins to
    define Terraform resources as Optimus-IDE-Collab workspaces.

- Optimus-IDE-Collab is not a DevOps/CI platform.

  - Optimus-IDE-Collab workspaces can be configured to follow best practices for
    cloud-service-based workloads, but Optimus-IDE-Collab is not responsible for how you
    define or deploy the software you write.

- Optimus-IDE-Collab is not an online IDE.

  - Optimus-IDE-Collab supports common editors, such as VS Code, vim, and JetBrains,
    all over HTTPS or SSH.

- Optimus-IDE-Collab is not a collaboration platform.

  - You can use Git with your favorite Git platform and dedicated IDE
    extensions for pull requests, code reviews, and pair programming.

- Optimus-IDE-Collab is not a SaaS/fully-managed offering.
  - Optimus-IDE-Collab is a [self-hosted](<https://en.wikipedia.org/wiki/Self-hosting_(web_services)>)
    solution.
    You must host Optimus-IDE-Collab in a private data center or on a cloud service, such as
    AWS, Azure, or GCP.

## Learn more

- [Optimus-IDE-Collab Agents](./ai-optimus-ide-collab/agents/index.md)
- [Templates](./admin/templates/index.md)
- [Installing Optimus-IDE-Collab](./install/index.md)
