# Creating your first optimus-ide-collab workspace
...
a Optimus-IDE-Collab workspace.
...
Optimus-IDE-Collab starts your new workspace from your template.
...
- SSH: Use SSH to log in to the workspace from your local machine. If you
  haven't already, you'll have to install Optimus-IDE-Collab on your local machine to
