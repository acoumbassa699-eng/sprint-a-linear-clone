...
curl -X GET http://optimus-ide-collab-server:8080/api/v2/organizations/{organization}/members \
...
|--------|---------------------------------------------------------|-------------|-------------------------------------------------------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | array of [optimus-ide-collabsdk.OrganizationMemberWithUserData](schemas.md#optimus-ide-collabsdkorganizationmemberwithuserdata) |
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/organizations/{organization}/members/roles \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
| Status | Meaning                                                 | Description | Schema                                                                  |
|--------|---------------------------------------------------------|-------------|-------------------------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | array of [optimus-ide-collabsdk.AssignableRoles](schemas.md#optimus-ide-collabsdkassignableroles) |
...
| `»» action`                         | [optimus-ide-collabsdk.RBACAction](schemas.md#optimus-ide-collabsdkrbacaction)     | false    |              |                                                                                                        |
| `»» negate`                         | boolean                                                  | false    |              | Negate makes this a negative permission                                                                |
| `»» resource_type`                  | [optimus-ide-collabsdk.RBACResource](schemas.md#optimus-ide-collabsdkrbacresource) | false    |              |                                                                                                        |
...
```sh
# Example request using curl
curl -X PUT http://optimus-ide-collab-server:8080/api/v2/organizations/{organization}/members/roles \
...
|----------------|------|--------------------------------------------------------------------|----------|---------------------|
| `organization` | path | string(uuid)                                                       | true     | Organization ID     |
| `body`         | body | [optimus-ide-collabsdk.CustomRoleRequest](schemas.md#optimus-ide-collabsdkcustomrolerequest) | true     | Update role request |
...
| Status | Meaning                                                 | Description | Schema                                            |
|--------|---------------------------------------------------------|-------------|---------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | array of [optimus-ide-collabsdk.Role](schemas.md#optimus-ide-collabsdkrole) |
...
```sh
# Example request using curl
curl -X POST http://optimus-ide-collab-server:8080/api/v2/organizations/{organization}/members/roles \
  -H 'Content-Type: application/json' \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
|----------------|------|--------------------------------------------------------------------|----------|---------------------|
| `organization` | path | string(uuid)                                                       | true     | Organization ID     |
| `body`         | body | [optimus-ide-collabsdk.CustomRoleRequest](schemas.md#optimus-ide-collabsdkcustomrolerequest) | true     | Insert role request |
...
```sh
# Example request using curl
curl -X DELETE http://optimus-ide-collab-server:8080/api/v2/organizations/{organization}/members/roles/{roleName} \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/organizations/{organization}/members/{user} \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
| Status | Meaning                                                 | Description | Schema                                                                                       |
|--------|---------------------------------------------------------|-------------|----------------------------------------------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | [optimus-ide-collabsdk.OrganizationMemberWithUserData](schemas.md#optimus-ide-collabsdkorganizationmemberwithuserdata) |
...
```sh
# Example request using curl
curl -X POST http://optimus-ide-collab-server:8080/api/v2/organizations/{organization}/members/{user} \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
| Status | Meaning                                                 | Description | Schema                                                               |
|--------|---------------------------------------------------------|-------------|----------------------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | [optimus-ide-collabsdk.OrganizationMember](schemas.md#optimus-ide-collabsdkorganizationmember) |
...
```sh
# Example request using curl
curl -X DELETE http://optimus-ide-collab-server:8080/api/v2/organizations/{organization}/members/{user} \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
```sh
# Example request using curl
curl -X PUT http://optimus-ide-collab-server:8080/api/v2/organizations/{organization}/members/{user}/roles \
  -H 'Content-Type: application/json' \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/organizations/{organization}/paginated-members \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
| Status | Meaning                                                 | Description | Schema                                                                                    |
|--------|---------------------------------------------------------|-------------|-------------------------------------------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | array of [optimus-ide-collabsdk.PaginatedMembersResponse](schemas.md#optimus-ide-collabsdkpaginatedmembersresponse) |
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/users/roles \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
