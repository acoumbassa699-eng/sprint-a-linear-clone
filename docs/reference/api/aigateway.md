...
curl -X GET http://optimus-ide-collab-server:8080/api/v2/ai-gateway/clients \
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/ai-gateway/models \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/ai-gateway/sessions \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
| Status | Meaning                                                 | Description | Schema                                                                                   |
|--------|---------------------------------------------------------|-------------|------------------------------------------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | [optimus-ide-collabsdk.AIBridgeListSessionsResponse](schemas.md#optimus-ide-collabsdkaibridgelistsessionsresponse) |
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/ai-gateway/sessions/{session_id} \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
| Status | Meaning                                                 | Description | Schema                                                                                       |
|--------|---------------------------------------------------------|-------------|----------------------------------------------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | [optimus-ide-collabsdk.AIBridgeSessionThreadsResponse](schemas.md#optimus-ide-collabsdkaibridgesessionthreadsresponse) |
