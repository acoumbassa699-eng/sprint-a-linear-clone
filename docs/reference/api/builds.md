...
curl -X GET http://optimus-ide-collab-server:8080/api/v2/users/{user}/workspace/{workspacename}/builds/{buildnumber} \
...
|--------|---------------------------------------------------------|-------------|--------------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | [optimus-ide-collabsdk.WorkspaceBuild](schemas.md#optimus-ide-collabsdkworkspacebuild) |
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/workspacebuilds/{workspacebuild} \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
```sh
# Example request using curl
curl -X PATCH http://optimus-ide-collab-server:8080/api/v2/workspacebuilds/{workspacebuild}/cancel \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/workspacebuilds/{workspacebuild}/logs \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/workspacebuilds/{workspacebuild}/parameters \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
| Status | Meaning                                                 | Description | Schema                                                                                  |
|--------|---------------------------------------------------------|-------------|-----------------------------------------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | array of [optimus-ide-collabsdk.WorkspaceBuildParameter](schemas.md#optimus-ide-collabsdkworkspacebuildparameter) |
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/workspacebuilds/{workspacebuild}/resources \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/workspacebuilds/{workspacebuild}/state \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
```sh
# Example request using curl
curl -X PUT http://optimus-ide-collab-server:8080/api/v2/workspacebuilds/{workspacebuild}/state \
...
| `body`           | body | [optimus-ide-collabsdk.UpdateWorkspaceBuildStateRequest](schemas.md#optimus-ide-collabsdkupdateworkspacebuildstaterequest) | true     | Request body       |
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/workspacebuilds/{workspacebuild}/timings \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
| Status | Meaning                                                 | Description | Schema                                                                     |
|--------|---------------------------------------------------------|-------------|----------------------------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | [optimus-ide-collabsdk.WorkspaceBuildTimings](schemas.md#optimus-ide-collabsdkworkspacebuildtimings) |
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/workspaces/{workspace}/builds \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
| Status | Meaning                                                 | Description | Schema                                                                |
|--------|---------------------------------------------------------|-------------|-----------------------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | array of [optimus-ide-collabsdk.WorkspaceBuild](schemas.md#optimus-ide-collabsdkworkspacebuild) |
...
| `» reason`                       | [optimus-ide-collabsdk.BuildReason](schemas.md#optimus-ide-collabsdkbuildreason)                                                 | false    |              |                                                                                                                                                                                                                                                |
...
| `»» type`                        | string                                                                                                 | false    |              |                                                                                                                                                                                                                                                |
| `»» workspace_transition`        | [optimus-ide-collabsdk.WorkspaceTransition](schemas.md#optimus-ide-collabsdkworkspacetransition)                                 | false    |              |                                                                                                                                                                                                                                                |
| `» status`                       | [optimus-ide-collabsdk.WorkspaceStatus](schemas.md#optimus-ide-collabsdkworkspacestatus)                                         | false    |              |                                                                                                                                                                                                                                                |
| `» template_version_id`          | string(uuid)                                                                                           | false    |              |                                                                                                                                                                                                                                                |
| `» template_version_name`        | string                                                                                                 | false    |              |                                                                                                                                                                                                                                                |
| `» template_version_preset_id`   | string(uuid)                                                                                           | false    |              |                                                                                                                                                                                                                                                |
| `» transition`                   | [optimus-ide-collabsdk.WorkspaceTransition](schemas.md#optimus-ide-collabsdkworkspacetransition)                                 | false    |              |                                                                                                                                                                                                                                                |
| `» updated_at`                   | string(date-time)                                                                                      | false    |              |                                                                                                                                                                                                                                                |
| `» workspace_id`                 | string(uuid)                                                                                           | false    |              |                                                                                                                                                                                                                                                |
| `» workspace_name`               | string                                                                                                 | false    |              |                                                                                                                                                                                                                                                |
...
```sh
# Example request using curl
curl -X POST http://optimus-ide-collab-server:8080/api/v2/workspaces/{workspace}/builds \
  -H 'Content-Type: application/json' \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
|-------------|------|----------------------------------------------------------------------------------------|----------|--------------------------------|
| `workspace` | path | string(uuid)                                                                           | true     | Workspace ID                   |
| `body`      | body | [optimus-ide-collabsdk.CreateWorkspaceBuildRequest](schemas.md#optimus-ide-collabsdkcreateworkspacebuildrequest) | true     | Create workspace build request |
