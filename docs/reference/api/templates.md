...
curl -X GET http://optimus-ide-collab-server:8080/api/v2/organizations/{organization}/templates \
...
|--------|---------------------------------------------------------|-------------|-----------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | array of [optimus-ide-collabsdk.Template](schemas.md#optimus-ide-collabsdktemplate) |
...
| `» autostart_requirement`            | [optimus-ide-collabsdk.TemplateAutostartRequirement](schemas.md#optimus-ide-collabsdktemplateautostartrequirement) | false    |              |                                                                                                                                                                            |
...
| `» autostop_requirement`             | [optimus-ide-collabsdk.TemplateAutostopRequirement](schemas.md#optimus-ide-collabsdktemplateautostoprequirement)   | false    |              | Autostop requirement and AutostartRequirement are enterprise features. Its value is only used if your license is entitled to use the advanced template scheduling feature. |
...
|`» build_time_stats`|[optimus-ide-collabsdk.TemplateBuildTimeStats](schemas.md#optimus-ide-collabsdktemplatebuildtimestats)|false|||
|`»» [any property]`|[optimus-ide-collabsdk.TransitionStats](schemas.md#optimus-ide-collabsdktransitionstats)|false|||
|`»»» p50`|integer|false|||
|`»»» p95`|integer|false|||
|`» cors_behavior`|[optimus-ide-collabsdk.CORSBehavior](schemas.md#optimus-ide-collabsdkcorsbehavior)|false|||
...
|`» max_port_share_level`|[optimus-ide-collabsdk.WorkspaceAgentPortShareLevel](schemas.md#optimus-ide-collabsdkworkspaceagentportsharelevel)|false|||
|`» name`|string|false|||
...
```sh
# Example request using curl
curl -X POST http://optimus-ide-collab-server:8080/api/v2/organizations/{organization}/templates \
...
| `body`         | body | [optimus-ide-collabsdk.CreateTemplateRequest](schemas.md#optimus-ide-collabsdkcreatetemplaterequest) | true     | Request body    |
...
| Status | Meaning                                                 | Description | Schema                                           |
|--------|---------------------------------------------------------|-------------|--------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | [optimus-ide-collabsdk.Template](schemas.md#optimus-ide-collabsdktemplate) |
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/organizations/{organization}/templates/examples \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
| Status | Meaning                                                 | Description | Schema                                                                  |
|--------|---------------------------------------------------------|-------------|-------------------------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | array of [optimus-ide-collabsdk.TemplateExample](schemas.md#optimus-ide-collabsdktemplateexample) |
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/organizations/{organization}/templates/{templatename} \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/organizations/{organization}/templates/{templatename}/versions/{templateversionname} \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
| Status | Meaning                                                 | Description | Schema                                                         |
|--------|---------------------------------------------------------|-------------|----------------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | [optimus-ide-collabsdk.TemplateVersion](schemas.md#optimus-ide-collabsdktemplateversion) |
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/organizations/{organization}/templates/{templatename}/versions/{templateversionname}/previous \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
```sh
# Example request using curl
curl -X POST http://optimus-ide-collab-server:8080/api/v2/organizations/{organization}/templateversions \
  -H 'Content-Type: application/json' \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
|----------------|------|------------------------------------------------------------------------------------------|----------|---------------------------------|
| `organization` | path | string(uuid)                                                                             | true     | Organization ID                 |
| `body`         | body | [optimus-ide-collabsdk.CreateTemplateVersionRequest](schemas.md#optimus-ide-collabsdkcreatetemplateversionrequest) | true     | Create template version request |
...
| Status | Meaning                                                      | Description | Schema                                                         |
|--------|--------------------------------------------------------------|-------------|----------------------------------------------------------------|
| 201    | [Created](https://tools.ietf.org/html/rfc7231#section-6.3.2) | Created     | [optimus-ide-collabsdk.TemplateVersion](schemas.md#optimus-ide-collabsdktemplateversion) |
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/templates \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/templates/examples \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/templates/{template} \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
```sh
# Example request using curl
curl -X DELETE http://optimus-ide-collab-server:8080/api/v2/templates/{template} \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
```sh
# Example request using curl
curl -X PATCH http://optimus-ide-collab-server:8080/api/v2/templates/{template} \
  -H 'Content-Type: application/json' \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
|------------|------|----------------------------------------------------------------------|----------|---------------------------------|
| `template` | path | string(uuid)                                                         | true     | Template ID                     |
| `body`     | body | [optimus-ide-collabsdk.UpdateTemplateMeta](schemas.md#optimus-ide-collabsdkupdatetemplatemeta) | true     | Patch template settings request |
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/templates/{template}/daus \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
| Status | Meaning                                                 | Description | Schema                                                   |
|--------|---------------------------------------------------------|-------------|----------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | [optimus-ide-collabsdk.DAUsResponse](schemas.md#optimus-ide-collabsdkdausresponse) |
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/templates/{template}/versions \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
| Status | Meaning                                                 | Description | Schema                                                                  |
|--------|---------------------------------------------------------|-------------|-------------------------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | array of [optimus-ide-collabsdk.TemplateVersion](schemas.md#optimus-ide-collabsdktemplateversion) |
...
| `» created_at`                   | string(date-time)                                                            | false    |              |                                                                                                                                                                     |
| `» created_by`                   | [optimus-ide-collabsdk.MinimalUser](schemas.md#optimus-ide-collabsdkminimaluser)                       | false    |              |                                                                                                                                                                     |
...
| `» id`                           | string(uuid)                                                                 | false    |              |                                                                                                                                                                     |
| `» job`                          | [optimus-ide-collabsdk.ProvisionerJob](schemas.md#optimus-ide-collabsdkprovisionerjob)                 | false    |              |                                                                                                                                                                     |
| `»» available_workers`           | array                                                                        | false    |              |                                                                                                                                                                     |
| `»» canceled_at`                 | string(date-time)                                                            | false    |              |                                                                                                                                                                     |
| `»» completed_at`                | string(date-time)                                                            | false    |              |                                                                                                                                                                     |
| `»» created_at`                  | string(date-time)                                                            | false    |              |                                                                                                                                                                     |
| `»» error`                       | string                                                                       | false    |              |                                                                                                                                                                     |
| `»» error_code`                  | [optimus-ide-collabsdk.JobErrorCode](schemas.md#optimus-ide-collabsdkjoberrorcode)                     | false    |              |                                                                                                                                                                     |
| `»» file_id`                     | string(uuid)                                                                 | false    |              |                                                                                                                                                                     |
| `»» id`                          | string(uuid)                                                                 | false    |              |                                                                                                                                                                     |
| `»» initiator_id`                | string(uuid)                                                                 | false    |              |                                                                                                                                                                     |
| `»» input`                       | [optimus-ide-collabsdk.ProvisionerJobInput](schemas.md#optimus-ide-collabsdkprovisionerjobinput)       | false    |              |                                                                                                                                                                     |
| `»»» error`                      | string                                                                       | false    |              |                                                                                                                                                                     |
| `»»» template_version_id`        | string(uuid)                                                                 | false    |              |                                                                                                                                                                     |
| `»»» workspace_build_id`         | string(uuid)                                                                 | false    |              |                                                                                                                                                                     |
| `»» logs_overflowed`             | boolean                                                                      | false    |              |                                                                                                                                                                     |
| `»» metadata`                    | [optimus-ide-collabsdk.ProvisionerJobMetadata](schemas.md#optimus-ide-collabsdkprovisionerjobmetadata) | false    |              |                                                                                                                                                                     |
| `»»» template_display_name`      | string                                                                       | false    |              |                                                                                                                                                                     |
| `»»» template_icon`              | string                                                                       | false    |              |                                                                                                                                                                     |
| `»»» template_id`                | string(uuid)                                                                 | false    |              |                                                                                                                                                                     |
| `»»» template_name`              | string                                                                       | false    |              |                                                                                                                                                                     |
| `»»» template_version_name`      | string                                                                       | false    |              |                                                                                                                                                                     |
| `»»» workspace_build_transition` | [optimus-ide-collabsdk.WorkspaceTransition](schemas.md#optimus-ide-collabsdkworkspacetransition)       | false    |              |                                                                                                                                                                     |
...
| `»» type`                        | [optimus-ide-collabsdk.ProvisionerJobType](schemas.md#optimus-ide-collabsdkprovisionerjobtype)         | false    |              |                                                                                                                                                                     |
| `»» worker_id`                   | string(uuid)                                                                 | false    |              |                                                                                                                                                                     |
| `»» worker_name`                 | string                                                                       | false    |              |                                                                                                                                                                     |
| `» matched_provisioners`         | [optimus-ide-collabsdk.MatchedProvisioners](schemas.md#optimus-ide-collabsdkmatchedprovisioners)       | false    |              |                                                                                                                                                                     |
...
```sh
# Example request using curl
curl -X PATCH http://optimus-ide-collab-server:8080/api/v2/templates/{template}/versions \
  -H 'Content-Type: application/json' \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
|------------|------|----------------------------------------------------------------------------------------|----------|---------------------------|
| `template` | path | string(uuid)                                                                           | true     | Template ID               |
| `body`     | body | [optimus-ide-collabsdk.UpdateActiveTemplateVersion](schemas.md#optimus-ide-collabsdkupdateactivetemplateversion) | true     | Modified template version |
...
```sh
# Example request using curl
curl -X POST http://optimus-ide-collab-server:8080/api/v2/templates/{template}/versions/archive \
  -H 'Content-Type: application/json' \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
|------------|------|----------------------------------------------------------------------------------------------|----------|-----------------|
| `template` | path | string(uuid)                                                                                 | true     | Template ID     |
| `body`     | body | [optimus-ide-collabsdk.ArchiveTemplateVersionsRequest](schemas.md#optimus-ide-collabsdkarchivetemplateversionsrequest) | true     | Archive request |
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/templates/{template}/versions/{templateversionname} \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/templateversions/{templateversion} \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
```sh
# Example request using curl
curl -X PATCH http://optimus-ide-collab-server:8080/api/v2/templateversions/{templateversion} \
  -H 'Content-Type: application/json' \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
|-------------------|------|----------------------------------------------------------------------------------------|----------|--------------------------------|
| `templateversion` | path | string(uuid)                                                                           | true     | Template version ID            |
| `body`            | body | [optimus-ide-collabsdk.PatchTemplateVersionRequest](schemas.md#optimus-ide-collabsdkpatchtemplateversionrequest) | true     | Patch template version request |
...
```sh
# Example request using curl
curl -X POST http://optimus-ide-collab-server:8080/api/v2/templateversions/{templateversion}/archive \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
```sh
# Example request using curl
curl -X PATCH http://optimus-ide-collab-server:8080/api/v2/templateversions/{templateversion}/cancel \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
```sh
# Example request using curl
curl -X POST http://optimus-ide-collab-server:8080/api/v2/templateversions/{templateversion}/dry-run \
  -H 'Content-Type: application/json' \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
|-------------------|------|------------------------------------------------------------------------------------------------------|----------|---------------------|
| `templateversion` | path | string(uuid)                                                                                         | true     | Template version ID |
| `body`            | body | [optimus-ide-collabsdk.CreateTemplateVersionDryRunRequest](schemas.md#optimus-ide-collabsdkcreatetemplateversiondryrunrequest) | true     | Dry-run request     |
...
| Status | Meaning                                                      | Description | Schema                                                       |
|--------|--------------------------------------------------------------|-------------|--------------------------------------------------------------|
| 201    | [Created](https://tools.ietf.org/html/rfc7231#section-6.3.2) | Created     | [optimus-ide-collabsdk.ProvisionerJob](schemas.md#optimus-ide-collabsdkprovisionerjob) |
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/templateversions/{templateversion}/dry-run/{jobID} \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
| Status | Meaning                                                 | Description | Schema                                                       |
|--------|---------------------------------------------------------|-------------|--------------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | [optimus-ide-collabsdk.ProvisionerJob](schemas.md#optimus-ide-collabsdkprovisionerjob) |
...
```sh
# Example request using curl
curl -X PATCH http://optimus-ide-collab-server:8080/api/v2/templateversions/{templateversion}/dry-run/{jobID}/cancel \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/templateversions/{templateversion}/dry-run/{jobID}/logs \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
| Status | Meaning                                                 | Description | Schema                                                                      |
|--------|---------------------------------------------------------|-------------|-----------------------------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | array of [optimus-ide-collabsdk.ProvisionerJobLog](schemas.md#optimus-ide-collabsdkprovisionerjoblog) |
...
| `» created_at` | string(date-time)                                  | false    |              |             |
| `» id`         | integer                                            | false    |              |             |
| `» log_level`  | [optimus-ide-collabsdk.LogLevel](schemas.md#optimus-ide-collabsdkloglevel)   | false    |              |             |
| `» log_source` | [optimus-ide-collabsdk.LogSource](schemas.md#optimus-ide-collabsdklogsource) | false    |              |             |
| `» output`     | string                                             | false    |              |             |
| `» stage`      | string                                             | false    |              |             |
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/templateversions/{templateversion}/dry-run/{jobID}/matched-provisioners \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
| Status | Meaning                                                 | Description | Schema                                                                 |
|--------|---------------------------------------------------------|-------------|------------------------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | [optimus-ide-collabsdk.MatchedProvisioners](schemas.md#optimus-ide-collabsdkmatchedprovisioners) |
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/templateversions/{templateversion}/dry-run/{jobID}/resources \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
| Status | Meaning                                                 | Description | Schema                                                                      |
|--------|---------------------------------------------------------|-------------|-----------------------------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | array of [optimus-ide-collabsdk.WorkspaceResource](schemas.md#optimus-ide-collabsdkworkspaceresource) |
...
| `»»» group`                     | string                                                                                                 | false    |              |                                                                                                                                                                                                                                                |
| `»»» health`                    | [optimus-ide-collabsdk.WorkspaceAppHealth](schemas.md#optimus-ide-collabsdkworkspaceapphealth)                                   | false    |              |                                                                                                                                                                                                                                                |
| `»»» healthcheck`               | [optimus-ide-collabsdk.Healthcheck](schemas.md#optimus-ide-collabsdkhealthcheck)                                                 | false    |              | Healthcheck specifies the configuration for checking app health.                                                                                                                                                                               |
...
| `»»» id`                        | string(uuid)                                                                                           | false    |              |                                                                                                                                                                                                                                                |
| `»»» open_in`                   | [optimus-ide-collabsdk.WorkspaceAppOpenIn](schemas.md#optimus-ide-collabsdkworkspaceappopenin)                                   | false    |              |                                                                                                                                                                                                                                                |
| `»»» sharing_level`             | [optimus-ide-collabsdk.WorkspaceAppSharingLevel](schemas.md#optimus-ide-collabsdkworkspaceappsharinglevel)                       | false    |              |                                                                                                                                                                                                                                                |
...
| `»»»» state`                    | [optimus-ide-collabsdk.WorkspaceAppStatusState](schemas.md#optimus-ide-collabsdkworkspaceappstatusstate)                         | false    |              |                                                                                                                                                                                                                                                |
...
| `»» health`                     | [optimus-ide-collabsdk.WorkspaceAgentHealth](schemas.md#optimus-ide-collabsdkworkspaceagenthealth)                               | false    |              | Health reports the health of the agent.                                                                                                                                                                                                        |
...
| `»»» [any property]`            | [optimus-ide-collabsdk.DERPRegion](schemas.md#optimus-ide-collabsdkderpregion)                                                   | false    |              |                                                                                                                                                                                                                                                |
| `»»»» latency_ms`               | number                                                                                                 | false    |              |                                                                                                                                                                                                                                                |
| `»»»» preferred`                | boolean                                                                                                | false    |              |                                                                                                                                                                                                                                                |
| `»» lifecycle_state`            | [optimus-ide-collabsdk.WorkspaceAgentLifecycle](schemas.md#optimus-ide-collabsdkworkspaceagentlifecycle)                         | false    |              |                                                                                                                                                                                                                                                |
...
| `»»» status`                    | [optimus-ide-collabsdk.WorkspaceAgentScriptStatus](schemas.md#optimus-ide-collabsdkworkspaceagentscriptstatus)                   | false    |              |                                                                                                                                                                                                                                                |
| `»»» timeout`                   | integer                                                                                                | false    |              |                                                                                                                                                                                                                                                |
| `»» started_at`                 | string(date-time)                                                                                      | false    |              |                                                                                                                                                                                                                                                |
| `»» startup_script_behavior`    | [optimus-ide-collabsdk.WorkspaceAgentStartupScriptBehavior](schemas.md#optimus-ide-collabsdkworkspaceagentstartupscriptbehavior) | false    |              | Startup script behavior is a legacy field that is deprecated in favor of the `optimus-ide-collab_script` resource. It's only referenced by old clients. Deprecated: Remove in the future!                                                                   |
| `»» status`                     | [optimus-ide-collabsdk.WorkspaceAgentStatus](schemas.md#optimus-ide-collabsdkworkspaceagentstatus)                               | false    |              |                                                                                                                                                                                                                                                |
...
| `» name`                        | string                                                                                                 | false    |              |                                                                                                                                                                                                                                                |
| `» type`                        | string                                                                                                 | false    |              |                                                                                                                                                                                                                                                |
| `» workspace_transition`        | [optimus-ide-collabsdk.WorkspaceTransition](schemas.md#optimus-ide-collabsdkworkspacetransition)                                 | false    |              |                                                                                                                                                                                                                                                |
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/templateversions/{templateversion}/dynamic-parameters \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
```sh
# Example request using curl
curl -X POST http://optimus-ide-collab-server:8080/api/v2/templateversions/{templateversion}/dynamic-parameters/evaluate \
  -H 'Content-Type: application/json' \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
|-------------------|------|----------------------------------------------------------------------------------|----------|--------------------------|
| `templateversion` | path | string(uuid)                                                                     | true     | Template version ID      |
| `body`            | body | [optimus-ide-collabsdk.DynamicParametersRequest](schemas.md#optimus-ide-collabsdkdynamicparametersrequest) | true     | Initial parameter values |
...
| Status | Meaning                                                 | Description | Schema                                                                             |
|--------|---------------------------------------------------------|-------------|------------------------------------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | [optimus-ide-collabsdk.DynamicParametersResponse](schemas.md#optimus-ide-collabsdkdynamicparametersresponse) |
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/templateversions/{templateversion}/external-auth \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
| Status | Meaning                                                 | Description | Schema                                                                                          |
|--------|---------------------------------------------------------|-------------|-------------------------------------------------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | array of [optimus-ide-collabsdk.TemplateVersionExternalAuth](schemas.md#optimus-ide-collabsdktemplateversionexternalauth) |
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/templateversions/{templateversion}/logs \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/templateversions/{templateversion}/parameters \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/templateversions/{templateversion}/presets \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
| Status | Meaning                                                 | Description | Schema                                                |
|--------|---------------------------------------------------------|-------------|-------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | array of [optimus-ide-collabsdk.Preset](schemas.md#optimus-ide-collabsdkpreset) |
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/templateversions/{templateversion}/resources \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/templateversions/{templateversion}/rich-parameters \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
| Status | Meaning                                                 | Description | Schema                                                                                    |
|--------|---------------------------------------------------------|-------------|-------------------------------------------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | array of [optimus-ide-collabsdk.TemplateVersionParameter](schemas.md#optimus-ide-collabsdktemplateversionparameter) |
...
| `» validation_monotonic`  | [optimus-ide-collabsdk.ValidationMonotonicOrder](schemas.md#optimus-ide-collabsdkvalidationmonotonicorder) | false    |              |                                                                                                    |
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/templateversions/{templateversion}/schema \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
```sh
# Example request using curl
curl -X POST http://optimus-ide-collab-server:8080/api/v2/templateversions/{templateversion}/unarchive \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/templateversions/{templateversion}/variables \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
| Status | Meaning                                                 | Description | Schema                                                                                  |
|--------|---------------------------------------------------------|-------------|-----------------------------------------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | array of [optimus-ide-collabsdk.TemplateVersionVariable](schemas.md#optimus-ide-collabsdktemplateversionvariable) |
