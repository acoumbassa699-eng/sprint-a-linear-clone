...
curl -X GET http://optimus-ide-collab-server:8080/api/v2/debug/coordinator \
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/debug/health \
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/debug/health/settings \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
```sh
# Example request using curl
curl -X PUT http://optimus-ide-collab-server:8080/api/v2/debug/health/settings \
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/debug/tailnet \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
