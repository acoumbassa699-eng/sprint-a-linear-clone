...
curl -X GET http://optimus-ide-collab-server:8080/api/v2/applications/auth-redirect \
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/v2/applications/host \
...
| Status | Meaning                                                 | Description | Schema                                                         |
|--------|---------------------------------------------------------|-------------|----------------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | [optimus-ide-collabsdk.AppHostResponse](schemas.md#optimus-ide-collabsdkapphostresponse) |
