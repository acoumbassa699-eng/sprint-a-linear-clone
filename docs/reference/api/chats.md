...
Programmatic API for Optimus-IDE-Collab Agents (the user-facing "Optimus-IDE-Collab Agents" / "Chats" product). Use these endpoints to create, list, and manage AI coding agent sessions.
...
curl -X GET http://optimus-ide-collab-server:8080/api/experimental/chats \
...
|--------|---------------------------------------------------------|-------------|---------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | array of [optimus-ide-collabsdk.Chat](schemas.md#optimus-ide-collabsdkchat) |
...
| `» children`              | [optimus-ide-collabsdk.Chat](schemas.md#optimus-ide-collabsdkchat)                                           | false    |              | Children holds child (subagent) chats nested under this root chat. Always initialized to an empty slice so the JSON field is present as []. Child chats cannot create their own subagents, so nesting depth is capped at 1 and this slice is always empty for child chats. |
| `» client_type`           | [optimus-ide-collabsdk.ChatClientType](schemas.md#optimus-ide-collabsdkchatclienttype)                       | false    |              |                                                                                                                                                                                                                                                                            |
| `» context`               | [optimus-ide-collabsdk.ChatContext](schemas.md#optimus-ide-collabsdkchatcontext)                             | false    |              | Context reports the chat's pinned workspace-context state and whether it has drifted from the agent's latest pushed snapshot. Nil when the chat has no pinned context yet.                                                                                                 |
...
| `»»» kind`                | [optimus-ide-collabsdk.ChatContextResourceKind](schemas.md#optimus-ide-collabsdkchatcontextresourcekind)     | false    |              |                                                                                                                                                                                                                                                                            |
...
| `» diff_status`           | [optimus-ide-collabsdk.ChatDiffStatus](schemas.md#optimus-ide-collabsdkchatdiffstatus)                       | false    |              |                                                                                                                                                                                                                                                                            |
...
| `» last_error`            | [optimus-ide-collabsdk.ChatError](schemas.md#optimus-ide-collabsdkchaterror)                                 | false    |              |                                                                                                                                                                                                                                                                            |
...
| `»» kind`                 | [optimus-ide-collabsdk.ChatErrorKind](schemas.md#optimus-ide-collabsdkchaterrorkind)                         | false    |              | Kind classifies the error for consistent client rendering.                                                                                                                                                                                                                 |
...
| `» plan_mode`             | [optimus-ide-collabsdk.ChatPlanMode](schemas.md#optimus-ide-collabsdkchatplanmode)                           | false    |              |                                                                                                                                                                                                                                                                            |
...
| `» status`                | [optimus-ide-collabsdk.ChatStatus](schemas.md#optimus-ide-collabsdkchatstatus)                               | false    |              |                                                                                                                                                                                                                                                                            |
...
```sh
# Example request using curl
curl -X POST http://optimus-ide-collab-server:8080/api/experimental/chats \
...
| Name   | In   | Type                                                               | Required | Description         |
|--------|------|--------------------------------------------------------------------|----------|---------------------|
| `body` | body | [optimus-ide-collabsdk.CreateChatRequest](schemas.md#optimus-ide-collabsdkcreatechatrequest) | true     | Create chat request |
...
| Status | Meaning                                                      | Description | Schema                                   |
|--------|--------------------------------------------------------------|-------------|------------------------------------------|
| 201    | [Created](https://tools.ietf.org/html/rfc7231#section-6.3.2) | Created     | [optimus-ide-collabsdk.Chat](schemas.md#optimus-ide-collabsdkchat) |
...
```sh
# Example request using curl
curl -X POST http://optimus-ide-collab-server:8080/api/experimental/chats/files?organization=497f6eca-6276-4993-bfeb-53cbbbba6f08 \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
| Status | Meaning                                                      | Description | Schema                                                                       |
|--------|--------------------------------------------------------------|-------------|------------------------------------------------------------------------------|
| 201    | [Created](https://tools.ietf.org/html/rfc7231#section-6.3.2) | Created     | [optimus-ide-collabsdk.UploadChatFileResponse](schemas.md#optimus-ide-collabsdkuploadchatfileresponse) |
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/experimental/chats/files/{file} \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/experimental/chats/models \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
| Status | Meaning                                                 | Description | Schema                                                               |
|--------|---------------------------------------------------------|-------------|----------------------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | [optimus-ide-collabsdk.ChatModelsResponse](schemas.md#optimus-ide-collabsdkchatmodelsresponse) |
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/experimental/chats/watch \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
| Status | Meaning                                                 | Description | Schema                                                       |
|--------|---------------------------------------------------------|-------------|--------------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | [optimus-ide-collabsdk.ChatWatchEvent](schemas.md#optimus-ide-collabsdkchatwatchevent) |
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/experimental/chats/{chat} \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
| Status | Meaning                                                 | Description | Schema                                   |
|--------|---------------------------------------------------------|-------------|------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | [optimus-ide-collabsdk.Chat](schemas.md#optimus-ide-collabsdkchat) |
...
```sh
# Example request using curl
curl -X PATCH http://optimus-ide-collab-server:8080/api/experimental/chats/{chat} \
  -H 'Content-Type: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
|--------|------|--------------------------------------------------------------------|----------|---------------------|
| `chat` | path | string(uuid)                                                       | true     | Chat ID             |
| `body` | body | [optimus-ide-collabsdk.UpdateChatRequest](schemas.md#optimus-ide-collabsdkupdatechatrequest) | true     | Update chat request |
...
```sh
# Example request using curl
curl -X PUT http://optimus-ide-collab-server:8080/api/experimental/chats/{chat}/context \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/experimental/chats/{chat}/cost \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
| Status | Meaning                                                 | Description | Schema                                           |
|--------|---------------------------------------------------------|-------------|--------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | [optimus-ide-collabsdk.ChatCost](schemas.md#optimus-ide-collabsdkchatcost) |
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/experimental/chats/{chat}/diff \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
| Status | Meaning                                                 | Description | Schema                                                           |
|--------|---------------------------------------------------------|-------------|------------------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | [optimus-ide-collabsdk.ChatDiffContents](schemas.md#optimus-ide-collabsdkchatdiffcontents) |
...
```sh
# Example request using curl
curl -X POST http://optimus-ide-collab-server:8080/api/experimental/chats/{chat}/interrupt \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/experimental/chats/{chat}/messages \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
| Status | Meaning                                                 | Description | Schema                                                                   |
|--------|---------------------------------------------------------|-------------|--------------------------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | [optimus-ide-collabsdk.ChatMessagesResponse](schemas.md#optimus-ide-collabsdkchatmessagesresponse) |
...
```sh
# Example request using curl
curl -X POST http://optimus-ide-collab-server:8080/api/experimental/chats/{chat}/messages \
  -H 'Content-Type: application/json' \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
|--------|------|----------------------------------------------------------------------------------|----------|-----------------------------|
| `chat` | path | string(uuid)                                                                     | true     | Chat ID                     |
| `body` | body | [optimus-ide-collabsdk.CreateChatMessageRequest](schemas.md#optimus-ide-collabsdkcreatechatmessagerequest) | true     | Create chat message request |
...
| Status | Meaning                                                 | Description | Schema                                                                             |
|--------|---------------------------------------------------------|-------------|------------------------------------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | [optimus-ide-collabsdk.CreateChatMessageResponse](schemas.md#optimus-ide-collabsdkcreatechatmessageresponse) |
...
```sh
# Example request using curl
curl -X PATCH http://optimus-ide-collab-server:8080/api/experimental/chats/{chat}/messages/{message} \
  -H 'Content-Type: application/json' \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
| `body`    | body | [optimus-ide-collabsdk.EditChatMessageRequest](schemas.md#optimus-ide-collabsdkeditchatmessagerequest) | true     | Edit chat message request |
...
| Status | Meaning                                                 | Description | Schema                                                                         |
|--------|---------------------------------------------------------|-------------|--------------------------------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | [optimus-ide-collabsdk.EditChatMessageResponse](schemas.md#optimus-ide-collabsdkeditchatmessageresponse) |
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/experimental/chats/{chat}/prompts \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
| Status | Meaning                                                 | Description | Schema                                                                 |
|--------|---------------------------------------------------------|-------------|------------------------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | [optimus-ide-collabsdk.ChatPromptsResponse](schemas.md#optimus-ide-collabsdkchatpromptsresponse) |
...
```sh
# Example request using curl
curl -X POST http://optimus-ide-collab-server:8080/api/experimental/chats/{chat}/reconcile-invalid \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/experimental/chats/{chat}/stream \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
| Status | Meaning                                                 | Description | Schema                                                         |
|--------|---------------------------------------------------------|-------------|----------------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | [optimus-ide-collabsdk.ChatStreamEvent](schemas.md#optimus-ide-collabsdkchatstreamevent) |
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/experimental/chats/{chat}/stream/desktop \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
```sh
# Example request using curl
curl -X GET http://optimus-ide-collab-server:8080/api/experimental/chats/{chat}/stream/git \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
...
| Status | Meaning                                                 | Description | Schema                                                                                       |
|--------|---------------------------------------------------------|-------------|----------------------------------------------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | [optimus-ide-collabsdk.WorkspaceAgentGitServerMessage](schemas.md#optimus-ide-collabsdkworkspaceagentgitservermessage) |
...
```sh
# Example request using curl
curl -X POST http://optimus-ide-collab-server:8080/api/experimental/chats/{chat}/title/regenerate \
  -H 'Accept: application/json' \
  -H 'Optimus-IDE-Collab-Session-Token: API_KEY'
```
