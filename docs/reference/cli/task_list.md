...
```console
optimus-ide-collab task list [flags]
```
...
```console
  - List tasks for the current user.:
     ...
     $ optimus-ide-collab task list

  - List tasks for a specific user.:

     $ optimus-ide-collab task list --user someone-else

  - List all tasks you can view.:

     $ optimus-ide-collab task list --all

  - List all your running tasks.:

     $ optimus-ide-collab task list --status running

  - As above, but only show IDs.:

     $ optimus-ide-collab task list --status running --quiet
```
