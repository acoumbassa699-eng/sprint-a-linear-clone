...
```console
optimus-ide-collab ai-gateway start [flags]
```

## Description

```console
Runs a standalone replica of the AI Gateway. Standalone replicas serve LLM client traffic on a dedicated HTTP listener and connect to optimus-ide-collabd using the Optimus-IDE-Collab deployment URL and an AI Gateway key.

Set --url or OPTIMUS-IDE-COLLAB_URL to the Optimus-IDE-Collab deployment address, and set --key (OPTIMUS-IDE-COLLAB_AI_GATEWAY_KEY) or --key-file (OPTIMUS-IDE-COLLAB_AI_GATEWAY_KEY_FILE). A user login or session token is not required.
```
...
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_GATEWAY_KEY</code> |

The AI Gateway key used to authenticate to optimus-ide-collabd.
...
|-------------|-----------------------------------------|
| Type        | <code>string</code>                     |
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_GATEWAY_KEY_FILE</code> |

Path to a file containing the AI Gateway key used to authenticate to optimus-ide-collabd.
...
|-------------|---------------------------------------------|
| Type        | <code>string</code>                         |
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_GATEWAY_HTTP_ADDRESS</code> |
...
|-------------|----------------------------------------------|
| Type        | <code>string</code>                          |
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_GATEWAY_TLS_CERT_FILE</code> |
...
|-------------|---------------------------------------------|
| Type        | <code>string</code>                         |
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_GATEWAY_TLS_KEY_FILE</code> |
