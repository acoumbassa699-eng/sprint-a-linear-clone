...
```console
optimus-ide-collab ssh [flags] <workspace> [command]
```

## Description

```console
This command does not have full parity with the standard SSH command. For users who need the full functionality of SSH, create an ssh configuration with `optimus-ide-collab config-ssh`.

  - Use `--` to separate and pass flags directly to the command executed via SSH.:

     $ optimus-ide-collab ssh <workspace> -- ls -la
```
...
|-------------|-------------------------------|
| Type        | <code>bool</code>             |
| Environment | <code>$OPTIMUS-IDE-COLLAB_SSH_STDIO</code> |
...
|-------------|-----------------------------|
| Type        | <code>bool</code>           |
| Environment | <code>$OPTIMUS-IDE-COLLAB_SSH_TTY</code> |
...
| Environment | <code>$OPTIMUS-IDE-COLLAB_SSH_SSH_HOST_PREFIX</code> |
...
|-------------|-----------------------------------------|
| Type        | <code>string</code>                     |
| Environment | <code>$OPTIMUS-IDE-COLLAB_SSH_HOSTNAME_SUFFIX</code> |
...
|-------------|---------------------------------------|
| Type        | <code>bool</code>                     |
| Environment | <code>$OPTIMUS-IDE-COLLAB_SSH_FORWARD_AGENT</code> |
...
|-------------|-------------------------------------|
| Type        | <code>bool</code>                   |
| Environment | <code>$OPTIMUS-IDE-COLLAB_SSH_FORWARD_GPG</code> |
...
|-------------|----------------------------------------|
| Type        | <code>string</code>                    |
| Environment | <code>$OPTIMUS-IDE-COLLAB_SSH_IDENTITY_AGENT</code> |
...
| Environment | <code>$OPTIMUS-IDE-COLLAB_WORKSPACE_POLL_INTERVAL</code> |
...
| Environment | <code>$OPTIMUS-IDE-COLLAB_SSH_WAIT</code> |
...
|-------------|---------------------------------|
| Type        | <code>bool</code>               |
| Environment | <code>$OPTIMUS-IDE-COLLAB_SSH_NO_WAIT</code> |
...
|-------------|---------------------------------|
| Type        | <code>string</code>             |
| Environment | <code>$OPTIMUS-IDE-COLLAB_SSH_LOG_DIR</code> |
...
| Environment | <code>$OPTIMUS-IDE-COLLAB_SSH_REMOTE_FORWARD</code> |
...
|-------------|-----------------------------|
| Type        | <code>string-array</code>   |
| Environment | <code>$OPTIMUS-IDE-COLLAB_SSH_ENV</code> |
...
|-------------|-------------------------------------------|
| Type        | <code>bool</code>                         |
| Environment | <code>$OPTIMUS-IDE-COLLAB_SSH_DISABLE_AUTOSTART</code> |
