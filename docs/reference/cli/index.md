...
```console
optimus-ide-collab [global-flags] <subcommand>
```

## Description

```console
Optimus-IDE-Collab — A tool for provisioning self-hosted development environments with Terraform.
  ...
  - Get started by creating a template from an example:
     ...
     $ optimus-ide-collab templates init
```
...
| [<code>login</code>](./login.md)                             | Authenticate with Optimus-IDE-Collab deployment                                                                                           |
...
| [<code>notifications</code>](./notifications.md)             | Manage Optimus-IDE-Collab notifications                                                                                                   |
| [<code>oauth2-provider</code>](./oauth2-provider.md)         | Manage Optimus-IDE-Collab OAuth2 provider settings                                                                                        |
| [<code>organizations</code>](./organizations.md)             | Organization related commands                                                                                                |
| [<code>port-forward</code>](./port-forward.md)               | Forward ports from a workspace to the local machine. For reverse port forwarding, use "optimus-ide-collab ssh -R".                        |
| [<code>publickey</code>](./publickey.md)                     | Output your Optimus-IDE-Collab public key used for Git operations                                                                         |
...
| [<code>version</code>](./version.md)                         | Show optimus-ide-collab version                                                                                                           |
| [<code>autoupdate</code>](./autoupdate.md)                   | Toggle auto-update policy for a workspace                                                                                    |
| [<code>config-ssh</code>](./config-ssh.md)                   | Add an SSH Host entry for your workspaces "ssh workspace.optimus-ide-collab"                                                              |
...
| [<code>whoami</code>](./whoami.md)                           | Fetch authenticated user info for Optimus-IDE-Collab deployment                                                                           |
| [<code>support</code>](./support.md)                         | Commands for troubleshooting issues with a Optimus-IDE-Collab deployment.                                                                 |
| [<code>server</code>](./server.md)                           | Start a Optimus-IDE-Collab server                                                                                                         |
...
| [<code>prebuilds</code>](./prebuilds.md)                     | Manage Optimus-IDE-Collab prebuilds                                                                                                       |
...
|-------------|-------------------------|
| Type        | <code>url</code>        |
| Environment | <code>$OPTIMUS-IDE-COLLAB_URL</code> |
...
| Environment | <code>$OPTIMUS-IDE-COLLAB_SESSION_TOKEN</code> |

Specify an authentication token. For security reasons setting OPTIMUS-IDE-COLLAB_SESSION_TOKEN is preferred.
...
|-------------|----------------------------------------|
| Type        | <code>bool</code>                      |
| Environment | <code>$OPTIMUS-IDE-COLLAB_NO_VERSION_WARNING</code> |
...
|-------------|----------------------------------------|
| Type        | <code>bool</code>                      |
| Environment | <code>$OPTIMUS-IDE-COLLAB_NO_FEATURE_WARNING</code> |
...
| Environment | <code>$OPTIMUS-IDE-COLLAB_HEADER</code> |
...
|-------------|------------------------------------|
| Type        | <code>string</code>                |
| Environment | <code>$OPTIMUS-IDE-COLLAB_HEADER_COMMAND</code> |
...
|-------------|-------------------------------|
| Type        | <code>bool</code>             |
| Environment | <code>$OPTIMUS-IDE-COLLAB_FORCE_TTY</code> |
...
|-------------|-----------------------------|
| Type        | <code>bool</code>           |
| Environment | <code>$OPTIMUS-IDE-COLLAB_VERBOSE</code> |
...
|-------------|------------------------------------------------|
| Type        | <code>bool</code>                              |
| Environment | <code>$OPTIMUS-IDE-COLLAB_DISABLE_DIRECT_CONNECTIONS</code> |
...
|-------------|-----------------------------------------------|
| Type        | <code>bool</code>                             |
| Environment | <code>$OPTIMUS-IDE-COLLAB_DISABLE_NETWORK_TELEMETRY</code> |

Disable network telemetry. Network telemetry is collected when connecting to workspaces using the CLI, and is forwarded to the server. If telemetry is also enabled on the server, it may be sent to Optimus-IDE-Collab. Network telemetry is used to measure network quality and detect regressions.
...
|-------------|----------------------------------------|
| Type        | <code>string</code>                    |
| Environment | <code>$OPTIMUS-IDE-COLLAB_CLIENT_TLS_CA_FILE</code> |
...
|-------------|------------------------------------------|
| Type        | <code>string</code>                      |
| Environment | <code>$OPTIMUS-IDE-COLLAB_CLIENT_TLS_CERT_FILE</code> |
...
|-------------|-----------------------------------------|
| Type        | <code>string</code>                     |
| Environment | <code>$OPTIMUS-IDE-COLLAB_CLIENT_TLS_KEY_FILE</code> |
...
|-------------|---------------------------------|
| Type        | <code>bool</code>               |
| Environment | <code>$OPTIMUS-IDE-COLLAB_USE_KEYRING</code> |
...
|-------------|--------------------------------|
| Type        | <code>string</code>            |
| Environment | <code>$OPTIMUS-IDE-COLLAB_CONFIG_DIR</code> |
| Default     | <code>~/.config/optimus-ide-collabv2</code> |

Path to the global `optimus-ide-collab` config directory.
