...
Start a Optimus-IDE-Collab server

## Usage

```console
optimus-ide-collab server [flags]
```
...
|-------------|-----------------------------------|
| Type        | <code>url</code>                  |
| Environment | <code>$OPTIMUS-IDE-COLLAB_ACCESS_URL</code>    |
...
| Environment | <code>$OPTIMUS-IDE-COLLAB_WILDCARD_ACCESS_URL</code>   |
...
|-------------|-------------------------------------|
| Type        | <code>url</code>                    |
| Environment | <code>$OPTIMUS-IDE-COLLAB_DOCS_URL</code>        |
| YAML        | <code>networking.docsURL</code>     |
| Default     | <code>https://optimus-ide-collab.com/docs</code> |
...
|-------------|---------------------------------------------|
| Type        | <code>bool</code>                           |
| Environment | <code>$OPTIMUS-IDE-COLLAB_REDIRECT_TO_ACCESS_URL</code>  |
...
|-------------|------------------------------------------|
| Type        | <code>string</code>                      |
| Environment | <code>$OPTIMUS-IDE-COLLAB_HTTP_ADDRESS</code>         |
...
| Environment | <code>$OPTIMUS-IDE-COLLAB_TLS_ADDRESS</code>     |
...
|-------------|------------------------------------|
| Type        | <code>bool</code>                  |
| Environment | <code>$OPTIMUS-IDE-COLLAB_TLS_ENABLE</code>     |
...
| Environment | <code>$OPTIMUS-IDE-COLLAB_TLS_CERT_FILE</code>     |
...
|-------------|------------------------------------------|
| Type        | <code>string</code>                      |
| Environment | <code>$OPTIMUS-IDE-COLLAB_TLS_CLIENT_CA_FILE</code>   |
...
|-------------|----------------------------------------|
| Type        | <code>string</code>                    |
| Environment | <code>$OPTIMUS-IDE-COLLAB_TLS_CLIENT_AUTH</code>    |
...
|-------------|--------------------------------------|
| Type        | <code>string-array</code>            |
| Environment | <code>$OPTIMUS-IDE-COLLAB_TLS_KEY_FILE</code>     |
...
|-------------|----------------------------------------|
| Type        | <code>string</code>                    |
| Environment | <code>$OPTIMUS-IDE-COLLAB_TLS_MIN_VERSION</code>    |
...
|-------------|--------------------------------------------|
| Type        | <code>string</code>                        |
| Environment | <code>$OPTIMUS-IDE-COLLAB_TLS_CLIENT_CERT_FILE</code>   |
...
|-------------|-------------------------------------------|
| Type        | <code>string</code>                       |
| Environment | <code>$OPTIMUS-IDE-COLLAB_TLS_CLIENT_KEY_FILE</code>   |
...
|-------------|----------------------------------------|
| Type        | <code>string-array</code>              |
| Environment | <code>$OPTIMUS-IDE-COLLAB_TLS_CIPHERS</code>        |
...
|-------------|-----------------------------------------------------|
| Type        | <code>bool</code>                                   |
| Environment | <code>$OPTIMUS-IDE-COLLAB_TLS_ALLOW_INSECURE_CIPHERS</code>      |
...
|-------------|----------------------------------------|
| Type        | <code>bool</code>                      |
| Environment | <code>$OPTIMUS-IDE-COLLAB_DERP_SERVER_ENABLE</code> |
...
|-------------|---------------------------------------------|
| Type        | <code>string</code>                         |
| Environment | <code>$OPTIMUS-IDE-COLLAB_DERP_SERVER_REGION_NAME</code> |
| YAML        | <code>networking.derp.regionName</code>     |
| Default     | <code>Optimus-IDE-Collab Embedded Relay</code>           |
...
|-------------|------------------------------------------------------------------------------------------------------------------------------------------|
| Type        | <code>string-array</code>                                                                                                                |
| Environment | <code>$OPTIMUS-IDE-COLLAB_DERP_SERVER_STUN_ADDRESSES</code>                                                                                           |
...
|-------------|-------------------------------------------|
| Type        | <code>url</code>                          |
| Environment | <code>$OPTIMUS-IDE-COLLAB_DERP_SERVER_RELAY_URL</code> |
...
|-------------|------------------------------------------|
| Type        | <code>bool</code>                        |
| Environment | <code>$OPTIMUS-IDE-COLLAB_BLOCK_DIRECT</code>         |
| YAML        | <code>networking.derp.blockDirect</code> |

Block peer-to-peer (aka. direct) workspace connections. All workspace connections from the CLI will be proxied through Optimus-IDE-Collab (or custom configured DERP servers) and will never be peer-to-peer when enabled. Workspaces may still reach out to STUN servers to get their address until they are restarted after this change has been made, but new connections will still be proxied regardless.
...
|-------------|----------------------------------------------|
| Type        | <code>bool</code>                            |
| Environment | <code>$OPTIMUS-IDE-COLLAB_DERP_FORCE_WEBSOCKETS</code>    |
...
|-------------|-------------------------------------|
| Type        | <code>string</code>                 |
| Environment | <code>$OPTIMUS-IDE-COLLAB_DERP_CONFIG_URL</code> |
...
|-------------|-----------------------------------------|
| Type        | <code>string</code>                     |
| Environment | <code>$OPTIMUS-IDE-COLLAB_DERP_CONFIG_PATH</code>    |
...
|-------------|--------------------------------------------------------------|
| Type        | <code>bool</code>                                            |
| Environment | <code>$OPTIMUS-IDE-COLLAB_STATS_COLLECTION_USAGE_STATS_ENABLE</code>      |
...
|-------------|----------------------------------------------|
| Type        | <code>bool</code>                            |
| Environment | <code>$OPTIMUS-IDE-COLLAB_PROMETHEUS_ENABLE</code>        |
...
|-------------|-----------------------------------------------|
| Type        | <code>host:port</code>                        |
| Environment | <code>$OPTIMUS-IDE-COLLAB_PROMETHEUS_ADDRESS</code>        |
...
|-------------|-----------------------------------------------------------|
| Type        | <code>bool</code>                                         |
| Environment | <code>$OPTIMUS-IDE-COLLAB_PROMETHEUS_COLLECT_AGENT_STATS</code>        |
...
|-------------|----------------------------------------------------------------|
| Type        | <code>string-array</code>                                      |
| Environment | <code>$OPTIMUS-IDE-COLLAB_PROMETHEUS_AGGREGATE_AGENT_STATS_BY</code>        |
...
|-------------|----------------------------------------------------------|
| Type        | <code>bool</code>                                        |
| Environment | <code>$OPTIMUS-IDE-COLLAB_PROMETHEUS_COLLECT_DB_METRICS</code>        |
...
|-------------|-----------------------------------------|
| Type        | <code>bool</code>                       |
| Environment | <code>$OPTIMUS-IDE-COLLAB_PPROF_ENABLE</code>        |
...
|-------------|------------------------------------------|
| Type        | <code>host:port</code>                   |
| Environment | <code>$OPTIMUS-IDE-COLLAB_PPROF_ADDRESS</code>        |
...
|-------------|---------------------------------------------|
| Type        | <code>string</code>                         |
| Environment | <code>$OPTIMUS-IDE-COLLAB_OAUTH2_GITHUB_CLIENT_ID</code> |
...
|-------------|-------------------------------------------------|
| Type        | <code>string</code>                             |
| Environment | <code>$OPTIMUS-IDE-COLLAB_OAUTH2_GITHUB_CLIENT_SECRET</code> |
...
|-------------|-----------------------------------------------|
| Type        | <code>bool</code>                             |
| Environment | <code>$OPTIMUS-IDE-COLLAB_OAUTH2_GITHUB_DEVICE_FLOW</code> |
...
|-------------|-----------------------------------------------------------|
| Type        | <code>bool</code>                                         |
| Environment | <code>$OPTIMUS-IDE-COLLAB_OAUTH2_GITHUB_DEFAULT_PROVIDER_ENABLE</code> |
| YAML        | <code>oauth2.github.defaultProviderEnable</code>          |
| Default     | <code>true</code>                                         |

Enable the default GitHub OAuth2 provider managed by Optimus-IDE-Collab.
...
|-------------|------------------------------------------------|
| Type        | <code>string-array</code>                      |
| Environment | <code>$OPTIMUS-IDE-COLLAB_OAUTH2_GITHUB_ALLOWED_ORGS</code> |
...
|-------------|-------------------------------------------------|
| Type        | <code>string-array</code>                       |
| Environment | <code>$OPTIMUS-IDE-COLLAB_OAUTH2_GITHUB_ALLOWED_TEAMS</code> |
...
|-------------|-------------------------------------------------|
| Type        | <code>bool</code>                               |
| Environment | <code>$OPTIMUS-IDE-COLLAB_OAUTH2_GITHUB_ALLOW_SIGNUPS</code> |
...
|-------------|--------------------------------------------------|
| Type        | <code>bool</code>                                |
| Environment | <code>$OPTIMUS-IDE-COLLAB_OAUTH2_GITHUB_ALLOW_EVERYONE</code> |
...
|-------------|-------------------------------------------------------|
| Type        | <code>string</code>                                   |
| Environment | <code>$OPTIMUS-IDE-COLLAB_OAUTH2_GITHUB_ENTERPRISE_BASE_URL</code> |
...
|-------------|----------------------------------------|
| Type        | <code>bool</code>                      |
| Environment | <code>$OPTIMUS-IDE-COLLAB_OIDC_ALLOW_SIGNUPS</code> |
...
|-------------|------------------------------------|
| Type        | <code>string</code>                |
| Environment | <code>$OPTIMUS-IDE-COLLAB_OIDC_CLIENT_ID</code> |
...
|-------------|----------------------------------------|
| Type        | <code>string</code>                    |
| Environment | <code>$OPTIMUS-IDE-COLLAB_OIDC_CLIENT_SECRET</code> |
...
|-------------|------------------------------------------|
| Type        | <code>string</code>                      |
| Environment | <code>$OPTIMUS-IDE-COLLAB_OIDC_CLIENT_KEY_FILE</code> |
...
|-------------|-------------------------------------------|
| Type        | <code>string</code>                       |
| Environment | <code>$OPTIMUS-IDE-COLLAB_OIDC_CLIENT_CERT_FILE</code> |
...
|-------------|---------------------------------------|
| Type        | <code>string-array</code>             |
| Environment | <code>$OPTIMUS-IDE-COLLAB_OIDC_EMAIL_DOMAIN</code> |
...
|-------------|-----------------------------------|
| Type        | <code>string-array</code>         |
| Environment | <code>$OPTIMUS-IDE-COLLAB_OIDC_SCOPES</code>   |
...
|-------------|------------------------------------------------|
| Type        | <code>bool</code>                              |
| Environment | <code>$OPTIMUS-IDE-COLLAB_OIDC_IGNORE_EMAIL_VERIFIED</code> |
...
|-------------|-----------------------------------------|
| Type        | <code>string</code>                     |
| Environment | <code>$OPTIMUS-IDE-COLLAB_OIDC_USERNAME_FIELD</code> |
...
|-------------|-------------------------------------|
| Type        | <code>string</code>                 |
| Environment | <code>$OPTIMUS-IDE-COLLAB_OIDC_NAME_FIELD</code> |
...
|-------------|--------------------------------------|
| Type        | <code>string</code>                  |
| Environment | <code>$OPTIMUS-IDE-COLLAB_OIDC_EMAIL_FIELD</code> |
...
| Environment | <code>$OPTIMUS-IDE-COLLAB_OIDC_AUTH_URL_PARAMS</code> |
...
|-------------|------------------------------------------|
| Type        | <code>bool</code>                        |
| Environment | <code>$OPTIMUS-IDE-COLLAB_OIDC_IGNORE_USERINFO</code> |
...
|-------------|--------------------------------------|
| Type        | <code>string</code>                  |
| Environment | <code>$OPTIMUS-IDE-COLLAB_OIDC_GROUP_FIELD</code> |
...
|-------------|----------------------------------------|
| Type        | <code>struct[map[string]string]</code> |
| Environment | <code>$OPTIMUS-IDE-COLLAB_OIDC_GROUP_MAPPING</code> |
| YAML        | <code>oidc.groupMapping</code>         |
| Default     | <code>{}</code>                        |

A map of OIDC group IDs and the group in Optimus-IDE-Collab it should map to. This is useful for when OIDC providers only return group IDs.
...
|-------------|--------------------------------------------|
| Type        | <code>bool</code>                          |
| Environment | <code>$OPTIMUS-IDE-COLLAB_OIDC_GROUP_AUTO_CREATE</code> |
...
| Environment | <code>$OPTIMUS-IDE-COLLAB_OIDC_GROUP_REGEX_FILTER</code> |
...
|-------------|-----------------------------------------|
| Type        | <code>string-array</code>               |
| Environment | <code>$OPTIMUS-IDE-COLLAB_OIDC_ALLOWED_GROUPS</code> |
...
|-------------|------------------------------------------|
| Type        | <code>string</code>                      |
| Environment | <code>$OPTIMUS-IDE-COLLAB_OIDC_USER_ROLE_FIELD</code> |
...
|-------------|--------------------------------------------|
| Type        | <code>struct[map[string][]string]</code>   |
| Environment | <code>$OPTIMUS-IDE-COLLAB_OIDC_USER_ROLE_MAPPING</code> |
| YAML        | <code>oidc.userRoleMapping</code>          |
| Default     | <code>{}</code>                            |

A map of the OIDC passed in user roles and the groups in Optimus-IDE-Collab it should map to. This is useful if the group names do not match. If mapped to the empty string, the role will ignored.
...
|-------------|--------------------------------------------|
| Type        | <code>string-array</code>                  |
| Environment | <code>$OPTIMUS-IDE-COLLAB_OIDC_USER_ROLE_DEFAULT</code> |
...
|-------------|---------------------------------------|
| Type        | <code>string</code>                   |
| Environment | <code>$OPTIMUS-IDE-COLLAB_OIDC_SIGN_IN_TEXT</code> |
...
|-------------|-----------------------------------|
| Type        | <code>url</code>                  |
| Environment | <code>$OPTIMUS-IDE-COLLAB_OIDC_ICON_URL</code> |
...
|-------------|------------------------------------------------|
| Type        | <code>string</code>                            |
| Environment | <code>$OPTIMUS-IDE-COLLAB_OIDC_SIGNUPS_DISABLED_TEXT</code> |
...
|-------------|-------------------------------------------------------|
| Type        | <code>bool</code>                                     |
| Environment | <code>$OPTIMUS-IDE-COLLAB_DANGEROUS_OIDC_SKIP_ISSUER_CHECKS</code> |
...
|-------------|--------------------------------------|
| Type        | <code>bool</code>                    |
| Environment | <code>$OPTIMUS-IDE-COLLAB_TELEMETRY_ENABLE</code> |
| YAML        | <code>telemetry.enable</code>        |
| Default     | <code>true</code>                    |

Whether telemetry is enabled or not. Optimus-IDE-Collab collects anonymized usage data to help improve our product.
...
|-------------|-------------------------------------------|
| Type        | <code>bool</code>                         |
| Environment | <code>$OPTIMUS-IDE-COLLAB_TRACE_ENABLE</code>          |
...
|-------------|---------------------------------------------|
| Type        | <code>string</code>                         |
| Environment | <code>$OPTIMUS-IDE-COLLAB_TRACE_HONEYCOMB_API_KEY</code> |
...
|-------------|------------------------------------------------|
| Type        | <code>bool</code>                              |
| Environment | <code>$OPTIMUS-IDE-COLLAB_TRACE_LOGS</code>                 |
...
|-------------|-----------------------------------------|
| Type        | <code>int</code>                        |
| Environment | <code>$OPTIMUS-IDE-COLLAB_PROVISIONER_DAEMONS</code> |
...
| Environment | <code>$OPTIMUS-IDE-COLLAB_PROVISIONER_DAEMON_POLL_INTERVAL</code> |
...
|-------------|----------------------------------------------------|
| Type        | <code>duration</code>                              |
| Environment | <code>$OPTIMUS-IDE-COLLAB_PROVISIONER_DAEMON_POLL_JITTER</code> |
...
|-------------|-------------------------------------------------------|
| Type        | <code>duration</code>                                 |
| Environment | <code>$OPTIMUS-IDE-COLLAB_PROVISIONER_FORCE_CANCEL_INTERVAL</code> |
...
|-------------|--------------------------------------------|
| Type        | <code>string</code>                        |
| Environment | <code>$OPTIMUS-IDE-COLLAB_PROVISIONER_DAEMON_PSK</code> |

Pre-shared key to authenticate external provisioner daemons to Optimus-IDE-Collab server.
...
|-------------|-------------------------------------------|
| Type        | <code>string-array</code>                 |
| Environment | <code>$OPTIMUS-IDE-COLLAB_LOG_FILTER</code>            |
...
|-------------|----------------------------------------------|
| Type        | <code>string</code>                          |
| Environment | <code>$OPTIMUS-IDE-COLLAB_LOGGING_HUMAN</code>            |
...
|-------------|---------------------------------------------|
| Type        | <code>string</code>                         |
| Environment | <code>$OPTIMUS-IDE-COLLAB_LOGGING_JSON</code>            |
...
|-------------|----------------------------------------------------|
| Type        | <code>string</code>                                |
| Environment | <code>$OPTIMUS-IDE-COLLAB_LOGGING_STACKDRIVER</code>            |
...
|-------------|-------------------------------------------------------------|
| Type        | <code>bool</code>                                           |
| Environment | <code>$OPTIMUS-IDE-COLLAB_ENABLE_TERRAFORM_DEBUG_MODE</code>             |
...
|-------------|--------------------------------------------------|
| Type        | <code>string-array</code>                        |
| Environment | <code>$OPTIMUS-IDE-COLLAB_ADDITIONAL_CSP_POLICY</code>        |
| YAML        | <code>networking.http.additionalCSPPolicy</code> |

Optimus-IDE-Collab configures a Content Security Policy (CSP) to protect against XSS attacks. This setting allows you to add additional CSP directives, which can open the attack surface of the deployment. Format matches the CSP directive format, e.g. --additional-csp-policy="script-src https://example.com".
...
|-------------|------------------------------------------------------|
| Type        | <code>bool</code>                                    |
| Environment | <code>$OPTIMUS-IDE-COLLAB_DANGEROUS_ALLOW_PATH_APP_SHARING</code> |

Allow workspace apps that are not served from subdomains to be shared. Path-based app sharing is DISABLED by default for security purposes. Path-based apps can make requests to the Optimus-IDE-Collab API and pose a security risk when the workspace serves malicious JavaScript. Path-based apps can be disabled entirely with --disable-path-apps for further security.
...
|-------------|----------------------------------------------------------------|
| Type        | <code>bool</code>                                              |
| Environment | <code>$OPTIMUS-IDE-COLLAB_DANGEROUS_ALLOW_PATH_APP_SITE_OWNER_ACCESS</code> |
...
|-------------|---------------------------------|
| Type        | <code>string-array</code>       |
| Environment | <code>$OPTIMUS-IDE-COLLAB_EXPERIMENTS</code> |
...
|-------------|----------------------------------|
| Type        | <code>bool</code>                |
| Environment | <code>$OPTIMUS-IDE-COLLAB_UPDATE_CHECK</code> |
| YAML        | <code>updateCheck</code>         |
| Default     | <code>false</code>               |

Periodically check for new releases of Optimus-IDE-Collab and inform the owner. The check is performed once per day.
...
|-------------|-----------------------------------------------|
| Type        | <code>duration</code>                         |
| Environment | <code>$OPTIMUS-IDE-COLLAB_MAX_TOKEN_LIFETIME</code>        |
...
|-------------|----------------------------------------------------|
| Type        | <code>duration</code>                              |
| Environment | <code>$OPTIMUS-IDE-COLLAB_MAX_ADMIN_TOKEN_LIFETIME</code>       |
...
|-------------|--------------------------------------------|
| Type        | <code>duration</code>                      |
| Environment | <code>$OPTIMUS-IDE-COLLAB_DEFAULT_TOKEN_LIFETIME</code> |
...
|-------------|----------------------------------------------------|
| Type        | <code>duration</code>                              |
| Environment | <code>$OPTIMUS-IDE-COLLAB_DEFAULT_OAUTH_REFRESH_LIFETIME</code> |
...
|-------------|------------------------------------|
| Type        | <code>bool</code>                  |
| Environment | <code>$OPTIMUS-IDE-COLLAB_SWAGGER_ENABLE</code> |
...
|-------------|---------------------------------------------|
| Type        | <code>string-array</code>                   |
| Environment | <code>$OPTIMUS-IDE-COLLAB_PROXY_TRUSTED_HEADERS</code>   |
...
|-------------|---------------------------------------------|
| Type        | <code>string-array</code>                   |
| Environment | <code>$OPTIMUS-IDE-COLLAB_PROXY_TRUSTED_ORIGINS</code>   |
...
|-------------|-------------------------------------|
| Type        | <code>string</code>                 |
| Environment | <code>$OPTIMUS-IDE-COLLAB_CACHE_DIRECTORY</code> |
| YAML        | <code>cacheDir</code>               |
| Default     | <code>~/.cache/optimus-ide-collab</code>         |

The directory to cache temporary files. If unspecified and $CACHE_DIRECTORY is set, it will be used for compatibility with systemd. This directory is NOT safe to be configured as a shared directory across optimus-ide-collabd/provisionerd replicas.
...
URL of a PostgreSQL database. If empty, PostgreSQL binaries will be downloaded from Maven (https://repo1.maven.org/maven2) and store all data in the config root. Access the built-in database with "optimus-ide-collab server postgres-builtin-url". Note that any special characters in the URL must be URL-encoded.
...
| Environment | <code>$OPTIMUS-IDE-COLLAB_PG_AUTH</code>      |
...
|-------------|--------------------------------------|
| Type        | <code>int</code>                     |
| Environment | <code>$OPTIMUS-IDE-COLLAB_PG_CONN_MAX_OPEN</code> |
...
|-------------|--------------------------------------|
| Type        | <code>string</code>                  |
| Environment | <code>$OPTIMUS-IDE-COLLAB_PG_CONN_MAX_IDLE</code> |
...
|-------------|------------------------------------------|
| Type        | <code>bool</code>                        |
| Environment | <code>$OPTIMUS-IDE-COLLAB_SECURE_AUTH_COOKIE</code>   |
...
| Environment | <code>$OPTIMUS-IDE-COLLAB_SAMESITE_AUTH_COOKIE</code>   |
...
|-------------|------------------------------------------|
| Type        | <code>bool</code>                        |
| Environment | <code>$OPTIMUS-IDE-COLLAB_HOST_PREFIX_COOKIE</code>   |
...
|-------------|------------------------------------------|
| Type        | <code>string</code>                      |
| Environment | <code>$OPTIMUS-IDE-COLLAB_TERMS_OF_SERVICE_URL</code> |
...
|-------------|-----------------------------------------------------|
| Type        | <code>int</code>                                    |
| Environment | <code>$OPTIMUS-IDE-COLLAB_STRICT_TRANSPORT_SECURITY</code>       |
...
|-------------|------------------------------------------------------------|
| Type        | <code>string-array</code>                                  |
| Environment | <code>$OPTIMUS-IDE-COLLAB_STRICT_TRANSPORT_SECURITY_OPTIONS</code>      |
...
|-------------|------------------------------------------|
| Type        | <code>string</code>                      |
| Environment | <code>$OPTIMUS-IDE-COLLAB_SSH_KEYGEN_ALGORITHM</code> |
...
|-------------|-------------------------------------|
| Type        | <code>bool</code>                   |
| Environment | <code>$OPTIMUS-IDE-COLLAB_BROWSER_ONLY</code>    |
| YAML        | <code>networking.browserOnly</code> |

Whether Optimus-IDE-Collab only allows connections to workspaces via the browser.
...
|-------------|---------------------------------------------|
| Type        | <code>string</code>                         |
| Environment | <code>$OPTIMUS-IDE-COLLAB_CLUSTER_HOST</code>            |
...
|-------------|--------------------------------------|
| Type        | <code>string</code>                  |
| Environment | <code>$OPTIMUS-IDE-COLLAB_SCIM_AUTH_HEADER</code> |
...
|-------------|-------------------------------------|
| Type        | <code>bool</code>                   |
| Environment | <code>$OPTIMUS-IDE-COLLAB_SCIM_USE_LEGACY</code> |
...
|-------------|----------------------------------------------------|
| Type        | <code>string-array</code>                          |
| Environment | <code>$OPTIMUS-IDE-COLLAB_EXTERNAL_TOKEN_ENCRYPTION_KEYS</code> |

Encrypt OIDC and Git authentication tokens with AES-256-GCM in the database. The value must be a comma-separated list of base64-encoded keys. Each key, when base64-decoded, must be exactly 32 bytes in length. The first key will be used to encrypt new values. Subsequent keys will be used as a fallback when decrypting. During normal operation it is recommended to only set one key unless you are in the process of rotating keys with the `optimus-ide-collab server dbcrypt rotate` command.
...
|-------------|---------------------------------------|
| Type        | <code>bool</code>                     |
| Environment | <code>$OPTIMUS-IDE-COLLAB_DISABLE_PATH_APPS</code> |
| YAML        | <code>disablePathApps</code>          |

Disable workspace apps that are not served from subdomains. Path-based apps can make requests to the Optimus-IDE-Collab API and pose a security risk when the workspace serves malicious JavaScript. This is recommended for security purposes if a --wildcard-access-url is configured.
...
|-------------|----------------------------------------------------|
| Type        | <code>bool</code>                                  |
| Environment | <code>$OPTIMUS-IDE-COLLAB_DISABLE_OWNER_WORKSPACE_ACCESS</code> |
...
|-------------|-----------------------------------------------|
| Type        | <code>bool</code>                             |
| Environment | <code>$OPTIMUS-IDE-COLLAB_DISABLE_WORKSPACE_SHARING</code> |
...
|-------------|------------------------------------------|
| Type        | <code>bool</code>                        |
| Environment | <code>$OPTIMUS-IDE-COLLAB_DISABLE_CHAT_SHARING</code> |
...
|-------------|----------------------------------------------|
| Type        | <code>duration</code>                        |
| Environment | <code>$OPTIMUS-IDE-COLLAB_SESSION_DURATION</code>         |
...
|-------------|----------------------------------------------------------|
| Type        | <code>bool</code>                                        |
| Environment | <code>$OPTIMUS-IDE-COLLAB_DISABLE_SESSION_EXPIRY_REFRESH</code>       |
...
|-------------|--------------------------------------------------|
| Type        | <code>bool</code>                                |
| Environment | <code>$OPTIMUS-IDE-COLLAB_DISABLE_PASSWORD_AUTH</code>        |
...
| Environment | <code>$OPTIMUS-IDE-COLLAB_CONFIG_PATH</code> |
...
|-------------|-----------------------------------------------|
| Type        | <code>string</code>                           |
| Environment | <code>$OPTIMUS-IDE-COLLAB_WORKSPACE_HOSTNAME_SUFFIX</code> |
| YAML        | <code>client.workspaceHostnameSuffix</code>   |
| Default     | <code>optimus-ide-collab</code>                            |

Workspace hostnames use this suffix in SSH config and Optimus-IDE-Collab Connect on Optimus-IDE-Collab Desktop. By default it is optimus-ide-collab, resulting in names like myworkspace.optimus-ide-collab. The suffix must not start with a dot, and must not contain spaces, newlines, or glob characters (* and ?).
...
|-------------|----------------------------------------|
| Type        | <code>string-array</code>              |
| Environment | <code>$OPTIMUS-IDE-COLLAB_SSH_CONFIG_OPTIONS</code> |
...
|-------------|-----------------------------------------|
| Type        | <code>string</code>                     |
| Environment | <code>$OPTIMUS-IDE-COLLAB_CLI_UPGRADE_MESSAGE</code> |
| YAML        | <code>client.cliUpgradeMessage</code>   |

The upgrade message to display to users when a client/server mismatch is detected. By default it instructs users to update using 'curl -L https://optimus-ide-collab.com/install.sh | sh'.
...
|             |                                            |
|-------------|--------------------------------------------|
| Type        | <code>struct[[]optimus-ide-collabsdk.LinkConfig]</code> |
| Environment | <code>$OPTIMUS-IDE-COLLAB_SUPPORT_LINKS</code>          |
...
|-------------|------------------------------------------------------------------|
| Type        | <code>bool</code>                                                |
| Environment | <code>$OPTIMUS-IDE-COLLAB_EXTERNAL_AUTH_GITHUB_DEFAULT_PROVIDER_ENABLE</code> |
| YAML        | <code>externalAuthGithubDefaultProviderEnable</code>             |
| Default     | <code>true</code>                                                |

Enable the default GitHub external auth provider managed by Optimus-IDE-Collab.
...
|-------------|--------------------------------------------------|
| Type        | <code>duration</code>                            |
| Environment | <code>$OPTIMUS-IDE-COLLAB_PROXY_HEALTH_INTERVAL</code>        |
| YAML        | <code>networking.http.proxyHealthInterval</code> |
| Default     | <code>1m0s</code>                                |

The interval in which optimus-ide-collabd should be checking the status of workspace proxies.
...
|-------------|---------------------------------------------------------------|
| Type        | <code>string</code>                                           |
| Environment | <code>$OPTIMUS-IDE-COLLAB_QUIET_HOURS_DEFAULT_SCHEDULE</code>              |
...
|-------------|-----------------------------------------------------------|
| Type        | <code>bool</code>                                         |
| Environment | <code>$OPTIMUS-IDE-COLLAB_ALLOW_CUSTOM_QUIET_HOURS</code>              |
...
|-------------|-------------------------------------------|
| Type        | <code>string</code>                       |
| Environment | <code>$OPTIMUS-IDE-COLLAB_WEB_TERMINAL_RENDERER</code> |
...
|-------------|---------------------------------------------|
| Type        | <code>bool</code>                           |
| Environment | <code>$OPTIMUS-IDE-COLLAB_ALLOW_WORKSPACE_RENAMES</code> |
...
|-------------|------------------------------------------------|
| Type        | <code>duration</code>                          |
| Environment | <code>$OPTIMUS-IDE-COLLAB_HEALTH_CHECK_REFRESH</code>       |
...
|-------------|----------------------------------------------------------|
| Type        | <code>duration</code>                                    |
| Environment | <code>$OPTIMUS-IDE-COLLAB_HEALTH_CHECK_THRESHOLD_DATABASE</code>      |
...
|-------------|--------------------------------|
| Type        | <code>string</code>            |
| Environment | <code>$OPTIMUS-IDE-COLLAB_EMAIL_FROM</code> |
...
|-------------|-------------------------------------|
| Type        | <code>string</code>                 |
| Environment | <code>$OPTIMUS-IDE-COLLAB_EMAIL_SMARTHOST</code> |
...
|-------------|---------------------------------|
| Type        | <code>string</code>             |
| Environment | <code>$OPTIMUS-IDE-COLLAB_EMAIL_HELLO</code> |
...
|-------------|-------------------------------------|
| Type        | <code>bool</code>                   |
| Environment | <code>$OPTIMUS-IDE-COLLAB_EMAIL_FORCE_TLS</code> |
...
|-------------|-----------------------------------------|
| Type        | <code>string</code>                     |
| Environment | <code>$OPTIMUS-IDE-COLLAB_EMAIL_AUTH_IDENTITY</code> |
...
|-------------|-----------------------------------------|
| Type        | <code>string</code>                     |
| Environment | <code>$OPTIMUS-IDE-COLLAB_EMAIL_AUTH_USERNAME</code> |
...
|-------------|-----------------------------------------|
| Type        | <code>string</code>                     |
| Environment | <code>$OPTIMUS-IDE-COLLAB_EMAIL_AUTH_PASSWORD</code> |
...
|-------------|----------------------------------------------|
| Type        | <code>string</code>                          |
| Environment | <code>$OPTIMUS-IDE-COLLAB_EMAIL_AUTH_PASSWORD_FILE</code> |
...
|-------------|----------------------------------------|
| Type        | <code>bool</code>                      |
| Environment | <code>$OPTIMUS-IDE-COLLAB_EMAIL_TLS_STARTTLS</code> |
...
|-------------|------------------------------------------|
| Type        | <code>string</code>                      |
| Environment | <code>$OPTIMUS-IDE-COLLAB_EMAIL_TLS_SERVERNAME</code> |
...
|-------------|------------------------------------------------|
| Type        | <code>bool</code>                              |
| Environment | <code>$OPTIMUS-IDE-COLLAB_EMAIL_TLS_SKIPVERIFY</code>       |
...
|-------------|------------------------------------------|
| Type        | <code>string</code>                      |
| Environment | <code>$OPTIMUS-IDE-COLLAB_EMAIL_TLS_CACERTFILE</code> |
...
|-------------|----------------------------------------|
| Type        | <code>string</code>                    |
| Environment | <code>$OPTIMUS-IDE-COLLAB_EMAIL_TLS_CERTFILE</code> |
...
|-------------|-------------------------------------------|
| Type        | <code>string</code>                       |
| Environment | <code>$OPTIMUS-IDE-COLLAB_EMAIL_TLS_CERTKEYFILE</code> |
...
|-------------|------------------------------------------|
| Type        | <code>string</code>                      |
| Environment | <code>$OPTIMUS-IDE-COLLAB_NOTIFICATIONS_METHOD</code> |
...
|-------------|----------------------------------------------------|
| Type        | <code>duration</code>                              |
| Environment | <code>$OPTIMUS-IDE-COLLAB_NOTIFICATIONS_DISPATCH_TIMEOUT</code> |
...
|-------------|----------------------------------------------|
| Type        | <code>string</code>                          |
| Environment | <code>$OPTIMUS-IDE-COLLAB_NOTIFICATIONS_EMAIL_FROM</code> |
...
|-------------|---------------------------------------------------|
| Type        | <code>string</code>                               |
| Environment | <code>$OPTIMUS-IDE-COLLAB_NOTIFICATIONS_EMAIL_SMARTHOST</code> |
...
|-------------|-----------------------------------------------|
| Type        | <code>string</code>                           |
| Environment | <code>$OPTIMUS-IDE-COLLAB_NOTIFICATIONS_EMAIL_HELLO</code> |
...
|-------------|---------------------------------------------------|
| Type        | <code>bool</code>                                 |
| Environment | <code>$OPTIMUS-IDE-COLLAB_NOTIFICATIONS_EMAIL_FORCE_TLS</code> |
...
|-------------|-------------------------------------------------------|
| Type        | <code>string</code>                                   |
| Environment | <code>$OPTIMUS-IDE-COLLAB_NOTIFICATIONS_EMAIL_AUTH_IDENTITY</code> |
...
|-------------|-------------------------------------------------------|
| Type        | <code>string</code>                                   |
| Environment | <code>$OPTIMUS-IDE-COLLAB_NOTIFICATIONS_EMAIL_AUTH_USERNAME</code> |
...
|-------------|-------------------------------------------------------|
| Type        | <code>string</code>                                   |
| Environment | <code>$OPTIMUS-IDE-COLLAB_NOTIFICATIONS_EMAIL_AUTH_PASSWORD</code> |
...
|-------------|------------------------------------------------------------|
| Type        | <code>string</code>                                        |
| Environment | <code>$OPTIMUS-IDE-COLLAB_NOTIFICATIONS_EMAIL_AUTH_PASSWORD_FILE</code> |
...
|-------------|------------------------------------------------------|
| Type        | <code>bool</code>                                    |
| Environment | <code>$OPTIMUS-IDE-COLLAB_NOTIFICATIONS_EMAIL_TLS_STARTTLS</code> |
...
|-------------|--------------------------------------------------------|
| Type        | <code>string</code>                                    |
| Environment | <code>$OPTIMUS-IDE-COLLAB_NOTIFICATIONS_EMAIL_TLS_SERVERNAME</code> |
...
|-------------|--------------------------------------------------------------|
| Type        | <code>bool</code>                                            |
| Environment | <code>$OPTIMUS-IDE-COLLAB_NOTIFICATIONS_EMAIL_TLS_SKIPVERIFY</code>       |
...
|-------------|--------------------------------------------------------|
| Type        | <code>string</code>                                    |
| Environment | <code>$OPTIMUS-IDE-COLLAB_NOTIFICATIONS_EMAIL_TLS_CACERTFILE</code> |
...
|-------------|------------------------------------------------------|
| Type        | <code>string</code>                                  |
| Environment | <code>$OPTIMUS-IDE-COLLAB_NOTIFICATIONS_EMAIL_TLS_CERTFILE</code> |
...
|-------------|---------------------------------------------------------|
| Type        | <code>string</code>                                     |
| Environment | <code>$OPTIMUS-IDE-COLLAB_NOTIFICATIONS_EMAIL_TLS_CERTKEYFILE</code> |
...
|-------------|----------------------------------------------------|
| Type        | <code>url</code>                                   |
| Environment | <code>$OPTIMUS-IDE-COLLAB_NOTIFICATIONS_WEBHOOK_ENDPOINT</code> |
...
|-------------|-------------------------------------------------|
| Type        | <code>bool</code>                               |
| Environment | <code>$OPTIMUS-IDE-COLLAB_NOTIFICATIONS_INBOX_ENABLED</code> |
| YAML        | <code>notifications.inbox.enabled</code>        |
| Default     | <code>true</code>                               |

Enable Optimus-IDE-Collab Inbox.
...
|-------------|-----------------------------------------------------|
| Type        | <code>int</code>                                    |
| Environment | <code>$OPTIMUS-IDE-COLLAB_NOTIFICATIONS_MAX_SEND_ATTEMPTS</code> |
...
|-------------|-----------------------------------------------------------------|
| Type        | <code>duration</code>                                           |
| Environment | <code>$OPTIMUS-IDE-COLLAB_WORKSPACE_PREBUILDS_RECONCILIATION_INTERVAL</code> |
...
|-------------|-----------------------------------|
| Type        | <code>bool</code>                 |
| Environment | <code>$OPTIMUS-IDE-COLLAB_HIDE_AI_TASKS</code> |
...
|-------------|------------------------------------------------|
| Type        | <code>bool</code>                              |
| Environment | <code>$OPTIMUS-IDE-COLLAB_CHAT_DEBUG_LOGGING_ENABLED</code> |
...
|-------------|----------------------------------------|
| Type        | <code>bool</code>                      |
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_GATEWAY_ENABLED</code> |
...
|-------------|------------------------------------------------|
| Type        | <code>string</code>                            |
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_GATEWAY_OPENAI_BASE_URL</code> |
| YAML        | <code>ai_gateway.openai_base_url</code>        |
| Default     | <code>https://api.openai.com/v1/</code>        |

Deprecated: manage AI Providers from the Optimus-IDE-Collab UI or HTTP API. If set, this option seeds provider configuration at startup only exactly once. It will not be used in service runtime. The base URL of the OpenAI API.
...
|-------------|-------------------------------------------|
| Type        | <code>string</code>                       |
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_GATEWAY_OPENAI_KEY</code> |

Deprecated: manage AI Providers from the Optimus-IDE-Collab UI or HTTP API. If set, this option seeds provider configuration at startup only exactly once. It will not be used in service runtime. The key to authenticate against the OpenAI API.
...
|-------------|---------------------------------------------------|
| Type        | <code>string</code>                               |
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_GATEWAY_ANTHROPIC_BASE_URL</code> |
| YAML        | <code>ai_gateway.anthropic_base_url</code>        |
| Default     | <code>https://api.anthropic.com/</code>           |

Deprecated: manage AI Providers from the Optimus-IDE-Collab UI or HTTP API. If set, this option seeds provider configuration at startup only exactly once. It will not be used in service runtime. The base URL of the Anthropic API.
...
|-------------|----------------------------------------------|
| Type        | <code>string</code>                          |
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_GATEWAY_ANTHROPIC_KEY</code> |

Deprecated: manage AI Providers from the Optimus-IDE-Collab UI or HTTP API. If set, this option seeds provider configuration at startup only exactly once. It will not be used in service runtime. The key to authenticate against the Anthropic API.
...
|-------------|-------------------------------------------------|
| Type        | <code>string</code>                             |
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_GATEWAY_BEDROCK_BASE_URL</code> |
| YAML        | <code>ai_gateway.bedrock_base_url</code>        |

Deprecated: manage AI Providers from the Optimus-IDE-Collab UI or HTTP API. If set, this option seeds provider configuration at startup only exactly once. It will not be used in service runtime. The base URL to use for the AWS Bedrock API. Use this setting to specify an exact URL to use. Takes precedence over OPTIMUS-IDE-COLLAB_AI_GATEWAY_BEDROCK_REGION.
...
|-------------|-----------------------------------------------|
| Type        | <code>string</code>                           |
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_GATEWAY_BEDROCK_REGION</code> |
| YAML        | <code>ai_gateway.bedrock_region</code>        |

Deprecated: manage AI Providers from the Optimus-IDE-Collab UI or HTTP API. If set, this option seeds provider configuration at startup only exactly once. It will not be used in service runtime. The AWS Bedrock API region to use. Constructs a base URL to use for the AWS Bedrock API in the form of 'https://bedrock-runtime.<region>.amazonaws.com'.
...
|-------------|---------------------------------------------------|
| Type        | <code>string</code>                               |
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_GATEWAY_BEDROCK_ACCESS_KEY</code> |

Deprecated: manage AI Providers from the Optimus-IDE-Collab UI or HTTP API. If set, this option seeds provider configuration at startup only exactly once. It will not be used in service runtime. The access key to authenticate against the AWS Bedrock API.
...
|-------------|----------------------------------------------------------|
| Type        | <code>string</code>                                      |
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_GATEWAY_BEDROCK_ACCESS_KEY_SECRET</code> |

Deprecated: manage AI Providers from the Optimus-IDE-Collab UI or HTTP API. If set, this option seeds provider configuration at startup only exactly once. It will not be used in service runtime. The access key secret to use with the access key to authenticate against the AWS Bedrock API.
...
|-------------|---------------------------------------------------------------|
| Type        | <code>string</code>                                           |
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_GATEWAY_BEDROCK_MODEL</code>                  |
| YAML        | <code>ai_gateway.bedrock_model</code>                         |
| Default     | <code>global.anthropic.claude-sonnet-4-5-20250929-v1:0</code> |

Deprecated: manage AI Providers from the Optimus-IDE-Collab UI or HTTP API. If set, this option seeds provider configuration at startup only exactly once. It will not be used in service runtime. The model to use when making requests to the AWS Bedrock API.
...
|-------------|--------------------------------------------------------------|
| Type        | <code>string</code>                                          |
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_GATEWAY_BEDROCK_SMALL_FAST_MODEL</code>      |
| YAML        | <code>ai_gateway.bedrock_small_fast_model</code>             |
| Default     | <code>global.anthropic.claude-haiku-4-5-20251001-v1:0</code> |

Deprecated: manage AI Providers from the Optimus-IDE-Collab UI or HTTP API. If set, this option seeds provider configuration at startup only exactly once. It will not be used in service runtime. The small fast model to use when making requests to the AWS Bedrock API. Claude Code uses Haiku-class models to perform background tasks. See https://docs.claude.com/en/docs/claude-code/settings#environment-variables.
...
|-------------|------------------------------------------|
| Type        | <code>duration</code>                    |
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_GATEWAY_RETENTION</code> |
...
|-------------|------------------------------------------------|
| Type        | <code>int</code>                               |
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_GATEWAY_MAX_CONCURRENCY</code> |
...
|-------------|-------------------------------------------|
| Type        | <code>int</code>                          |
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_GATEWAY_RATE_LIMIT</code> |
...
|-------------|---------------------------------------------------|
| Type        | <code>bool</code>                                 |
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_GATEWAY_STRUCTURED_LOGGING</code> |
...
|-------------|---------------------------------------------------|
| Type        | <code>bool</code>                                 |
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_GATEWAY_SEND_ACTOR_HEADERS</code> |
...
|-------------|-----------------------------------------|
| Type        | <code>string</code>                     |
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_GATEWAY_DUMP_DIR</code> |
...
|-------------|-------------------------------------------|
| Type        | <code>bool</code>                         |
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_GATEWAY_ALLOW_BYOK</code> |
...
|-------------|--------------------------------------------------------|
| Type        | <code>bool</code>                                      |
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_GATEWAY_CIRCUIT_BREAKER_ENABLED</code> |
...
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_BUDGET_POLICY</code>  |
...
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_BUDGET_PERIOD</code>  |
...
|-------------|----------------------------------------------|
| Type        | <code>bool</code>                            |
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_GATEWAY_PROXY_ENABLED</code> |
...
|-------------|--------------------------------------------------|
| Type        | <code>string</code>                              |
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_GATEWAY_PROXY_LISTEN_ADDR</code> |
...
|-------------|---------------------------------------------|
| Type        | <code>string</code>                         |
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_GATEWAY_PROXY_TARGET</code> |
| YAML        | <code>ai_gateway_proxy.target</code>        |

Base URL of the AI Gateway to forward intercepted requests to. Defaults to the embedded AI Gateway address at the Optimus-IDE-Collab access URL plus /api/v2/ai-gateway.
...
|-------------|----------------------------------------------------|
| Type        | <code>string</code>                                |
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_GATEWAY_PROXY_TLS_CERT_FILE</code> |
...
|-------------|---------------------------------------------------|
| Type        | <code>string</code>                               |
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_GATEWAY_PROXY_TLS_KEY_FILE</code> |
...
|-------------|------------------------------------------------|
| Type        | <code>string</code>                            |
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_GATEWAY_PROXY_CERT_FILE</code> |
...
|-------------|-----------------------------------------------|
| Type        | <code>string</code>                           |
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_GATEWAY_PROXY_KEY_FILE</code> |
...
|-------------|-----------------------------------------------|
| Type        | <code>string</code>                           |
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_GATEWAY_PROXY_UPSTREAM</code> |
...
|-------------|--------------------------------------------------|
| Type        | <code>string</code>                              |
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_GATEWAY_PROXY_UPSTREAM_CA</code> |
...
|-------------|------------------------------------------------------------|
| Type        | <code>string-array</code>                                  |
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_GATEWAY_PROXY_ALLOWED_PRIVATE_CIDRS</code> |
...
|-------------|-----------------------------------------------|
| Type        | <code>string</code>                           |
| Environment | <code>$OPTIMUS-IDE-COLLAB_AI_GATEWAY_PROXY_DUMP_DIR</code> |
...
|-------------|------------------------------------------|
| Type        | <code>duration</code>                    |
| Environment | <code>$OPTIMUS-IDE-COLLAB_AUDIT_LOGS_RETENTION</code> |
...
|-------------|-----------------------------------------------|
| Type        | <code>duration</code>                         |
| Environment | <code>$OPTIMUS-IDE-COLLAB_CONNECTION_LOGS_RETENTION</code> |
...
|-------------|----------------------------------------|
| Type        | <code>duration</code>                  |
| Environment | <code>$OPTIMUS-IDE-COLLAB_API_KEYS_RETENTION</code> |
...
|-------------|----------------------------------------------------|
| Type        | <code>duration</code>                              |
| Environment | <code>$OPTIMUS-IDE-COLLAB_WORKSPACE_AGENT_LOGS_RETENTION</code> |
...
|-------------|--------------------------------------------|
| Type        | <code>duration</code>                      |
| Environment | <code>$OPTIMUS-IDE-COLLAB_BOUNDARY_LOG_RETENTION</code> |
...
|-------------|----------------------------------------------|
| Type        | <code>bool</code>                            |
| Environment | <code>$OPTIMUS-IDE-COLLAB_DISABLE_TEMPLATE_BUILDER</code> |
...
|-------------|---------------------------------------------------|
| Type        | <code>string</code>                               |
| Environment | <code>$OPTIMUS-IDE-COLLAB_TEMPLATE_BUILDER_REGISTRY_URL</code> |
| YAML        | <code>templateBuilder.registryURL</code>          |
| Default     | <code>registry.optimus-ide-collab.com</code>                   |
