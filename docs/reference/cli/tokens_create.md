...
```console
optimus-ide-collab tokens create [flags]
```
...
| Environment | <code>$OPTIMUS-IDE-COLLAB_TOKEN_LIFETIME</code> |
...
|-------------|--------------------------------|
| Type        | <code>string</code>            |
| Environment | <code>$OPTIMUS-IDE-COLLAB_TOKEN_NAME</code> |
...
|-------------|--------------------------------|
| Type        | <code>string</code>            |
| Environment | <code>$OPTIMUS-IDE-COLLAB_TOKEN_USER</code> |
