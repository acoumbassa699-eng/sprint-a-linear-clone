...
```console
optimus-ide-collab organizations show [flags] ["selected"|"me"|uuid|org_name]
```

## Description

```console
  - optimus-ide-collab org show selected:

     $ Shows the organizations selected with '--org=<org_name>'. This organization is the organization used by the cli.

  - optimus-ide-collab org show me:

     $ List of all organizations you are a member of.

  - optimus-ide-collab org show developers:

     $ Show organization with name 'developers'

  - optimus-ide-collab org show 90ee1875-3db5-43b3-828e-af3687522e43:
