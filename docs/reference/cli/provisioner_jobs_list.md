...
```console
optimus-ide-collab provisioner jobs list [flags]
```
...
| Environment | <code>$OPTIMUS-IDE-COLLAB_PROVISIONER_JOB_LIST_STATUS</code>                                  |
...
|-------------|------------------------------------------------|
| Type        | <code>int</code>                               |
| Environment | <code>$OPTIMUS-IDE-COLLAB_PROVISIONER_JOB_LIST_LIMIT</code> |
...
| Environment | <code>$OPTIMUS-IDE-COLLAB_PROVISIONER_JOB_LIST_INITIATOR</code> |
