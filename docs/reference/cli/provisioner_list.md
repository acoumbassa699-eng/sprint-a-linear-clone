...
```console
optimus-ide-collab provisioner list [flags]
```
...
|-------------|--------------------------------------------|
| Type        | <code>int</code>                           |
| Environment | <code>$OPTIMUS-IDE-COLLAB_PROVISIONER_LIST_LIMIT</code> |
...
|-------------|----------------------------------------------|
| Type        | <code>bool</code>                            |
| Environment | <code>$OPTIMUS-IDE-COLLAB_PROVISIONER_SHOW_OFFLINE</code> |
...
| Environment | <code>$OPTIMUS-IDE-COLLAB_PROVISIONER_LIST_STATUS</code> |
...
| Environment | <code>$OPTIMUS-IDE-COLLAB_PROVISIONER_LIST_MAX_AGE</code> |
