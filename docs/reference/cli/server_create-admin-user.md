...
```console
optimus-ide-collab server create-admin-user [flags]
```
...
|-------------|------------------------------|
| Type        | <code>string</code>          |
| Environment | <code>$OPTIMUS-IDE-COLLAB_USERNAME</code> |
...
|-------------|---------------------------|
| Type        | <code>string</code>       |
| Environment | <code>$OPTIMUS-IDE-COLLAB_EMAIL</code> |
...
|-------------|------------------------------|
| Type        | <code>string</code>          |
| Environment | <code>$OPTIMUS-IDE-COLLAB_PASSWORD</code> |
