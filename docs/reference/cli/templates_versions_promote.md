...
```console
optimus-ide-collab templates versions promote [flags] --template=<template_name> --template-version=<template_version_name>
```
...
|-------------|-------------------------------------------|
| Type        | <code>string</code>                       |
| Environment | <code>$OPTIMUS-IDE-COLLAB_TEMPLATE_VERSION_NAME</code> |
