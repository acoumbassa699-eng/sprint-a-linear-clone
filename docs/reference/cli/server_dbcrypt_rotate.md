...
```console
optimus-ide-collab server dbcrypt rotate [flags]
```
...
|-------------|---------------------------------------------------------------|
| Type        | <code>string</code>                                           |
| Environment | <code>$OPTIMUS-IDE-COLLAB_EXTERNAL_TOKEN_ENCRYPTION_ENCRYPT_NEW_KEY</code> |
...
| Environment | <code>$OPTIMUS-IDE-COLLAB_EXTERNAL_TOKEN_ENCRYPTION_ENCRYPT_OLD_KEYS</code> |
