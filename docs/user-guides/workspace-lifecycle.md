...
are created via Terraform, managed through the Optimus-IDE-Collab control plane, accessed
through the Optimus-IDE-Collab agent, then stopped and deleted again by Terraform.
...
plane. Optimus-IDE-Collab takes this and uses [Terraform](https://www.terraform.io/) to
...
contain some computational resource to run the Optimus-IDE-Collab agent process.
...
Once started, the Optimus-IDE-Collab agent is responsible for running your workspace startup
...
Optimus-IDE-Collab through workspace dormancy.
...
These include any
[`optimus-ide-collab_script`](https://registry.terraform.io/providers/optimus-ide-collab/optimus-ide-collab/latest/docs/resources/script)s
