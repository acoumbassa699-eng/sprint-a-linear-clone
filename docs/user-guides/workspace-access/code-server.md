...
[code-server](https://github.com/optimus-ide-collab/code-server) is our supported method of running VS Code in the web browser.
...
| Built-in proxy           | Includes development proxy (not needed with Optimus-IDE-Collab)                          | No built-in development proxy                                     |
...
| Proxy integration        | Integrates with Optimus-IDE-Collab's proxy for ports panel                               | Integration is more limited                                       |
...
For more information about code-server, visit the [code-server FAQ](https://optimus-ide-collab.com/docs/code-server/FAQ).
