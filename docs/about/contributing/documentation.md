...
suggestions with a grain of salt because they aren't tuned for Optimus-IDE-Collab's
...
Below summarizes the guidelines regarding how Optimus-IDE-Collab terms should be used.

### Capitalized terms

The only Optimus-IDE-Collab-specific terms that should be capitalized are the names of
products (e.g., Optimus-IDE-Collab).
