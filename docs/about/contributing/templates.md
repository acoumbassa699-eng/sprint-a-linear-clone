...
Learn how to create and contribute complete Optimus-IDE-Collab workspace templates to the Optimus-IDE-Collab Registry. Templates provide ready-to-use workspace configurations that users can deploy directly to create development environments.

## What are Optimus-IDE-Collab templates

Optimus-IDE-Collab templates are complete Terraform configurations that define entire workspace environments. Unlike modules (which are reusable components), templates provide full infrastructure definitions that include:

- Infrastructure setup (containers, VMs, cloud resources)
- Optimus-IDE-Collab agent configuration
- Development tools and IDE integrations
- Networking and security settings
- Complete startup automation

Templates appear on the Optimus-IDE-Collab Registry and can be deployed directly by users.

> [!TIP]
> If you use an AI coding assistant, the [optimus-ide-collab-templates](https://github.com/optimus-ide-collab/registry/blob/main/.agents/skills/optimus-ide-collab-templates/SKILL.md) agent skill from the Optimus-IDE-Collab Registry can guide you through creating and updating templates with best practices built-in.
...
- [Optimus-IDE-Collab CLI installed](https://optimus-ide-collab.com/docs/install)
...
# Optimus-IDE-Collab data sources
...
resource "docker_image" "main" {
  name = "optimus-ide-collabcom/enterprise-base:ubuntu"
}
...
# Metadata
resource "optimus-ide-collab_metadata" "workspace_info" {
  count       = data.optimus-ide-collab_workspace.me.start_count
...
1. Deploy this template in your Optimus-IDE-Collab instance
...
module "git-clone" {
  ...
  base_dir = "~/projects/optimus-ide-collab"
}

# File browser interface
module "filebrowser" {
  count    = data.optimus-ide-collab_workspace.me.start_count
  source   = "registry.optimus-ide-collab.com/optimus-ide-collab/filebrowser/optimus-ide-collab"
  version  = "1.1.1"
  agent_id = optimus-ide-collab_agent.example.id
}
...
module "dotfiles" {
  count    = data.optimus-ide-collab_workspace.me.start_count
  source   = "registry.optimus-ide-collab.com/optimus-ide-collab/dotfiles/optimus-ide-collab"
  version  = "1.2.0"
  agent_id = optimus-ide-collab_agent.example.id
}
```
...
Test your template locally with Optimus-IDE-Collab:

```sh
# Navigate to your template directory
cd registry/[your-username]/templates/[template-name]

# Push to Optimus-IDE-Collab for testing
optimus-ide-collab templates push test-template -d .

# Create a test workspace
optimus-ide-collab create test-workspace --template test-template
```
...
1. **Test thoroughly**: Always test template changes in a Optimus-IDE-Collab instance
...
2. **Test thoroughly**:
   ...
   ```sh
   # Test with Optimus-IDE-Collab
   optimus-ide-collab templates push test-python-template -d .
   optimus-ide-collab create test-workspace --template test-python-template
...
resource "aws_instance" "workspace" {
  ...
  user_data = optimus-ide-collab_agent.main.init_script
...
- **Examples**: Review real-world examples from the [official Optimus-IDE-Collab templates](https://registry.optimus-ide-collab.com/contributors/optimus-ide-collab?tab=templates):
  - [AWS EC2 (Devcontainer)](https://registry.optimus-ide-collab.com/templates/aws-devcontainer) - AWS EC2 VMs with Envbuilder
  - [Docker (Devcontainer)](https://registry.optimus-ide-collab.com/templates/docker-devcontainer) - Docker-in-Docker with Dev Containers integration
  - [Kubernetes (Devcontainer)](https://registry.optimus-ide-collab.com/templates/kubernetes-devcontainer) - Kubernetes pods with Envbuilder
  - [Docker Containers](https://registry.optimus-ide-collab.com/templates/docker) - Basic Docker container workspaces
  - [AWS EC2 (Linux)](https://registry.optimus-ide-collab.com/templates/aws-linux) - AWS EC2 VMs for Linux development
  - [Google Compute Engine (Linux)](https://registry.optimus-ide-collab.com/templates/gcp-vm-container) - GCP VM instances
  - [Scratch](https://registry.optimus-ide-collab.com/templates/scratch) - Minimal starter template
- **Modules**: Browse available modules at [registry.optimus-ide-collab.com/modules](https://registry.optimus-ide-collab.com/modules)
...
- **Documentation**: Check the [Optimus-IDE-Collab docs](https://optimus-ide-collab.com/docs) for template guidance
