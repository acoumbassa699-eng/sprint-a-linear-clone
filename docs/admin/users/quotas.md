...
[`resource_metadata`](https://registry.terraform.io/providers/optimus-ide-collab/optimus-ide-collab/latest/docs/resources/metadata).
...
resource "docker_volume" "home_volume" {
  name = "optimus-ide-collab-${data.optimus-ide-collab_workspace_owner.me.name}-${data.optimus-ide-collab_workspace.me.name}-root"
}

resource "optimus-ide-collab_metadata" "home_volume" {
...
resource "docker_container" "workspace" {
  ...
  image = "optimus-ide-collabcom/code-server:latest"
  ...
  volumes {
...
resource "optimus-ide-collab_metadata" "workspace" {
    count       = data.optimus-ide-collab_workspace.me.start_count
...
`optimus-ide-collab_metadata` both get deleted. This reduces the cost from 30 credits to 10
credits.
...
Optimus-IDE-Collab enforces Quota on workspace start and stop operations. The workspace build
