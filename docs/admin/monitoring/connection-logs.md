...
> [Premium license](https://optimus-ide-collab.com/pricing#compare-plans).
> For more details, [contact your account team](https://optimus-ide-collab.com/contact).
...
These originate from within the Optimus-IDE-Collab deployment, and thus the connection log
...
Agent-reported events do not identify the Optimus-IDE-Collab user who connected. To
...
- A tunnel event records that a tunnel was established, not what it was
  ...
  including `optimus-ide-collab ssh`, `optimus-ide-collab port-forward`, `optimus-ide-collab ping`,
  `optimus-ide-collab speedtest`, and IDE extensions. One tunnel may carry many
  sessions, or none.
...
- Connections made through Optimus-IDE-Collab Desktop (Optimus-IDE-Collab Connect) do not
...
- `type` - The type of the connection, such as SSH, VS Code, or workspace app.
    ...
    [Optimus-IDE-CollabSDK documentation](https://pkg.go.dev/github.com/optimus-ide-collab/optimus-ide-collab/v2/optimus-ide-collabsdk#ConnectionType).
...
In addition to the Optimus-IDE-Collab dashboard, there are multiple ways to consume or query
connection events.

### REST API

You can retrieve connection logs via the Optimus-IDE-Collab API.
Visit the
...
```json
{
    ...
    "level": "INFO",
    "msg": "connection_log",
    "caller": "/home/optimus-ide-collab/optimus-ide-collab/enterprise/audit/backends/slog.go:38",
    "func": "github.com/optimus-ide-collab/optimus-ide-collab/v2/enterprise/audit/backends.(*SlogExporter).ExportStruct",
    "logger_names": ["optimus-ide-collabd"],
    "fields": {
...
`--connection-logs-retention` flag or `OPTIMUS-IDE-COLLAB_CONNECTION_LOGS_RETENTION`
