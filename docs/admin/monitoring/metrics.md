...
Optimus-IDE-Collab exposes many metrics which give insight into the current state of a live
Optimus-IDE-Collab deployment. Our metrics are designed to be consumed by a
...
- [Configure Prometheus to scrape Optimus-IDE-Collab metrics](../integrations/prometheus.md#prometheus-configuration)
