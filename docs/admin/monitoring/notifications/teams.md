...
used collaboration platform, and with Optimus-IDE-Collab's integration, you can enable
   ...
   **Recipient**: `user_email`
   ...
   ```json
   {
       ...
       "body": [
           {
               "type": "Image",
               "url": "https://optimus-ide-collab.com/optimus-ide-collab-logo-horizontal.png",
               "height": "40px",
               "altText": "Optimus-IDE-Collab",
   ...
   _Notice_: The Optimus-IDE-Collab `actions` format differs from the `ActionSet` schema, so
...
To enable webhook integration in Optimus-IDE-Collab, define the POST webhook endpoint created
by your Teams workflow:

```sh
export OPTIMUS-IDE-COLLAB_NOTIFICATIONS_WEBHOOK_ENDPOINT=https://prod-16.eastus.logic.azure.com:443/workflows/f8fbe3e8211e4b638...`
```
