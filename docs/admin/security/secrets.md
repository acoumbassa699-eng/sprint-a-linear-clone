...
Optimus-IDE-Collab is open-minded about how you get your secrets into your workspaces. For
...
Use this guide to configure how templates make secrets available to Optimus-IDE-Collab
workspaces. To authenticate workspace provisioners with Optimus-IDE-Collab, see the
...
Your first attempt to use secrets with Optimus-IDE-Collab should be your local method. You
can do everything you can locally and more with your Optimus-IDE-Collab workspace, so
...
Optimus-IDE-Collab generates SSH key pairs for each user. This can be used as an
...
> [!NOTE]
> SSH keys are never stored in Optimus-IDE-Collab workspaces, and are fetched only when
> SSH is invoked. The keys are held in-memory and never written to disk.

## User secrets

User secrets are developer-managed values that Optimus-IDE-Collab injects at workspace start.
If a user secret targets the same environment variable name or file path as a
template-provided variable or file, Optimus-IDE-Collab injects the user secret into that
...
[`optimus-ide-collab_metadata`](https://registry.terraform.io/providers/optimus-ide-collab/optimus-ide-collab/latest/docs/resources/metadata).
...
resource "optimus-ide-collab_metadata" "twilio_key" {
...
more information on how to integrate HashiCorp Vault with Optimus-IDE-Collab.
