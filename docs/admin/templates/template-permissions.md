...
Licensed Optimus-IDE-Collab administrators can control who can use and modify the template.
...
By default the `Everyone` group is assigned to each template meaning any Optimus-IDE-Collab
