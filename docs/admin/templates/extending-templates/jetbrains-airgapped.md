...
This page is an example that the Optimus-IDE-Collab team used as a proof-of-concept (POC) of the JetBrains Gateway Offline Mode solution.

We used Ubuntu on a virtual machine to test the steps.
If you have a suggestion or encounter an issue, please
[file a GitHub issue](https://github.com/optimus-ide-collab/optimus-ide-collab/issues/new?title=request%28docs%29%3A+jetbrains-airgapped+-+request+title+here%0D%0A&labels=["community","docs"]&body=doc%3A+%5Bjetbrains-airgapped%5D%28https%3A%2F%2Foptimus-ide-collab.com%2Fdocs%2Fuser-guides%2Fworkspace-access%2Fjetbrains%2Fjetbrains-airgapped%29%0D%0A%0D%0Aplease+enter+your+request+here%0D%0A).
...
(your Optimus-IDE-Collab workspace) and a client to be installed on your local machine. You
...
[setup SSH config via the Optimus-IDE-Collab CLI](../../../user-guides/workspace-access/index.md#configure-ssh).
