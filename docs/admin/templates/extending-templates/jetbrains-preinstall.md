...
If you are using our [jetbrains-gateway](https://registry.optimus-ide-collab.com/modules/optimus-ide-collab/jetbrains-gateway) module, you can configure it by adding the following snippet to your template:

```tf
module "jetbrains_gateway" {
  count          = data.optimus-ide-collab_workspace.me.start_count
  source         = "registry.optimus-ide-collab.com/modules/jetbrains-gateway/optimus-ide-collab"
  version        = "1.0.29"
  agent_id       = optimus-ide-collab_agent.main.id
  folder         = "/home/optimus-ide-collab/example"
  jetbrains_ides = ["IU"]
  default        = "IU"
  latest         = false
