...
- [**Default autostop**](../../../user-guides/workspace-scheduling.md#autostop):
  How long a workspace runs without user activity before Optimus-IDE-Collab automatically
  stops it.
...
Dormancy Threshold defines how long Optimus-IDE-Collab allows a workspace to remain inactive
...
the user before being accessible. Optimus-IDE-Collab stops workspaces during their transition
...
[OPTIMUS-IDE-COLLAB_QUIET_HOURS_DEFAULT_SCHEDULE](../../../reference/cli/server.md#--default-quiet-hours-schedule)
...
using Optimus-IDE-Collab.

Admins can force users to use the default quiet hours with the
[OPTIMUS-IDE-COLLAB_ALLOW_CUSTOM_QUIET_HOURS](../../../reference/cli/server.md#--allow-custom-quiet-hours)
