...
While Optimus-IDE-Collab provides example
[container images](https://github.com/optimus-ide-collab/images) for
...
best practices around managing workspace images for Optimus-IDE-Collab.
...
While you may not use this directly in Optimus-IDE-Collab templates, it's useful to have a
minimal base image as a small image that contains only the necessary
dependencies to work in your network and work with Optimus-IDE-Collab. Here are some things
to consider:
...
- If the Optimus-IDE-Collab server is using a certificate from an internal certificate
...
- [`optimus-ide-collabcom/example-minimal:ubuntu`](https://github.com/optimus-ide-collab/images/tree/main/images/minimal): only the necessary dependencies for a Optimus-IDE-Collab workspace to bootstrap
- [`optimus-ide-collabcom/example-base:ubuntu`](https://github.com/optimus-ide-collab/images/tree/main/images/base): a slightly more padded starting point with common utilities preinstalled
...
- **Scripting:** Developers may just want to hop in a Optimus-IDE-Collab workspace to run
...
- [`optimus-ide-collabcom/example-universal:ubuntu`](https://github.com/optimus-ide-collab/images/tree/main/images/universal): a catch-all image with many languages and tools preinstalled. Runs as the `optimus-ide-collab` user, so it works with Optimus-IDE-Collab templates out of the box.
...
- [`optimus-ide-collabcom/example-golang:ubuntu`](https://github.com/optimus-ide-collab/images/tree/main/images/golang),
  [`optimus-ide-collabcom/example-java:ubuntu`](https://github.com/optimus-ide-collab/images/tree/main/images/java),
  [`optimus-ide-collabcom/example-node:ubuntu`](https://github.com/optimus-ide-collab/images/tree/main/images/node):
  Optimus-IDE-Collab's example language-specific images, all running as the `optimus-ide-collab` user.
  Refer to [optimus-ide-collab/images](https://github.com/optimus-ide-collab/images) for the full list.
- [`optimus-ide-collabcom/oss-dogfood:latest`](https://github.com/optimus-ide-collab/optimus-ide-collab/tree/main/dogfood):
  the image Optimus-IDE-Collab's own engineers use to develop Optimus-IDE-Collab. A good reference for a
...
- [Dev Containers](https://containers.dev): developers define their project's
  dependencies in a `devcontainer.json` in their Git repository, and Optimus-IDE-Collab
