...
underlying infrastructure that all Optimus-IDE-Collab workspaces run on.
...
While templates are written in standard Terraform, it's important to learn the Optimus-IDE-Collab-specific concepts behind templates.
...
tasks. As your Optimus-IDE-Collab deployment grows, you can create more templates to meet the
needs of different teams.

- [Image management](./managing-templates/image-management.md): Learn how to
  create and publish images for use within Optimus-IDE-Collab workspaces & templates.
...
- [External Workspaces](./managing-templates/external-workspaces.md): Learn how to connect your existing infrastructure to Optimus-IDE-Collab workspaces.
