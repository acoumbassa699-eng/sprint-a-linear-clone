...
Optimus-IDE-Collab is highly extensible and is not limited to the platforms outlined in these
...
The following resources may help as you're deploying Optimus-IDE-Collab.

- [Optimus-IDE-Collab packages: one-click install on cloud providers](https://github.com/optimus-ide-collab/packages)
- [Deploy Optimus-IDE-Collab Air-gapped](../../install/airgap.md)
