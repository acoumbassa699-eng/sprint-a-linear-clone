...
[Envbuilder documentation](https://github.com/optimus-ide-collab/envbuilder/blob/main/docs/container-registry-auth.md)
...
Refer to the
[Envbuilder documentation](https://github.com/optimus-ide-collab/envbuilder/blob/main/docs/caching.md)
...
[Envbuilder Terraform Provider](https://github.com/optimus-ide-collab/terraform-provider-envbuilder)
...
[provider documentation](https://registry.terraform.io/providers/optimus-ide-collab/envbuilder/latest/docs/resources/cached_image).
You may also wish to consult a
[documented example usage of the `envbuilder_cached_image` resource](https://github.com/optimus-ide-collab/terraform-provider-envbuilder/blob/main/examples/resources/envbuilder_cached_image/envbuilder_cached_image_resource.tf).
