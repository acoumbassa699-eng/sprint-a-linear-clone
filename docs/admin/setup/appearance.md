...
> [!NOTE]
> Customizing Optimus-IDE-Collab's appearance is a Premium feature.
> [Learn more](https://optimus-ide-collab.com/pricing#compare-plans).

Customize the look of your Optimus-IDE-Collab deployment to meet your enterprise
requirements.
...
is Optimus-IDE-Collab.

## Logo URL

Specify a custom URL for your enterprise's logo to be displayed on the sign in
page and in the top left corner of the dashboard. The default is the Optimus-IDE-Collab logo.
...
users of which network their Optimus-IDE-Collab deployment is on.
...
To configure support links in your Optimus-IDE-Collab Kubernetes deployment, update your Helm
chart values as follows:

```yaml
optimus-ide-collab:
  env:
    - name: OPTIMUS-IDE-COLLAB_SUPPORT_LINKS
      value: >
        [{"name": "Hello GitHub", "target": "https://github.com/optimus-ide-collab/optimus-ide-collab",
        "icon": "bug"},
         {"name": "Hello Slack", "target":
        "https://optimus-ide-collabcom.slack.com/archives/C014JH42DBJ", "icon":
        "/icon/slack.svg"},
         {"name": "Hello Discord", "target": "https://discord.gg/optimus-ide-collab", "icon":
...
`OPTIMUS-IDE-COLLAB_SUPPORT_LINKS` in `/etc/optimus-ide-collab.d/optimus-ide-collab.env` as follows,

```dotenv
OPTIMUS-IDE-COLLAB_SUPPORT_LINKS='[{"name": "Hello GitHub", "target": "https://github.com/optimus-ide-collab/optimus-ide-collab", "icon": "bug"}, {"name": "Hello Slack", "target": "https://optimus-ide-collabcom.slack.com/archives/C014JH42DBJ", "icon": "https://raw.githubusercontent.com/optimus-ide-collab/optimus-ide-collab/main/site/static/icon/slack.svg"}, {"name": "Hello Discord", "target": "https://discord.gg/optimus-ide-collab", "icon": "https://raw.githubusercontent.com/optimus-ide-collab/optimus-ide-collab/main/site/static/icon/discord.svg", "location": "navbar"}, {"name": "Hello Foobar", "target": "https://discord.gg/optimus-ide-collab", "icon": "/emojis/1f3e1.png"}]'
```

For CLI, use,

```sh
export OPTIMUS-IDE-COLLAB_SUPPORT_LINKS='[{"name": "Hello GitHub", "target": "https://github.com/optimus-ide-collab/optimus-ide-collab", "icon": "bug"}, {"name": "Hello Slack", "target": "https://optimus-ide-collabcom.slack.com/archives/C014JH42DBJ", "icon": "https://raw.githubusercontent.com/optimus-ide-collab/optimus-ide-collab/main/site/static/icon/slack.svg"}, {"name": "Hello Discord", "target": "https://discord.gg/optimus-ide-collab", "icon": "https://raw.githubusercontent.com/optimus-ide-collab/optimus-ide-collab/main/site/static/icon/discord.svg", "location": "navbar"}, {"name": "Hello Foobar", "target": "https://discord.gg/optimus-ide-collab", "icon": "/emojis/1f3e1.png"}]'
