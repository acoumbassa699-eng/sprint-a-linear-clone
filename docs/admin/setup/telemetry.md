...
> [!NOTE]
> TL;DR: disable telemetry by setting <code>OPTIMUS-IDE-COLLAB_TELEMETRY_ENABLE=false</code>.

Optimus-IDE-Collab collects telemetry from all installations by default. We believe our users
...
[here](../../../optimus-ide-collabd/telemetry/telemetry.go).
...
In the event we discover a critical security issue with Optimus-IDE-Collab, we will use
...
`OPTIMUS-IDE-COLLAB_TELEMETRY_ENABLE=[true|false]` environment variable or the
