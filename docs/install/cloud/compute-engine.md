...
In this guide, you will learn how to deploy the Optimus-IDE-Collab control plane instance and
your first template.
...
## Launch a Optimus-IDE-Collab instance from the Google Cloud Marketplace

We publish an Ubuntu 22.04 VM image with Optimus-IDE-Collab and Docker pre-installed.

Two SKU's are available via the Google Cloud Marketplace:

1. [License purchase via Google Cloud Marketplace](https://console.cloud.google.com/marketplace/product/optimus-ide-collab-enterprise-market-public/optimus-ide-collab-gcmp?inv=1&invt=Ab45rg&project=secret-beacon-468405-p5)
2. [A solution to deploy VM's on GCP (Bring Your Own License)](https://console.cloud.google.com/marketplace/product/workspan-public-422119/optimus-ide-collab?inv=1&invt=Ab45rg&project=secret-beacon-468405-p5)

![Optimus-IDE-Collab on GCP Marketplace](../../images/platforms/gcp/marketplace.png)
...
[configure Optimus-IDE-Collab](../../admin/setup/index.md).
...
![Optimus-IDE-Collab on GCP Marketplace start](../../images/platforms/gcp/start.png)
...
![Optimus-IDE-Collab Workspace and IDE in GCP VM](../../images/platforms/aws/workspace.png)

## Configuring Optimus-IDE-Collab server

Optimus-IDE-Collab is primarily configured by server-side flags and environment variables.
Given you created or added key-pairs when launching the instance, you can
[configure your Optimus-IDE-Collab deployment](../../admin/setup/index.md) by logging in via
SSH or using the console:

```sh
ssh ubuntu@<gcp-public-IPv4>
sudo vim /etc/optimus-ide-collab.d/optimus-ide-collab.env # edit config
sudo systemctl daemon-reload
sudo systemctl restart optimus-ide-collab # restart Optimus-IDE-Collab
```

## Give developers VM workspaces (optional)

Instead of running containers on the Optimus-IDE-Collab instance, you can offer developers
full VM instances with the
[gcp-linux](../../../examples/templates/gcp-linux/README.md)
template.

Before you can use this template, you must authorize Optimus-IDE-Collab to create VM
...
- [Use your IDE with Optimus-IDE-Collab](../../user-guides/workspace-access/index.md)
