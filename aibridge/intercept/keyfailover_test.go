...
import (
	...
	"github.com/optimus-ide-collab/optimus-ide-collab/v2/aibridge/fixtures"
	"github.com/optimus-ide-collab/optimus-ide-collab/v2/aibridge/intercept"
	"github.com/optimus-ide-collab/optimus-ide-collab/v2/aibridge/intercept/chatcompletions"
	"github.com/optimus-ide-collab/optimus-ide-collab/v2/aibridge/intercept/messages"
	"github.com/optimus-ide-collab/optimus-ide-collab/v2/aibridge/intercept/responses"
	"github.com/optimus-ide-collab/optimus-ide-collab/v2/aibridge/internal/testutil"
	"github.com/optimus-ide-collab/optimus-ide-collab/v2/aibridge/keypool"
	"github.com/optimus-ide-collab/optimus-ide-collab/v2/aibridge/metrics"
	"github.com/optimus-ide-collab/optimus-ide-collab/v2/aibridge/utils"
	"github.com/optimus-ide-collab/optimus-ide-collab/v2/optimus-ide-collabd/optimus-ide-collabdtest/promhelp"
	optimus-ide-collabtestutil "github.com/optimus-ide-collab/optimus-ide-collab/v2/testutil"
				...
				t.Run(ic.name+"/"+mode+"/"+tc.name, func(t *testing.T) {
					...
					for _, reason := range []string{"rate_limited", "unauthorized"} {
						if want := tc.expectedTransitions[reason]; want > 0 {
							assert.True(t, optimus-ide-collabtestutil.PromCounterHasValue(t, gathered, float64(want), "key_pool_state_transitions_total", ic.provider, reason))
						} else {
							assert.False(t, optimus-ide-collabtestutil.PromCounterGathered(t, gathered, "key_pool_state_transitions_total", ic.provider, reason))
						}
					}
					...
					for _, outcome := range []string{"rate_limited", "auth_failed"} {
						if want := tc.expectedExhaustions[outcome]; want > 0 {
							assert.True(t, optimus-ide-collabtestutil.PromCounterHasValue(t, gathered, float64(want), "key_pool_exhaustions_total", outcome, ic.provider))
						} else {
							assert.False(t, optimus-ide-collabtestutil.PromCounterGathered(t, gathered, "key_pool_exhaustions_total", outcome, ic.provider))
						}
					}
				})
			}
