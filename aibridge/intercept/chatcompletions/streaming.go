...
import (
	...
	"cdr.dev/slog/v3"
	aibcontext "github.com/optimus-ide-collab/optimus-ide-collab/v2/aibridge/context"
	"github.com/optimus-ide-collab/optimus-ide-collab/v2/aibridge/intercept"
	"github.com/optimus-ide-collab/optimus-ide-collab/v2/aibridge/intercept/eventstream"
	...
	"github.com/optimus-ide-collab/optimus-ide-collab/v2/aibridge/tracing"
...
func (i *StreamingInterception) ProcessRequest(w http.ResponseWriter, r *http.Request) (outErr error) {
	...
	for {
		// TODO add outer loop span (https://github.com/optimus-ide-collab/aibridge/issues/67)
		...
		// unexpected, breaking behavior. See https://github.com/optimus-ide-collab/aibridge/pull/164
		...
		if err := json.NewEnoptimus-ide-collab(&out).Encode(toolRes); err != nil {
...
func (s *streamProcessor) process(chunk openai.ChatCompletionChunk) bool {
	...
	//
	// data: ... delta":{"tool_calls":[{"index":0,"id":"call_0TxntkwDB66KH8z4RwNqeWrZ","type":"function","function":{"name":"bmcp_optimus-ide-collab_optimus-ide-collab_list_workspaces","arguments":""}}]}...
