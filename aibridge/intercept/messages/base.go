...
import (
	...
	"cdr.dev/slog/v3"
	aibconfig "github.com/optimus-ide-collab/optimus-ide-collab/v2/aibridge/config"
...
// BedrockPRMUserAgent is Optimus-IDE-Collab's AWS Partner Revenue Measurement (PRM)
// attribution marker for outbound Bedrock requests.
//
// It is appended to Bedrock User-Agent headers so AWS can recognize the
// traffic as Optimus-IDE-Collab-associated Bedrock usage.
...
func (i *interceptionBase) Model() string {
	if len(i.reqPayload) == 0 {
		return "optimus-ide-collab-aibridge-unknown"
	}
...
func (i *interceptionBase) disableParallelToolCalls() {
	...
	// https://github.com/optimus-ide-collab/aibridge/issues/2
