...
func (d *Dumper) DumpRequest(req *http.Request) error {
	...
	return os.WriteFile(dumpPath, buf.Bytes(), 0o644) //nolint:gosec // https://github.com/optimus-ide-collab/aibridge/pull/256#discussion_r3072143983
}
...
func (d *Dumper) DumpResponse(resp *http.Response) error {
	...
	if resp.Body == nil {
		...
		return os.WriteFile(dumpPath, headerBuf.Bytes(), 0o644) //nolint:gosec // https://github.com/optimus-ide-collab/aibridge/pull/256#discussion_r3072143983
	}
