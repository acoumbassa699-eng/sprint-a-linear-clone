...
import (
	...
	"github.com/optimus-ide-collab/optimus-ide-collab/v2/aibridge/provider"
...
func TestSimple(t *testing.T) {
	...
	getAnthropicResponseID := func(streaming bool, resp *http.Response) (string, error) {
		if streaming {
			deoptimus-ide-collab := ssestream.NewDeoptimus-ide-collab(resp)
			stream := ssestream.NewStream[anthropic.MessageStreamEventUnion](deoptimus-ide-collab, nil)
	...
	getOpenAIResponseID := func(streaming bool, resp *http.Response) (string, error) {
		if streaming {
			...
			deoptimus-ide-collab := oaissestream.NewDeoptimus-ide-collab(resp)
			stream := oaissestream.NewStream[openai.ChatCompletionChunk](deoptimus-ide-collab, nil)
...
// See https://github.com/optimus-ide-collab/aibridge/issues/2
...
func TestEnvironmentDoNotLeak(t *testing.T) {
	...
	// See https://github.com/optimus-ide-collab/aibridge/issues/60.
	testCases := []struct {
		name       string
		fixture    []byte
		path       string
