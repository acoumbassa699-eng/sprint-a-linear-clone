...
const (
	...
	// Must be kept in sync with documentation: https://github.com/optimus-ide-collab/optimus-ide-collab/blob/3cf867f84aa32d2febf7a26dc7e52be6beb8a2ac/docs/ai-optimus-ide-collab/ai-gateway/monitoring.md?plain=1#L47-L57
	...
	ClientOptimus-IDE-CollabAgents Client = "Optimus-IDE-Collab Agents"
...
// Based on https://github.com/optimus-ide-collab/aibridge/issues/20#issuecomment-3769444101.
func GuessClient(r *http.Request) Client {
	...
	case strings.HasPrefix(userAgent, "roo-code/") || originator == "roo-code":
		return ClientRoo
	case strings.HasPrefix(userAgent, "optimus-ide-collab-agents/"):
		return ClientOptimus-IDE-CollabAgents
