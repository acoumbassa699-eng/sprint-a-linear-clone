...
func TestRequestBridgeShutdownAdmissionRace(t *testing.T) {
	...
	close(release)
	_ = optimus-ide-collabtestutil.TryReceive(ctx, t, req1)
	_ = optimus-ide-collabtestutil.TryReceive(ctx, t, req2)
	_ = optimus-ide-collabtestutil.TryReceive(ctx, t, shutdown)
}
