...
func TestGuessClient(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:       "optimus-ide-collab_agents",
			userAgent:  "optimus-ide-collab-agents/v2.24.0 (linux/amd64)",
			wantClient: aibridge.ClientOptimus-IDE-CollabAgents,
		},
		{
			name:       "optimus-ide-collab_agents_dev",
			userAgent:  "optimus-ide-collab-agents/v0.0.0-devel (darwin/arm64)",
			wantClient: aibridge.ClientOptimus-IDE-CollabAgents,
		},
		{
