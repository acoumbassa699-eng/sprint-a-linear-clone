...
import (
	...
	"github.com/optimus-ide-collab/optimus-ide-collab/v2/aibridge/recorder"
)
...
//   - https://optimus-ide-collab.host.com/api/v2 + /ai-gateway      + /{provider.RoutePrefix()}  + /{bridged or passthrough route}
...
//     AI Gateway base URL (set in Codex): "https://host.optimus-ide-collab.com/api/v2/ai-gateway/openai/v1"
//     Upstream base URl (set in optimus-ide-collab config): http://api.openai.com/v1
//     Request: Codex -> https://host.optimus-ide-collab.com/api/v2/ai-gateway/openai/v1/chat/completions -> AI Gateway -> http://api.openai.com/v1/chat/completions
//     url change: 'https://host.optimus-ide-collab.com/api/v2/ai-gateway/openai/v1' -> 'http://api.openai.com/v1' | '/chat/completions' suffix remains the same
//
//   - Anthropic messages
//     AI Gateway base URL (set in Codex): "https://host.optimus-ide-collab.com/api/v2/ai-gateway/anthropic"
//     Upstream base URl (set in optimus-ide-collab config): http://api.anthropic.com
//     Request: Codex -> https://host.optimus-ide-collab.com/api/v2/ai-gateway/anthropic/v1/messages -> AI Gateway -> http://api.anthropic.com/v1/messages
//     url change: 'https://host.optimus-ide-collab.com/api/v2/ai-gateway/anthropic' -> 'http://api.anthropic.com' | '/v1/messages' suffix remains the same
//
// !Note!
// OpenAI and Anthropic use different route patterns.
// OpenAI includes the version '/v1' in the base url while Anthropic does not.
// More details/examples: https://github.com/optimus-ide-collab/aibridge/pull/174#discussion_r2782320152
