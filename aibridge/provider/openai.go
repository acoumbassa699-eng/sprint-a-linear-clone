...
func (p *OpenAI) RoutePrefix() string {
	...
	// More detailed explanation: https://github.com/optimus-ide-collab/aibridge/pull/174#discussion_r2782320152
...
func (p *OpenAI) CreateInterceptor(_ http.ResponseWriter, r *http.Request, tracer trace.Tracer) (_ intercept.Interceptor, outErr error) {
	...
	case routeChatCompletions:
		...
		if err := json.NewDeoptimus-ide-collab(r.Body).Decode(&req); err != nil {
...
// point the request contains only LLM provider headers. Any Optimus-IDE-Collab-specific
