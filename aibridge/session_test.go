...
func TestGuessSessionID(t *testing.T) {
	...
	cases := []struct {
		...
		{
			name:      "optimus-ide-collab_agents_with_chat_id",
			client:    aibridge.ClientOptimus-IDE-CollabAgents,
			headers:   map[string]string{"X-Optimus-IDE-Collab-Chat-Id": "a1b2c3d4-e5f6-7890-abcd-ef1234567890"},
			sessionID: utils.PtrTo("a1b2c3d4-e5f6-7890-abcd-ef1234567890"),
		},
		{
			name:   "optimus-ide-collab_agents_without_chat_id",
			client: aibridge.ClientOptimus-IDE-CollabAgents,
		},
		// OpenCode.
		{
