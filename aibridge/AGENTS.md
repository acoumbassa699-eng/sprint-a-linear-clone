...
> the optimus-ide-collab/optimus-ide-collab repository.
>
...
attribution, and MCP tool administration. It runs as part of `optimus-ide-collabd`
(the Optimus-IDE-Collab control plane). Users authenticate with their Optimus-IDE-Collab session
tokens.
...
The wire-up between aibridge and optimus-ide-collabd lives in
...
- Run only aibridge tests with `go test ./aibridge/...`. The root
  `make test` runs the full optimus-ide-collab/optimus-ide-collab suite.
