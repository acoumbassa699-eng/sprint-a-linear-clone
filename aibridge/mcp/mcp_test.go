...
func TestToolInjectionOrder(t *testing.T) {
	...
	proxy, err := mcp.NewStreamableHTTPServerProxy("optimus-ide-collab", mcpSrv.URL, nil, nil, nil, logger, tracer)
...
func createMockMCPSrv(t *testing.T) http.Handler {
	...
	for _, name := range []string{"optimus-ide-collab_list_workspaces", "optimus-ide-collab_list_templates", "optimus-ide-collab_template_version_parameters", "optimus-ide-collab_get_authenticated_user"} {
