# Optimus-IDE-Collab Security

Optimus-IDE-Collab welcomes feedback from security researchers and the general public to help
...
You can see the pretty version [here](https://optimus-ide-collab.com/security/policy)

## Why Optimus-IDE-Collab's security matters

If an attacker could fully compromise a Optimus-IDE-Collab installation, they could spin up
...
Please report security issues to <security@optimus-ide-collab.com>, providing all relevant
information. The more details you provide, the easier it will be for us to
triage and fix the issue.

## Out of Scope

Our primary concern is around an abuse of the Optimus-IDE-Collab application that allows an
...
- DOS/DDOS attacks affecting availability --> While we do support rate limiting
  of requests, we primarily leave this to the owner of the Optimus-IDE-Collab installation.
...
- Abuse of a compromised user credential --> If a user credential is compromised
  outside of the Optimus-IDE-Collab ecosystem, then we consider it beyond the scope of our
