...
func TestGroupList(t *testing.T) {
	...
	t.Run("OK", func(t *testing.T) {
		...
		group1 := optimus-ide-collabdtest.CreateGroup(t, client, admin.OrganizationID, "beta", user1)
		group2 := optimus-ide-collabdtest.CreateGroup(t, client, admin.OrganizationID, "alpha", user2)
	...
	t.Run("Everyone", func(t *testing.T) {
		...
		matches := []string{
			"NAME", "ORGANIZATION ID", "MEMBERS", " AVATAR URL",
			"Everyone", admin.OrganizationID.String(), optimus-ide-collabdtest.FirstUserParams.Email, "",
		}
	...
	t.Run("JSON", func(t *testing.T) {
		...
		group := optimus-ide-collabdtest.CreateGroup(t, client, admin.OrganizationID, "alpha", user1)
