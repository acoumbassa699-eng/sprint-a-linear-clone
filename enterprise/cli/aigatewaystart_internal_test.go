...
// modeling a optimus-ide-collabd connection or provider fetch that recovers after a few
// transient failures.
...
func TestAIGatewayStart_HealthBeforeProviders(t *testing.T) {
	...
	optimus-ide-collabAddress := fmt.Sprintf("127.0.0.1:%d", testutil.RandomPort(t))

	var root RootCmd
	cmd, err := root.Command(root.enterpriseOnly())
	require.NoError(t, err)
	inv, _ := clitest.NewWithCommand(t, cmd,
		"--url", "http://"+optimus-ide-collabAddress,
		"ai-gateway", "start",
		"--key", "test-key",
...
func TestRunStandaloneGateway_DaemonExited(t *testing.T) {
	...
	test.params.dialer = func(context.Context) (aibridged.DRPCClient, error) {
		return nil, optimus-ide-collabsdk.NewError(http.StatusUnauthorized, optimus-ide-collabsdk.Response{Message: "invalid gateway key"})
	}
...
func TestAIGatewayStart_TracingOutermost(t *testing.T) {
	...
	req.Header.Set(agplaibridge.HeaderOptimus-IDE-CollabToken, "byok-token")
...
// from optimus-ide-collabd's deployment values are consciously used or dropped.
...
func TestAIGatewayStart_InheritedOptions(t *testing.T) {
	...
	// inherit because they only apply to optimus-ide-collabd.
	dropped := map[string]struct{}{
		// Logging
		"OPTIMUS-IDE-COLLAB_ENABLE_TERRAFORM_DEBUG_MODE": {},

		// AI Gateway (optimus-ide-collabd-only: provider seeding, budgets, retention, etc.)
		"OPTIMUS-IDE-COLLAB_AI_BUDGET_PERIOD":                     {},
		"OPTIMUS-IDE-COLLAB_AI_BUDGET_POLICY":                     {},
		"OPTIMUS-IDE-COLLAB_AI_GATEWAY_ANTHROPIC_BASE_URL":        {},
		"OPTIMUS-IDE-COLLAB_AI_GATEWAY_ANTHROPIC_KEY":             {},
		"OPTIMUS-IDE-COLLAB_AI_GATEWAY_BEDROCK_ACCESS_KEY":        {},
		"OPTIMUS-IDE-COLLAB_AI_GATEWAY_BEDROCK_ACCESS_KEY_SECRET": {},
		"OPTIMUS-IDE-COLLAB_AI_GATEWAY_BEDROCK_BASE_URL":          {},
		"OPTIMUS-IDE-COLLAB_AI_GATEWAY_BEDROCK_MODEL":             {},
		"OPTIMUS-IDE-COLLAB_AI_GATEWAY_BEDROCK_REGION":            {},
		"OPTIMUS-IDE-COLLAB_AI_GATEWAY_BEDROCK_SMALL_FAST_MODEL":  {},
		"OPTIMUS-IDE-COLLAB_AI_GATEWAY_ENABLED":                   {},
		"OPTIMUS-IDE-COLLAB_AI_GATEWAY_INJECT_OPTIMUS-IDE-COLLAB_MCP_TOOLS":    {},
		"OPTIMUS-IDE-COLLAB_AI_GATEWAY_OPENAI_BASE_URL":           {},
		"OPTIMUS-IDE-COLLAB_AI_GATEWAY_OPENAI_KEY":                {},
		"OPTIMUS-IDE-COLLAB_AI_GATEWAY_RETENTION":                 {},
		"OPTIMUS-IDE-COLLAB_AI_GATEWAY_STRUCTURED_LOGGING":        {},

		// Prometheus (optimus-ide-collabd-only: agent/database collectors)
		"OPTIMUS-IDE-COLLAB_PROMETHEUS_AGGREGATE_AGENT_STATS_BY": {},
		"OPTIMUS-IDE-COLLAB_PROMETHEUS_COLLECT_AGENT_STATS":      {},
		"OPTIMUS-IDE-COLLAB_PROMETHEUS_COLLECT_DB_METRICS":       {},
	}
