...
func TestResolveAIGatewayProxyTarget(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:      "ExplicitTarget",
			accessURL: &url.URL{Scheme: "https", Host: "optimus-ide-collab.example.com", Path: "/optimus-ide-collab"},
		...
		},
		{
			...
			accessURL: &url.URL{Scheme: "https", Host: "optimus-ide-collab.example.com", Path: "/optimus-ide-collab"},
			want:      "https://optimus-ide-collab.example.com/optimus-ide-collab" + agplaibridge.AIGatewayRootPath,
		},
		{
