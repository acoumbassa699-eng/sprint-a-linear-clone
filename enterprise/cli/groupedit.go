...
func (r *RootCmd) groupEdit() *serpent.Command {
	...
	cmd := &serpent.Command{
		...
		Handler: func(inv *serpent.Invocation) error {
			...
			req := optimus-ide-collabsdk.PatchGroupRequest{
				Name: name,
			}
			...
			userRes, err := client.Users(ctx, optimus-ide-collabsdk.UsersRequest{})
			if err != nil {
...
func convertToUserIDs(userList []string, users []optimus-ide-collabsdk.User) ([]string, error) {
