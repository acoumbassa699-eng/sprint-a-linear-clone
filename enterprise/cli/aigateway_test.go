...
// runAIGatewayKeys runs `optimus-ide-collab ai-gateway keys <args...>` as the given client
// and returns its stdout, stderr, and the run error.
func runAIGatewayKeys(ctx context.Context, t *testing.T, client *optimus-ide-collabsdk.Client, args ...string) (stdout, stderr string, err error) {
	t.Helper()
...
func createAIGatewayKey(ctx context.Context, t *testing.T, client *optimus-ide-collabsdk.Client, name string) aiGatewayKey {
	t.Helper()
...
func listAIGatewayKeys(ctx context.Context, t *testing.T, client *optimus-ide-collabsdk.Client) []optimus-ide-collabsdk.AIGatewayKey {
	t.Helper()
	stdout, _, err := runAIGatewayKeys(ctx, t, client, "list", "--output=json")
	require.NoError(t, err)
	var listed []optimus-ide-collabsdk.AIGatewayKey
...
func deleteAIGatewayKey(ctx context.Context, t *testing.T, client *optimus-ide-collabsdk.Client, arg string) string {
	t.Helper()
...
func TestAIGatewayKeys(t *testing.T) {
	...
	t.Run("CRUD", func(t *testing.T) {
		...
		slices.SortFunc(listed, func(a, b optimus-ide-collabsdk.AIGatewayKey) int {
