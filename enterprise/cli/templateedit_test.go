...
func TestTemplateEdit(t *testing.T) {
	...
	t.Run("OK", func(t *testing.T) {
		...
		_ = optimus-ide-collabdtest.AwaitTemplateVersionJobCompleted(t, templateAdmin, version.ID)
	...
	t.Run("DefaultsDontOverride", func(t *testing.T) {
		...
		assertFieldsFn := func(t *testing.T, tpl optimus-ide-collabsdk.Template, acl optimus-ide-collabsdk.TemplateACL) {
			t.Helper()
		...
		template, err := ownerClient.UpdateTemplateMeta(ctx, dbtemplate.ID, optimus-ide-collabsdk.UpdateTemplateMeta{
