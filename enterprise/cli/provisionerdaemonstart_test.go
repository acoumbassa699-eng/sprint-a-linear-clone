...
func TestProvisionerDaemon_PSK(t *testing.T) {
	...
	t.Run("OK", func(t *testing.T) {
		...
		var daemons []optimus-ide-collabsdk.ProvisionerDaemon
	...
	t.Run("AnotherOrgByNameWithUser", func(t *testing.T) {
		...
		anotherOrg := optimus-ide-collabdenttest.CreateOrganization(t, client, optimus-ide-collabdenttest.CreateOrganizationOptions{})
		anotherClient, _ := optimus-ide-collabdtest.CreateAnotherUser(t, client, anotherOrg.ID, rbac.RoleTemplateAdmin())
...
func TestProvisionerDaemon_SessionToken(t *testing.T) {
	...
	t.Run("ScopeUser", func(t *testing.T) {
		...
		anotherClient, anotherUser := optimus-ide-collabdtest.CreateAnotherUser(t, client, admin.OrganizationID)
	...
	t.Run("ScopeOrg", func(t *testing.T) {
		...
		anotherClient, _ := optimus-ide-collabdtest.CreateAnotherUser(t, client, admin.OrganizationID, rbac.RoleTemplateAdmin())
	...
	t.Run("ScopeUserAnotherOrg", func(t *testing.T) {
		...
		anotherOrg := optimus-ide-collabdenttest.CreateOrganization(t, client, optimus-ide-collabdenttest.CreateOrganizationOptions{})
		anotherClient, anotherUser := optimus-ide-collabdtest.CreateAnotherUser(t, client, anotherOrg.ID, rbac.RoleTemplateAdmin())
...
func TestProvisionerDaemon_ProvisionerKey(t *testing.T) {
	...
	t.Run("OK", func(t *testing.T) {
		...
		res, err := client.CreateProvisionerKey(ctx, user.OrganizationID, optimus-ide-collabsdk.CreateProvisionerKeyRequest{
			Name: "dont-TEST-me",
		})
		require.NoError(t, err)
	...
	t.Run("AnotherOrg", func(t *testing.T) {
		...
		anotherOrg := optimus-ide-collabdenttest.CreateOrganization(t, client, optimus-ide-collabdenttest.CreateOrganizationOptions{})
		// nolint:gocritic // test
		res, err := client.CreateProvisionerKey(ctx, anotherOrg.ID, optimus-ide-collabsdk.CreateProvisionerKeyRequest{
			Name: "dont-TEST-me",
		})
		require.NoError(t, err)
		inv, conf := newCLI(t, "provisionerd", "start", "--key", res.Key, "--name=matt-daemon")
...
func TestProvisionerDaemon_PrometheusEnabled(t *testing.T) {
	...
	hasPromHTTP := false
	for scanner.Scan() {
		if strings.HasPrefix(scanner.Text(), "optimus-ide-collabd_provisionerd_num_daemons 1") {
			hasOneDaemon = true
			continue
		}
