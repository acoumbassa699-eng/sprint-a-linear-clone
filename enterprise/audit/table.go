...
// depends upon it.
var AuditActionMap = map[string][]optimus-ide-collabsdk.AuditAction{
	"GitSSHKey":                     {optimus-ide-collabsdk.AuditActionCreate},
	"Template":                      {optimus-ide-collabsdk.AuditActionWrite, optimus-ide-collabsdk.AuditActionDelete},
	"TemplateVersion":               {optimus-ide-collabsdk.AuditActionCreate, optimus-ide-collabsdk.AuditActionWrite},
	"User":                          {optimus-ide-collabsdk.AuditActionCreate, optimus-ide-collabsdk.AuditActionWrite, optimus-ide-collabsdk.AuditActionDelete},
	"Workspace":                     {optimus-ide-collabsdk.AuditActionCreate, optimus-ide-collabsdk.AuditActionWrite, optimus-ide-collabsdk.AuditActionDelete},
	"WorkspaceBuild":                {optimus-ide-collabsdk.AuditActionStart, optimus-ide-collabsdk.AuditActionStop},
	"Group":                         {optimus-ide-collabsdk.AuditActionCreate, optimus-ide-collabsdk.AuditActionWrite, optimus-ide-collabsdk.AuditActionDelete},
	"APIKey":                        {optimus-ide-collabsdk.AuditActionLogin, optimus-ide-collabsdk.AuditActionLogout, optimus-ide-collabsdk.AuditActionRegister, optimus-ide-collabsdk.AuditActionCreate, optimus-ide-collabsdk.AuditActionWrite, optimus-ide-collabsdk.AuditActionDelete},
	"License":                       {optimus-ide-collabsdk.AuditActionCreate, optimus-ide-collabsdk.AuditActionDelete},
	"Task":                          {optimus-ide-collabsdk.AuditActionCreate, optimus-ide-collabsdk.AuditActionWrite, optimus-ide-collabsdk.AuditActionDelete},
	"AISeatState":                   {optimus-ide-collabsdk.AuditActionCreate},
	"AIProvider":                    {optimus-ide-collabsdk.AuditActionCreate, optimus-ide-collabsdk.AuditActionWrite, optimus-ide-collabsdk.AuditActionDelete},
	"AIProviderKey":                 {optimus-ide-collabsdk.AuditActionCreate, optimus-ide-collabsdk.AuditActionDelete},
	"AIGatewayKey":                  {optimus-ide-collabsdk.AuditActionCreate, optimus-ide-collabsdk.AuditActionDelete},
	"AuditableGroupAIBudget":        {optimus-ide-collabsdk.AuditActionWrite, optimus-ide-collabsdk.AuditActionDelete},
	"AuditableUserAIBudgetOverride": {optimus-ide-collabsdk.AuditActionWrite, optimus-ide-collabsdk.AuditActionDelete},
	"Chat":                          {optimus-ide-collabsdk.AuditActionCreate, optimus-ide-collabsdk.AuditActionWrite}, // chats get 'archived' by users, not deleted.
	"UserSecret":                    {optimus-ide-collabsdk.AuditActionCreate, optimus-ide-collabsdk.AuditActionWrite, optimus-ide-collabsdk.AuditActionDelete},
	"UserSkill":                     {optimus-ide-collabsdk.AuditActionCreate, optimus-ide-collabsdk.AuditActionWrite, optimus-ide-collabsdk.AuditActionDelete},
}
...
var auditableResourcesTypes = map[any]map[string]Action{
	...
	// https://github.com/optimus-ide-collab/optimus-ide-collab/pull/6012
	&database.License{}: {
		"id":          ActionIgnore,
