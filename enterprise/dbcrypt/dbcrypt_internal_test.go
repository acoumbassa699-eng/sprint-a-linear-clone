...
func TestNew(t *testing.T) {
	...
	t.Run("OK", func(t *testing.T) {
		...
		requireEncryptedEquals(t, cipher, keys[0].Test, "optimus-ide-collab")
	})
	...
	t.Run("MissingKey", func(t *testing.T) {
		...
		requireEncryptedEquals(t, cipher2, keys[1].Test, "optimus-ide-collab")
	})
	...
	t.Run("Retry", func(t *testing.T) {
		...
		cipher := initCipher(t)
		ctx, cancel := context.WithCancel(context.Background())
		testVal, err := cipher.Encrypt([]byte("optimus-ide-collab"))
