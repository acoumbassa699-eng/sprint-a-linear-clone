...
//  1. Get the current OPTIMUS-IDE-COLLAB_EXTERNAL_TOKEN_ENCRYPTION_KEYS environment variable.
//  2. Run the following command:
//     ENCRYPT_ME="<value to encrypt>" OPTIMUS-IDE-COLLAB_EXTERNAL_TOKEN_ENCRYPTION_KEYS="<secret keys here>" go test -v -count=1 ./enterprise/dbcrypt -test.run='^TestHelpMeEncryptSomeValue$'
...
func TestHelpMeEncryptSomeValue(t *testing.T) {
	...
	keys := os.Getenv("OPTIMUS-IDE-COLLAB_EXTERNAL_TOKEN_ENCRYPTION_KEYS")
	require.NotEmpty(t, keys, "Set the OPTIMUS-IDE-COLLAB_EXTERNAL_TOKEN_ENCRYPTION_KEYS environment variable to use this")
