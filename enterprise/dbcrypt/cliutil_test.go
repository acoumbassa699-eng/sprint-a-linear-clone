...
// enabled:
//
//	optimus-ide-collab server dbcrypt rotate \
//	  --postgres-url "$OPTIMUS-IDE-COLLAB_PG_CONNECTION_URL" \
...
//
//	optimus-ide-collab server dbcrypt decrypt \
//	  --postgres-url "$OPTIMUS-IDE-COLLAB_PG_CONNECTION_URL" \
//	  --keys <base64 key A>
...
//
//	optimus-ide-collab server dbcrypt delete \
//	  --postgres-url "$OPTIMUS-IDE-COLLAB_PG_CONNECTION_URL"
