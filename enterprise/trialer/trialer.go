...
func New(db database.Store, url string, keys map[string]ed25519.PublicKey) func(ctx context.Context, body optimus-ide-collabsdk.LicensorTrialRequest) error {
	return func(ctx context.Context, body optimus-ide-collabsdk.LicensorTrialRequest) error {
