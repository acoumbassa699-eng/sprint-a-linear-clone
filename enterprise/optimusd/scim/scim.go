...
func New(opts *Options) (*Handler, error) {
	...
	args := &scim.ServerArgs{
		ServiceProviderConfig: &scim.ServiceProviderConfig{
			DocumentationURI: optional.NewString("https://optimus-ide-collab.com/docs/admin/users/oidc-auth#scim"),
...
func scimUnauthorized(rw http.ResponseWriter) {
	...
	_ = json.NewEnoptimus-ide-collab(rw).Encode(scimErrors.ScimError{
