...
import (
	...
	aiblib "github.com/optimus-ide-collab/optimus-ide-collab/v2/aibridge"
	...
	entoptimus-ide-collabd "github.com/optimus-ide-collab/optimus-ide-collab/v2/enterprise/optimus-ide-collabd"
...
func aibridgeOpts(t *testing.T) *optimus-ide-collabdenttest.Options {
	t.Helper()
...
func TestAIBridgeListSessions(t *testing.T) {
	...
	t.Run("EmptyDB", func(t *testing.T) {
		t.Parallel()
		client, _ := optimus-ide-collabdenttest.New(t, aibridgeOpts(t))
		ctx := testutil.Context(t, testutil.WaitLong)
		//nolint:gocritic // Owner role is irrelevant here.
		res, err := client.AIBridgeListSessions(ctx, optimus-ide-collabsdk.AIBridgeListSessionsFilter{})
	...
	t.Run("OK", func(t *testing.T) {
		t.Parallel()
		client, db, firstUser := optimus-ide-collabdenttest.NewWithDatabase(t, aibridgeOpts(t))
		ctx := testutil.Context(t, testutil.WaitLong)
	...
	t.Run("NetworkCalls", func(t *testing.T) {
		...
		client, _, firstUser := optimus-ide-collabdenttest.NewWithDatabase(t, opts)
		ctx := testutil.Context(t, testutil.WaitLong)
		...
		byID := make(map[string]optimus-ide-collabsdk.AIBridgeSession, len(res.Sessions))
	...
	t.Run("Pagination", func(t *testing.T) {
		...
		res, err = client.AIBridgeListSessions(ctx, optimus-ide-collabsdk.AIBridgeListSessionsFilter{
			Pagination: optimus-ide-collabsdk.Pagination{Limit: 2, Offset: 2},
		})
		require.NoError(t, err)
		require.Len(t, res.Sessions, 2)
		...
		_, err = client.AIBridgeListSessions(ctx, optimus-ide-collabsdk.AIBridgeListSessionsFilter{
			Pagination:     optimus-ide-collabsdk.Pagination{Limit: 2, Offset: 1},
	...
	t.Run("AfterSessionIDNotFound", func(t *testing.T) {
		...
		//nolint:gocritic // Owner role is irrelevant here.
		_, err := client.AIBridgeListSessions(ctx, optimus-ide-collabsdk.AIBridgeListSessionsFilter{
			Pagination:     optimus-ide-collabsdk.Pagination{Limit: 10},
	...
	t.Run("Filters", func(t *testing.T) {
		...
		_, user2 := optimus-ide-collabdtest.CreateAnotherUser(t, client, firstUser.OrganizationID)
	...
	t.Run("FilterByMe/MemberCannotReadOwn", func(t *testing.T) {
		t.Parallel()
		ownerClient, db, firstUser := optimus-ide-collabdenttest.NewWithDatabase(t, aibridgeOpts(t))
		ctx := testutil.Context(t, testutil.WaitLong)

		memberClient, member := optimus-ide-collabdtest.CreateAnotherUser(t, ownerClient, firstUser.OrganizationID)
		...
		// filtering by "me".
		res, err := memberClient.AIBridgeListSessions(ctx, optimus-ide-collabsdk.AIBridgeListSessionsFilter{
			Initiator: optimus-ide-collabsdk.Me,
		})
		require.NoError(t, err)
		require.EqualValues(t, 0, res.Count)
		require.Empty(t, res.Sessions)
	...
	t.Run("Authorized", func(t *testing.T) {
		t.Parallel()
		adminClient, db, firstUser := optimus-ide-collabdenttest.NewWithDatabase(t, aibridgeOpts(t))
		ctx := testutil.Context(t, testutil.WaitLong)

		auditorClient, auditorUser := optimus-ide-collabdtest.CreateAnotherUser(t, adminClient, firstUser.OrganizationID, rbac.RoleAuditor())
		...
		res, err := auditorClient.AIBridgeListSessions(ctx, optimus-ide-collabsdk.AIBridgeListSessionsFilter{})
		require.NoError(t, err)
	...
	t.Run("FilterErrors", func(t *testing.T) {
		...
		cases := []struct {
			name string
			q    string
			want []optimus-ide-collabsdk.ValidationError
		}{
			{
	...
	t.Run("CursorPaginationWithTiedStartedAt", func(t *testing.T) {
		...
		all, err := client.AIBridgeListSessions(ctx, optimus-ide-collabsdk.AIBridgeListSessionsFilter{})
		require.NoError(t, err)
		...
		page, err := client.AIBridgeListSessions(ctx, optimus-ide-collabsdk.AIBridgeListSessionsFilter{
			Pagination:     optimus-ide-collabsdk.Pagination{Limit: 10},
...
func TestAIBridgeListClients(t *testing.T) {
	...
	dv := optimus-ide-collabdtest.DeploymentValues(t)
	dv.AI.BridgeConfig.Enabled = serpent.Bool(true)
	client, db, firstUser := optimus-ide-collabdenttest.NewWithDatabase(t, &optimus-ide-collabdenttest.Options{
		Options: &optimus-ide-collabdtest.Options{
			DeploymentValues: dv,
		},
		LicenseOptions: &optimus-ide-collabdenttest.LicenseOptions{
...
func TestAIBridgeRouting(t *testing.T) {
	...
	dv := optimus-ide-collabdtest.DeploymentValues(t)
	dv.AI.BridgeConfig.Enabled = serpent.Bool(true)
	client, closer, api, _ := optimus-ide-collabdenttest.NewWithAPI(t, &optimus-ide-collabdenttest.Options{
		Options: &optimus-ide-collabdtest.Options{
			DeploymentValues: dv,
		},
		LicenseOptions: &optimus-ide-collabdenttest.LicenseOptions{
...
func TestAIBridgeGetSessionThreads(t *testing.T) {
	...
	t.Run("NotFound", func(t *testing.T) {
		t.Parallel()
		ownerClient, firstUser := optimus-ide-collabdenttest.New(t, aibridgeOpts(t))
		memberClient, _ := optimus-ide-collabdtest.CreateAnotherUser(t, ownerClient, firstUser.OrganizationID)
...
func TestAIBridgeAllowBYOK(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			allowBYOK: true,
			reqHeaders: map[string]string{
				"Authorization": "Bearer optimus-ide-collab-token",
			},
		...
		},
		{
			...
			allowBYOK: true,
			reqHeaders: map[string]string{
				agplaibridge.HeaderOptimus-IDE-CollabToken: "optimus-ide-collab-token",
...
func TestGroupAIBudget(t *testing.T) {
	...
	t.Run("Upsert", func(t *testing.T) {
		...
		newBudget, err := adminClient.UpsertGroupAIBudget(ctx, group.ID, optimus-ide-collabsdk.UpsertGroupAIBudgetRequest{
		...
		updatedBudget, err := adminClient.UpsertGroupAIBudget(ctx, group.ID, optimus-ide-collabsdk.UpsertGroupAIBudgetRequest{
	...
	t.Run("DeleteWhenPresent", func(t *testing.T) {
		...
		_, err := adminClient.UpsertGroupAIBudget(ctx, group.ID, optimus-ide-collabsdk.UpsertGroupAIBudgetRequest{
			SpendLimitMicros: 500_000_000,
		})
		require.NoError(t, err)
	...
	t.Run("AcceptsZeroSpendLimitToBlock", func(t *testing.T) {
		...
		budget, err := adminClient.UpsertGroupAIBudget(ctx, group.ID, optimus-ide-collabsdk.UpsertGroupAIBudgetRequest{
			SpendLimitMicros: 0,
		})
		require.NoError(t, err)
	...
	t.Run("GroupMemberCanReadButNotWrite", func(t *testing.T) {
		...
		adminClient, _ := optimus-ide-collabdtest.CreateAnotherUser(t, ownerClient, owner.OrganizationID, rbac.RoleUserAdmin())
		memberClient, member := optimus-ide-collabdtest.CreateAnotherUser(t, ownerClient, owner.OrganizationID)

		ctx := testutil.Context(t, testutil.WaitLong)
		group, err := adminClient.CreateGroup(ctx, owner.OrganizationID, optimus-ide-collabsdk.CreateGroupRequest{
			Name: "budget-group",
		})
		require.NoError(t, err)

		// Add the member to the group so the Group.RBACObject ACL grants them read.
		_, err = adminClient.PatchGroup(ctx, group.ID, optimus-ide-collabsdk.PatchGroupRequest{
		...
		_, err = memberClient.UpsertGroupAIBudget(ctx, group.ID, optimus-ide-collabsdk.UpsertGroupAIBudgetRequest{
			SpendLimitMicros: 1_000_000_000,
		})
		var sdkErr *optimus-ide-collabsdk.Error
		require.ErrorAs(t, err, &sdkErr)
...
func TestUserAIBudgetOverride(t *testing.T) {
	...
	t.Run("Upsert/CreatesAndUpdates", func(t *testing.T) {
		...
		newOverride, err := adminClient.UpsertUserAIBudgetOverride(ctx, targetUser.ID, optimus-ide-collabsdk.UpsertUserAIBudgetOverrideRequest{
			GroupID:          group.ID,
			SpendLimitMicros: 500_000_000,
		})
		require.NoError(t, err)
		...
		updatedOverride, err := adminClient.UpsertUserAIBudgetOverride(ctx, targetUser.ID, optimus-ide-collabsdk.UpsertUserAIBudgetOverrideRequest{
			GroupID:          group.ID,
			SpendLimitMicros: 1_000_000_000,
		})
		require.NoError(t, err)
	...
	t.Run("Upsert/ReassignsGroup", func(t *testing.T) {
		...
		_, err := adminClient.UpsertUserAIBudgetOverride(ctx, targetUser.ID, optimus-ide-collabsdk.UpsertUserAIBudgetOverrideRequest{
			GroupID:          groupA.ID,
			SpendLimitMicros: 500_000_000,
		})
		require.NoError(t, err)
		...
		groupB, err := adminClient.CreateGroup(ctx, targetUser.OrganizationIDs[0], optimus-ide-collabsdk.CreateGroupRequest{
			Name: "reassign-test-group-b",
		})
		require.NoError(t, err)
		_, err = adminClient.PatchGroup(ctx, groupB.ID, optimus-ide-collabsdk.PatchGroupRequest{
			AddUsers: []string{targetUser.ID.String()},
		})
		require.NoError(t, err)

		// Reassign the override's attribution to groupB.
		updated, err := adminClient.UpsertUserAIBudgetOverride(ctx, targetUser.ID, optimus-ide-collabsdk.UpsertUserAIBudgetOverrideRequest{
			GroupID:          groupB.ID,
			SpendLimitMicros: 500_000_000,
		})
		require.NoError(t, err)
	...
	t.Run("Upsert/EveryoneGroup", func(t *testing.T) {
		...
		override, err := adminClient.UpsertUserAIBudgetOverride(ctx, targetUser.ID, optimus-ide-collabsdk.UpsertUserAIBudgetOverrideRequest{
	...
	t.Run("Upsert/RejectsNonMemberGroup", func(t *testing.T) {
		...
		outsiderGroup, err := adminClient.CreateGroup(ctx, targetUser.OrganizationIDs[0], optimus-ide-collabsdk.CreateGroupRequest{
			Name: "outsider-group",
		})
		require.NoError(t, err)
	...
	t.Run("Audit/UpsertEverything", func(t *testing.T) {
		...
		ctx := testutil.Context(t, testutil.WaitLong)
		groupA, err := adminClient.CreateGroup(ctx, owner.OrganizationID, optimus-ide-collabsdk.CreateGroupRequest{
			Name: "reassign-audit-a",
		})
		require.NoError(t, err)
		_, err = adminClient.PatchGroup(ctx, groupA.ID, optimus-ide-collabsdk.PatchGroupRequest{
			AddUsers: []string{targetUser.ID.String()},
		})
		require.NoError(t, err)

		groupB, err := adminClient.CreateGroup(ctx, owner.OrganizationID, optimus-ide-collabsdk.CreateGroupRequest{
...
func TestUserAIBudgetOverrideRoleAccess(t *testing.T) {
	...
	dv := optimus-ide-collabdtest.DeploymentValues(t)
	dv.AI.BridgeConfig.Enabled = serpent.Bool(true)
	dv.Experiments = []string{string(optimus-ide-collabsdk.ExperimentAIGatewayCostControl)}
	ownerClient, owner := optimus-ide-collabdenttest.New(t, &optimus-ide-collabdenttest.Options{
		Options: &optimus-ide-collabdtest.Options{DeploymentValues: dv},
		LicenseOptions: &optimus-ide-collabdenttest.LicenseOptions{
			Features: license.Features{
	...
	userAdminClient, _ := optimus-ide-collabdtest.CreateAnotherUser(t, ownerClient, owner.OrganizationID, rbac.RoleUserAdmin())
	...
	orgUserAdminClient, _ := optimus-ide-collabdtest.CreateAnotherUser(t, ownerClient, owner.OrganizationID, rbac.ScopedRoleOrgUserAdmin(owner.OrganizationID))

	setupCtx := testutil.Context(t, testutil.WaitLong)
	group, err := userAdminClient.CreateGroup(setupCtx, owner.OrganizationID, optimus-ide-collabsdk.CreateGroupRequest{
	...
	for _, tc := range cases {
		t.Run(tc.Name, func(t *testing.T) {
			...
			_, targetUser := optimus-ide-collabdtest.CreateAnotherUser(t, ownerClient, owner.OrganizationID)
			_, err := userAdminClient.PatchGroup(ctx, group.ID, optimus-ide-collabsdk.PatchGroupRequest{
				AddUsers: []string{targetUser.ID.String()},
			})
			require.NoError(t, err)

			upsertReq := optimus-ide-collabsdk.UpsertUserAIBudgetOverrideRequest{
				GroupID:          group.ID,
				SpendLimitMicros: 500_000_000,
			}
...
func TestUserAISpendStatus(t *testing.T) {
	...
	tests := []struct {
		...
		wantLimitSource        *optimus-ide-collabsdk.AIBudgetLimitSource
	...
	}{
		{
			...
			wantLimitSource:       ptr.Ref(optimus-ide-collabsdk.AIBudgetLimitSourceGroup),
		},
		{
		...
		},
		{
			...
			wantLimitSource:       ptr.Ref(optimus-ide-collabsdk.AIBudgetLimitSourceUserOverride),
		},
		{
...
func TestUserAISpendStatusRoleAccess(t *testing.T) {
	...
	orgAdminClient, _ := optimus-ide-collabdtest.CreateAnotherUser(t, ownerClient, owner.OrganizationID, rbac.ScopedRoleOrgAdmin(owner.OrganizationID))
	orgUserAdminClient, _ := optimus-ide-collabdtest.CreateAnotherUser(t, ownerClient, owner.OrganizationID, rbac.ScopedRoleOrgUserAdmin(owner.OrganizationID))
	memberClient, memberUser := optimus-ide-collabdtest.CreateAnotherUser(t, ownerClient, owner.OrganizationID)
	_, targetUser := optimus-ide-collabdtest.CreateAnotherUser(t, ownerClient, owner.OrganizationID)
...
func TestOrganizationGroupsAISpendRoleAccess(t *testing.T) {
	...
	otherOrg := optimus-ide-collabdenttest.CreateOrganization(t, ownerClient, optimus-ide-collabdenttest.CreateOrganizationOptions{})
	otherOrgMemberClient, _ := optimus-ide-collabdtest.CreateAnotherUser(t, ownerClient, otherOrg.ID)

	ctx := testutil.Context(t, testutil.WaitLong)
	group, err := userAdminClient.CreateGroup(ctx, owner.OrganizationID, optimus-ide-collabsdk.CreateGroupRequest{
		Name: "role-access-group",
	})
	require.NoError(t, err)
...
func requestAISpendExport(ctx context.Context, t *testing.T, client *optimus-ide-collabsdk.Client, orgID uuid.UUID, params map[string]string) *http.Response {
	t.Helper()
...
func TestExportOrganizationAISpend(t *testing.T) {
	...
	t.Run("Enablement", func(t *testing.T) {
		...
		cases := []struct {
		...
		}{
			{
				...
				experiments:     []string{string(optimus-ide-collabsdk.ExperimentAIGatewayCostControl)},
				features:        license.Features{},
			...
			},
			{
				...
				experiments:     nil,
				features:        license.Features{optimus-ide-collabsdk.FeatureAIBridge: 1},
		...
		for _, tc := range cases {
			t.Run(tc.name, func(t *testing.T) {
				...
				client, owner := optimus-ide-collabdenttest.New(t, &optimus-ide-collabdenttest.Options{
					Options:        &optimus-ide-collabdtest.Options{DeploymentValues: dv},
					LicenseOptions: &optimus-ide-collabdenttest.LicenseOptions{Features: tc.features},
				})
				ctx := testutil.Context(t, testutil.WaitLong)

				//nolint:gocritic // Owner role is irrelevant because the request is blocked before RBAC.
				_, err := client.ExportOrganizationAISpend(ctx, owner.OrganizationID, optimus-ide-collabsdk.AISpendPeriodWindow{})
				var sdkErr *optimus-ide-collabsdk.Error
				require.ErrorAs(t, err, &sdkErr)
				require.Equal(t, http.StatusForbidden, sdkErr.StatusCode())
	...
	t.Run("PeriodValidation", func(t *testing.T) {
		...
		for _, tc := range cases {
			t.Run(tc.name, func(t *testing.T) {
				...
				var sdkErr *optimus-ide-collabsdk.Error
				require.ErrorAs(t, optimus-ide-collabsdk.ReadBodyAsError(res), &sdkErr)
				require.Contains(t, sdkErr.Message, tc.wantMsgContains)
			})
		}
	})
	...
	t.Run("DefaultsToCurrentMonthAndAggregates", func(t *testing.T) {
		...
		require.Equal(t, entoptimus-ide-collabd.AISpendExportCSVHeader, records[0])
	...
	t.Run("ExplicitPeriodBeforeRetentionRejected", func(t *testing.T) {
		...
		_, err := adminClient.ExportOrganizationAISpend(ctx, group.OrganizationID, optimus-ide-collabsdk.AISpendPeriodWindow{
			PeriodStart: start,
			PeriodEnd:   now,
		})
		var sdkErr *optimus-ide-collabsdk.Error
	...
	t.Run("SeparateRowPerGroup", func(t *testing.T) {
		...
		secondGroup, err := adminClient.CreateGroup(ctx, group.OrganizationID, optimus-ide-collabsdk.CreateGroupRequest{
	...
	t.Run("ExcludesOtherOrganizations", func(t *testing.T) {
		...
		dv.Experiments = []string{string(optimus-ide-collabsdk.ExperimentAIGatewayCostControl)}
		ownerClient, owner := optimus-ide-collabdenttest.New(t, &optimus-ide-collabdenttest.Options{
			Options: &optimus-ide-collabdtest.Options{DeploymentValues: dv, Database: db, Pubsub: ps, Clock: clock},
			LicenseOptions: &optimus-ide-collabdenttest.LicenseOptions{
				Features: license.Features{
					optimus-ide-collabsdk.FeatureTemplateRBAC:          1,
					optimus-ide-collabsdk.FeatureAIBridge:              1,
		...
		otherOrg := optimus-ide-collabdenttest.CreateOrganization(t, ownerClient, optimus-ide-collabdenttest.CreateOrganizationOptions{})
		_, otherOrgMember := optimus-ide-collabdtest.CreateAnotherUser(t, ownerClient, otherOrg.ID)
		userAdminClient, _ := optimus-ide-collabdtest.CreateAnotherUser(t, ownerClient, owner.OrganizationID, rbac.RoleUserAdmin())
		group, err := userAdminClient.CreateGroup(ctx, owner.OrganizationID, optimus-ide-collabsdk.CreateGroupRequest{
			Name: "export-org-scope-group",
		})
		require.NoError(t, err)
		otherOrgGroup, err := userAdminClient.CreateGroup(ctx, otherOrg.ID, optimus-ide-collabsdk.CreateGroupRequest{
		...
		require.Equal(t, []string{
			owner.UserID.String(), optimus-ide-collabdtest.FirstUserParams.Username,
			group.ID.String(), group.Name,
...
func TestExportOrganizationAISpendRoleAccess(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			...
			body, err := tc.client.ExportOrganizationAISpend(ctx, owner.OrganizationID, optimus-ide-collabsdk.AISpendPeriodWindow{})
			if tc.wantStatus != 0 {
				var sdkErr *optimus-ide-collabsdk.Error
				require.ErrorAs(t, err, &sdkErr)
...
func TestGroupMembersAISpend(t *testing.T) {
	...
	tests := []struct {
		...
		wantGroupBudget       *optimus-ide-collabsdk.AIGroupBudget
	...
	}{
		{
			...
			wantGroupBudget: &optimus-ide-collabsdk.AIGroupBudget{
				SpendLimitMicros: 1_000_000_000,
				LimitSource:      optimus-ide-collabsdk.AIBudgetLimitSourceGroup,
			},
		},
		{
			name:               "BudgetWithSpend",
		...
		},
		{
			...
			wantGroupBudget: &optimus-ide-collabsdk.AIGroupBudget{
				SpendLimitMicros: 500_000_000,
				LimitSource:      optimus-ide-collabsdk.AIBudgetLimitSourceUserOverride,
			},
		},
		{
	...
	t.Run("CrossOrgEffectiveGroupMasked", func(t *testing.T) {
		...
		db, ps := dbtestutil.NewDB(t)
		ownerClient, owner := optimus-ide-collabdenttest.New(t, &optimus-ide-collabdenttest.Options{
			Options: &optimus-ide-collabdtest.Options{DeploymentValues: dv, Database: db, Pubsub: ps},
			LicenseOptions: &optimus-ide-collabdenttest.LicenseOptions{
				Features: license.Features{
					optimus-ide-collabsdk.FeatureTemplateRBAC:          1,
					optimus-ide-collabsdk.FeatureAIBridge:              1,
		...
		queried, err := userAdminClient.CreateGroup(ctx, owner.OrganizationID, optimus-ide-collabsdk.CreateGroupRequest{
			Name: "queried-cross-org-mask-group",
		})
		require.NoError(t, err)
		_, err = userAdminClient.PatchGroup(ctx, queried.ID, optimus-ide-collabsdk.PatchGroupRequest{
			AddUsers: []string{targetUser.ID.String()},
		})
		require.NoError(t, err)
		crossOrgGroup, err := userAdminClient.CreateGroup(ctx, otherOrg.ID, optimus-ide-collabsdk.CreateGroupRequest{
			Name: "cross-org-budget-group",
		})
		require.NoError(t, err)
		_, err = userAdminClient.PatchGroup(ctx, crossOrgGroup.ID, optimus-ide-collabsdk.PatchGroupRequest{
			AddUsers: []string{targetUser.ID.String()},
		})
		require.NoError(t, err)
		_, err = userAdminClient.UpsertGroupAIBudget(ctx, crossOrgGroup.ID, optimus-ide-collabsdk.UpsertGroupAIBudgetRequest{
	...
	t.Run("CrossOrgFallbackEveryoneMasked", func(t *testing.T) {
		...
		// queried group.
		queriedOrg := optimus-ide-collabdenttest.CreateOrganization(t, ownerClient, optimus-ide-collabdenttest.CreateOrganizationOptions{})
		_, targetUser := optimus-ide-collabdtest.CreateAnotherUser(t, ownerClient, owner.OrganizationID)
		dbgen.OrganizationMember(t, db, database.OrganizationMember{UserID: targetUser.ID, OrganizationID: queriedOrg.ID})
		queried, err := userAdminClient.CreateGroup(ctx, queriedOrg.ID, optimus-ide-collabsdk.CreateGroupRequest{
	...
	t.Run("OrgScopedRoute", func(t *testing.T) {
		...
		require.Equal(t, http.StatusOK, res.StatusCode)
		var got optimus-ide-collabsdk.GroupMembersAISpend
...
func TestGroupMembersAISpendRoleAccess(t *testing.T) {
	...
	orgUserAdminClient, _ := optimus-ide-collabdtest.CreateAnotherUser(t, ownerClient, owner.OrganizationID, rbac.ScopedRoleOrgUserAdmin(owner.OrganizationID))
	memberClient, member := optimus-ide-collabdtest.CreateAnotherUser(t, ownerClient, owner.OrganizationID)
	_, otherMember := optimus-ide-collabdtest.CreateAnotherUser(t, ownerClient, owner.OrganizationID)
...
func setupAICostControlTest(t *testing.T, opts aiCostControlTestOptions) (*optimus-ide-collabsdk.Client, optimus-ide-collabsdk.User, optimus-ide-collabsdk.Group) {
	t.Helper()
	...
	optimus-ide-collabdOpts := &optimus-ide-collabdtest.Options{DeploymentValues: dv}
	if opts.Clock != nil {
		optimus-ide-collabdOpts.Clock = opts.Clock
	}
	if opts.Database != nil {
		optimus-ide-collabdOpts.Database = opts.Database
	}
	if opts.Pubsub != nil {
		optimus-ide-collabdOpts.Pubsub = opts.Pubsub
	}
	ownerClient, owner := optimus-ide-collabdenttest.New(t, &optimus-ide-collabdenttest.Options{
		Options: optimus-ide-collabdOpts,
		LicenseOptions: &optimus-ide-collabdenttest.LicenseOptions{
			Features: license.Features{
				optimus-ide-collabsdk.FeatureTemplateRBAC: 1,
				optimus-ide-collabsdk.FeatureAIBridge:     1,
	...
	ctx := testutil.Context(t, testutil.WaitLong)
	g, err := adminClient.CreateGroup(ctx, owner.OrganizationID, optimus-ide-collabsdk.CreateGroupRequest{
		Name: opts.GroupName,
	})
	require.NoError(t, err)
	g, err = adminClient.PatchGroup(ctx, g.ID, optimus-ide-collabsdk.PatchGroupRequest{
		AddUsers: []string{targetUser.ID.String()},
	})
	require.NoError(t, err)
...
func setupUserAIBudgetOverrideAuditTest(t *testing.T) (database.Store, *optimus-ide-collabsdk.Client, optimus-ide-collabsdk.CreateFirstUserResponse, optimus-ide-collabsdk.User) {
	t.Helper()
...
func setupGroupAIBudgetTest(t *testing.T) (adminClient *optimus-ide-collabsdk.Client, group optimus-ide-collabsdk.Group) {
	t.Helper()
