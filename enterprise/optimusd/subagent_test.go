...
import (
	...
	entdbauthz "github.com/optimus-ide-collab/optimus-ide-collab/v2/enterprise/optimus-ide-collabd/dbauthz"
	entportsharing "github.com/optimus-ide-collab/optimus-ide-collab/v2/enterprise/optimus-ide-collabd/portsharing"
...
func TestDevcontainerOptimus-IDE-CollabAppShareClampedWithGroupRestrictedEnterpriseTemplateACL(t *testing.T) {
	t.Parallel()
...
func withGroupRestrictedTemplateACL(t testing.TB, db database.Store, org database.Organization, user database.User, template *database.Template) {
	...
	template.GroupACL = database.TemplateACL{
		group.ID.String(): db2sdk.TemplateRoleActions(optimus-ide-collabsdk.TemplateRoleUse),
	}
