...
func TestExtractProvisionerDaemonAuthenticated(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			if test.provisionerKey != "" {
				r.Header.Set(optimus-ide-collabsdk.ProvisionerDaemonKey, test.provisionerKey)
			}
			if test.provisionerPSK != "" {
				r.Header.Set(optimus-ide-collabsdk.ProvisionerDaemonPSK, test.provisionerPSK)
			}
	...
	t.Run("ProvisionerKey", func(t *testing.T) {
		...
		key, err := client.CreateProvisionerKey(ctx, user.OrganizationID, optimus-ide-collabsdk.CreateProvisionerKeyRequest{
			Name: "dont-TEST-me",
		})
		...
		r.Header.Set(optimus-ide-collabsdk.ProvisionerDaemonKey, key.Key)
	...
	t.Run("ProvisionerKey_NotFound", func(t *testing.T) {
		...
		// nolint:gocritic // test
		_, err := client.CreateProvisionerKey(ctx, user.OrganizationID, optimus-ide-collabsdk.CreateProvisionerKeyRequest{
			Name: "dont-TEST-me",
		})
		require.NoError(t, err)
		...
		r.Header.Set(optimus-ide-collabsdk.ProvisionerDaemonKey, pkey)
	...
	t.Run("ProvisionerKey_CompareFail", func(t *testing.T) {
		...
		r.Header.Set(optimus-ide-collabsdk.ProvisionerDaemonKey, functionalKey)
