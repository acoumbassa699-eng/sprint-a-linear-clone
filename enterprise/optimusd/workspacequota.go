...
// @Success 200 {object} optimus-ide-collabsdk.WorkspaceQuota
...
func (api *API) workspaceQuota(rw http.ResponseWriter, r *http.Request) {
	...
	licensed := api.Entitlements.Enabled(optimus-ide-collabsdk.FeatureTemplateRBAC)
	...
	httpapi.Write(r.Context(), rw, http.StatusOK, optimus-ide-collabsdk.WorkspaceQuota{
