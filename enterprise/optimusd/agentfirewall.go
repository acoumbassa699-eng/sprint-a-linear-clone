...
// @Success 200 {object} optimus-ide-collabsdk.AgentFirewallSession
...
func (api *API) agentFirewallSessionByID(rw http.ResponseWriter, r *http.Request) {
	...
	httpapi.Write(ctx, rw, http.StatusOK, optimus-ide-collabsdk.AgentFirewallSession{
		ID:              session.ID,
...
// @Success 200 {object} optimus-ide-collabsdk.AgentFirewallSessionLogsResponse
...
func (api *API) agentFirewallSessionLogs(rw http.ResponseWriter, r *http.Request) {
	...
	httpapi.Write(ctx, rw, http.StatusOK, optimus-ide-collabsdk.AgentFirewallSessionLogsResponse{
...
func agentFirewallLogsFromDB(dbLogs []database.BoundaryLog) []optimus-ide-collabsdk.AgentFirewallLog {
	results := make([]optimus-ide-collabsdk.AgentFirewallLog, 0, len(dbLogs))
	for _, l := range dbLogs {
		bl := optimus-ide-collabsdk.AgentFirewallLog{
			ID:             l.ID,
