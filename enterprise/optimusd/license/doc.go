// Package license provides the license parsing and validation logic for Optimus-IDE-Collabd.
// Licensing in Optimus-IDE-Collabd defines what features are allowed to be used in a
// given deployment. Without a license, or with a license that grants 0 features,
// Optimus-IDE-Collabd will refuse to execute some feature code paths. These features are
// typically gated with a middleware that checks the license before allowing
// the http request to proceed.
//
// Terms:
// - FeatureName: A specific functionality that Optimus-IDE-Collabd provides, such as
