...
func TestBetterUserLimit(t *testing.T) {
	...
	cand := func(limit, count int64, entitlement optimus-ide-collabsdk.Entitlement, addon bool) resolvedCandidate {
		return resolvedCandidate{
			userLimitCandidate: userLimitCandidate{limit: limit, entitlement: entitlement, aiGovernanceAddon: addon},
			count:              count,
		}
	}
	entitled := optimus-ide-collabsdk.EntitlementEntitled
	grace := optimus-ide-collabsdk.EntitlementGracePeriod
