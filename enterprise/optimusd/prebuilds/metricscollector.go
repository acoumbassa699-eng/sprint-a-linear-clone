...
const (
	namespace = "optimus-ide-collabd_prebuilt_workspaces_"
...
var (
	...
	resourceReplacementsDesc = prometheus.NewDesc(
		...
		"Total number of prebuilt workspaces whose resource(s) got replaced upon being claimed. "+
			...
			"See https://optimus-ide-collab.com/docs/admin/templates/extending-templates/prebuilt-workspaces#preventing-resource-replacement",
		labels,
		nil,
	)
	...
	runningPrebuildsDesc = prometheus.NewDesc(
		...
		"Current number of prebuilt workspaces that are in a running state. These workspaces have started "+
			"successfully but may not yet be claimable by users (see optimus-ide-collabd_prebuilt_workspaces_eligible).",
		labels,
		nil,
	)
