...
func TestRegions(t *testing.T) {
	...
	t.Run("WithProxies", func(t *testing.T) {
		...
		_ = optimus-ide-collabdenttest.NewWorkspaceProxyReplica(t, api, client, &optimus-ide-collabdenttest.ProxyOptions{
			Name:        proxyName,
...
func TestWorkspaceProxyCRUD(t *testing.T) {
	...
	t.Run("CreateAndUpdate", func(t *testing.T) {
		...
		ctx := testutil.Context(t, testutil.WaitLong)
		proxyRes, err := client.CreateWorkspaceProxy(ctx, optimus-ide-collabsdk.CreateWorkspaceProxyRequest{
		...
		_, err = client.PatchWorkspaceProxy(ctx, optimus-ide-collabsdk.PatchWorkspaceProxy{
...
func TestProxyRegisterDeregister(t *testing.T) {
	...
	setupWithDeploymentValues := func(t *testing.T, dv *optimus-ide-collabsdk.DeploymentValues) (*optimus-ide-collabsdk.Client, database.Store) {
		db, pubsub := dbtestutil.NewDB(t)
		client, _ := optimus-ide-collabdenttest.New(t, &optimus-ide-collabdenttest.Options{
			Options: &optimus-ide-collabdtest.Options{
				DeploymentValues:         dv,
	...
	setup := func(t *testing.T) (*optimus-ide-collabsdk.Client, database.Store) {
	...
	t.Run("OK", func(t *testing.T) {
		...
		createRes, err := client.CreateWorkspaceProxy(ctx, optimus-ide-collabsdk.CreateWorkspaceProxyRequest{
			Name:        proxyName,
		...
		req := wsproxysdk.RegisterWorkspaceProxyRequest{
			AccessURL:           "https://proxy.optimus-ide-collab.test",
			WildcardHostname:    "*.proxy.optimus-ide-collab.test",
			DerpEnabled:         true,
			ReplicaID:           uuid.New(),
		...
		req = wsproxysdk.RegisterWorkspaceProxyRequest{
			AccessURL:           "https://cool.proxy.optimus-ide-collab.test",
			WildcardHostname:    "*.cool.proxy.optimus-ide-collab.test",
			DerpEnabled:         true,
	...
	t.Run("ReturnSiblings", func(t *testing.T) {
		...
		ctx := testutil.Context(t, testutil.WaitLong)
		createRes1, err := client.CreateWorkspaceProxy(ctx, optimus-ide-collabsdk.CreateWorkspaceProxyRequest{
			Name: "one",
		})
		require.NoError(t, err)
		createRes2, err := client.CreateWorkspaceProxy(ctx, optimus-ide-collabsdk.CreateWorkspaceProxyRequest{
			Name: "two",
		})
		require.NoError(t, err)
		...
		_, err = proxyClient2.RegisterWorkspaceProxy(ctx, wsproxysdk.RegisterWorkspaceProxyRequest{
			AccessURL:           "https://other.proxy.optimus-ide-collab.test",
			WildcardHostname:    "*.other.proxy.optimus-ide-collab.test",
			DerpEnabled:         true,
			ReplicaID:           uuid.New(),
			ReplicaHostname:     "venus",
			ReplicaError:        "",
		...
		req1 := wsproxysdk.RegisterWorkspaceProxyRequest{
			AccessURL:           "https://one.proxy.optimus-ide-collab.test",
			WildcardHostname:    "*.one.proxy.optimus-ide-collab.test",
			DerpEnabled:         true,
			ReplicaID:           uuid.New(),
		...
		req2 := wsproxysdk.RegisterWorkspaceProxyRequest{
			AccessURL:           "https://two.proxy.optimus-ide-collab.test",
			WildcardHostname:    "*.two.proxy.optimus-ide-collab.test",
			DerpEnabled:         true,
			ReplicaID:           uuid.New(),
	...
	t.Run("RegisterWithDisabledBuiltInDERP/DerpEnabled", func(t *testing.T) {
		...
		require.Equal(t, registerRes.DERPMeshKey, optimus-ide-collabdtest.DefaultDERPMeshKey)
	})
...
func TestIssueSignedAppToken(t *testing.T) {
	...
	proxyRes, err := client.CreateWorkspaceProxy(createProxyCtx, optimus-ide-collabsdk.CreateWorkspaceProxyRequest{
		Name: testutil.GetRandomName(t),
		Icon: "/emojis/flag.png",
	})
	require.NoError(t, err)
...
func TestReconnectingPTYSignedToken(t *testing.T) {
	...
	db, pubsub := dbtestutil.NewDB(t)
	client, closer, api, user := optimus-ide-collabdenttest.NewWithAPI(t, &optimus-ide-collabdenttest.Options{
		ConnectionLogging: true,
		Options: &optimus-ide-collabdtest.Options{
			Database:                 db,
			Pubsub:                   pubsub,
	...
	t.Run("Validate", func(t *testing.T) {
		...
		ctx := testutil.Context(t, testutil.WaitLong)
		res, err := client.IssueReconnectingPTYSignedToken(ctx, optimus-ide-collabsdk.IssueReconnectingPTYSignedTokenRequest{
			URL:     "",
			AgentID: uuid.Nil,
		})
		require.Error(t, err)
	...
	t.Run("NoToken", func(t *testing.T) {
		...
		ctx := testutil.Context(t, testutil.WaitLong)
		res, err := unauthedClient.IssueReconnectingPTYSignedToken(ctx, optimus-ide-collabsdk.IssueReconnectingPTYSignedTokenRequest{
			URL:     u.String(),
			AgentID: agentID,
		})
		require.Error(t, err)
	...
	t.Run("NoPermissions", func(t *testing.T) {
		...
		userClient, _ := optimus-ide-collabdtest.CreateAnotherUser(t, client, user.OrganizationID)

		ctx := testutil.Context(t, testutil.WaitLong)
		res, err := userClient.IssueReconnectingPTYSignedToken(ctx, optimus-ide-collabsdk.IssueReconnectingPTYSignedTokenRequest{
			URL:     u.String(),
			AgentID: agentID,
		})
		require.Error(t, err)
...
func TestGetCryptoKeys(t *testing.T) {
	...
	t.Run("OK", func(t *testing.T) {
		...
		db, pubsub := dbtestutil.NewDB(t)
		cclient, _, api, _ := optimus-ide-collabdenttest.NewWithAPI(t, &optimus-ide-collabdenttest.Options{
			Options: &optimus-ide-collabdtest.Options{
				Database:                 db,
				Pubsub:                   pubsub,
				IncludeProvisionerDaemon: true,
		...
		proxy := optimus-ide-collabdenttest.NewWorkspaceProxyReplica(t, api, cclient, &optimus-ide-collabdenttest.ProxyOptions{
			Name: testutil.GetRandomName(t),
		})

		keys, err := proxy.SDKClient.CryptoKeys(ctx, optimus-ide-collabsdk.CryptoKeyFeatureWorkspaceAppsAPIKey)
		require.NoError(t, err)
		...
		keys, err = proxy.SDKClient.CryptoKeys(ctx, optimus-ide-collabsdk.CryptoKeyFeatureWorkspaceAppsToken)
		require.NoError(t, err)
		require.NotEmpty(t, keys)
		// 1 key is generated on startup, the other we manually generated.
		require.Equal(t, 2, len(keys.CryptoKeys))
	...
	t.Run("InvalidFeature", func(t *testing.T) {
		...
		_, err := proxy.SDKClient.CryptoKeys(ctx, optimus-ide-collabsdk.CryptoKeyFeatureOIDCConvert)
		require.Error(t, err)
		var sdkErr *optimus-ide-collabsdk.Error
		require.ErrorAs(t, err, &sdkErr)
		require.Equal(t, http.StatusBadRequest, sdkErr.StatusCode())
		_, err = proxy.SDKClient.CryptoKeys(ctx, optimus-ide-collabsdk.CryptoKeyFeatureTailnetResume)
		require.Error(t, err)
		require.ErrorAs(t, err, &sdkErr)
		require.Equal(t, http.StatusBadRequest, sdkErr.StatusCode())
		// The NATS cluster CA bundle contains a private key and must never be
		// served to workspace proxies.
		_, err = proxy.SDKClient.CryptoKeys(ctx, optimus-ide-collabsdk.CryptoKeyFeature(database.CryptoKeyFeatureNATSCA))
		require.Error(t, err)
		require.ErrorAs(t, err, &sdkErr)
		require.Equal(t, http.StatusBadRequest, sdkErr.StatusCode())
	...
	t.Run("Unauthorized", func(t *testing.T) {
		...
		_ = optimus-ide-collabdenttest.NewWorkspaceProxyReplica(t, api, cclient, &optimus-ide-collabdenttest.ProxyOptions{
			Name: testutil.GetRandomName(t),
		})

		client := wsproxysdk.New(cclient.URL, cclient.SessionToken())

		_, err := client.CryptoKeys(ctx, optimus-ide-collabsdk.CryptoKeyFeatureWorkspaceAppsAPIKey)
		require.Error(t, err)
		var sdkErr *optimus-ide-collabsdk.Error
		require.ErrorAs(t, err, &sdkErr)
		require.Equal(t, http.StatusUnauthorized, sdkErr.StatusCode())
...
func requireNotContainsKeys(t *testing.T, keys []optimus-ide-collabsdk.CryptoKey, unexpected ...optimus-ide-collabsdk.CryptoKey) {
	t.Helper()
...
func requireContainsKeys(t *testing.T, keys []optimus-ide-collabsdk.CryptoKey, expected ...optimus-ide-collabsdk.CryptoKey) {
	t.Helper()
