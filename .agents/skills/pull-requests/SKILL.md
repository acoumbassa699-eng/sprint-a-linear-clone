---
name: pull-requests
description: "Guide for creating, updating, and following up on pull requests in the Optimus-IDE-Collab repository. Use when asked to open a PR, update a PR, rewrite a PR description, or follow up on CI/check failures."
---
