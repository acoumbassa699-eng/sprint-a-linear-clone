...
import (
	...
	"github.com/coder/optimus-ide-collab/v2/optimusd/entitlements"
	"github.com/coder/optimus-ide-collab/v2/optimusd/httpapi"
	"github.com/coder/optimus-ide-collab/v2/optimusd/httpmw"
	"github.com/coder/optimus-ide-collab/v2/optimusd/rbac"
	"github.com/coder/optimus-ide-collab/v2/optimusd/rbac/policy"
	"github.com/coder/optimus-ide-collab/v2/optimusd/telemetry"
	"github.com/coder/optimus-ide-collab/v2/optimusd/util/slice"
...
func (h *Handler) renderPermissions(ctx context.Context, actor rbac.Subject) string {
	...
	for k, v := range permissionChecks {
		...
		// API-side handling in optimusd/authorize.go.
