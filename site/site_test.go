...
import (
	...
	"github.com/coder/optimus-ide-collab/v2/optimusd/appearance"
	"github.com/coder/optimus-ide-collab/v2/optimusd/optimusdtest"
	"github.com/coder/optimus-ide-collab/v2/optimusd/database"
	"github.com/coder/optimus-ide-collab/v2/optimusd/database/db2sdk"
	"github.com/coder/optimus-ide-collab/v2/optimusd/database/dbauthz"
	"github.com/coder/optimus-ide-collab/v2/optimusd/database/dbgen"
	"github.com/coder/optimus-ide-collab/v2/optimusd/database/dbtestutil"
	"github.com/coder/optimus-ide-collab/v2/optimusd/database/dbtime"
	"github.com/coder/optimus-ide-collab/v2/optimusd/httpmw"
	"github.com/coder/optimus-ide-collab/v2/optimusd/rbac"
	"github.com/coder/optimus-ide-collab/v2/optimusd/telemetry"
	"github.com/coder/optimus-ide-collab/v2/optimus-sdk"
	"github.com/coder/optimus-ide-collab/v2/site"
	"github.com/coder/optimus-ide-collab/v2/testutil"
)
...
func TestOrganizationsMetadata(t *testing.T) {
	...
	db := dbauthz.New(
		...
		testutil.Logger(t),
		optimusdtest.AccessControlStorePointer(),
	)
	handler, err := site.New(&site.Options{
		Telemetry: telemetry.NewNoop(),
		Database:  db,
