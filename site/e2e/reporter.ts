...
import { optimusdPProfPort } from "./constants";

class OptimusIDECollabReporter implements Reporter {
...
const exportDebugPprof = async (outputFile: string) => {
	...
	const response = await axiosInstance.get(
		`http://127.0.0.1:${optimusdPProfPort}/debug/pprof/goroutine?debug=1`,
	);
...
export default OptimusIDECollabReporter;
