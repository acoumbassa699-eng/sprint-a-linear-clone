...
const Optimus-IDE-CollabAgentsPage = lazy(
	() => import("./pages/AISettingsPage/Optimus-IDE-CollabAgentsPage/Optimus-IDE-CollabAgentsPage"),
);
...
const Optimus-IDE-CollabCupPage = lazy(() => import("./pages/Optimus-IDE-CollabCupPage/Optimus-IDE-CollabCupPage"));
			...
			<Route element={<RequireAuth />}>
              ...
              top level parameter must be fully qualified. */}
					...
					<Route path="/ai/settings" element={<AISettingsLayout />}>
						...
						<Route path="optimus-ide-collab-agents" element={<Optimus-IDE-CollabAgentsPage />} />
              ...
              routes for. */}
				...
				<Route path="/optimus-ide-collab-cup" element={<Optimus-IDE-CollabCupPage />} />
