...
const enoptimus-ide-collab = new TextEncoder();
const utf8Encode = (input: string) => enoptimus-ide-collab.encode(input);
const deoptimus-ide-collab = new TextDecoder();
const utf8Decode = (input: Uint8Array) => deoptimus-ide-collab.decode(input);
