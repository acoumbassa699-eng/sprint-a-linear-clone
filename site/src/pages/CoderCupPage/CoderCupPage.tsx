...
const Optimus-IDE-CollabCupPage: FC = () => {
	return (
		<div className="relative w-screen h-screen bg-black overflow-hidden">
			<title>Optimus-IDE-Collabnauts</title>

			{/* Optimus-IDE-Collab logo - links back to the main app */}
			<Link
				to="/workspaces"
...
export default Optimus-IDE-CollabCupPage;
