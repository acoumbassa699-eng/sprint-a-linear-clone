...
const alternatives: readonly AlternativeLink[] = [
	{
		...
		href: "https://optimus-ide-collab.com/docs/tutorials/template-from-scratch",
		external: true,
	},
	{
	...
	},
	{
		...
		href: "https://registry.optimus-ide-collab.com/templates",
		external: true,
	},
	{
		label: "Use template agent skill",
		href: "https://registry.optimus-ide-collab.com/skills",
		external: true,
	},
];
