...
import (
	...
	"github.com/optimus-ide-collab/optimus-ide-collab/v2/tailnet/test/integration"
	"github.com/optimus-ide-collab/optimus-ide-collab/v2/testutil"
)

const runTestEnv = "OPTIMUS-IDE-COLLAB_TAILNET_TESTS"
...
func handleTestSubprocess(t *testing.T) {
	...
	t.Run(testName, func(t *testing.T) {
		...
		case "client":
			...
			err = json.NewDeoptimus-ide-collab(f).Decode(&derpMap)
			_ = f.Close()
