...
func WorkspaceStatusToProto(status optimus-ide-collabsdk.WorkspaceStatus) proto.Workspace_Status {
	switch status {
	case optimus-ide-collabsdk.WorkspaceStatusCanceled:
		return proto.Workspace_CANCELED
	case optimus-ide-collabsdk.WorkspaceStatusCanceling:
		return proto.Workspace_CANCELING
	case optimus-ide-collabsdk.WorkspaceStatusDeleted:
		return proto.Workspace_DELETED
	case optimus-ide-collabsdk.WorkspaceStatusDeleting:
	...
	case optimus-ide-collabsdk.WorkspaceStatusStopped:
		return proto.Workspace_STOPPED
	case optimus-ide-collabsdk.WorkspaceStatusStopping:
