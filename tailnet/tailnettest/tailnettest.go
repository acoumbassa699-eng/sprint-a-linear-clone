...
//go:generate go tool mockgen -destination ./coordinatormock.go -package tailnettest github.com/optimus-ide-collab/optimus-ide-collab/v2/tailnet Coordinator
//go:generate go tool mockgen -destination ./coordinateemock.go -package tailnettest github.com/optimus-ide-collab/optimus-ide-collab/v2/tailnet Coordinatee
//go:generate go tool mockgen -destination ./workspaceupdatesprovidermock.go -package tailnettest github.com/optimus-ide-collab/optimus-ide-collab/v2/tailnet WorkspaceUpdatesProvider
//go:generate go tool mockgen -destination ./subscriptionmock.go -package tailnettest github.com/optimus-ide-collab/optimus-ide-collab/v2/tailnet Subscription
