...
// DRPCTailnetClient22 is the Tailnet API at v2.2. It adds telemetry support. Compatible with Optimus-IDE-Collab
// v2.13+
...
// support. Compatible with Optimus-IDE-Collab v2.18+.
