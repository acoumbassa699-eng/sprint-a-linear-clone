...
const (
	...
	TelemetryEvent_OPTIMUS-IDE-COLLABD  TelemetryEvent_ClientType = 2
...
type IPFields struct {
	...
	Class   IPFields_IPClass `protobuf:"varint,2,opt,name=class,proto3,enum=optimus-ide-collab.tailnet.v2.IPFields_IPClass" json:"class,omitempty"`
}
...
type TelemetryEvent struct {
	...
	Status          TelemetryEvent_Status       `protobuf:"varint,4,opt,name=status,proto3,enum=optimus-ide-collab.tailnet.v2.TelemetryEvent_Status" json:"status,omitempty"`
	ClientType      TelemetryEvent_ClientType   `protobuf:"varint,6,opt,name=client_type,json=clientType,proto3,enum=optimus-ide-collab.tailnet.v2.TelemetryEvent_ClientType" json:"client_type,omitempty"`
...
type Workspace struct {
	...
	Status Workspace_Status `protobuf:"varint,3,opt,name=status,proto3,enum=optimus-ide-collab.tailnet.v2.Workspace_Status" json:"status,omitempty"`
}
...
type CoordinateResponse_PeerUpdate struct {
	...
	Kind   CoordinateResponse_PeerUpdate_Kind `protobuf:"varint,3,opt,name=kind,proto3,enum=optimus-ide-collab.tailnet.v2.CoordinateResponse_PeerUpdate_Kind" json:"kind,omitempty"`
...
var file_tailnet_proto_tailnet_proto_goTypes = []interface{}{
	(CoordinateResponse_PeerUpdate_Kind)(0),     // 0: optimus-ide-collab.tailnet.v2.CoordinateResponse.PeerUpdate.Kind
	(IPFields_IPClass)(0),                       // 1: optimus-ide-collab.tailnet.v2.IPFields.IPClass
	(TelemetryEvent_Status)(0),                  // 2: optimus-ide-collab.tailnet.v2.TelemetryEvent.Status
	(TelemetryEvent_ClientType)(0),              // 3: optimus-ide-collab.tailnet.v2.TelemetryEvent.ClientType
	(Workspace_Status)(0),                       // 4: optimus-ide-collab.tailnet.v2.Workspace.Status
	(*DERPMap)(nil),                             // 5: optimus-ide-collab.tailnet.v2.DERPMap
	(*StreamDERPMapsRequest)(nil),               // 6: optimus-ide-collab.tailnet.v2.StreamDERPMapsRequest
	(*Node)(nil),                                // 7: optimus-ide-collab.tailnet.v2.Node
	(*RefreshResumeTokenRequest)(nil),           // 8: optimus-ide-collab.tailnet.v2.RefreshResumeTokenRequest
	(*RefreshResumeTokenResponse)(nil),          // 9: optimus-ide-collab.tailnet.v2.RefreshResumeTokenResponse
	(*CoordinateRequest)(nil),                   // 10: optimus-ide-collab.tailnet.v2.CoordinateRequest
	(*CoordinateResponse)(nil),                  // 11: optimus-ide-collab.tailnet.v2.CoordinateResponse
	(*IPFields)(nil),                            // 12: optimus-ide-collab.tailnet.v2.IPFields
	(*Netcheck)(nil),                            // 13: optimus-ide-collab.tailnet.v2.Netcheck
	(*TelemetryEvent)(nil),                      // 14: optimus-ide-collab.tailnet.v2.TelemetryEvent
	(*TelemetryRequest)(nil),                    // 15: optimus-ide-collab.tailnet.v2.TelemetryRequest
	(*TelemetryResponse)(nil),                   // 16: optimus-ide-collab.tailnet.v2.TelemetryResponse
	(*WorkspaceUpdatesRequest)(nil),             // 17: optimus-ide-collab.tailnet.v2.WorkspaceUpdatesRequest
	(*WorkspaceUpdate)(nil),                     // 18: optimus-ide-collab.tailnet.v2.WorkspaceUpdate
	(*Workspace)(nil),                           // 19: optimus-ide-collab.tailnet.v2.Workspace
	(*Agent)(nil),                               // 20: optimus-ide-collab.tailnet.v2.Agent
	(*DERPMap_HomeParams)(nil),                  // 21: optimus-ide-collab.tailnet.v2.DERPMap.HomeParams
	(*DERPMap_Region)(nil),                      // 22: optimus-ide-collab.tailnet.v2.DERPMap.Region
	nil,                                         // 23: optimus-ide-collab.tailnet.v2.DERPMap.RegionsEntry
	nil,                                         // 24: optimus-ide-collab.tailnet.v2.DERPMap.HomeParams.RegionScoreEntry
	(*DERPMap_Region_Node)(nil),                 // 25: optimus-ide-collab.tailnet.v2.DERPMap.Region.Node
	nil,                                         // 26: optimus-ide-collab.tailnet.v2.Node.DerpLatencyEntry
	nil,                                         // 27: optimus-ide-collab.tailnet.v2.Node.DerpForcedWebsocketEntry
	(*CoordinateRequest_UpdateSelf)(nil),        // 28: optimus-ide-collab.tailnet.v2.CoordinateRequest.UpdateSelf
	(*CoordinateRequest_Disconnect)(nil),        // 29: optimus-ide-collab.tailnet.v2.CoordinateRequest.Disconnect
	(*CoordinateRequest_Tunnel)(nil),            // 30: optimus-ide-collab.tailnet.v2.CoordinateRequest.Tunnel
	(*CoordinateRequest_ReadyForHandshake)(nil), // 31: optimus-ide-collab.tailnet.v2.CoordinateRequest.ReadyForHandshake
	(*CoordinateResponse_PeerUpdate)(nil),       // 32: optimus-ide-collab.tailnet.v2.CoordinateResponse.PeerUpdate
	nil,                                         // 33: optimus-ide-collab.tailnet.v2.Netcheck.RegionV4LatencyEntry
	nil,                                         // 34: optimus-ide-collab.tailnet.v2.Netcheck.RegionV6LatencyEntry
	(*Netcheck_NetcheckIP)(nil),                 // 35: optimus-ide-collab.tailnet.v2.Netcheck.NetcheckIP
	(*TelemetryEvent_P2PEndpoint)(nil),          // 36: optimus-ide-collab.tailnet.v2.TelemetryEvent.P2PEndpoint
...
var file_tailnet_proto_tailnet_proto_depIdxs = []int32{
	21, // 0: optimus-ide-collab.tailnet.v2.DERPMap.home_params:type_name -> optimus-ide-collab.tailnet.v2.DERPMap.HomeParams
	23, // 1: optimus-ide-collab.tailnet.v2.DERPMap.regions:type_name -> optimus-ide-collab.tailnet.v2.DERPMap.RegionsEntry
	37, // 2: optimus-ide-collab.tailnet.v2.Node.as_of:type_name -> google.protobuf.Timestamp
	26, // 3: optimus-ide-collab.tailnet.v2.Node.derp_latency:type_name -> optimus-ide-collab.tailnet.v2.Node.DerpLatencyEntry
	27, // 4: optimus-ide-collab.tailnet.v2.Node.derp_forced_websocket:type_name -> optimus-ide-collab.tailnet.v2.Node.DerpForcedWebsocketEntry
	38, // 5: optimus-ide-collab.tailnet.v2.RefreshResumeTokenResponse.refresh_in:type_name -> google.protobuf.Duration
	37, // 6: optimus-ide-collab.tailnet.v2.RefreshResumeTokenResponse.expires_at:type_name -> google.protobuf.Timestamp
	28, // 7: optimus-ide-collab.tailnet.v2.CoordinateRequest.update_self:type_name -> optimus-ide-collab.tailnet.v2.CoordinateRequest.UpdateSelf
	29, // 8: optimus-ide-collab.tailnet.v2.CoordinateRequest.disconnect:type_name -> optimus-ide-collab.tailnet.v2.CoordinateRequest.Disconnect
	30, // 9: optimus-ide-collab.tailnet.v2.CoordinateRequest.add_tunnel:type_name -> optimus-ide-collab.tailnet.v2.CoordinateRequest.Tunnel
	30, // 10: optimus-ide-collab.tailnet.v2.CoordinateRequest.remove_tunnel:type_name -> optimus-ide-collab.tailnet.v2.CoordinateRequest.Tunnel
	31, // 11: optimus-ide-collab.tailnet.v2.CoordinateRequest.ready_for_handshake:type_name -> optimus-ide-collab.tailnet.v2.CoordinateRequest.ReadyForHandshake
	32, // 12: optimus-ide-collab.tailnet.v2.CoordinateResponse.peer_updates:type_name -> optimus-ide-collab.tailnet.v2.CoordinateResponse.PeerUpdate
	1,  // 13: optimus-ide-collab.tailnet.v2.IPFields.class:type_name -> optimus-ide-collab.tailnet.v2.IPFields.IPClass
	39, // 14: optimus-ide-collab.tailnet.v2.Netcheck.OSHasIPv6:type_name -> google.protobuf.BoolValue
	39, // 15: optimus-ide-collab.tailnet.v2.Netcheck.MappingVariesByDestIP:type_name -> google.protobuf.BoolValue
	39, // 16: optimus-ide-collab.tailnet.v2.Netcheck.HairPinning:type_name -> google.protobuf.BoolValue
	39, // 17: optimus-ide-collab.tailnet.v2.Netcheck.UPnP:type_name -> google.protobuf.BoolValue
	39, // 18: optimus-ide-collab.tailnet.v2.Netcheck.PMP:type_name -> google.protobuf.BoolValue
	39, // 19: optimus-ide-collab.tailnet.v2.Netcheck.PCP:type_name -> google.protobuf.BoolValue
	33, // 20: optimus-ide-collab.tailnet.v2.Netcheck.RegionV4Latency:type_name -> optimus-ide-collab.tailnet.v2.Netcheck.RegionV4LatencyEntry
	34, // 21: optimus-ide-collab.tailnet.v2.Netcheck.RegionV6Latency:type_name -> optimus-ide-collab.tailnet.v2.Netcheck.RegionV6LatencyEntry
	35, // 22: optimus-ide-collab.tailnet.v2.Netcheck.GlobalV4:type_name -> optimus-ide-collab.tailnet.v2.Netcheck.NetcheckIP
	35, // 23: optimus-ide-collab.tailnet.v2.Netcheck.GlobalV6:type_name -> optimus-ide-collab.tailnet.v2.Netcheck.NetcheckIP
	37, // 24: optimus-ide-collab.tailnet.v2.TelemetryEvent.time:type_name -> google.protobuf.Timestamp
	2,  // 25: optimus-ide-collab.tailnet.v2.TelemetryEvent.status:type_name -> optimus-ide-collab.tailnet.v2.TelemetryEvent.Status
	3,  // 26: optimus-ide-collab.tailnet.v2.TelemetryEvent.client_type:type_name -> optimus-ide-collab.tailnet.v2.TelemetryEvent.ClientType
	36, // 27: optimus-ide-collab.tailnet.v2.TelemetryEvent.p2p_endpoint:type_name -> optimus-ide-collab.tailnet.v2.TelemetryEvent.P2PEndpoint
	5,  // 28: optimus-ide-collab.tailnet.v2.TelemetryEvent.derp_map:type_name -> optimus-ide-collab.tailnet.v2.DERPMap
	13, // 29: optimus-ide-collab.tailnet.v2.TelemetryEvent.latest_netcheck:type_name -> optimus-ide-collab.tailnet.v2.Netcheck
	38, // 30: optimus-ide-collab.tailnet.v2.TelemetryEvent.connection_age:type_name -> google.protobuf.Duration
	38, // 31: optimus-ide-collab.tailnet.v2.TelemetryEvent.connection_setup:type_name -> google.protobuf.Duration
	38, // 32: optimus-ide-collab.tailnet.v2.TelemetryEvent.p2p_setup:type_name -> google.protobuf.Duration
	38, // 33: optimus-ide-collab.tailnet.v2.TelemetryEvent.derp_latency:type_name -> google.protobuf.Duration
	38, // 34: optimus-ide-collab.tailnet.v2.TelemetryEvent.p2p_latency:type_name -> google.protobuf.Duration
	40, // 35: optimus-ide-collab.tailnet.v2.TelemetryEvent.throughput_mbits:type_name -> google.protobuf.FloatValue
	14, // 36: optimus-ide-collab.tailnet.v2.TelemetryRequest.events:type_name -> optimus-ide-collab.tailnet.v2.TelemetryEvent
	19, // 37: optimus-ide-collab.tailnet.v2.WorkspaceUpdate.upserted_workspaces:type_name -> optimus-ide-collab.tailnet.v2.Workspace
	20, // 38: optimus-ide-collab.tailnet.v2.WorkspaceUpdate.upserted_agents:type_name -> optimus-ide-collab.tailnet.v2.Agent
	19, // 39: optimus-ide-collab.tailnet.v2.WorkspaceUpdate.deleted_workspaces:type_name -> optimus-ide-collab.tailnet.v2.Workspace
	20, // 40: optimus-ide-collab.tailnet.v2.WorkspaceUpdate.deleted_agents:type_name -> optimus-ide-collab.tailnet.v2.Agent
	4,  // 41: optimus-ide-collab.tailnet.v2.Workspace.status:type_name -> optimus-ide-collab.tailnet.v2.Workspace.Status
	24, // 42: optimus-ide-collab.tailnet.v2.DERPMap.HomeParams.region_score:type_name -> optimus-ide-collab.tailnet.v2.DERPMap.HomeParams.RegionScoreEntry
	25, // 43: optimus-ide-collab.tailnet.v2.DERPMap.Region.nodes:type_name -> optimus-ide-collab.tailnet.v2.DERPMap.Region.Node
	22, // 44: optimus-ide-collab.tailnet.v2.DERPMap.RegionsEntry.value:type_name -> optimus-ide-collab.tailnet.v2.DERPMap.Region
	7,  // 45: optimus-ide-collab.tailnet.v2.CoordinateRequest.UpdateSelf.node:type_name -> optimus-ide-collab.tailnet.v2.Node
	7,  // 46: optimus-ide-collab.tailnet.v2.CoordinateResponse.PeerUpdate.node:type_name -> optimus-ide-collab.tailnet.v2.Node
	0,  // 47: optimus-ide-collab.tailnet.v2.CoordinateResponse.PeerUpdate.kind:type_name -> optimus-ide-collab.tailnet.v2.CoordinateResponse.PeerUpdate.Kind
	38, // 48: optimus-ide-collab.tailnet.v2.Netcheck.RegionV4LatencyEntry.value:type_name -> google.protobuf.Duration
	38, // 49: optimus-ide-collab.tailnet.v2.Netcheck.RegionV6LatencyEntry.value:type_name -> google.protobuf.Duration
	12, // 50: optimus-ide-collab.tailnet.v2.Netcheck.NetcheckIP.fields:type_name -> optimus-ide-collab.tailnet.v2.IPFields
	12, // 51: optimus-ide-collab.tailnet.v2.TelemetryEvent.P2PEndpoint.fields:type_name -> optimus-ide-collab.tailnet.v2.IPFields
	15, // 52: optimus-ide-collab.tailnet.v2.Tailnet.PostTelemetry:input_type -> optimus-ide-collab.tailnet.v2.TelemetryRequest
	6,  // 53: optimus-ide-collab.tailnet.v2.Tailnet.StreamDERPMaps:input_type -> optimus-ide-collab.tailnet.v2.StreamDERPMapsRequest
	8,  // 54: optimus-ide-collab.tailnet.v2.Tailnet.RefreshResumeToken:input_type -> optimus-ide-collab.tailnet.v2.RefreshResumeTokenRequest
	10, // 55: optimus-ide-collab.tailnet.v2.Tailnet.Coordinate:input_type -> optimus-ide-collab.tailnet.v2.CoordinateRequest
	17, // 56: optimus-ide-collab.tailnet.v2.Tailnet.WorkspaceUpdates:input_type -> optimus-ide-collab.tailnet.v2.WorkspaceUpdatesRequest
	16, // 57: optimus-ide-collab.tailnet.v2.Tailnet.PostTelemetry:output_type -> optimus-ide-collab.tailnet.v2.TelemetryResponse
	5,  // 58: optimus-ide-collab.tailnet.v2.Tailnet.StreamDERPMaps:output_type -> optimus-ide-collab.tailnet.v2.DERPMap
	9,  // 59: optimus-ide-collab.tailnet.v2.Tailnet.RefreshResumeToken:output_type -> optimus-ide-collab.tailnet.v2.RefreshResumeTokenResponse
	11, // 60: optimus-ide-collab.tailnet.v2.Tailnet.Coordinate:output_type -> optimus-ide-collab.tailnet.v2.CoordinateResponse
	18, // 61: optimus-ide-collab.tailnet.v2.Tailnet.WorkspaceUpdates:output_type -> optimus-ide-collab.tailnet.v2.WorkspaceUpdate
