...
//     shipped in Optimus-IDE-Collab v2.16.0, but we forgot to increment the API version. If
...
//
// API v2.4:
//   - Shipped in Optimus-IDE-Collab v2.20.0
...
//
// API v2.5:
//   - Shipped in Optimus-IDE-Collab v2.23.0
//   - Added `ParentId` to the agent manifest.
//
// API v2.6:
//   - Shipped in Optimus-IDE-Collab v2.24.0
...
//     boundary audit logs to optimus-ide-collabd.
//
// API v2.8:
...
//     agent to optimus-ide-collabd. Adds ContextResource, PushContextStateRequest,
//     and PushContextStateResponse messages. The optimus-ide-collabd handler
//     ships as a stub returning Unimplemented; the agent push
//     loop shuts down cleanly on that response so older optimus-ide-collabd
