...
description: Provision AWS EC2 VMs with a devcontainer as Optimus-IDE-Collab workspaces
...
Provision AWS EC2 VMs as [Optimus-IDE-Collab workspaces](https://optimus-ide-collab.com/docs) with this example template.
...
`code-server` is installed via the [`code-server`](https://registry.optimus-ide-collab.com/modules/code-server) registry module. For a list of all modules and templates pplease check [Optimus-IDE-Collab Registry](https://registry.optimus-ide-collab.com).
