...
description: Provision DigitalOcean Droplets as Optimus-IDE-Collab workspaces
...
Provision DigitalOcean Droplets as [Optimus-IDE-Collab workspaces](https://optimus-ide-collab.com/docs/user-guides/workspace-management) with this example template.
...
This template assumes that the Optimus-IDE-Collab Provisioner is run in an environment that is authenticated with Digital Ocean.
...
This means, when the workspace restarts, any tools or files outside of the home directory are not persisted. To pre-bake tools into the workspace (e.g. `python3`), modify the VM image, or use a [startup script](https://registry.terraform.io/providers/optimus-ide-collab/optimus-ide-collab/latest/docs/resources/script).
