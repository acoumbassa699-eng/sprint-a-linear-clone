---
display_name: Nomad
description: Provision Nomad Jobs as Optimus-IDE-Collab workspaces
...
Provision Nomad Jobs as [Optimus-IDE-Collab workspaces](https://optimus-ide-collab.com/docs/user-guides/workspace-management) with this example template. This example shows how to use Nomad service tasks to be used as a development environment using docker and host csi volumes.
...
1. Create the template by running the following command:
   ...
   ```shell
   optimus-ide-collab template init nomad-docker
   cd nomad-docker
   optimus-ide-collab template push
   ```
