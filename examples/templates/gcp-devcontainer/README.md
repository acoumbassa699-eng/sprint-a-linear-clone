...
description: Provision a Devcontainer on Google Compute Engine instances as Optimus-IDE-Collab workspaces
...
import credentials on the system and user running optimus-ide-collabd. For other ways to
authenticate [consult the Terraform
docs](https://registry.terraform.io/providers/hashicorp/google/latest/docs/guides/getting_started#adding-credentials).

Optimus-IDE-Collab requires a Google Cloud Service Account to provision workspaces. To create
a service account:
...
1. Generate a **JSON private key**, which will be what you provide to Optimus-IDE-Collab
...
- [Envbuilder container](https://github.com/optimus-ide-collab/envbuilder) inside the GCP VM

Optimus-IDE-Collab persists the root volume. The full filesystem is preserved when the workspace restarts.
...
`code-server` is installed via the [`code-server`](https://registry.optimus-ide-collab.com/modules/code-server) registry module. Please check [Optimus-IDE-Collab Registry](https://registry.optimus-ide-collab.com) for a list of all modules and templates.
