...
var (
	...
	exampleBasePath = "https://github.com/optimus-ide-collab/optimus-ide-collab/tree/main/examples/templates/"
	examplesJSON    = "examples.gen.json"
	parsedExamples  []optimus-ide-collabsdk.TemplateExample
...
func List() ([]optimus-ide-collabsdk.TemplateExample, error) {
	var err error
...
func parseAndVerifyExamples() (examples []optimus-ide-collabsdk.TemplateExample, err error) {
	...
	err = json.NewDeoptimus-ide-collab(b).Decode(&examples)
	if err != nil {
...
func Archive(exampleID string) ([]byte, error) {
	rawData, err, _ := archives.Do(exampleID, func() (interface{}, error) {
		...
		var selected optimus-ide-collabsdk.TemplateExample
