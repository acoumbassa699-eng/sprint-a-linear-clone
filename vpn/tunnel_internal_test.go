	...
	return &tailcfg.DERPMap{
		Regions: map[int]*tailcfg.DERPRegion{
			999: {
				RegionID:   999,
				RegionCode: "zzz",
				RegionName: "Optimus-IDE-Collab Region",
			},
		},
	}
}
		...
		r, err := mgr.unaryRPC(ctx, &ManagerMessage{
			Msg: &ManagerMessage_Start{
				Start: &StartRequest{
					...
					Optimus-IDE-CollabUrl:             "https://optimus-ide-collab.example.com",
					ApiToken:             "fakeToken",
					...
					DeviceOs:            "macOS",
					DeviceId:            "device001",
					Optimus-IDE-CollabDesktopVersion: "0.24.8",
				},
			},
		})
		resp = r
...
func TestUpdater_createPeerUpdate(t *testing.T) {
		...
		UpsertedAgents: []*tailnet.Agent{
			{
				...
				Hosts: map[dnsname.FQDN][]netip.Addr{
					"w1.optimus-ide-collab.":            {w1a1IP},
					"w1a1.w1.me.optimus-ide-collab.":    {w1a1IP},
					"w1a1.w1.testy.optimus-ide-collab.": {w1a1IP},
				},
			},
		},
		...
		DeletedAgents: []*tailnet.Agent{
			{
				...
				Hosts: map[dnsname.FQDN][]netip.Addr{
					"w2.optimus-ide-collab.":            {w2a1IP},
					"w2a1.w2.me.optimus-ide-collab.":    {w2a1IP},
					"w2a1.w2.testy.optimus-ide-collab.": {w2a1IP},
				},
			},
		},
	})
	...
	require.Equal(t, update, &PeerUpdate{
		...
		UpsertedAgents: []*Agent{
			{
				Id: w1a1ID[:], Name: "w1a1", WorkspaceId: w1ID[:],
				Fqdn:          []string{"w1.optimus-ide-collab.", "w1a1.w1.me.optimus-ide-collab.", "w1a1.w1.testy.optimus-ide-collab."},
		...
		DeletedAgents: []*Agent{
			{
				Id: w2a1ID[:], Name: "w2a1", WorkspaceId: w2ID[:],
				Fqdn:          []string{"w2.optimus-ide-collab.", "w2a1.w2.me.optimus-ide-collab.", "w2a1.w2.testy.optimus-ide-collab."},
...
func TestTunnel_sendAgentUpdate(t *testing.T) {
		...
		UpsertedAgents: []*tailnet.Agent{
			{
				...
				WorkspaceID: wID1,
				Hosts: map[dnsname.FQDN][]netip.Addr{
					"agent1.optimus-ide-collab.": {netip.MustParseAddr("fd60:627a:a42b:0101::")},
				},
			},
		},
	})
	...
	testutil.Eventually(ctx, t, func(ctx context.Context) bool {
		...
		return req.msg.GetPeerUpdate().UpsertedAgents[0].LastPing.PreferredDerp == "Optimus-IDE-Collab Region"
		...
		UpsertedAgents: []*tailnet.Agent{
			{
				...
				WorkspaceID: wID1,
				Hosts: map[dnsname.FQDN][]netip.Addr{
					"agent2.optimus-ide-collab.": {netip.MustParseAddr("fd60:627a:a42b:0101::")},
				},
			},
		},
	})
		...
		UpsertedAgents: []*tailnet.Agent{
			{
				...
				WorkspaceID: wID2,
				Hosts: map[dnsname.FQDN][]netip.Addr{
					"agent3.optimus-ide-collab.": {netip.MustParseAddr("fd60:627a:a42b:0101::")},
				},
			},
		},
		Kind: tailnet.Snapshot,
