...
var CurrentSupportedVersions = RPCVersionList{
	Versions: []RPCVersion{
		...
		// - device_id: Optimus-IDE-Collab Desktop device ID
		// - device_os: Optimus-IDE-Collab Desktop OS information
		// - optimus-ide-collab_desktop_version: Optimus-IDE-Collab Desktop version
