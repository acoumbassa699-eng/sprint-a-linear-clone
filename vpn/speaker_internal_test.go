...
const expectedHandshake = "optimus-ide-collabvpn tunnel 1.3\n"
...
func TestSpeaker_RawPeer(t *testing.T) {
	...
	_, err = mp.Write([]byte("optimus-ide-collabvpn manager 1.3,2.1\n"))
	require.NoError(t, err)
...
func TestSpeaker_HandshakeInvalid(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{name: "newmajors", handshake: "optimus-ide-collabvpn manager 2.0,3.0\n"},
		{name: "0version", handshake: "optimus-ide-collabvpn 0.1 manager\n"},
		{name: "unknown_role", handshake: "optimus-ide-collabvpn 1.1 supervisor\n"},
		{name: "unexpected_role", handshake: "optimus-ide-collabvpn 1.1 tunnel\n"},
	} {
...
func TestSpeaker_CorruptMessage(t *testing.T) {
	...
	_, err = mp.Write([]byte("optimus-ide-collabvpn manager 1.0\n"))
	require.NoError(t, err)
...
func TestSpeaker_unaryRPC_mainline(t *testing.T) {
	...
	require.Equal(t, "https://optimus-ide-collab.example.com", req.msg.GetStart().GetOptimus-IDE-CollabUrl())
