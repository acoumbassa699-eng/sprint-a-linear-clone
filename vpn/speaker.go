...
// speaker is an implementation of the Optimus-IDE-CollabVPN protocol. It handles unary RPCs and their responses,
...
// handshake performs the initial Optimus-IDE-CollabVPN protocol handshake over the given conn
func handshake(
...
const headerPreamble = "optimus-ide-collabvpn"
