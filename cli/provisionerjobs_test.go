...
func TestProvisionerJobs(t *testing.T) {
	...
	t.Run("Cancel", func(t *testing.T) {
		...
		templateAdminClient, templateAdmin := optimus-ide-collabdtest.CreateAnotherUser(t, client, owner.OrganizationID, rbac.ScopedRoleOrgTemplateAdmin(owner.OrganizationID))
		...
		prepareJob := func(t *testing.T, jobType database.ProvisionerJobType, input json.RawMessage) database.ProvisionerJob {
			t.Helper()
			return dbgen.ProvisionerJob(t, db, optimus-ide-collabdAPI.Pubsub, database.ProvisionerJob{
				InitiatorID: member.ID,
				Input:       input,
				Type:        jobType,
				StartedAt:   sql.NullTime{Time: optimus-ide-collabdAPI.Clock.Now().Add(-time.Minute), Valid: true},
	...
	t.Run("List", func(t *testing.T) {
		...
		t.Run("JSON", func(t *testing.T) {
			...
			// Parse JSON output
			var jobs []optimus-ide-collabsdk.ProvisionerJob
