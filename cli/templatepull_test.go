...
func TestTemplatePull_Stdout(t *testing.T) {
	...
	version1 := optimus-ide-collabdtest.CreateTemplateVersion(t, client, owner.OrganizationID, source1)
	_ = optimus-ide-collabdtest.AwaitTemplateVersionJobCompleted(t, client, version1.ID)
	...
	updatedVersion := optimus-ide-collabdtest.UpdateTemplateVersion(t, client, owner.OrganizationID, source2, template.ID)
	_ = optimus-ide-collabdtest.AwaitTemplateVersionJobCompleted(t, client, updatedVersion.ID)
	optimus-ide-collabdtest.UpdateActiveTemplateVersion(t, client, template.ID, updatedVersion.ID)
	...
	expectedZip, err := archive.CreateZipFromTar(tarReader, optimus-ide-collabd.HTTPFileMaxBytes)
	require.NoError(t, err)
...
func TestTemplatePull_SpecifiedStdout(t *testing.T) {
	...
	updatedVersion2 := optimus-ide-collabdtest.UpdateTemplateVersion(t, client, owner.OrganizationID, source3, template.ID)
	_ = optimus-ide-collabdtest.AwaitTemplateVersionJobCompleted(t, client, updatedVersion2.ID)
	optimus-ide-collabdtest.UpdateActiveTemplateVersion(t, client, template.ID, updatedVersion2.ID)
