...
func (r *RootCmd) syncCommand() *serpent.Command {
	...
	cmd := &serpent.Command{
		...
		Long:  "Commands for orchestrating unit startup order in workspaces. Units are most commonly optimus-ide-collab scripts. Use these commands to declare dependencies between units, coordinate their startup sequence, and ensure units start only after their dependencies are ready. This helps prevent race conditions and startup failures.",
