...
func TestServerCreateAdminUser(t *testing.T) {
	...
	verifyUser := func(t *testing.T, dbURL, username, email, password string) {
		...
		require.EqualValues(t, []string{optimus-ide-collabsdk.RoleOwner}, user.RBACRoles, "user does not have owner role")
	...
	t.Run("Env", func(t *testing.T) {
		...
		inv.Environ.Set("OPTIMUS-IDE-COLLAB_PG_CONNECTION_URL", connectionURL)
		inv.Environ.Set("OPTIMUS-IDE-COLLAB_SSH_KEYGEN_ALGORITHM", "ed25519")
		inv.Environ.Set("OPTIMUS-IDE-COLLAB_USERNAME", username)
		inv.Environ.Set("OPTIMUS-IDE-COLLAB_EMAIL", email)
		inv.Environ.Set("OPTIMUS-IDE-COLLAB_PASSWORD", password)
