...
func (r *RootCmd) newRegenerateVapidKeypairCommand() *serpent.Command {
	...
	regenerateVapidKeypairCommand := &serpent.Command{
		...
		Handler: func(inv *serpent.Invocation) error {
			...
			sqlDriver := "postgres"
			var err error
			if optimus-ide-collabsdk.PostgresAuth(regenVapidKeypairPgAuth) == optimus-ide-collabsdk.PostgresAuthAWSIAMRDS {
	...
	regenerateVapidKeypairCommand.Options.Add(
		...
		serpent.Option{
			...
			Default:     "password",
			Value:       serpent.EnumOf(&regenVapidKeypairPgAuth, optimus-ide-collabsdk.PostgresAuthDrivers...),
		},
	)
