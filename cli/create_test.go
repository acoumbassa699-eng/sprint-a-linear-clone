...
func TestCreateDynamic(t *testing.T) {
	t.Parallel()
	owner := optimus-ide-collabdtest.New(t, &optimus-ide-collabdtest.Options{IncludeProvisionerDaemon: true})
	first := optimus-ide-collabdtest.CreateFirstUser(t, owner)
	member, _ := optimus-ide-collabdtest.CreateAnotherUser(t, owner, first.OrganizationID)
	...
	const conditionalParamTF = `
		...
		data "optimus-ide-collab_parameter" "enable_region" {
		  name         = "enable_region"
		  order        = 1
		  type         = "bool"
		  default      = "false"
		...
		data "optimus-ide-collab_parameter" "region" {
		  name         = "region"
		  count        = data.optimus-ide-collab_parameter.enable_region.value == "true" ? 1 : 0
		  order        = 2
		  type         = "string"
	...
	t.Run("ConditionalParam", func(t *testing.T) {
		...
		template, _ := optimus-ide-collabdtest.DynamicParameterTemplate(t, owner, first.OrganizationID, optimus-ide-collabdtest.DynamicParameterTemplateParams{
		...
		ws, err := member.WorkspaceByOwnerAndName(t.Context(), optimus-ide-collabsdk.Me, "ws-no-region", optimus-ide-collabsdk.WorkspaceOptions{})
		require.NoError(t, err)
		...
		require.Contains(t, buildParams, optimus-ide-collabsdk.WorkspaceBuildParameter{Name: "enable_region", Value: "false"})
		...
		ws, err = member.WorkspaceByOwnerAndName(t.Context(), optimus-ide-collabsdk.Me, "ws-with-region", optimus-ide-collabsdk.WorkspaceOptions{})
		require.NoError(t, err)
		buildParams, err = member.WorkspaceBuildParameters(t.Context(), ws.LatestBuild.ID)
		require.NoError(t, err)
		require.Len(t, buildParams, 2, "expected both enable_region and region parameters when enable_region=true")
		require.Contains(t, buildParams, optimus-ide-collabsdk.WorkspaceBuildParameter{Name: "enable_region", Value: "true"})
		require.Contains(t, buildParams, optimus-ide-collabsdk.WorkspaceBuildParameter{Name: "region", Value: "us-east"})
	})
	...
	t.Run("PromptForConditionalParam", func(t *testing.T) {
		...
		// Verify workspace created with both parameters
		ws, err := member.WorkspaceByOwnerAndName(t.Context(), optimus-ide-collabsdk.Me, "ws-prompted", optimus-ide-collabsdk.WorkspaceOptions{})
		require.NoError(t, err)
		buildParams, err := member.WorkspaceBuildParameters(t.Context(), ws.LatestBuild.ID)
		require.NoError(t, err)
		require.Len(t, buildParams, 2, "expected both enable_region and region parameters")
		require.Contains(t, buildParams, optimus-ide-collabsdk.WorkspaceBuildParameter{Name: "enable_region", Value: "true"})
		require.Contains(t, buildParams, optimus-ide-collabsdk.WorkspaceBuildParameter{Name: "region", Value: "eu-west"})
	})
	...
	t.Run("UpdateTemplateRequiredParamStartFails", func(t *testing.T) {
		...
		optimus-ide-collabdtest.DynamicParameterTemplate(t, owner, first.OrganizationID, optimus-ide-collabdtest.DynamicParameterTemplateParams{
			MainTF:     updatedTF,
	...
	t.Run("DynamicValidation", func(t *testing.T) {
		...
		const dynamicValidationTF = `
			...
			data "optimus-ide-collab_workspace_owner" "me" {}
			data "optimus-ide-collab_parameter" "max_slider" {
			  name         = "max_slider"
			  type         = "number"
			  default      = 5
			}
			data "optimus-ide-collab_parameter" "slider" {
			  name         = "slider"
			  type         = "number"
			  default      = 1
			  validation {
			    min = 1
			    max = data.optimus-ide-collab_parameter.max_slider.value
			  }
			}
		`
		...
		ws, err := member.WorkspaceByOwnerAndName(t.Context(), optimus-ide-collabsdk.Me, "ws-validation-pass", optimus-ide-collabsdk.WorkspaceOptions{})
		require.NoError(t, err)
		buildParams, err := member.WorkspaceBuildParameters(t.Context(), ws.LatestBuild.ID)
		require.NoError(t, err)
		require.Contains(t, buildParams, optimus-ide-collabsdk.WorkspaceBuildParameter{Name: "max_slider", Value: "10"})
		require.Contains(t, buildParams, optimus-ide-collabsdk.WorkspaceBuildParameter{Name: "slider", Value: "8"})
	})
}
...
func TestCreate(t *testing.T) {
	...
	t.Run("Create", func(t *testing.T) {
		...
		ws, err := member.WorkspaceByOwnerAndName(context.Background(), optimus-ide-collabsdk.Me, "my-workspace", optimus-ide-collabsdk.WorkspaceOptions{})
		if assert.NoError(t, err, "expected workspace to be created") {
			...
			assert.Equal(t, optimus-ide-collabsdk.AutomaticUpdatesAlways, ws.AutomaticUpdates)
		}
	})
	...
	t.Run("CreateForOtherUser", func(t *testing.T) {
		...
		ws, err := client.WorkspaceByOwnerAndName(context.Background(), user.Username, "their-workspace", optimus-ide-collabsdk.WorkspaceOptions{})
		if assert.NoError(t, err, "expected workspace to be created") {
			assert.Equal(t, ws.TemplateName, template.Name)
			if assert.NotNil(t, ws.AutostartSchedule) {
				assert.Equal(t, *ws.AutostartSchedule, "CRON_TZ=US/Central 30 9 * * Mon-Fri")
	...
	t.Run("CreateWithSpecificTemplateVersion", func(t *testing.T) {
		...
		owner := optimus-ide-collabdtest.CreateFirstUser(t, client)
		member, _ := optimus-ide-collabdtest.CreateAnotherUser(t, client, owner.OrganizationID)
		version := optimus-ide-collabdtest.CreateTemplateVersion(t, client, owner.OrganizationID, completeWithAgent(), func(ctvr *optimus-ide-collabsdk.CreateTemplateVersionRequest) {
			ctvr.Name = "v1"
		})
		optimus-ide-collabdtest.AwaitTemplateVersionJobCompleted(t, client, version.ID)
		template := optimus-ide-collabdtest.CreateTemplate(t, client, owner.OrganizationID, version.ID)
	...
	t.Run("CreateFromListWithSkip", func(t *testing.T) {
		...
		member, _ := optimus-ide-collabdtest.CreateAnotherUser(t, client, user.OrganizationID)
		clitest.SetupConfig(t, member, root)
	...
	t.Run("FromNothing", func(t *testing.T) {
		...
		ws, err := member.WorkspaceByOwnerAndName(inv.Context(), optimus-ide-collabsdk.Me, "my-workspace", optimus-ide-collabsdk.WorkspaceOptions{})
		if assert.NoError(t, err, "expected workspace to be created") {
			assert.Equal(t, ws.TemplateName, template.Name)
	...
	t.Run("NoWait", func(t *testing.T) {
		...
		ws, err := member.WorkspaceByOwnerAndName(ctx, optimus-ide-collabsdk.Me, "my-workspace", optimus-ide-collabsdk.WorkspaceOptions{})
		require.NoError(t, err)
		assert.Equal(t, ws.TemplateName, template.Name)
	})
	...
	t.Run("NoWaitWithParameterDefaults", func(t *testing.T) {
		...
		owner := optimus-ide-collabdtest.CreateFirstUser(t, client)
		member, _ := optimus-ide-collabdtest.CreateAnotherUser(t, client, owner.OrganizationID)
		version := optimus-ide-collabdtest.CreateTemplateVersion(t, client, owner.OrganizationID, prepareEchoResponses([]*proto.RichParameter{
		...
		require.NoError(t, err)
		assert.Contains(t, buildParams, optimus-ide-collabsdk.WorkspaceBuildParameter{Name: "region", Value: "us-east-1"})
		assert.Contains(t, buildParams, optimus-ide-collabsdk.WorkspaceBuildParameter{Name: "instance_type", Value: "t3.micro"})
	})
	...
	t.Run("EmptyStringDefaultNoPrompt", func(t *testing.T) {
		...
		require.NoError(t, err)
		assert.Contains(t, buildParams, optimus-ide-collabsdk.WorkspaceBuildParameter{Name: "region", Value: "us-east-1"})
		assert.Contains(t, buildParams, optimus-ide-collabsdk.WorkspaceBuildParameter{Name: "optional_field", Value: ""})
	})
}
...
func TestCreateWithRichParameters(t *testing.T) {
	...
	type testContext struct {
		...
		member        *optimus-ide-collabsdk.Client
		owner         optimus-ide-collabsdk.CreateFirstUserResponse
	...
	tests := []struct {
		...
		},
		{
			...
			postRun: func(t *testing.T, tctx testContext) string {
				...
				version2 := optimus-ide-collabdtest.CreateTemplateVersion(t, tctx.client, tctx.owner.OrganizationID, prepareEchoResponses([]*proto.RichParameter{
				...
				optimus-ide-collabdtest.AwaitTemplateVersionJobCompleted(t, tctx.client, version2.ID)
				optimus-ide-collabdtest.UpdateActiveTemplateVersion(t, tctx.client, tctx.template.ID, version2.ID)
...
cli_param: from file`)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			owner := optimus-ide-collabdtest.CreateFirstUser(t, client)
			member, _ := optimus-ide-collabdtest.CreateAnotherUser(t, client, owner.OrganizationID)
			version := optimus-ide-collabdtest.CreateTemplateVersion(t, client, owner.OrganizationID, prepareEchoResponses(rparams))
			...
			if len(tt.errors) > 0 {
				...
				workspaces, err := client.Workspaces(ctx, optimus-ide-collabsdk.WorkspaceFilter{Name: workspaceName})
				...
				for _, param := range parameters {
					require.Contains(t, buildParameters, optimus-ide-collabsdk.WorkspaceBuildParameter{Name: param.name, Value: param.value})
				}
			}
		})
	}
...
func TestCreateWithPreset(t *testing.T) {
	...
	t.Run("PresetFlag", func(t *testing.T) {
		...
		version := optimus-ide-collabdtest.CreateTemplateVersion(t, client, owner.OrganizationID, echoResponses(&defaultPreset, &preset))
		optimus-ide-collabdtest.AwaitTemplateVersionJobCompleted(t, client, version.ID)
		template := optimus-ide-collabdtest.CreateTemplate(t, client, owner.OrganizationID, version.ID)
		...
		var selectedPreset *optimus-ide-collabsdk.Preset
		...
		require.Contains(t, buildParameters, optimus-ide-collabsdk.WorkspaceBuildParameter{Name: firstParameterName, Value: secondOptionalParameterValue})
		require.Contains(t, buildParameters, optimus-ide-collabsdk.WorkspaceBuildParameter{Name: thirdParameterName, Value: thirdParameterValue})
	})
	...
	t.Run("NoDefaultPresetPromptUser", func(t *testing.T) {
		...
		version := optimus-ide-collabdtest.CreateTemplateVersion(t, client, owner.OrganizationID, echoResponses(&preset))
		optimus-ide-collabdtest.AwaitTemplateVersionJobCompleted(t, client, version.ID)
		template := optimus-ide-collabdtest.CreateTemplate(t, client, owner.OrganizationID, version.ID)
	...
	t.Run("TemplateVersionWithoutPresets", func(t *testing.T) {
		...
		version := optimus-ide-collabdtest.CreateTemplateVersion(t, client, owner.OrganizationID, echoResponses())
		optimus-ide-collabdtest.AwaitTemplateVersionJobCompleted(t, client, version.ID)
		template := optimus-ide-collabdtest.CreateTemplate(t, client, owner.OrganizationID, version.ID)
		...
		require.NoError(t, err)
		require.Len(t, buildParameters, 2)
		require.Contains(t, buildParameters, optimus-ide-collabsdk.WorkspaceBuildParameter{Name: firstParameterName, Value: firstOptionalParameterValue})
		require.Contains(t, buildParameters, optimus-ide-collabsdk.WorkspaceBuildParameter{Name: thirdParameterName, Value: thirdParameterValue})
	})
...
func TestCreateValidateRichParameters(t *testing.T) {
	...
	t.Run("ValidateString", func(t *testing.T) {
		...
		owner := optimus-ide-collabdtest.CreateFirstUser(t, client)
		member, _ := optimus-ide-collabdtest.CreateAnotherUser(t, client, owner.OrganizationID)
		version := optimus-ide-collabdtest.CreateTemplateVersion(t, client, owner.OrganizationID, prepareEchoResponses(stringRichParameters))
		optimus-ide-collabdtest.AwaitTemplateVersionJobCompleted(t, client, version.ID)
	...
	t.Run("ValidateNumber", func(t *testing.T) {
		...
		owner := optimus-ide-collabdtest.CreateFirstUser(t, client)
		member, _ := optimus-ide-collabdtest.CreateAnotherUser(t, client, owner.OrganizationID)
		version := optimus-ide-collabdtest.CreateTemplateVersion(t, client, owner.OrganizationID, prepareEchoResponses(numberRichParameters))
		optimus-ide-collabdtest.AwaitTemplateVersionJobCompleted(t, client, version.ID)
	...
	t.Run("ValidateNumber_CustomError", func(t *testing.T) {
		...
		owner := optimus-ide-collabdtest.CreateFirstUser(t, client)
		member, _ := optimus-ide-collabdtest.CreateAnotherUser(t, client, owner.OrganizationID)
		version := optimus-ide-collabdtest.CreateTemplateVersion(t, client, owner.OrganizationID, prepareEchoResponses(numberCustomErrorRichParameters))
		optimus-ide-collabdtest.AwaitTemplateVersionJobCompleted(t, client, version.ID)
	...
	t.Run("ValidateBool", func(t *testing.T) {
		...
		owner := optimus-ide-collabdtest.CreateFirstUser(t, client)
		member, _ := optimus-ide-collabdtest.CreateAnotherUser(t, client, owner.OrganizationID)
		version := optimus-ide-collabdtest.CreateTemplateVersion(t, client, owner.OrganizationID, prepareEchoResponses(boolRichParameters))
		optimus-ide-collabdtest.AwaitTemplateVersionJobCompleted(t, client, version.ID)
	...
	t.Run("ValidateListOfStrings", func(t *testing.T) {
		...
		owner := optimus-ide-collabdtest.CreateFirstUser(t, client)
		member, _ := optimus-ide-collabdtest.CreateAnotherUser(t, client, owner.OrganizationID)
		version := optimus-ide-collabdtest.CreateTemplateVersion(t, client, owner.OrganizationID, prepareEchoResponses(listOfStringsRichParameters))
		optimus-ide-collabdtest.AwaitTemplateVersionJobCompleted(t, client, version.ID)
		template := optimus-ide-collabdtest.CreateTemplate(t, client, owner.OrganizationID, version.ID)
...
func TestCreateWithGitAuth(t *testing.T) {
	...
	resp := optimus-ide-collabdtest.RequestExternalAuthCallback(t, "github", member)
	_ = resp.Body.Close()
