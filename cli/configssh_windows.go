...
//
// "for /f %%a in ('powershell.exe -Command [char]34') do @cmd.exe /c %%aC:\Program Files\Optimus-IDE-Collab\bin\optimus-ide-collab.exe%%a connect exists %h"
//
...
//
// %%aC:\Program Files\Optimus-IDE-Collab\bin\optimus-ide-collab.exe%%a.
//
...
//   - we need another invocation of cmd.exe (e.g. `do @cmd.exe /c %%aC:\Program Files\Optimus-IDE-Collab\bin\optimus-ide-collab.exe%%a`). Without
