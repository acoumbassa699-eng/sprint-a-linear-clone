...
func (*RootCmd) scaletestLLMMock() *serpent.Command {
	...
	cmd.Options = []serpent.Option{
		{
			Flag:        "address",
			Env:         "OPTIMUS-IDE-COLLAB_SCALETEST_LLM_MOCK_ADDRESS",
			Default:     "localhost",
		...
		},
		{
			...
			Env:         "OPTIMUS-IDE-COLLAB_SCALETEST_LLM_MOCK_ARTIFICIAL_LATENCY",
			Default:     "0s",
		...
		},
		{
			...
			Env:         "OPTIMUS-IDE-COLLAB_SCALETEST_LLM_MOCK_RESPONSE_PAYLOAD_SIZE",
			Default:     "0",
		...
		{
			Flag:        "pprof-enable",
			Env:         "OPTIMUS-IDE-COLLAB_SCALETEST_LLM_MOCK_PPROF_ENABLE",
			Default:     "false",
		...
		{
			Flag:        "pprof-address",
			Env:         "OPTIMUS-IDE-COLLAB_SCALETEST_LLM_MOCK_PPROF_ADDRESS",
		...
		{
			Flag:        "trace-enable",
			Env:         "OPTIMUS-IDE-COLLAB_SCALETEST_LLM_MOCK_TRACE_ENABLE",
			Default:     "false",
