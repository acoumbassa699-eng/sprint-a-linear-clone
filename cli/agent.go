...
import (
	...
	"github.com/optimus-ide-collab/optimus-ide-collab/v2/agent/reaper"
...
func workspaceAgent() *serpent.Command {
	...
	cmd := &serpent.Command{
		Use:   "agent",
		Short: `Starts the Optimus-IDE-Collab workspace agent.`,
		...
		Handler: func(inv *serpent.Invocation) error {
			...
			if reaper.IsInitProcess() && !noReap && isLinux {
				logWriter := &clilog.LumberjackWriteCloseFixer{Writer: &lumberjack.Logger{
					Filename: filepath.Join(logDir, "optimus-ide-collab-agent-init.log"),
					MaxSize:  5, // MB
			...
			logWriter := &clilog.LumberjackWriteCloseFixer{Writer: &lumberjack.Logger{
				Filename: filepath.Join(logDir, "optimus-ide-collab-agent.log"),
				MaxSize:  5, // MB
			...
			for _, s := range strings.Split(subsystemsRaw, ",") {
				subsystem := optimus-ide-collabsdk.AgentSubsystem(strings.TrimSpace(s))
				if subsystem == "" {
					continue
				}
				if !subsystem.Valid() {
	...
	cmd.Options = serpent.OptionSet{
		{
			...
			Env:         "OPTIMUS-IDE-COLLAB_AGENT_LOG_DIR",
		...
		},
		{
			...
			Env:         "OPTIMUS-IDE-COLLAB_AGENT_SCRIPT_DATA_DIR",
			Value:       serpent.StringOf(&scriptDataDir),
		},
		{
			Flag:        "pprof-address",
			Default:     "127.0.0.1:6060",
			Env:         "OPTIMUS-IDE-COLLAB_AGENT_PPROF_ADDRESS",
			Value:       serpent.StringOf(&pprofAddress),
			Description: "The address to serve pprof.",
		},
		{
			Flag:        "agent-header-command",
			Env:         "OPTIMUS-IDE-COLLAB_AGENT_HEADER_COMMAND",
		...
		{
			Flag:        "agent-header",
			Env:         "OPTIMUS-IDE-COLLAB_AGENT_HEADER",
		...
		},
		{
			...
			Default:     "72h",
			Env:         "OPTIMUS-IDE-COLLAB_AGENT_SSH_MAX_TIMEOUT",
		...
		},
		{
			...
			Default:     "0",
			Env:         "OPTIMUS-IDE-COLLAB_AGENT_TAILNET_LISTEN_PORT",
		...
		},
		{
			...
			Env:         "OPTIMUS-IDE-COLLAB_AGENT_PROMETHEUS_ADDRESS",
		...
		},
		{
			...
			Env:         "OPTIMUS-IDE-COLLAB_AGENT_DEBUG_ADDRESS",
		...
		},
		{
			...
			Flag:        "log-human",
			Env:         "OPTIMUS-IDE-COLLAB_AGENT_LOGGING_HUMAN",
			Default:     "/dev/stderr",
		...
		},
		{
			...
			Flag:        "log-json",
			Env:         "OPTIMUS-IDE-COLLAB_AGENT_LOGGING_JSON",
			Default:     "",
		...
		},
		{
			...
			Env:         "OPTIMUS-IDE-COLLAB_AGENT_LOGGING_STACKDRIVER",
			Default:     "",
		...
		},
		{
			...
			Default:     "false",
			Env:         "OPTIMUS-IDE-COLLAB_AGENT_BLOCK_FILE_TRANSFER",
		...
		},
		{
			...
			Default:     "false",
			Env:         "OPTIMUS-IDE-COLLAB_AGENT_BLOCK_REVERSE_PORT_FORWARDING",
		...
		},
		{
			...
			Default:     "false",
			Env:         "OPTIMUS-IDE-COLLAB_AGENT_BLOCK_LOCAL_PORT_FORWARDING",
		...
		},
		{
			...
			Default:     "true",
			Env:         "OPTIMUS-IDE-COLLAB_AGENT_DEVCONTAINERS_ENABLE",
		...
		},
		{
			...
			Default:     "true",
			Env:         "OPTIMUS-IDE-COLLAB_AGENT_DEVCONTAINERS_PROJECT_DISCOVERY_ENABLE",
		...
		},
		{
			...
			Default:     "false",
			Env:         "OPTIMUS-IDE-COLLAB_AGENT_DEVCONTAINERS_DISCOVERY_AUTOSTART_ENABLE",
		...
		},
		{
			...
			Default:     "true",
			Env:         "OPTIMUS-IDE-COLLAB_AGENT_SOCKET_SERVER_ENABLED",
		...
		},
		{
			...
			Env:         "OPTIMUS-IDE-COLLAB_AGENT_BOUNDARY_LOG_PROXY_SOCKET_PATH",
			...
			UseInstead: []serpent.Option{
				{
					...
					Env:  "OPTIMUS-IDE-COLLAB_AGENT_FIREWALL_LOG_PROXY_SOCKET_PATH",
				},
			},
		},
		{
