...
func (r *RootCmd) templatePull() *serpent.Command {
	...
	cmd := &serpent.Command{
		...
		Handler: func(inv *serpent.Invocation) error {
			...
			var latestVersion optimus-ide-collabsdk.TemplateVersion
			{
			...
			if zipMode {
				fileFormat = optimus-ide-collabsdk.FormatZip
			}
			...
			if fileFormat == "" && ctype != optimus-ide-collabsdk.ContentTypeTar {
				return xerrors.Errorf("unexpected Content-Type %q, expecting %q", ctype, optimus-ide-collabsdk.ContentTypeTar)
			}
			if fileFormat == optimus-ide-collabsdk.FormatZip && ctype != optimus-ide-collabsdk.ContentTypeZip {
				return xerrors.Errorf("unexpected Content-Type %q, expecting %q", ctype, optimus-ide-collabsdk.ContentTypeZip)
			}
