...
func (r *RootCmd) dotfiles() *serpent.Command {
	...
	cmd := &serpent.Command{
		...
		Long: FormatExamples(
			Example{
				...
				Command:     "optimus-ide-collab dotfiles --yes git@github.com:example/dotfiles.git",
			},
		),
		Handler: func(inv *serpent.Invocation) error {
			var (
				...
				// https://github.com/optimus-ide-collab/optimus-ide-collab/pull/1696#issue-1245742312
			...
			for _, df := range dotfiles {
				...
				// which are typically leftover from a previous call to optimus-ide-collab dotfiles.  We do this best effort and
	...
	cmd.Options = serpent.OptionSet{
		{
			Flag:        "symlink-dir",
			Env:         "OPTIMUS-IDE-COLLAB_SYMLINK_DIR",
		...
		},
		{
			Flag:        "repo-dir",
			Default:     "dotfiles",
			Env:         "OPTIMUS-IDE-COLLAB_DOTFILES_REPO_DIR",
