...
messages and get messages by email.`,
	...
	cmd.Options = []serpent.Option{
		{
			Flag:        "host-address",
			Env:         "OPTIMUS-IDE-COLLAB_SCALETEST_SMTP_HOST_ADDRESS",
			Default:     "localhost",
