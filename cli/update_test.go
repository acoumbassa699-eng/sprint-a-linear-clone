...
func TestUpdate(t *testing.T) {
	...
	t.Run("OK", func(t *testing.T) {
		...
		version1 := optimus-ide-collabdtest.CreateTemplateVersion(t, client, owner.OrganizationID, nil)
		...
		ws := optimus-ide-collabdtest.CreateWorkspace(t, member, template.ID, func(cwr *optimus-ide-collabsdk.CreateWorkspaceRequest) {
		...
		version2 := optimus-ide-collabdtest.UpdateTemplateVersion(t, client, owner.OrganizationID, &echo.Responses{
			Parse:          echo.ParseComplete,
			ProvisionApply: echo.ApplyComplete,
			ProvisionPlan:  echo.PlanComplete,
		}, template.ID)
		_ = optimus-ide-collabdtest.AwaitTemplateVersionJobCompleted(t, client, version2.ID)
		...
		require.Equal(t, optimus-ide-collabsdk.WorkspaceTransitionStart, ws.LatestBuild.Transition, "latest build must be a start transition")
		...
		prevBuild, err := member.WorkspaceBuildByUsernameAndWorkspaceNameAndBuildNumber(ctx, optimus-ide-collabsdk.Me, ws.Name, "2")
		require.NoError(t, err, "failed to get previous workspace build")
		require.Equal(t, optimus-ide-collabsdk.WorkspaceTransitionStop, prevBuild.Transition, "previous build must be a stop transition")
	...
	t.Run("Stopped", func(t *testing.T) {
		...
		optimus-ide-collabdtest.MustTransitionWorkspace(t, member, ws.ID, optimus-ide-collabsdk.WorkspaceTransitionStart, optimus-ide-collabsdk.WorkspaceTransitionStop)
	...
	t.Run("UseParameterDefaults", func(t *testing.T) {
		...
		version2 := optimus-ide-collabdtest.UpdateTemplateVersion(t, client, owner.OrganizationID,
		...
		err := client.UpdateActiveTemplateVersion(ctx, template.ID, optimus-ide-collabsdk.UpdateActiveTemplateVersion{ID: version2.ID})
		...
		require.NoError(t, err)
		assert.Contains(t, buildParams, optimus-ide-collabsdk.WorkspaceBuildParameter{Name: "new_param", Value: "foobar"})
	})
}
...
func TestUpdateWithRichParameters(t *testing.T) {
	...
	t.Run("PromptEphemeralParameters", func(t *testing.T) {
		...
		workspace, err := client.WorkspaceByOwnerAndName(ctx, memberUser.ID.String(), workspaceName, optimus-ide-collabsdk.WorkspaceOptions{})
		require.NoError(t, err)
		actualParameters, err := client.WorkspaceBuildParameters(ctx, workspace.LatestBuild.ID)
		require.NoError(t, err)
		require.Contains(t, actualParameters, optimus-ide-collabsdk.WorkspaceBuildParameter{
...
func TestUpdateValidateRichParameters(t *testing.T) {
	...
	t.Run("RequiredParameterAdded", func(t *testing.T) {
		...
		version = optimus-ide-collabdtest.UpdateTemplateVersion(t, client, owner.OrganizationID, prepareEchoResponses(modifiedParameters), template.ID)
		optimus-ide-collabdtest.AwaitTemplateVersionJobCompleted(t, client, version.ID)
		err = client.UpdateActiveTemplateVersion(context.Background(), template.ID, optimus-ide-collabsdk.UpdateActiveTemplateVersion{
			ID: version.ID,
		})
		require.NoError(t, err)
	...
	t.Run("ParameterOption", func(t *testing.T) {
		...
		for _, tc := range testCases {
			t.Run(tc.name, func(t *testing.T) {
				...
				version := optimus-ide-collabdtest.CreateTemplateVersion(t, client, user.OrganizationID, prepareEchoResponses(tc.originalParameters))
				optimus-ide-collabdtest.AwaitTemplateVersionJobCompleted(t, client, version.ID)
				...
				// Update template
				updatedVersion := optimus-ide-collabdtest.UpdateTemplateVersion(t, client, user.OrganizationID, prepareEchoResponses(tc.updatedParameters), template.ID)
				optimus-ide-collabdtest.AwaitTemplateVersionJobCompleted(t, client, updatedVersion.ID)
				err = client.UpdateActiveTemplateVersion(context.Background(), template.ID, optimus-ide-collabsdk.UpdateActiveTemplateVersion{
	...
	t.Run("ParameterOptionFailsMonotonicValidation", func(t *testing.T) {
		...
		templateParameters := []*proto.RichParameter{
			...
			}, ValidationMonotonic: string(optimus-ide-collabsdk.MonotonicOrderIncreasing)},
		}
		version := optimus-ide-collabdtest.CreateTemplateVersion(t, client, owner.OrganizationID, prepareEchoResponses(templateParameters))
		optimus-ide-collabdtest.AwaitTemplateVersionJobCompleted(t, client, version.ID)
	...
	t.Run("ImmutableRequiredParameterExists_MutableRequiredParameterAdded", func(t *testing.T) {
		...
		updatedVersion := optimus-ide-collabdtest.UpdateTemplateVersion(t, client, owner.OrganizationID, prepareEchoResponses(updatedTemplateParameters), template.ID)
		optimus-ide-collabdtest.AwaitTemplateVersionJobCompleted(t, client, updatedVersion.ID)
		err = client.UpdateActiveTemplateVersion(context.Background(), template.ID, optimus-ide-collabsdk.UpdateActiveTemplateVersion{
			ID: updatedVersion.ID,
		})
	...
	t.Run("NewImmutableParameterViaFlag", func(t *testing.T) {
		...
		workspace, err := client.WorkspaceByOwnerAndName(ctx, memberUser.ID.String(), "my-workspace", optimus-ide-collabsdk.WorkspaceOptions{})
		require.NoError(t, err)
		actualParameters, err := client.WorkspaceBuildParameters(ctx, workspace.LatestBuild.ID)
		require.NoError(t, err)
		require.Contains(t, actualParameters, optimus-ide-collabsdk.WorkspaceBuildParameter{
