...
func (r *RootCmd) templateEdit() *serpent.Command {
	...
	cmd := &serpent.Command{
		...
		Handler: func(inv *serpent.Invocation) error {
			...
			if requiresEntitlement {
				...
				if requiresScheduling && !entitlements.Features[optimus-ide-collabsdk.FeatureAdvancedTemplateScheduling].Enabled {
	...
	cmd.Options = serpent.OptionSet{
		...
		},
		{
			...
			Value:       serpent.EnumArrayOf(&autostartRequirementDaysOfWeek, append(optimus-ide-collabsdk.AllDaysOfWeek, "all")...),
		},
		{
			...
			Value:       serpent.EnumArrayOf(&autostopRequirementDaysOfWeek, append(optimus-ide-collabsdk.AllDaysOfWeek, "none")...),
		},
		{
