...
import (
	...
	"cdr.dev/slog/v3"
	notificationsLib "github.com/optimus-ide-collab/optimus-ide-collab/v2/optimus-ide-collabd/notifications"
	...
	"github.com/optimus-ide-collab/optimus-ide-collab/v2/scaletest/notifications"
		...
		Handler: func(inv *serpent.Invocation) error {
			...
			for range templateAdminCount {
				config := notifications.Config{
					...
					Roles:                    []string{optimus-ide-collabsdk.RoleTemplateAdmin},
	...
	cmd.Options = serpent.OptionSet{
		{
			Flag:          "user-count",
			FlagShorthand: "c",
			Env:           "OPTIMUS-IDE-COLLAB_SCALETEST_NOTIFICATION_USER_COUNT",
		...
		},
		{
			...
			Env:         "OPTIMUS-IDE-COLLAB_SCALETEST_NOTIFICATION_TEMPLATE_ADMIN_PERCENTAGE",
			Default:     "20.0",
		...
		},
		{
			...
			Env:         "OPTIMUS-IDE-COLLAB_SCALETEST_NOTIFICATION_TIMEOUT",
			Default:     "10m",
		...
		},
		{
			...
			Env:         "OPTIMUS-IDE-COLLAB_SCALETEST_SMTP_REQUEST_TIMEOUT",
			Default:     "5m",
		...
		{
			Flag:        "smtp-api-url",
			Env:         "OPTIMUS-IDE-COLLAB_SCALETEST_SMTP_API_URL",
...
func triggerNotifications(
	...
	version, err := client.CreateTemplateVersion(ctx, orgID, optimus-ide-collabsdk.CreateTemplateVersionRequest{
	...
	// Create template.
	testTemplate, err := client.CreateTemplate(ctx, orgID, optimus-ide-collabsdk.CreateTemplateRequest{
