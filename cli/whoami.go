...
func (r whoamiRow) String() string {
	return fmt.Sprintf(
		Caret+"Optimus-IDE-Collab is running at %s, You're authenticated as %s !\n",
...
func (r *RootCmd) whoami() *serpent.Command {
	...
	cmd := &serpent.Command{
		...
		Use:         "whoami",
		Short:       "Fetch authenticated user info for Optimus-IDE-Collab deployment",
		...
		Handler: func(inv *serpent.Invocation) error {
			...
			// Get Optimus-IDE-Collab instance url
