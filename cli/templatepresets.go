	...
	cmd := &serpent.Command{
		...
		Long: FormatExamples(
			Example{
				...
				Command:     "optimus-ide-collab templates presets list my-template",
			},
			Example{
				Description: "List presets for a specific version of a template",
				Command:     "optimus-ide-collab templates presets list my-template --template-version my-template-version",
			},
		),
...
func (r *RootCmd) templatePresetsList() *serpent.Command {
	...
	cmd := &serpent.Command{
		...
		Handler: func(inv *serpent.Invocation) error {
			...
			var version optimus-ide-collabsdk.TemplateVersion
...
type TemplatePresetRow struct {
	// For json format
	TemplatePreset optimus-ide-collabsdk.Preset `table:"-"`
...
func formatPresetParameters(params []optimus-ide-collabsdk.PresetParameter) string {
...
// for outputting.
func templatePresetsToRows(presets ...optimus-ide-collabsdk.Preset) []TemplatePresetRow {
