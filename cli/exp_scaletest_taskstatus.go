...
import (
	...
	"github.com/optimus-ide-collab/optimus-ide-collab/v2/scaletest/taskstatus"
...
func (r *RootCmd) scaletestTaskStatus() *serpent.Command {
	...
	cmd := &serpent.Command{
		Use:   "task-status",
		Short: "Generates load on the Optimus-IDE-Collab server by simulating task status reporting",
...
After all runners connect, it waits for the baseline duration before triggering status reporting.`,
	...
	cmd.Options = serpent.OptionSet{
		...
		{
			Flag:        "template",
			Description: "Name or UUID of the template to use for the scale test. The template MUST include a optimus-ide-collab_external_agent and a optimus-ide-collab_app.",
