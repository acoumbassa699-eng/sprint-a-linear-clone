	...
	settings := []organizationSetting{
		{
			...
			Patch: func(ctx context.Context, cli *optimus-ide-collabsdk.Client, org uuid.UUID, input json.RawMessage) (any, error) {
			...
			Fetch: func(ctx context.Context, cli *optimus-ide-collabsdk.Client, org uuid.UUID) (any, error) {
		...
		},
		{
			...
			Patch: func(ctx context.Context, cli *optimus-ide-collabsdk.Client, _ uuid.UUID, input json.RawMessage) (any, error) {
			...
			Fetch: func(ctx context.Context, cli *optimus-ide-collabsdk.Client, _ uuid.UUID) (any, error) {
	...
	cmd := &serpent.Command{
		...
		Long: FormatExamples(
			Example{
				...
				Command:     "optimus-ide-collab organization settings set groupsync < input.json",
			},
		),
	...
	for _, set := range settings {
		...
		cmd.Children = append(cmd.Children, &serpent.Command{
			...
			Handler: func(inv *serpent.Invocation) error {
				...
				ctx := inv.Context()
				var org optimus-ide-collabsdk.Organization
	...
	cmd := &serpent.Command{
		...
		Long: FormatExamples(
			Example{
				...
				Command:     "optimus-ide-collab organization settings show groupsync",
			},
		),
		Options: []serpent.Option{},
		Middleware: serpent.Chain(
