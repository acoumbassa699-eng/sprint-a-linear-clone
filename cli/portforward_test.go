...
func TestPortForward(t *testing.T) {
	...
	cases := []struct {
		name    string
		network string
		// The flag(s) to pass to `optimus-ide-collab port-forward X` to port-forward this type
...
// nolint:unused
func runAgent(t *testing.T, client *optimus-ide-collabsdk.Client, owner uuid.UUID, db database.Store) database.WorkspaceTable {
