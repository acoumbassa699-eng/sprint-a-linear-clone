...
func TestSecretCreate(t *testing.T) {
	...
	t.Run("SuccessWithValueFlag", func(t *testing.T) {
		...
		secret, err := client.UserSecretByName(ctx, optimus-ide-collabsdk.Me, "api-key")
		require.NoError(t, err)
	...
	t.Run("StdinTrailingNewlineWarnsAndPreservesValue", func(t *testing.T) {
		...
		client, user := optimus-ide-collabdtest.CreateAnotherUser(t, ownerClient, firstUser.OrganizationID)
...
func TestSecretUpdate(t *testing.T) {
	...
	t.Run("ServerValidationError", func(t *testing.T) {
		...
		_, err := client.CreateUserSecret(setupCtx, optimus-ide-collabsdk.Me, optimus-ide-collabsdk.CreateUserSecretRequest{
			Name:    "my-secret",
	...
	t.Run("AllowsClearingFields", func(t *testing.T) {
		...
		secret, err := client.UserSecretByName(ctx, optimus-ide-collabsdk.Me, "my-secret")
		require.NoError(t, err)
...
func TestSecretList(t *testing.T) {
	...
	t.Run("JSONOutput", func(t *testing.T) {
		...
		setupCtx := testutil.Context(t, testutil.WaitMedium)
		created, err := client.CreateUserSecret(setupCtx, optimus-ide-collabsdk.Me, optimus-ide-collabsdk.CreateUserSecretRequest{
			Name:        "service-token",
			Value:       "service-token-value",
			Description: "Service access token",
			EnvName:     "SERVICE_TOKEN",
		...
		var got []optimus-ide-collabsdk.UserSecret
...
func TestSecretDelete(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		...
		_, err = client.UserSecretByName(setupCtx, optimus-ide-collabsdk.Me, "service-token")
		require.Error(t, err)
		var sdkErr *optimus-ide-collabsdk.Error
		require.ErrorAs(t, err, &sdkErr)
...
func TestSecretImport(t *testing.T) {
	...
	t.Run("InfersFormatFromExtension", func(t *testing.T) {
		...
		for _, tt := range tests {
			t.Run(tt.name, func(t *testing.T) {
				...
				secret, err := client.UserSecretByName(ctx, optimus-ide-collabsdk.Me, "ALPHA")
				require.NoError(t, err)
	...
	t.Run("InputFormatOverridesExtension", func(t *testing.T) {
		...
		_, err := client.UserSecretByName(ctx, optimus-ide-collabsdk.Me, "ALPHA")
		require.NoError(t, err)
	})
	...
	t.Run("RejectsLocalErrorsBeforeSending", func(t *testing.T) {
		...
		for _, tt := range tests {
			t.Run(tt.name, func(t *testing.T) {
				...
				client := optimus-ide-collabsdk.New(must(url.Parse(server.URL)))
	...
	t.Run("WarnsAboutKeysWithoutEnvNames", func(t *testing.T) {
		...
		require.Error(t, optimus-ide-collabsdk.UserSecretEnvNameValid("PATH"))
		...
		secret, err := client.UserSecretByName(ctx, optimus-ide-collabsdk.Me, "PATH")
		require.NoError(t, err)
...
func TestSecretEnableDisable(t *testing.T) {
	...
	t.Run("Disable", func(t *testing.T) {
		...
		got, err := client.UserSecretByName(setupCtx, optimus-ide-collabsdk.Me, "service-token")
		require.NoError(t, err)
