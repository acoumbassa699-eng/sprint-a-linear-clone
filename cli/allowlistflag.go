...
// AllowListFlag implements pflag.SliceValue for optimus-ide-collabsdk.APIAllowListTarget entries.
type AllowListFlag []optimus-ide-collabsdk.APIAllowListTarget

func AllowListFlagOf(al *[]optimus-ide-collabsdk.APIAllowListTarget) *AllowListFlag {
...
func (a AllowListFlag) Value() []optimus-ide-collabsdk.APIAllowListTarget {
	return []optimus-ide-collabsdk.APIAllowListTarget(a)
}
...
func (a *AllowListFlag) Append(value string) error {
	...
	var target optimus-ide-collabsdk.APIAllowListTarget
...
func (a *AllowListFlag) Replace(items []string) error {
	*a = []optimus-ide-collabsdk.APIAllowListTarget{}
