...
func TestTemplatePresets(t *testing.T) {
	...
	t.Run("NoPresets", func(t *testing.T) {
		...
		version := optimus-ide-collabdtest.CreateTemplateVersion(t, client, owner.OrganizationID, templateWithPresets([]*proto.Preset{}))
	...
	t.Run("ListsPresetsForDefaultTemplateVersion", func(t *testing.T) {
		...
		version := optimus-ide-collabdtest.CreateTemplateVersion(t, client, owner.OrganizationID, templateWithPresets(presets))
		_ = optimus-ide-collabdtest.AwaitTemplateVersionJobCompleted(t, client, version.ID)
		template := optimus-ide-collabdtest.CreateTemplate(t, client, owner.OrganizationID, version.ID)
	...
	t.Run("ListsPresetsForSpecifiedTemplateVersion", func(t *testing.T) {
		...
		activeVersion := optimus-ide-collabdtest.UpdateTemplateVersion(t, client, owner.OrganizationID, templateWithPresets([]*proto.Preset{}), template.ID)
		_ = optimus-ide-collabdtest.AwaitTemplateVersionJobCompleted(t, client, activeVersion.ID)
	...
	t.Run("ListsPresetsJSON", func(t *testing.T) {
		...
		version := optimus-ide-collabdtest.CreateTemplateVersion(t, client, owner.OrganizationID, templateWithPresets([]*proto.Preset{&preset}))
		_ = optimus-ide-collabdtest.AwaitTemplateVersionJobCompleted(t, client, version.ID)
		template := optimus-ide-collabdtest.CreateTemplate(t, client, owner.OrganizationID, version.ID)
		require.Equal(t, version.ID, template.ActiveVersionID)
