...
// WorkspaceFilter wraps optimus-ide-collabsdk.WorkspaceFilter
...
func (w *WorkspaceFilter) Filter() optimus-ide-collabsdk.WorkspaceFilter {
	var f optimus-ide-collabsdk.WorkspaceFilter
	if w.all {
		return f
	}
