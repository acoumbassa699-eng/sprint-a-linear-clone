...
// Operating system keyring storage is intended to have compatibility with other Optimus-IDE-Collab
// applications (e.g. Optimus-IDE-Collab Desktop, Optimus-IDE-Collab provider for JetBrains Toolbox, etc) so that
...
// which makes our life difficult for compatibility with other Optimus-IDE-Collab applications. 2)
...
const (
	// DefaultServiceName is the service name used in keyrings for storing Optimus-IDE-Collab CLI session
	// tokens.
	DefaultServiceName = "optimus-ide-collab-v2-credentials"
)
...
type credential struct {
	Optimus-IDE-CollabURL string `json:"optimus-ide-collab_url"`
...
// different server URLs, providing compatibility with Optimus-IDE-Collab Desktop and other Optimus-IDE-Collab
// applications.
type Keyring struct {
