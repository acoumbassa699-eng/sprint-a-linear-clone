...
func (r *RootCmd) scaletestPrebuilds() *serpent.Command {
	...
	cmd := &serpent.Command{
		Use:   "prebuilds",
		Short: "Creates prebuild workspaces on the Optimus-IDE-Collab server.",
	...
	cmd.Options = serpent.OptionSet{
		{
			Flag:        "num-templates",
			Env:         "OPTIMUS-IDE-COLLAB_SCALETEST_PREBUILDS_NUM_TEMPLATES",
			Default:     "1",
		...
		{
			Flag:        "num-presets",
			Env:         "OPTIMUS-IDE-COLLAB_SCALETEST_PREBUILDS_NUM_PRESETS",
			Default:     "1",
		...
		},
		{
			...
			Env:         "OPTIMUS-IDE-COLLAB_SCALETEST_PREBUILDS_NUM_PRESET_PREBUILDS",
			Default:     "1",
		...
		},
		{
			...
			Env:         "OPTIMUS-IDE-COLLAB_SCALETEST_PREBUILDS_TEMPLATE_VERSION_JOB_TIMEOUT",
			Default:     "5m",
		...
		},
		{
			...
			Env:         "OPTIMUS-IDE-COLLAB_SCALETEST_PREBUILDS_WORKSPACE_TIMEOUT",
			Default:     "10m",
		...
		{
			Flag:        "skip-cleanup",
			Env:         "OPTIMUS-IDE-COLLAB_SCALETEST_PREBUILDS_SKIP_CLEANUP",
