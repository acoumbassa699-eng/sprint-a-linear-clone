...
func workspaceLogs(ctx context.Context, client *optimus-ide-collabsdk.Client, wb optimus-ide-collabsdk.WorkspaceBuild, follow bool) ([]logLine, <-chan logLine, error) {
	logs := make([]logLine, 0)
