...
var testCases = []testCase{
	...
	},
	{
		...
		expectedError: "aigateway.optimus-ide-collabTLS.clientSecret.certKey and keyKey are required when name is set.",
	},
	{
		name:          "partial_ca_tls",
		fixture:       "fails_partial_ca_tls",
		expectedError: "aigateway.optimus-ide-collabTLS.caSecret.key is required when name is set.",
	},
	{
